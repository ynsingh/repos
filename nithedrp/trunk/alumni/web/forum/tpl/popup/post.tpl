...
%>
				...
				<jsp:setProperty name="Threads" property="posttext" value="<%= posttext %>"/>
...
<script language="javascript" type="text/javascript">
	...
	function refreshParent()
	{
		...
		var location = 'index.jsp?page=thread&threadid=<%= Threads.getThreadid() %>';
		...
		<form name="post" method="post">
			<table>
					...
					<td colspan="2" valign="middle">
						<table width="100%" height="40">
							<tr>
								...
								<td valign="middle"><span class="head">Post Message</span></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td valign="middle"><input type=text name="subject" size="80" value="<%= request.getParameter("subject") == null ? "" : request.getParameter("subject") %>">
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" align="right" valign=middle><input type="submit" name="post" value="Post" onClick="return checkForm()"></td>
				</tr>
