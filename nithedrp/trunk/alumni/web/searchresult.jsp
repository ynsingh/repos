...
<div class="wrapper">
	...
	<form  name="theForm" action="includes/alumnisearch1.jsp" method="post">
		...
		<div class="container" >
			...
			<div class="linepart1"><input type="radio" name="psearchtype" value="Firstname"  <%
					if(psearchtype.equals("Firstname"))
					out.println(" checked ");
					%> >&nbsp;<strong>First Name</strong></div>
			<div class="linepart1"><input type="radio" name="psearchtype" value="Lastname" <%
					if(psearchtype.equals("Lastname"))
					out.println(" checked ");
					%>>&nbsp;<strong>Last Name</strong></div>
			<div class="linepart1"><input type="radio" name="psearchtype" value="Department" <%
					if(psearchtype.equals("Department"))
					out.println(" checked ");
					%>>&nbsp;<strong>Department</strong></div>
			<div class="linepart1"><input type="radio" name="psearchtype" value="Batch" <%
					if(psearchtype.equals("Batch"))
					out.println(" checked ");
					%>>&nbsp;<strong>Passing out Year</strong></div>
		</div>
