...
<html>
    ...
    <s:select label="Institution" required="true" name="sim.institutionmaster.imId" headerKey="" headerValue="-- Please Select --" list="simImIdList" listKey="imId" listValue="imName" cssClass="textInput"/>
                                    ...
                                    <s:select label="College/Faculty/School Head Name" required="true" name="sim.employeemaster.empId" headerKey="" headerValue="-- Please Select --" list="empList" listKey="empId" listValue="empFname+' '+empMname+' '+empLname" cssClass="textInput"/>
                                    <s:select label="Type" required="true" name="sim.subinstitutiontype.erpmgmEgmId" headerKey="" headerValue="-- Please Select --" list="simTypeList" listKey="erpmgmEgmId" listValue="erpmgmEgmDesc" cssClass="textInput"/>
                                    <s:textfield required="true" requiredposition="left" maxLength="10" size="10"
                                                 label="Institution Short Name" name="sim.simShortName" title="Enter Short Name for InstitutionName" cssClass="textInput"/>
                                    <s:textfield required="true" requiredposition="left" maxLength="50" size="50"
                                                 label="Institution Address" name="sim.simAddressLine1" title="Enter Address" cssClass="textInput"/>
                ...
                onchange="getStateList('SaveSubInstitutionAction_sim_countrymaster_countryId','SaveSubInstitutionAction_sim_statemaster_stateId')" cssClass="textInput"/>
                                   <s:select label="State" required="true"  name="sim.statemaster.stateId" headerKey="" headerValue="-- Please Select --" list="statemasterList" listKey="stateId" listValue="stateName" cssClass="textInput"/>
                                    ...
                                    <s:textfield required="true" requiredposition="left" maxLength="50" size="50"
                                                 label="Institution E-Mail" name="sim.simEmailId" title="Enter Institution E-Mail Address"  cssClass="textInput"/>
                                </td>
                            </tr> <tr>
                                <td>
                                    <s:submit theme="simple" name="btnSubmit" value="Save Sub Institution"   cssClass="textInput"/>
                                </td>
                                <td>
                                    <s:submit theme="simple" name="bthReset" value="Clear" onclick="ClearSubInstitutionFields();" cssClass="textInput"/>
                                <td>
                            </tr>
                            <tr>
                    <td> <br><br> </td>
