...
// Generated Mar 10, 2011 3:52:34 PM by Hibernate Tools 3.2.1.GA
...
public class UserMessage  implements java.io.Serializable {
    ...
    public UserMessage(int umId) {
        this.umId = umId;
    }
    public UserMessage(int umId, Erpmusers erpmusersByUmFromErpmuId, ErpmGenMaster erpmGenMaster, Erpmusers erpmusersByUmToErpmuId, String umMessage, String umActionName, Date umRequestSubmissionDate, String umReqType, Short umReqTypeId, Integer umMsgId) {
       this.umId = umId;
