...
public List<ErpmItemRateTaxes> findAll() {
  ...
  public List<ErpmItemRateTaxes>  findByirdItemRateDetailsId(Integer irdItemRateDetailsId) {
        beginTransaction();
        List<ErpmItemRateTaxes> itemratetaxList  = getSession().createQuery("Select u from ErpmItemRateTaxes u where u.erpmItemRateDetails.irdItemRateDetailsId = :irdItemRateDetailsId").setParameter("irdItemRateDetailsId", irdItemRateDetailsId).list();
        commitTransaction();
   ...
   public List<ErpmItemRateTaxes>  findByindtDetailsId(Integer irdItemRateDetailsId) {
        beginTransaction();
        List<ErpmItemRateTaxes> indentList  = getSession().createQuery("Select u from ErpmItemRateTaxes u where u.erpmItemRateDetails.irdItemRateDetailsId = :irdItemRateDetailsId").setParameter("irdItemRateDetailsId", irdItemRateDetailsId).list();
        commitTransaction();
       return indentList;
   }
