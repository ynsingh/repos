...
public ErpmItemRateDetails findIndentRateDetailId(Integer irdItemRateDetailsId) {
        beginTransaction();
        List<ErpmItemRateDetails> itemratedet  = getSession().createQuery("Select u from ErpmItemRateDetails u where u.irdItemRateDetailsId = :irdItemRateDetailsId").setParameter("irdItemRateDetailsId",irdItemRateDetailsId).list();
        commitTransaction();
