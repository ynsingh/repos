...
public class ManageInstitutionUserRole  extends DevelopmentSupport {
  ...
  public void seterpmpList(List<Erpmprogram> erpmpList) {
    ...
    //This method setusp editing of a particular privilege given to a role in an institution
    ...
    public String AddIURP() throws Exception {
        try {
           ...
           erpmpList = erpmpDao.findByErpmmId(Byte.parseByte("1"));
           //Retrieve IUR Record
