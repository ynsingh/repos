...
public class Subinstitutionmaster  implements java.io.Serializable {
    ...
    public Subinstitutionmaster(Statemaster statemaster, Employeemaster employeemaster, Countrymaster countrymaster, Institutionmaster institutionmaster, String simName, String simShortName, Integer simType, String simAddressLine1, String simAddressLine2, String simDistrict, String simPinNo, String simEmailId, String simHeadDesignation, Set workflowmasters, Set budgetmasters, Set departmentalBudgetAllocations, Set erpmPoMasters, Set committeemasters, Set itemcategories, Set erpmPurchasechallanMasters, Set employeemasters, Set erpmuserroles, Set erpmIndentMasters, Set departmentmasters, Set supplierregistrationauthorities) {
