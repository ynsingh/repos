...
public class Institutionroleprivileges  implements java.io.Serializable {
    ...
    public Institutionroleprivileges(Institutionmaster institutionmaster, Erpmprogram erpmprogram, Erpmmodule erpmmodule, Institutionuserroles institutionuserroles, Boolean iupCanAdd, Boolean iupCanDelete, Boolean iupCanEdit, Boolean iupCanView, Set erpmuserdepartmentses) {
