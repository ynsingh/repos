...
//        List<SupplierAddress> saList = getSession().createQuery("Select u, concat(u.adLine1, u.adLine2, u.adCity) as FullAddress from SupplierAddress u where u.suppliermaster.smId = :smId").setParameter("smId", smId).list();
        commitTransaction();
        return saList;
    }

//    public List<SupplierAddress> findBySuppId(Integer smId) {
//        beginTransaction();
////        List<SupplierAddress> saList = getSession().createQuery("Select u from SupplierAddress u where u.suppliermaster.smId = :smId").setParameter("smId", smId).list();
//        List<SupplierAddress> supList = getSession().createQuery("Select u.supAdId, concat(u.adLine1, u.adLine2, adCity) as FullAddress from SupplierAddress u where u.suppliermaster.smId = :smId").setParameter("smId", smId).list();
//        commitTransaction();
//        return supList;
//    }
