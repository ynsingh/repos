...
public class InstitutionAction extends DevelopmentSupport {
    ...
    public String Edit() throws Exception {
        try {
            if (getImId().shortValue() == Short.valueOf(getSession().getAttribute("imId").toString())) {
                ...
                message = "You cannot EDIT any other Institution's record.";
                return INPUT;
            }
        } catch (Exception e) {
    ...
    public String Delete() {
        message = "You cannot DELETE any Institution record.";
        return INPUT;
    }
    ...
    public String Print() throws Exception {
        ...
        String repPath = "pico" + pathSeparator + "Administration" + pathSeparator + "Reports" + pathSeparator + "Institution.jasper";
...
//        response.setHeader("Content-Disposition","attachment; filename=\"Institutions.pdf\"");
    ...
    private void prepare_lovs() {
        ...
        Short IM_ID = Short.parseShort(getSession().getAttribute("imId").toString());
        //Institutionmaster im3=imDaofindInstByIMShortName(IM_SN);
        //Institutionmaster im3=imDao.findByImId(IM_ID);
