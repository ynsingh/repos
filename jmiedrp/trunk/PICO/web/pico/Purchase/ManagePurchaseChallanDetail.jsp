        ...
        <div id="container">
            ...
            <div id ="mainContent" align="left">
                ...
                <div style="background-color: #215dc6;  " >
                    <p align="center" class="pageHeading" style="color:  #ffffff"> &nbsp;MANAGE PURCHASE CHALLAN DETAILS</p>
                    ...
                    <s:form name="FrmPurchaseChallanDetails" action="SavePurchaseChallanDetail" theme="qxhtml">
                        ...
                        <table border="0" cellpadding="4" cellspacing="0" align="center" >
                            <tbody>
                                <tr>
                                    <td>
                                       ...
                                       label="You are now Adding Details for the PC ID NO:" name="defaultPCM" title="" readonly="true"/>     --%>
                                        ...
                                        <s:textfield maxLength="30" size="30" label="PO No"  value="%{purchaseOrderNo}"   cssClass="textInputRO" readonly="true" >
                                            <s:param name="labelcolspan" value="%{1}" />
                                            <s:param name="inputcolspan" value="%{3}" />
                                        </s:textfield>
                                        <s:label value=". . ." cssClass="tdSpace"/>
                                        <s:textfield  cssClass="textInputRO"  maxLength="50" size="50"
                                                      label="Challan No" name="PChallanMast.pcmChallanNo" title="" readonly="true">
                                            <s:param name="labelcolspan" value="%{1}" />
                                            <s:param name="inputcolspan" value="%{3}" />
                                        </s:textfield>
                                        <s:textfield  cssClass="textInputRO"  maxLength="50" size="50"
                                                      label="Insitute Name" name="PChallanMast.institutionmaster.imName" title="" readonly="true" value="%{institutionName}" >
                                            <s:param name="labelcolspan" value="%{1}" />
                                            <s:param name="inputcolspan" value="%{3}" />
                                        </s:textfield>
                                        <s:label value=". . ." cssClass="tdSpace"/>
                                        <s:textfield  cssClass="textInputRO"  maxLength="50" size="50"
                                                      label="College/Faculty/School" name="PChallanMast.subinstitutionmaster.simName" title="" readonly="true" value="%{subInstitutionName}" >
                                            <s:param name="labelcolspan" value="%{1}" />
                                            <s:param name="inputcolspan" value="%{3}" />
                                        </s:textfield>
                                        <s:textfield  cssClass="textInputRO"  maxLength="50" size="50" value="%{departmentName}"
                                                      label="Department" name="PChallanMast.departmentmaster.dmName" title="" readonly="true" >
                                            <s:param name="labelcolspan" value="%{1}" />
                                        ...
                                        <s:select cssClass="textInput" label="Item Name" name="PCDetail.erpmItemMaster.erpmimId" headerKey="" headerValue="-- Please Select --" list="poditemlist" listKey="erpmItemMaster.erpmimId"
                                ...
                                <tr>
                                    <td align="centre">
                                        <s:submit cssClass="savebutton"  name="btnSubmit" value="Add Items" disabled="PcdDisable"/>

                                        <s:submit  cssClass="savebutton"  name="btnSubmit" value="Clear" action="ClearPurchaseChallanDetail" />

                                        <s:submit  cssClass="savebutton"  name="btnSubmit" value="Save Check & Verify" action="SaveCheckAndVerify" disabled="btnCheckAndVerifySave" />
                                    </td>
                ...
                <s:if test="PCDetailslist.size() > 0">
                        <hr>
                        <s:label value="Challan details are: "/>
                <s:form name="FrmPurchaseChallanDetails">
                                ...
                                <display:column paramId="PCDETID" paramProperty="pcdPcdId"  maxLength="100"
