        ...
        <div id="container" >
            <div id="headerbar1">
                ...
                <div style="border: solid 1px #000000; background: gainsboro">
                    ...
                    <s:form name="frmDMU" action="DataManagementUtilityAction"  theme="qxhtml">
                        ...
                        <table border="0" cellpadding="8" cellspacing="0" align="center" >
                            <tbody>
                                ...
                                <s:textarea cssClass="textArea"  rows="25" cols="120" label="SQL To Be Executed" name="sQLToBeExecuted" maxLength="150">
                                ...
                                <tr><td align="left">
                                        <s:submit theme="simple" name="btnexe" value="Execute" action="ExecuteSqlQuery" />

                                    </td><td align="left">

                                        <s:submit theme="simple" name="bthReset" value="Clear"  action="ClearDMU"  />
