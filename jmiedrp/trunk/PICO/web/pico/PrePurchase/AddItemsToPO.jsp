        ...
        <div id="container">
            ...
            <div id ="mainContent" align="left">
                 ...
                 <div style="background-color: #215dc6;">
                             <p align="left" class="pageHeading" style="color:  #ffffff"> &nbsp;Step 3 of 5 (Add Non-Indented Items to PO)</p>
            ...
            <s:iterator value="{1,1,1,1,1,1}">
                <s:label value="..." cssClass="tdSpace"/>
                    ...
                    <s:label value="In the following section, please add items to the PO" cssClass= "pageSubHeadingBlue">
                                <s:param name="labelcolspan" value="%{0}" />
                                <s:param name="inputcolspan" value="%{11}" />
                    </s:label>

                    <s:if test="(editPODetail=='ON')">
                    <s:select   cssClass="textInputRO" label="Items" name="podetail.erpmItemMaster.erpmimId" headerKey="" headerValue="-- Please Select --"
                    ...
                    <s:else>
                    <s:select   cssClass="textInput" label="Items" name="podetail.erpmItemMaster.erpmimId" headerKey="" headerValue="-- Please Select --"
                    ...
                    <s:textfield  cssClass="textInput"  maxLength="5" size="30" label="Quantity" name="podetail.podQuantity" 
                   ...
                   <s:textfield    requiredposition="left" maxLength="5" size="30" cssClass="textInputRO"
                    ...
                    <s:textfield  maxLength="20" size="12"  label="Cost" name="approxcost" cssClass="textInputRO"
                                  title="" onkeypress="return isNumberKey(event)" readonly="true">
                                <s:param name="labelcolspan" value="%{1}" />
                                <s:param name="inputcolspan" value="%{1}" />
                    </s:textfield>

                    <s:select  cssClass="textInput" label="Rates" name="podetail.erpmItemRate.irItemRateId" headerKey="" headerValue="-- Please Select --" required="true"
                   ...
                   <s:textfield requiredposition="left" maxLength="5" size="30" cssClass="textInputRO"
                    ...
                    <s:textfield   requiredposition="left" maxLength="15" size="15" cssClass="textInputRO"
                                   label="Tot. Cost" name="totalCost" readonly="true" title="Total Cost">
                                <s:param name="labelcolspan" value="%{2}" />
                                <s:param name="inputcolspan" value="%{1}" />
                    </s:textfield>
                   ...
                   <s:textfield requiredposition="left" maxLength="5" size="30" cssClass="textInputRO"
                                label="Purchase Unit" name="UOP"  readonly="true">
                                <s:param name="labelcolspan" value="%{1}" />
                                <s:param name="inputcolspan" value="%{1}" />
                    </s:textfield>
                    ...
                    <s:textfield    requiredposition="left" maxLength="5" size="30" cssClass="textInputRO"
                                    label="Valid From" name="selectedItemRateValidFrom" readonly="true" title="Rate valid from date">
                                    <s:param name="labelcolspan" value="%{1}" />
                                    <s:param name="inputcolspan" value="%{1}" />
                    </s:textfield>
                    ...
                    <s:textfield    requiredposition="left" maxLength="5" size="30" cssClass="textInputRO"
                                    label="Valid To" name="selectedItemRateValidTo" readonly="true" title="Rate valid till date">
                                    <s:param name="labelcolspan" value="%{1}" />
                                    <s:param name="inputcolspan" value="%{1}" />
                    </s:textfield>
                    ...
                    <s:textfield    requiredposition="left" maxLength="5" size="30" cssClass="textInputRO"
                                    label="Max Order Qty" name="maxOrderQuantity" readonly="true">
                                    <s:param name="labelcolspan" value="%{2}" />
                                    <s:param name="inputcolspan" value="%{1}" />
                    </s:textfield>
                    ...
                    <s:submit name="btnAddItemToPO" value="Add Item" action="addNonIndentedItemsToPO">
                    ...
                    <s:submit name="btnPrintPO" value="Distribution (5)"  title="Item(s) Distribution (Step -5)" action="prepareItemDeliveryLocationsForPO" disabled="false">
                          <s:param name="colspan" value="%{1}" />
                    </s:submit>
                ...
                <s:label value="Items in the Purchase Order" cssClass= "pageSubHeadingBlue">
                        <s:param name="labelcolspan" value="%{0}" />
                        <s:param name="inputcolspan" value="%{11}" />
                </s:label>
                <hr>
