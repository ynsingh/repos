...
<html>
    ...
    <body class="twoColElsLtHdr">
        <div id="container">
            ...
            <p align="center"><s:label cssClass="pageHeading" value="ITEM RATES HISTORY" style="color: #ffffff"  /></p>
...
use where only number is required for input other than number it does not accept value
 ...
 <table border="0" cellpadding="4" cellspacing="0" align="center" >
                    ...
                    <tr>
                    <td>
                        <s:select name="institutionId" label="Institution" headerKey="" headerValue="-- Please Select --" list="imList" listKey="imId" listValue="imName"
                   ...
                   <s:label value=". . ." cssClass="tdSpace"/>
                      ...
                      <s:textfield  required="true" requiredposition="left" maxLength="10" size="15" title="Enter warranty duration in months"
              ...
              <tr>
                <td align="right">
                    <s:submit  name="btnSubmit" value="Export Item Rates History" action="SubmitItemRateHistory"/>
                    </td>
