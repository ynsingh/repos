...
YAHOO.extend(YAHOO.widget.TextNode, YAHOO.widget.Node, {
     ...
     * @property outlabelStyle
     * @property labelStyle
     * @type string
     */
    outlabelStyle: "ygtvlabel",
    innerlabelStyle: "innerygtvlabel",
    /**
    ...
    setUpLabel: function(oData) { 
        ...
        if (oData.style) {
            this.labelStyle = oData.style;
             this.innerlabelStyle = oData.style;
        }
    ...
    getNodeHtml: function() { 
        ...
        for (var i=0;i<this.depth;++i) {
            ...
            sb[sb.length] = '<td  width="10%" class="' + this.getDepthStyle(i) + '">  </td>';
        }
        ...
        */
        ...
        sb[sb.length] = '</td>';
              if(this.depth=="0"){
        sb[sb.length] = '<td width=90% columnspan=2>';
       // sb[sb.length] = ' class="' + this.colum + '"';
        sb[sb.length] = '<a ';
        sb[sb.length] = ' id="' + this.labelElId + '"';

           sb[sb.length] = ' class="' + this.outlabelStyle + '"';
        }else{
                sb[sb.length] = '<td width=80%>';
       // sb[sb.length] = ' class="' + this.colum + '"';
        sb[sb.length] = '<a ';
        sb[sb.length] = ' id="' + this.labelElId + '"';
            sb[sb.length] = ' class="' + this.innerlabelStyle + '"';
         }
      ...
      // sb[sb.length]='<div align="left">'
        ...
        sb[sb.length] = '</td>';
          if(this.labelElId!="ygtvlabelel1"){
            sb[sb.length] = '<td>';
              sb[sb.length] = '</td>';
          }
        sb[sb.length] = '</tr>';
...
YAHOO.extend(YAHOO.widget.HTMLNode, YAHOO.widget.Node, {
    ...
    getNodeHtml: function() { 
        ...
        sb[sb.length] = '<table border="2" cellpadding="3" cellspacing="0">';
        sb[sb.length] = '<tr>';
