<g:form url="[controller:'quiz',action:'cfillblanks']" name="addQuizFrom" method="post">
	...
	<input type="hidden" name="qnId" id="qnId" value="0">
     <input type="hidden" name="ansType" id="ansType" value="fib"> 
	<div id="addFibQuestion" align="center" width="40%">
			<div id="addFibDiv" class="quizTable" align="center">
				<input type="hidden" name="qnTypeId" id="qnTypeId" value="4">
                <h3 id="qnHeader">Add Fill in the blank Question</h3>
                <br>
                <table width="100%" border="0">
                    <tbody>
                        <tr>
                            <td height="124" colspan="4" align="left"
                                style="padding-left: 10px;"><textarea class="fibdndquiztext" id="fillqnText" name="qnText" 
                        ...
                        <tr><td>
                            <div align="center" style="padding-left: 18px;">
                                <textarea style="font-style: italic;" onmouseout="" name="hintText" id="hintText" cols="45">Hint</textarea>
                ...
                <div align="center">
                    <input type="submit" name="addNewQn" id="addNewQn" value="&nbsp;Create Question&nbsp;" 
                        onclick="return validateFibDndQuiz('fillqnText');">&nbsp;&nbsp; <input
                        type="button" class="cancelBtn" value="&nbsp;Cancel&nbsp;"
                        id="cancel" name="cancel" onclick='closeDivs("addFill");'>
                </div>
                <br>
				</div>
	</div>
