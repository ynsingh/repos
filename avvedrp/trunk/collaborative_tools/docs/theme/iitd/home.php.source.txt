...
<div style="padding-left:35px; padding-top:5px; padding-right:10px">
    ...
    <div class="menuText" align="left">Featured Simulation</div>
			<div align="left">				                
                <a href="">
                <div><span class="featuredTitle">Wireless Lab</span><br />
                <img src="<?php echo getThemeImage('ico_wirelesss_lab.jpg');?>" /> 
                <p class="text-yellowBox"> In telecommunications, wireless communication is the transfer of information without the use of wires.The distances involved may be short (a few meters as in television remote control) or long (thousands or millions of kilometers for radio communications).</p> 
	...
	<tr>
        ...
        <div>
          ...
          <div class="title-box-roundfg">
            <div class="title-main-page">&nbsp;Virtual Labs at IIT Delhi</div>
          </div>
        ...
        <img src="<?php echo getThemeImage('icons-all.jpg');?>" width="480" border="0" usemap="#Map" align="right" />
        </div>
      </td>
	</tr>
...
<div>
  ...
  <div class="text-yellowBox" style="background-color:#FBF5F7">
    <img src="<?php echo getThemeImage('icon-earth.jpg');?>" alt="Virtual Lab" width="49" height="59" align="left" />Lab courses richly rely upon new up-to-date content and various techniques that require a new synergy of knowledge and experimental implementation. <br/><a href="#">More>></a> <br/></div>
    </div>
		    <td width="46">&nbsp;</td>
		    </tr>
		  </table></td>
