...
<!-- Middle area starts here -->	
		...
		<div style="float: left; width: 790px; margin-right: 5px;">
		              <div align="center"><h3>${sel_course}</h3></div>
                        ...
                        <param name="movie" value="${resource(dir:'charts',file:'staff_visual_details .swf')}" />
                        <param name="quality" value="high" />
                        <param name="bgcolor" value="#ffffff" />
                        <param name="allowScriptAccess" value="sameDomain" />
                        <param name="allowFullScreen" value="true" />
                        <!--[if !IE]>-->
                        <object type="application/x-shockwave-flash" data="${resource(dir:'charts',file:'staff_visual_details.swf')}" width="100%" height="600">
                        <param name="quality" value="high" />
                        <param name="bgcolor" value="#ffffff" />
                        <param name="allowScriptAccess" value="sameDomain" />
                        <param name="allowFullScreen" value="true" />
