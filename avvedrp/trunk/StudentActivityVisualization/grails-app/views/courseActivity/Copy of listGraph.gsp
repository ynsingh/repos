...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr >
    <td><img src="../header.jpg"   border="0"></td>
  </tr>
  ...
  <tr>
    <td height="479" align="center" valign="top" ><table width="59%" class="table"  cellspacing="0"  cellpadding="0">
      ...
      <tr >
        ...
        <g:link action="listSite" id="${params.siteId}" params="[siteId:params.siteId,siteName:params.siteName]">
        <img src="../visualDetails.jpg" border="0" /></g:link></td>
        <td  width="137" height="90" class="table" >
        <g:link action="listSiteEvent" id="${params.siteId}" params="[siteId:params.siteId,siteName:params.siteName]">
        <img src="../timeUtilZ.jpg" border="0"/>
        </g:link>
        </td>
        <td  width="137" height="90" class="table">
        <g:link action="listUser" id="${params.siteId}" params="[siteId:params.siteId,siteName:params.siteName]">
        <img src="../summary.jpg"  border="0"/></g:link></td>
        <td  width="184"  height="90"  class="table">
        <g:link action="list" id="${params.siteId}" params="[siteId:params.siteId,siteName:params.siteName]">
      ...
      <tr>
        <td height="37" class="table" colspan="4"> 
        <span class="menuButton"><a class="home" href="${resource(dir:'')}"><font color="#333" face="verdana" size="2">Home</font></a></span>
        &nbsp;</td>
      </tr>
    </table></td>
  </tr>
