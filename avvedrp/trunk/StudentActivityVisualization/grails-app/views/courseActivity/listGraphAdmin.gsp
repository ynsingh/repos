	...
	<div id="container">
		...
		<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		    ...
		    <td><g:link action="listAdmin" id="${params.siteId}" params="[siteId:params.siteId,siteName:params.siteName]"><img src="../summaryCourseAnalyitic.jpg" border="0" /></g:link></td>
