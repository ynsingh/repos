...
<g:if test="${flash.message}">
	...
	<center>
		...
		<div class="dialog">
		<br /><br /><h3><g:message code="Edit Expense"/></h3> <br />
			<table >
				<tbody>
				   <tr class="prop">
		...
		<div>
			<g:actionSubmit class="pushbutton" value="Update" action="updateExpense" />
			<g:actionSubmit class="pushbutton" value="Delete"  action="deleteExpense"/>
		</div>
		</center>
	</g:form>
</div>