...
<center>
		<div class="dialog">
			<table >
			<br /><br /><h3><g:message code="Expense Details"/></h3> <br />
				<tbody>
		...
		<div>
		<div>
			<g:actionSubmit class="pushbutton" value="Save" action="saveExpense" />
...
<div class="body">
	<div class="list">
	<center>
	<fieldset style="width:45%; border-color:transparent; padding:0;">
	  <div id="listExpense">
		<table frame="box">
			<thead>
