<div id="menus_wrapper">
    <div id="sec_menu">
          ...
          <li><a class="house" href="${createLink(action:'listStaffCourses',controller:'courseActivity')}">Home</a></li>
          </g:if>
	     ...
	     <g:if test="${session.ROLE == 'ROLE_INSTITUTE'}"  >
          ...
          <g:if test="${session.ROLE == 'ROLE_ADMIN' || session.ROLE == 'ROLE_UNIVERSITY'}"  >
          <li><a class="dashboard" href="${createLink(action:'admindashboard',controller:'dashboard')}">Dashboard</a></li>
          </g:if>
		  
		   <g:if test="${session.ROLE == 'ROLE_INSTITUTE'}"  >
          <li><a class="dashboard" href="${createLink(action:'institutedashboard',controller:'dashboard')}">Dashboard</a></li>
          </g:if>
