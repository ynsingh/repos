...
<div id="body">
		...
		<g:form controller="staffDetails" >
				<center>
						<div class="dialog">
								<table >
										<br /><br /><h3><g:message code="Non-teaching Staff Details"/></h3> <br />
										<tbody>
												<tr class="prop">
														...
														<td valign="top"  class="value">
																<g:select from= "${ntsTypeList}" id="ntsType" optionKey="id" name="ntsType" noSelection="['null':'-Select-']" value="${staffDetailsInstance?.ntsType}"></g:select>
														</td>
						...
						<div>
								<g:actionSubmit class="pushbutton" value="Save" action="saveNonteachingStaff" />
