...
jdbcUrl="<%=jdbc_url%>"
catalogUri="/WEB-INF/queries/projectExpense.xml">

SELECT {[Measures].[AccountHead Allocated],[Measures].[Expense Amount]} ON COLUMNS,
NON EMPTY {([Institution],[ProjectName],[AccountHhead])} ON ROWS
FROM [Projects]
