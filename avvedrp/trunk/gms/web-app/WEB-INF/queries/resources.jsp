...
jdbcUrl="<%=jdbc_url%>"
catalogUri="/WEB-INF/queries/resources.xml">

SELECT {[Measures].[No Of Resources],[Measures].[Cost]} ON COLUMNS,
  NON EMPTY {([Project],[Institute].[All Institute],[Resource Type])} ON ROWS
FROM [Resources]
 </jp:mondrianQuery>
 <c:set var="title01" scope="session">Resources details using Mondrian OLAP</c:set>
