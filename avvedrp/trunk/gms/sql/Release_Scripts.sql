...
MySQL - 5.0.19-nt : Database - gms_test1**********************************************************************//*!40101 SET NAMES utf8 */;/*!40101 SET SQL_MODE=''*/;/*!40014 SET @OLD_UNIQUE_CHECKS=@@UNIQUE_CHECKS, UNIQUE_CHECKS=0 */;/*!40014 SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0 */;/*!40101 SET @OLD_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO' */;/*!40111 SET @OLD_SQL_NOTES=@@SQL_NOTES, SQL_NOTES=0 */;CREATE DATABASE /*!32312 IF NOT EXISTS*/`gms_test1` /*!40100 DEFAULT CHARACTER SET latin1 */;USE `gms_test1`;/*Table structure for table `account_heads` */DROP TABLE IF EXISTS `account_heads`;CREATE TABLE `account_heads` (
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `acl_class` */DROP TABLE IF EXISTS `acl_class`;CREATE TABLE `acl_class` (
  `id` bigint(20) NOT NULL auto_increment,
  `class` varchar(255) NOT NULL,
  PRIMARY KEY  (`id`),
  UNIQUE KEY `class` (`class`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `acl_entry` */DROP TABLE IF EXISTS `acl_entry`;CREATE TABLE `acl_entry` (
  `id` bigint(20) NOT NULL auto_increment,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `acl_object_identity` */DROP TABLE IF EXISTS `acl_object_identity`;CREATE TABLE `acl_object_identity` (
  `id` bigint(20) NOT NULL auto_increment,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `acl_sid` */DROP TABLE IF EXISTS `acl_sid`;CREATE TABLE `acl_sid` (
  `id` bigint(20) NOT NULL auto_increment,
  `principal` bit(1) NOT NULL,
  `sid` varchar(255) NOT NULL,
  PRIMARY KEY  (`id`),
  UNIQUE KEY `sid` (`sid`,`principal`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `approval_authority` */DROP TABLE IF EXISTS `approval_authority`;CREATE TABLE `approval_authority` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `approval_authority_detail` */DROP TABLE IF EXISTS `approval_authority_detail`;CREATE TABLE `approval_authority_detail` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `attachment_type` */DROP TABLE IF EXISTS `attachment_type`;CREATE TABLE `attachment_type` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) default NULL,
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `attachments` */DROP TABLE IF EXISTS `attachments`;CREATE TABLE `attachments` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `audit_log` */DROP TABLE IF EXISTS `audit_log`;CREATE TABLE `audit_log` (
  `id` bigint(20) NOT NULL auto_increment,
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `authority` */DROP TABLE IF EXISTS `authority`;CREATE TABLE `authority` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `authority_person` */DROP TABLE IF EXISTS `authority_person`;CREATE TABLE `authority_person` (
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `award` */DROP TABLE IF EXISTS `award`;CREATE TABLE `award` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `eligibility_check` */DROP TABLE IF EXISTS `eligibility_check`;CREATE TABLE `eligibility_check` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `description` varchar(255) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `eligibility_criteria` */DROP TABLE IF EXISTS `eligibility_criteria`;CREATE TABLE `eligibility_criteria` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `eligibility_status` */DROP TABLE IF EXISTS `eligibility_status`;CREATE TABLE `eligibility_status` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `description` varchar(255) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `employee_designation` */DROP TABLE IF EXISTS `employee_designation`;CREATE TABLE `employee_designation` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `designation` varchar(255) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `eval_answer` */DROP TABLE IF EXISTS `eval_answer`;CREATE TABLE `eval_answer` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `eval_item` */DROP TABLE IF EXISTS `eval_item`;CREATE TABLE `eval_item` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `eval_item_notification_map` */DROP TABLE IF EXISTS `eval_item_notification_map`;CREATE TABLE `eval_item_notification_map` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) default NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `eval_scale` */DROP TABLE IF EXISTS `eval_scale`;CREATE TABLE `eval_scale` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `eval_scale_options` */DROP TABLE IF EXISTS `eval_scale_options`;CREATE TABLE `eval_scale_options` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `eval_score` */DROP TABLE IF EXISTS `eval_score`;CREATE TABLE `eval_score` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `expense_request` */DROP TABLE IF EXISTS `expense_request`;CREATE TABLE `expense_request` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `expense_request_entry` */DROP TABLE IF EXISTS `expense_request_entry`;CREATE TABLE `expense_request_entry` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `created_by` varchar(255) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `full_proposal` */DROP TABLE IF EXISTS `full_proposal`;CREATE TABLE `full_proposal` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `created_by` varchar(255) default NULL,
  `created_date` datetime default NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `full_proposal_detail` */DROP TABLE IF EXISTS `full_proposal_detail`;CREATE TABLE `full_proposal_detail` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `full_proposal_grant` */DROP TABLE IF EXISTS `full_proposal_grant`;CREATE TABLE `full_proposal_grant` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `fund_transfer` */DROP TABLE IF EXISTS `fund_transfer`;CREATE TABLE `fund_transfer` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `gms_settings` */DROP TABLE IF EXISTS `gms_settings`;CREATE TABLE `gms_settings` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) default NULL,
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `grant_allocation` */DROP TABLE IF EXISTS `grant_allocation`;CREATE TABLE `grant_allocation` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `grant_allocation_split` */DROP TABLE IF EXISTS `grant_allocation_split`;CREATE TABLE `grant_allocation_split` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `account_head_id` bigint(20) NOT NULL,
  `amount` double NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `grant_allocation_tracking` */DROP TABLE IF EXISTS `grant_allocation_tracking`;CREATE TABLE `grant_allocation_tracking` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `created_by` varchar(255) NOT NULL,
  `created_date` datetime NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `grant_expense` */DROP TABLE IF EXISTS `grant_expense`;CREATE TABLE `grant_expense` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `grant_period` */DROP TABLE IF EXISTS `grant_period`;CREATE TABLE `grant_period` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) NOT NULL,
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `grant_receipt` */DROP TABLE IF EXISTS `grant_receipt`;CREATE TABLE `grant_receipt` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `amount` double NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `graphs` */DROP TABLE IF EXISTS `graphs`;CREATE TABLE `graphs` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `graph_type` varchar(255) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `investigator` */DROP TABLE IF EXISTS `investigator`;CREATE TABLE `investigator` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `item_purchase` */DROP TABLE IF EXISTS `item_purchase`;CREATE TABLE `item_purchase` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `notification` */DROP TABLE IF EXISTS `notification`;CREATE TABLE `notification` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `amount` double NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `notifications_attachments` */DROP TABLE IF EXISTS `notifications_attachments`;CREATE TABLE `notifications_attachments` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `attachment_path` varchar(255) default NULL,
  `attachment_type_id` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `notifications_emails` */DROP TABLE IF EXISTS `notifications_emails`;CREATE TABLE `notifications_emails` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `notification_id` bigint(20) NOT NULL,
  `party_id` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `party` */DROP TABLE IF EXISTS `party`;CREATE TABLE `party` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `address` varchar(255) NOT NULL,
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `party_department` */DROP TABLE IF EXISTS `party_department`;CREATE TABLE `party_department` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) default NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `person` */DROP TABLE IF EXISTS `person`;CREATE TABLE `person` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `pre_proposal` */DROP TABLE IF EXISTS `pre_proposal`;CREATE TABLE `pre_proposal` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) default NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `pre_proposal_copi` */DROP TABLE IF EXISTS `pre_proposal_copi`;CREATE TABLE `pre_proposal_copi` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `pre_proposal_detail` */DROP TABLE IF EXISTS `pre_proposal_detail`;CREATE TABLE `pre_proposal_detail` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) default NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `project_department_map` */DROP TABLE IF EXISTS `project_department_map`;CREATE TABLE `project_department_map` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) default NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `project_employee` */DROP TABLE IF EXISTS `project_employee`;CREATE TABLE `project_employee` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `project_employee_experience` */DROP TABLE IF EXISTS `project_employee_experience`;CREATE TABLE `project_employee_experience` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `designation` varchar(255) NOT NULL,
  `joining_date` datetime NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `project_employee_qualification` */DROP TABLE IF EXISTS `project_employee_qualification`;CREATE TABLE `project_employee_qualification` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `project_employee_salary_details` */DROP TABLE IF EXISTS `project_employee_salary_details`;CREATE TABLE `project_employee_salary_details` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `project_tracking` */DROP TABLE IF EXISTS `project_tracking`;CREATE TABLE `project_tracking` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `created_by` varchar(255) NOT NULL,
  `created_date` datetime NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `project_type` */DROP TABLE IF EXISTS `project_type`;CREATE TABLE `project_type` (
  ...
  `type` varchar(255) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `projects` */DROP TABLE IF EXISTS `projects`;CREATE TABLE `projects` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `code` varchar(255) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `projectspimap` */DROP TABLE IF EXISTS `projectspimap`;CREATE TABLE `projectspimap` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `investigator_id` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `proposal` */DROP TABLE IF EXISTS `proposal`;CREATE TABLE `proposal` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `code` varchar(255) NOT NULL,
  `description` varchar(255) default NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `proposal_application` */DROP TABLE IF EXISTS `proposal_application`;CREATE TABLE `proposal_application` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `proposal_application_ext` */DROP TABLE IF EXISTS `proposal_application_ext`;CREATE TABLE `proposal_application_ext` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) default NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `proposal_approval` */DROP TABLE IF EXISTS `proposal_approval`;CREATE TABLE `proposal_approval` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `proposal_approval_authority_map` */DROP TABLE IF EXISTS `proposal_approval_authority_map`;CREATE TABLE `proposal_approval_authority_map` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `approval_authority_id` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `proposal_approval_detail` */DROP TABLE IF EXISTS `proposal_approval_detail`;CREATE TABLE `proposal_approval_detail` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `proposal_category` */DROP TABLE IF EXISTS `proposal_category`;CREATE TABLE `proposal_category` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `created_by` varchar(255) default NULL,
  ...
  `remarks` varchar(255) default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `report` */DROP TABLE IF EXISTS `report`;CREATE TABLE `report` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `name` varchar(255) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `requestmap` */DROP TABLE IF EXISTS `requestmap`;CREATE TABLE `requestmap` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `url` (`url`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `role` */DROP TABLE IF EXISTS `role`;CREATE TABLE `role` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `authority` varchar(255) NOT NULL,
  `description` varchar(255) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `role_people` */DROP TABLE IF EXISTS `role_people`;CREATE TABLE `role_people` (
  `user_id` bigint(20) NOT NULL,
  `role_id` bigint(20) NOT NULL,
  PRIMARY KEY  (`role_id`,`user_id`),
  KEY `FK28B75E78F7634DFA` (`user_id`),
  KEY `FK28B75E7852388A1A` (`role_id`),
  CONSTRAINT `FK28B75E7852388A1A` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`),
  CONSTRAINT `FK28B75E78F7634DFA` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `role_privileges` */DROP TABLE IF EXISTS `role_privileges`;CREATE TABLE `role_privileges` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `salary_component` */DROP TABLE IF EXISTS `salary_component`;CREATE TABLE `salary_component` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `active_yes_no` char(1) NOT NULL,
  `name` varchar(255) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `user` */DROP TABLE IF EXISTS `user`;CREATE TABLE `user` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `description` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `username` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `user_map` */DROP TABLE IF EXISTS `user_map`;CREATE TABLE `user_map` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
  `created_by` varchar(255) NOT NULL,
  `created_date` datetime default NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `user_role` */DROP TABLE IF EXISTS `user_role`;CREATE TABLE `user_role` (
  `role_id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
  PRIMARY KEY  (`role_id`,`user_id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `users` */DROP TABLE IF EXISTS `users`;CREATE TABLE `users` (
  `id` bigint(20) NOT NULL auto_increment,
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*Table structure for table `utilization` */DROP TABLE IF EXISTS `utilization`;CREATE TABLE `utilization` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` bigint(20) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;/*!40101 SET SQL_MODE=@OLD_SQL_MODE */;/*!40014 SET FOREIGN_KEY_CHECKS=@OLD_FOREIGN_KEY_CHECKS */;/*!40014 SET UNIQUE_CHECKS=@OLD_UNIQUE_CHECKS */;/*!40111 SET SQL_NOTES=@OLD_SQL_NOTES */;
