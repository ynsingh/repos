        ...
        <div class="tablewrapperpopup">
        	...
        	<g:subMenuList/>
	            ...
	            <g:form method="post" >
	                ...
	                <input type="hidden" id="unAllocatedAmt" name="unAllocatedAmt" value="${unAllocatedAmount}"/>  
	                                ...
	                                <g:if test="${grantAllocationSplitInstance.accHead != null}">
		                                <td valign="top" class=" " value ${hasErrors(bean:grantAllocationSplitInstance,field:'accHead','errors')}">
		                                    <g:select optionKey="id" 
			                                    ...
			                                    optionValue="accHeadCode" name="accountHead.id" value="${grantAllocationSplitInstance?.accHead?.id}" 
                                	...
                                	<td valign="top" class="name">
                            			<div id="subAccountHead">
							    			<g:select 																	       
										       name="subAccountHead" 
										       value="" 
											   optionKey="id" optionValue="accHeadCode" from="${accountHeadInstanceList}" noSelection="['null':'-Select-']"  
