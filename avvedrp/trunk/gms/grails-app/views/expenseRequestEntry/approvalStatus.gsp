				                        ...
				                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
		                         		...
		                         		<td></td>
		                         			...
		                         			<g:if test="${proposalApprovalDetailInstanceList[k] == null}">
		                         				...
		                         				<td>&nbsp;&nbsp;&nbsp;&nbsp;${approvalAuthorityDetailList[k].person.userRealName}&nbsp;-&nbsp;<g:message code="default.Pending.label"/></td>
		                         			</g:if>	
		                         			<g:else>
		                         				
		                         		<td>&nbsp;&nbsp;&nbsp;&nbsp;${approvalAuthorityDetailList[k].person.userRealName}&nbsp;-&nbsp;${proposalApprovalDetailInstanceList[k].proposalStatus}</td>
				                    	</g:else>
