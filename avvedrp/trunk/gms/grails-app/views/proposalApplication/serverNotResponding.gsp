 ...
 <br><br><br><br><br>
  ...
  <div class="body">
        ...
        <table width="70%" align="center" class="table" cellspacing="5" cellpadding="5">
         <tr><td>
       <img src="../images/skin/exclamation.png">&nbsp;&nbsp; The server is not responding, please try after sometime. </td></tr>
          <tr> 
      <td><table><tr><td>
      </td><td>
...
<g:actionSubmit class="inputbutton" value="Ok" action="partyNotificationsList"/>
