 ...
 <br><br><br><br><br>
  ...
  <div class="body">
        ...
        <table width="70%" align="center" class="table" cellspacing="5" cellpadding="5">
         <tr><td>
       &nbsp;&nbsp;<g:message code='default.ProposalControllerIdSend.message'/>.</td></tr>
         <tr><td>
       &nbsp;&nbsp;<g:message code='default.PleaseusethecontrollerId.message'/>.</td></tr> <tr> 
      <td><table><tr><td>
      </td><td>
   <g:form method="post" controller="notificationsEmails" action="partyNotificationsList" >
      <input type=hidden id="id" name="id" value="${params.id}">
 <input type=hidden id="proposalId" name="proposalId" value="${params.proposalId}">
<g:actionSubmit class="inputbutton" value="${message(code: 'default.ok.button')}" action="partyNotificationsList"/>
