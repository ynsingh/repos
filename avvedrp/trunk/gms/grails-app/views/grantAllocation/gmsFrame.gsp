...
<frameset frameborder="NO"  border="0" style="overflow:hidden" rows="20%,76%,4%">
	<frame src="../grantAllocation/top.gsp" name="top" scrolling="no" noresize="noresize" style="z-index:-1;overflow:hidden; height:100%; width:100%;">
		<frameset frameborder="NO" border="3"  cols="160px,*">
			<frame src="../grantAllocation/menu" name="left">
				<frame src=${path} name="right">
	    </frameset>
