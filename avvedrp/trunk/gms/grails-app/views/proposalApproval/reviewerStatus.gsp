            ...
            <div class="list">
               ...
               <g:each in="${ProposalApprovalValueInstance}" status="i" var="proposalApprovalInstance">
                      ...
                      <td>${i+1}</td>
                        ...
                        <%def proposalInstance = PreProposal.get(proposalApprovalInstance.proposalApproval.proposalApprovalAuthorityMap.proposalId)%>
                       <td>${fieldValue(bean: proposalInstance, field: "projectTitle")}</td>
