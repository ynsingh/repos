    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <g:form method="post" >
                ...
                <div class="buttons">
                    <span class="button"><g:actionSubmit class="save" action="update" id="${fieldValue(bean:externalFundAllocationInstance, field:'id')}" onClick="return validateEditGrantFund()" value="${message(code: 'default.button.update.label', default: 'Update')}" /></span>
                 </div>
            </g:form>
        </div>
    </body>
