...
<g:form action="agencySave" method="post" >
<div class="dialog">
<table>
    <tbody>
    
      <input type="hidden" id="projects" name="projects" value="${params.id}"/>  
      <input type="hidden" id="party" name="party" value="${granterInstance.id}"/>  
         <tr class="prop">
		       <td>
		        <label for="party">
		        ...
		        <td valign="top" class="value ${hasErrors(bean:grantAllocationInstance,field:'party','errors')}">
		          <g:select id="recipient" name="recipient" optionKey="id" optionValue="code"  from="${Party.findAll('from Party P where P.activeYesNo=\'Y\' and P.partyType= \'GA\' ')}" value="${externalFundAllocationInstance?.grantAllocation?.party}" 
...
<div class="buttons">
<span class="button"><g:submitButton name="create" class="agencySave"  onClick="return validateExternalFund()" value="${message(code: 'default.Create.button')}"   action="agencySave" /></span>
</div>
</g:form>
</div>
<div class="body">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="default.ExternalAgency.label" /></th>
                    ...
                    <g:each in="${allocationInstanceList}" status="i" var="grantAlocationInstance">
                         <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <%  l++ %>   
                       	    ...
                       	    <td><g:link action="tranferFund" id="${fieldValue(bean:grantAlocationInstance, field:'id')}" params="[fund:'ExternalAgency']"><g:message code="default.fundTransfer.label"/></g:link></td>
                        
                       	    <td><g:link controller="externalFundRefund" action="refundList" id="${fieldValue(bean:grantAlocationInstance, field:'id')}" params="[fund:'ExternalAgency']"><g:message code="default.RefundList.head"/></g:link></td>
                       	   
                       	    <td><g:link action="agencyEdit" id="${fieldValue(bean:grantAlocationInstance, field:'id')}"><g:message code="default.Edit.label"/></g:link></td>
