...
<html>
    <head>
        ...
        <title>Project Closure Entry</title>         
    </head>
    ...
    <body>
        ...
        <div class="nav">
            ...
            <span class="menuButton"><a class="list"  href="../../projects/${projectTrackingInstance.id}">Project List</a></span>
      ...
      <table class="tablewrapper" cellspacing="0" cellpadding="0">
        ...
        <div class="body">
            ...
            <g:form action="save" method="post" >
                ...
                <div class="buttons">
                    <span class="button"><input class="save" type="submit" value="Create" onClick="return validateProjectTracking()" /></span>
                </div>
            </g:form>
        </div>
       </td>
	        ...
	        <table cellspacing="0" cellpadding="0">
	            ...
	            <g:each in="${projectTrackingInstanceList}" status="i" var="projectTrackingInstance">
	                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
	                    ...
	                    <td><g:link action="edit" id="${projectTrackingInstance.id}">Edit</g:link></td>
