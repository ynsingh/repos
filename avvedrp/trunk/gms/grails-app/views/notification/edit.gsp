    ...
    <body>
      <div class="wrapper">
        <div class="body">
          ...
          <div class="dialog">
            <table>
                <tbody>
                        ...
                        <input type=hidden id="id" name="id" value="${fieldValue(bean:notificationInstance,field:'id')}">
                    <tr class="prop">
          ...
          <div class="buttons">
                    <span class="button"><g:actionSubmit class="save" action="update" onClick="return validateNotificationCreate()"  value="${message(code: 'default.Update.button')}" /></span>
           </div>
            </g:form>
        </div>
      </div>
