                    ...
                    <tbody>
                       ...
                       <tr class="prop">
                        ...
                        <tr class="prop">
                          ...
                          <td><a href="${g.createLink(controller:'proposalApplication',action:'applicationForm',id:proposalInstance.notification.id)}"><g:message code="default.View.label"/></a></td>
