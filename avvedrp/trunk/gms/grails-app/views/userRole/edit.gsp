                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userRoleInstance, field: 'role', 'errors')}">
                                    <g:select name="role.id" from="${Authority.list()}" optionKey="id" value="${userRoleInstance?.role?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userRoleInstance, field: 'user', 'errors')}">
                                    <g:select name="user.id" from="${Person.list()}" optionKey="id" value="${userRoleInstance?.user?.id}"  />
                                </td>
                            </tr>
