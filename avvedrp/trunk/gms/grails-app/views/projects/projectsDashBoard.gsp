<html>
    <head>
        ...
        <title><g:message code="default.ProjectsDashBoard.label"/></title>   
    ...
    <body>
       ...
       <h1><g:message code="default.ProjectsDashBoard.label"/></h1>
                    ...
                    <div id="content">
                        ...
                        <param name="movie" value="${resource(dir:'graphs',file:'dashboard.swf')}" />
                        <param name="quality" value="high" />
                        <param name="bgcolor" value="#ffffff" />
                        <param name="allowScriptAccess" value="sameDomain" />
                        <param name="allowFullScreen" value="true" />
                        <!--[if !IE]>-->
                        <object type="application/x-shockwave-flash" data="${resource(dir:'graphs',file:'dashboard.swf')}" width="100%" height="600">
                        <param name="quality" value="high" />
                        <param name="bgcolor" value="#ffffff" />
                        <param name="allowScriptAccess" value="sameDomain" />
                        <param name="allowFullScreen" value="true" />
