...
<html>
    <head>
        ...
        <title><g:message code="default.GrantAgency.EditGrantAgency.head"/></title>         
    </head>  
    <body>
      <div class="wrapper">
        <div class="body">
            <h1><g:message code="default.GrantAgency.EditGrantAgency.head"/></h1>
            ...
            <g:form method="post" >
                ...
                <div class="buttons">
                    <span class="button"><input class="save" type="submit" value="${message(code: 'default.Update.button')}" onClick="return validateParty()"  /></span>
                </div>
            </g:form>
        </div>
      </div>
