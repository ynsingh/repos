...
public class MasterTables extends HttpServlet{
	...
	private void edit_general_master(PrintWriter out,HttpServletRequest req,MultiLanguageString ml){
		try{
	...
	private void add_new_general_master(PrintWriter out,HttpServletRequest req,MultiLanguageString ml){
		try{
		    String category=req.getParameter("category");
		    out.println("<INPUT TYPE=\"HIDDEN\" NAME=\"category\" value=\""+category+"\" id=\"category\" />");
	        out.println("<TABLE border=\"1\" align=center class=\"ListTable\" cellspacing=0 width=\"100%\">");
	...
	private void save_add_new_general_master(Connection conn,HttpServletRequest req,HttpServletResponse res,PrintWriter out) throws IOException{
		...
		try{
	        ...
	        theStatement.executeUpdate("insert into general_master(category,fld_value,active_yes_no) values('"+category+"','"+fld_value+"','"+active_yes_no+"')");
             ...
             System.out.println ("Caught java.sql.SQLIntegrityConstraintViolationException") ;
             res.sendRedirect("./MasterTables?category="+category+"&action=add_new_general_master&tab_name=general_master&errmsg=Same_Record_Already_Exists.");
	      }      
	      catch (java.sql.SQLException e) {  
	             System.out.println   
	            ("Caught SQLException " + e.getErrorCode() + "/" + e.getSQLState() + " " +   
		    	...
		    	res.sendRedirect("./MasterTables?category="+category+"&action=add_new_general_master&tab_name=general_master&errmsg=Eorr_in_Save"); 
			    e.printStackTrace();			    
		     }
	...
	private void edit_principal_investigator_master(Connection conn,PrintWriter out,HttpServletRequest req,MultiLanguageString ml){
		try{
	...
	private void add_new_principal_investigator_master(Connection conn,PrintWriter out,HttpServletRequest req,MultiLanguageString ml){
		try{
			out.println("<TABLE border=\"1\" align=center class=\"ListTable\" cellspacing=0 width=\"100%\">");
	        out.println("<TR><TD align=center colspan=\"2\" class=\"thead\" >"+ml.getValue("add_new")+"</TD></TR>");
	        out.println("<TR><TD align=center colspan=\"2\" class=\"thead\" >"+ml.getValue("principal_investigator_master")+"</TD></TR>");
	...
	private void save_add_new_principal_investigator_master(Connection conn,HttpServletRequest req,HttpServletResponse res) throws IOException{
		try{
	        ...
	        theStatement.executeUpdate("insert into investigator_master(name,department_id,designation,email,address,active_yes_no) values('"+s[0]+"','"+s[1]+"','"+s[2]+"','"+s[3]+"','"+s[4]+"',"+s[5]+")");
             ...
             System.out.println ("Caught java.sql.SQLIntegrityConstraintViolationException") ;             
             res.sendRedirect("./MasterTables?action=add_new_principal_investigator_master&tab_name=principal_investigator_master&errmsg=Same_Record_Already_Exists.");
	      }      
	      catch (java.sql.SQLException e) {  
	             System.out.println   
	            ("Caught SQLException " + e.getErrorCode() + "/" + e.getSQLState() + " " +   
	    	  ...
	    	  res.sendRedirect("./MasterTables?action=add_new_principal_investigator_master&tab_name=principal_investigator_master&errmsg=Eorr_in_Save"); 
  		      e.printStackTrace();			    
		     }
	}//end of function save_edit_principal_investigator_master.
	...
	private void edit_courses_taught_master(Connection conn, PrintWriter out,HttpServletRequest req,MultiLanguageString ml){
		try{
	...
	private void add_new_courses_taught_master(Connection conn, PrintWriter out,HttpServletRequest req,MultiLanguageString ml){
		try{
			String faculty_name=req.getParameter("faculty_name");
		    out.println("<INPUT TYPE=\"HIDDEN\" name=\"faculty_name\" value=\""+faculty_name+"\" />");
		    out.println("<TABLE border=\"1\" align=center class=\"ListTable\" cellspacing=0 width=\"100%\">");
    	...
    	try{			
	        ...
	        theStatement.executeUpdate("insert into course_taught(idf,academic_term,class_name,course_name,students_registered,percent_of_pass,active_yes_no) values("+s[0]+",'"+s[1]+"','"+s[2]+"','"+s[3]+"','"+s[4]+"','"+s[5]+"',"+s[6]+")");
	  	    ...
	  	    res.sendRedirect("./MasterTables?action=show_courses_taught_master&tab_name=courses_taught_master&faculty_name="+s[0]);
	             ...
	             System.out.println ("Caught java.sql.SQLIntegrityConstraintViolationException") ;             
	             res.sendRedirect("./MasterTables?action=add_new_courses_taught_master&tab_name=courses_taught_master&faculty_name="+s[0]+"&errmsg=Same_Record_Already_Exists.");
		      }      
		      catch (java.sql.SQLException e) {  
		             System.out.println   
		            ("Caught SQLException " + e.getErrorCode() + "/" + e.getSQLState() + " " +   
		    	  ...
		    	  res.sendRedirect("./MasterTables?action=add_new_courses_taught_master&tab_name=courses_taught_master&faculty_name="+s[0]+"&errmsg=Eorr_in_Save"); 
	  		      e.printStackTrace();			    
			     }	     
    ...
    private void edit_university_master(PrintWriter out,HttpServletRequest req,MultiLanguageString ml){
    	try{
    ...
    private void add_new_university_master(PrintWriter out,HttpServletRequest req,MultiLanguageString ml){
    	try{
    		out.println("<TABLE border=\"1\" align=center class=\"ListTable\" cellspacing=0 width=\"100%\">");
    		out.println("<TR><TD align=center colspan=\"2\" class=\"thead\" >"+ml.getValue("add_new")+"</TD></TR>");
	        out.println("<TR><TD align=center colspan=\"2\" class=\"thead\" >"+ml.getValue("university_master")+"</TD></TR>");
    	...
    	try{
	        ...
	        theStatement.executeUpdate("insert into university_master(name,short_name,address,active_yes_no) values('"+s[0]+"','"+s[1]+"','"+s[2]+"',"+s[3]+")");
	  	    ...
	  	    res.sendRedirect("./MasterTables?action=show_university_master&tab_name=university_master");
	             ...
	             System.out.println ("Caught java.sql.SQLIntegrityConstraintViolationException") ;             
	             res.sendRedirect("./MasterTables?action=add_new_university_master&tab_name=university_master&errmsg=Same_Record_Already_Exists.");
		      }      
		      catch (java.sql.SQLException e) {  
		             System.out.println   
		            ("Caught SQLException " + e.getErrorCode() + "/" + e.getSQLState() + " " +   
		    	  ...
		    	  res.sendRedirect("./MasterTables?action=add_new_university_master&tab_name=university_master&errmsg=Eorr_in_Save"); 
	  		      e.printStackTrace();			    
			     }	   
	}//end of function save_add_new_courses_taught_master.
    private void show_institution_master(Connection conn,PrintWriter out,MultiLanguageString ml,HttpServletRequest req){
    	try{
		    ...
		    if (getUserDetails.getRole(userName).equals("ROLE_ADMIN_UNIVERSITY")){
		      ...
		      theResult=theStatement.executeQuery("select * from institution_master");	
		    }
    ...
    private void edit_institution_master(Connection conn,PrintWriter out,HttpServletRequest req,MultiLanguageString ml){
    	try{
    		GetRecordValue getUserDetails=new GetRecordValue();
    		String userName = req.getUserPrincipal().getName();
    		ResultSet theResult = null;
    ...
    private void save_edit_institution_master(Connection conn,HttpServletRequest req,HttpServletResponse res) throws IOException{
    	try{
	        ...
	        theStatement.executeUpdate("update institution_master set name=\'"+s[1]+"\',short_name=\'"+s[2]+"\',address=\'"+s[3]+"\',location=\'"+s[4]+"\',university_id="+s[5]+",active_yes_no="+s[6]+" where id="+s[0]);
	      	theStatement.close();//Close statement
	  	    res.sendRedirect("./MasterTables?action=show_institution_master&tab_name=institution_master");
	        }catch(java.sql.SQLIntegrityConstraintViolationException e) {  
	             System.out.println ("Caught java.sql.SQLIntegrityConstraintViolationException") ;             
    ...
    private void add_new_institution_master(Connection conn,PrintWriter out,HttpServletRequest req,MultiLanguageString ml){
    	try{
    		GetRecordValue getUserDetails=new GetRecordValue();
    		String userName = req.getUserPrincipal().getName();
    		ResultSet theResult = null;
    	...
    	try{
	        ...
	        theStatement.executeUpdate("insert into institution_master(name,short_name,address,location,university_id,active_yes_no) values(\'"+s[0]+"\',\'"+s[1]+"\',\'"+s[2]+"\',\'"+s[3]+"\',"+s[4]+","+s[5]+")");
	  	    ...
	  	    res.sendRedirect("./MasterTables?action=show_institution_master&tab_name=institution_master");
	             ...
	             System.out.println ("Caught java.sql.SQLIntegrityConstraintViolationException") ;             
	             res.sendRedirect("./MasterTables?action=add_new_institution_master&tab_name=institution_master&errmsg=Same_Record_Already_Exists.");
		      }      
		      catch (java.sql.SQLException e) {  
		             System.out.println   
		            ("Caught SQLException " + e.getErrorCode() + "/" + e.getSQLState() + " " +   
		    	  ...
		    	  res.sendRedirect("./MasterTables?action=add_new_institution_master&tab_name=institution_master&errmsg=Eorr_in_Save"); 
	  		      e.printStackTrace();			    
			     }
    ...
    private void edit_institution_department_master(Connection conn,HttpServletRequest req,PrintWriter out,MultiLanguageString ml){
    ...
    private void add_new_institution_department_master(Connection conn,HttpServletRequest req,PrintWriter out,MultiLanguageString ml){
    	...
    	try{    		
	        ...
	        theStatement.executeUpdate("insert into department_master(institution_id,department_id,active_yes_no) values("+s[0]+","+s[1]+","+s[2]+")");
	  	    ...
	  	    res.sendRedirect("./MasterTables?action=show_institution_department_master&tab_name=institution_department_master&institution_id="+s[0]);
	             ...
	             System.out.println ("Caught java.sql.SQLIntegrityConstraintViolationException") ;             
	             res.sendRedirect("./MasterTables?action=add_new_institution_department_master&tab_name=institution_department_master&institution_id="+s[0]+"&institution_name="+ s[3] +"&errmsg=Same_Record_Already_Exists.");
		      }      
		      catch (java.sql.SQLException e) {  
		             System.out.println   
		            ("Caught SQLException " + e.getErrorCode() + "/" + e.getSQLState() + " " +   
		    	  ...
		    	  res.sendRedirect("./MasterTables?action=add_new_institution_department_master&tab_name=institution_department_master&institution_id="+s[0]+"&errmsg=Eorr_in_Save"); 
	  		      e.printStackTrace();			    
			     }
