...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Equation','Table','Rule']	// No comma for the last row.
] ;
/*FCKConfig.ToolbarSets["Default"] = [
	...
	['Equation','Rule']	// No comma for the last row.
] ;*/
/*['fckeditor_wiris_openCAS','Table','Rule'], ['fckeditor_wiris_openFormulaEditor','Table','Rule']*/
/*['Equation','Rule']	*/
