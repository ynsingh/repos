...
document.getElementById("music1").innerHTML='<object id="mediaPlayer" width="290" height="50" '
...
+'bgcolor="101010" showcontrols="false" width="290" height="50" '
...
<body  onLoad="PlayIt('../audio/Businesstrip_Col.Nair_edited.wav')">
