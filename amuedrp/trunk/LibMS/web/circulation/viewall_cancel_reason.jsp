...
<%@page contentType="text/html" pageEncoding="UTF-8" import="com.myapp.struts.hbm.CancellationReason,java.util.List"%>
...
int i=0;
 int j=0;
List<CancellationReason> l11=(List<CancellationReason>)session.getAttribute("actlist1");
...
%>
    ...
    <body>
      <table width="100%" class="table" valign="top">
          ...
          <logic:iterate id="CancellationReason" name="actlist1" length="4" offset="<%=String.valueOf(fromIndex)%>">
                <html:form action="/DelUpdate1" method="post">
            <tr>
            <td><input type="text" readonly="true" name="id"  value="<bean:write name="CancellationReason" property="id.id"/>"/></td>
            <td><input type="text" name="details" value="<bean:write name="CancellationReason" property="details"/>"/></td>
