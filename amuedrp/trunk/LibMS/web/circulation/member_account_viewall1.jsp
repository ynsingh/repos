...
function show(x)
{
    f.action="<%=request.getContextPath()%>/circulation/showAccount1.do?id="+document.getElementById('memid').value+"&status="+x;
f.method="post";
f.target="_self";
f.submit();
}
...
<tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;">Change Status to Delinquent Members</td></tr>
 <tr><td valign="top" align="center"> <br/>
         <table cellspacing="10px">
                    ...
                    <tr><td dir="<%=rtl%>" rowspan="5" class="txt2"><%=resource.getString("circulation.cir_member_reg.entermemid")%><br>
                          ...
                          <br>
                        </td><td dir="<%=rtl%>" width="150px" align="center"> <input type="button" class="btn"  id="btnstatus"  value="Blocked" onclick="show('Blocked')"  /></td></tr>
                    <tr><td dir="<%=rtl%>" width="150px" align="center"><input type="button" id="btnstatus"  value="UnBlock" class="btn"  onclick="show('Active')"/></td></tr>
       ...
       <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;">View All Delinquent Members</td></tr>
                <tr><td valign="top" align="center"> <br/>
