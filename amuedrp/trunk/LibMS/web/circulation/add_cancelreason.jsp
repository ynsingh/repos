<%-- 
    Document   : add_activity1
    Created on : Sep 27, 2011, 10:15:27 AM
    Author     : EdRP-05
--%>

<%@page contentType="text/html" pageEncoding="UTF-8" import="com.myapp.struts.hbm.CancellationReason,java.util.List,com.myapp.struts.CirDAO.CirculationDAO "%>
...
List<CancellationReason> l1=(List<CancellationReason>)session.getAttribute("actlist1");
...
<link href="<%=request.getContextPath()%>/css/page.css" rel="stylesheet" type="text/css" />
  ...
  <%! int i=0,j=10; %>
  <html:form action="/addCancel" styleId="form1" onsubmit="return check1();">
          

 <table  class="table" width="50%"  align="center" cellpadding="10px">
     <tr class="headerStyle"><td align="center" height="35px">Cancellation Reason SetUp</td></tr>
     <tr ><td  align="center"> 
     <table  border="0px" width="50%">
         <tr><td>
               CancellationReason Id<br/>
...
<%=msg1%>
 ...
 <tr class="headerStyle"><td  align="center" height="35px">View All CancellationReason SetUp</td></tr>

  <tr><td colspan="3"><div id="divlist">
               <iframe name="listdiv" scrolling="no" frameborder="0" height="200px" width="100%" src="<%=request.getContextPath()%>/circulation/viewallCancel.do"></iframe>
               </div>
           </td></tr>
        ...
        <a dir="" target="listdiv" href="<%=request.getContextPath()%>/circulation/viewallCancel.do?pageIndex=<%=ii%>"><%=ii%></a>&nbsp;&nbsp;
