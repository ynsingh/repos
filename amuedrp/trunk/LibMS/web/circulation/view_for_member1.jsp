...
<script language="javascript" type="text/javascript">
  function quit()
  {
      ...
      window.location="<%=request.getContextPath()%>/circulation/cir_enquirymember.jsp";
      return false;
  }
...
<body onload="return call();">
 ...
 <table dir="<%=rtl%>" class="table" width="88%"  align="center">
  ...
  <tr>
    <td dir="<%=rtl%>" align="<%=align%>"><strong>Last CheckOut Date</strong></td>
    <td dir="<%=rtl%>"  ><html:text property="" styleClass="textBoxWidth" value="<%=cma.getLastchkoutdate() %>" readonly="true"/></td>
  </tr>
  <tr>
    <td dir="<%=rtl%>" align="<%=align%>"><strong>Fine Due</strong></td>
    <td dir="<%=rtl%>"  ><html:text property="" styleClass="textBoxWidth" value="<%=cma.getFine() %>" readonly="true"/></td>
  </tr>
  <tr>
