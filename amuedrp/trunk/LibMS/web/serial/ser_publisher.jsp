...
function check1()
{
    if(document.getElementById('pub_id').value=="")
    {
        alert("Enter Publisher Id...");

        document.getElementById('pub_id').focus();
...
<body style="margin:0px 0px 0px 0px">
    ...
    <html:form method="post" onsubmit="return check1()" action="/ser_pub">
...
<table class="table" border="1" width="400px" height="180px" align="center">
                ...
                <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;">Serial Publisher</td></tr>
                <tr><td valign="top" align="center">
                <table cellspacing="10px">

                    <tr><td rowspan="5" class="txt2" valign="center">Enter Serial Publisher ID<br><br>
                        <input type="text" id="pub_id" name="pub_id" value=""/>
    ...
    <input type="hidden" name="library_id" value="<%=library_id%>">
        ...
        %>
          ...
          <tr><td align="justify" colspan="2"><font color="blue" size="-1"><b>Example:</b> short form for publisher name</font></td></tr>
