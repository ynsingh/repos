...
<%
if(session.getAttribute("accdocumentdetail")!=null){
 opacList = new ArrayList ();
 opacList = (ArrayList)session.getAttribute("accdocumentdetail");
...
<ui:dataGrid items="${opacList}"   var="doc" name="datagrid1" cellPadding="0"  cellSpacing="0" styleClass="datagrid">
  <columns>
    ...
    <column width="100">
      ...
      <item  styleClass="item"  value="${doc.callNo}" hyperLink="./AccessionRecord.do?doc_id=${doc.accessionNo}&amp;library_id=${doc.id.libraryId}&amp;sublibraryId=${doc.id.sublibraryId}" hyperLinkTarget="fr2"  hAlign="left" />
    </column>
 <column width="100">
...
<tr><td height="10px">
  ...
  <%}%>
  <%}else if(session.getAttribute("accdocumentdetail1")!=null){
      System.out.println("dd");
       opacList = new ArrayList ();
 opacList = (ArrayList)session.getAttribute("accdocumentdetail1");
// System.out.println(opacList.size());
   int tcount =0;
   if(opacList!=null)tcount=opacList.size();
   int perpage=10;
...
<ui:dataGrid items="${opacList}"   var="doc" name="datagrid1" cellPadding="0"  cellSpacing="0" styleClass="datagrid">
  <columns>
    <column width="450">
      <header value="${Title}" hAlign="left" styleClass="header"/>
      <item  styleClass="item"  value="${doc.bibliographicDetailsLang.title}" hyperLink="./viewDetails2.do?doc_id=${doc.accessionRegister.accessionNo}&amp;library_id=${doc.bibliographicDetailsLang.id.libraryId}&amp;sublibrary_id=${doc.bibliographicDetailsLang.id.sublibraryId}" hyperLinkTarget="fr2" hAlign="left"/>
    </column>

    <column width="200">
      <header value="${MainEntry}" hAlign="left" styleClass="header"/>
      <item  styleClass="item"  value="${doc.bibliographicDetailsLang.mainEntry}" hyperLink="./viewDetails2.do?doc_id=${doc.accessionRegister.accessionNo}&amp;library_id=${doc.bibliographicDetailsLang.id.libraryId}&amp;sublibrary_id=${doc.bibliographicDetailsLang.id.sublibraryId}" hyperLinkTarget="fr2" hAlign="left"  />
    </column>

    <column width="100">
      <header value="${CallNo}" hAlign="left" styleClass="header"/>
      <item  styleClass="item"  value="${doc.bibliographicDetailsLang.callNo}" hyperLink="./viewDetails2.do?doc_id=${doc.accessionRegister.accessionNo}&amp;library_id=${doc.bibliographicDetailsLang.id.libraryId}&amp;sublibraryId=${doc.bibliographicDetailsLang.id.sublibraryId}" hyperLinkTarget="fr2"  hAlign="left" />
    </column>
 <column width="100">
      <header value="${AccessionNo}" hAlign="left" styleClass="header"/>
      <item  styleClass="item"  value="${doc.accessionRegister.accessionNo}" hyperLink="./viewDetails2.do?doc_id=${doc.accessionRegister.accessionNo}&amp;library_id=${doc.bibliographicDetailsLang.id.libraryId}&amp;sublibrary_id=${doc.bibliographicDetailsLang.id.sublibraryId}" hyperLinkTarget="fr2"  hAlign="left" />
    </column>
      <column width="150">
      <header value="${LibraryID}" hAlign="left" styleClass="header"/>
      <item  styleClass="item"  value="${doc.bibliographicDetailsLang.id.libraryId}" hyperLink="./viewDetails2.do?doc_id=${doc.accessionRegister.accessionNo}&amp;library_id=${doc.bibliographicDetailsLang.id.libraryId}&amp;sublibrary_id=${doc.bibliographicDetailsLang.id.sublibraryId}" hyperLinkTarget="fr2"  hAlign="left" />
    </column>
 </columns>
<rows styleClass="rows" hiliteStyleClass="hiliterows"/>
  <alternateRows styleClass="alternaterows"/>
