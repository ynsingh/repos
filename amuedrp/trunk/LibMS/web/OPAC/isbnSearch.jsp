...
<table height="300px" width="100%" dir="<%=rtl%>"><tr><td valign="top" dir="<%=rtl%>">
            ...
            <i>ISBN Search Result>> <%=tcount%> Record Found</i>
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" scroll="yes" cellSpacing="0" styleClass="datagrid" >
 ...
 <column width="10%">
      ...
      <item  styleClass="item"  value="${doc.isbn10}" hyperLink="${project}/OPAC/viewDetails.do?doc_id=${doc.id.biblioId}&amp;library_id=${doc.id.libraryId}&amp;sublibrary_id=${doc.id.sublibraryId}"  hAlign="left" />
    </column>
...
{
%>
<i>    ISBN Results>> <%=tcount%> Record Found</i>
<%}
else
{%>
