...
<body> 
<%! String title,author,doctype,publ_pl,pub_name,added,notes,added1,added2,added3,pub_yr,pages,index,callno,phy_width,loc,pubyr,copy,vol,ed,publ,place,isbn,accno,subtitle,subject,id,lib_id,status,location,booktype,lccno;
int no_of_copy=0;
...
dd = (List<BibliographicDetailsLang>)session.getAttribute("MLIdocumentDetail");
        if(dd!=null){
           ...
           // location=dd.getLocation();
            ...
            added=dd.get(0).getAddedEntry();
            added1=dd.get(0).getAddedEntry1();
            added2=dd.get(0).getAddedEntry2();
            added3=dd.get(0).getAddedEntry3();
...
locale1=(String)session.getAttribute("locale");
   ...
   <TR dir="<%=rtl%>">
      ...
      <a href="../OPAC/newjsp1.jsp" style="text-decoration:none;font-family: Arial;color:white;font-size: 13px" >
      <b >Brief Details</b></a>&nbsp;|&nbsp;
       <a href="../OPAC/subjectlang.jsp"  style="text-decoration:none;font-family: Arial;color:white;font-size: 13px" >
      <b > Subject Details</b></a>&nbsp;|&nbsp;
      <a href="../OPAC/fulldetailslang.jsp"  style="text-decoration:none;font-family: Arial;color:white;font-size: 13px" >
      <b> Full Details</b></a>
...
<TR dir="<%=rtl%>">
    ...
    <TR dir="<%=rtl%>">
       ...
       <TD><%=author%><%=added!=null?","+added:""%><%=added1!=null?","+added1:""%><%=added2!=null?","+added2:""%><%=added3!=null?","+added3:""%></TD>
    </TR>
       <TR dir="<%=rtl%>">
    ...
    <TR dir="<%=rtl%>">
     ...
     <TR dir="<%=rtl%>">
        <TD NOWRAP valign='top' dir="<%=rtl%>"><b>Notes : </b></TD>
        <td>:</td><TD>
        <%=notes!=null?notes:""%></TD>
    </TR>
