...
<table height="300px" width="100%" ><tr><td valign="top" align="left">
           <i>    Advacned Results>> <%=tcount%> Record Found&nbsp;&nbsp;&nbsp;  Records In Current Page >><%=opacList.size()%> &nbsp;&nbsp;&nbsp;Current Page Size >> 100</i>
          <% if(pageNumber>0){
           %>
...
<column width="5px">
    ...
    <column width="20%">
      ...
      <column width="10%">
      <header value="ISBN10" hAlign="left" styleClass="header"/>
...
{%>
<table height="300px" width="100%" ><tr><td valign="top" align="left">
           <i>    Advanced Results>> <%=tcount%> Record Found&nbsp;&nbsp;&nbsp;  Records In Current Page >><%=opacList.size()%> &nbsp;&nbsp;&nbsp;Current Page Size >> 100</i>
          <% if(pageNumber>0){%>
  <input type="button" onclick="previous()" value="previous" class="datagrid"/>
  <%}%>
           <% if(opacList.size()<pagesize){
