...
<form name="Form1" action="search_log.do"  >
  ...
  <tr style="background-color:#e0e8f5;"><td width="80%">
          <table dir="<%=rtl%>" border="0px" align="<%=align%>">
              <tr><td dir="<%=rtl%>" align="<%=align%>"><%=resource.getString("enterstartingkeyword")%></td><td><input  name="search_keyword" type="text" id="search_keyword" onkeyup="fun()" onfocus="statwords('Enter Starting Keyword')" onblur="loadHelp()"></td>
              <td>
