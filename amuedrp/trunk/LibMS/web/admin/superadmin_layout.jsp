...
<tiles:insert definition="superadmin-template" >
	<tiles:put name="body" value="<%=request.getContextPath()%>/admin/admin_form.jsp" />
</tiles:insert>
...
<div
   ...
   right:5px;
    ...
    <body leftmargin="0" background="<%=request.getContextPath()%>/images/headersuper.png" topmargin="0" marginwidth="0" marginheight="0" dir="<%=rtl%>">
...
<li><a href="#" rel="dropmenu2">SetUp</a></li>
</ul>
</div>
...
<!--2st drop down menu -->
<div id="dropmenu2" class="dropmenudiv"  style="top:70px;
   left:5px;
   right:5px;
      position: absolute;
...
<li><a href="<%=contextPath%>/manage_superadmin.jsp"  target="f3">Change Superadmin Password</a></li>
