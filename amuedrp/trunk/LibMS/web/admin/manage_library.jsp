   ...
   right:5px;
    ...
    <table border="1" class="table" width="400px" height="200px" align="center">
                ...
                <table cellspacing="10px">
                    ...
                    <tr><td rowspan="5" class="txt2">Enter SubLibrary ID<br>
    ...
    <input type="hidden" name="library_id" value="<%=library_id%>">
        ...
        %>
                ...
                <tr><td align="justify"><font color="blue" size="-1"><b>Example:</b> cs for Computer Science, phy for Physics & so on, if SubLibrary/Departmental Library/Seminar Library exists.</font></td></tr>
    </table>
        </div>
