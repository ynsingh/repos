...
<%@page contentType="text/html" import="java.util.*,java.io.*,java.net.*,com.myapp.struts.AdminDAO.AdminRegistrationDAO"%>
...
This Page is to Show Menu and Header Section  of LibMS
-->

<html>
    <head>
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
        <title>LibMS : Web Application Section</title>
        <%!
    Locale locale=null;
    String locale1="en";
    String rtl="ltr";
...
if(sublibrary_name.equalsIgnoreCase("Main Library"))
{
    AdminRegistrationDAO admindao=new AdminRegistrationDAO();
    AdminRegistration admin=admindao.searchInstitute(library_id);
    sublibrary_name=admin.getLibraryName()+"/Central Library"; }
       ...
       Privilege rst1=(Privilege)session.getAttribute("privilege_resultset");
       AcqPrivilege acq=(AcqPrivilege)session.getAttribute("acq_privilege_resultset");
       CatPrivilege cat=(CatPrivilege)session.getAttribute("cat_privilege_resultset");
       CirPrivilege cir=(CirPrivilege)session.getAttribute("cir_privilege_resultset");
       SerPrivilege ser=(SerPrivilege)session.getAttribute("ser_privilege_resultset");
...
//Start: Second Level Serial Menu 2222222222222222222222222222222222222222222222222222222222222222222222
               ...
               // oSerSubscriptionListMenu.addItem(new YAHOO.widget.MenuItem("New Entry", {  disabled: <%=ser_privilege[4]%>,  url: "<%=request.getContextPath()%>/serial/ser_new_entry.jsp"}));
                oSerSubscriptionListMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.serial35") %>", {  disabled: <%=ser_privilege[4]%>,  url: "<%=request.getContextPath()%>/serial/ser_new_entry.jsp"}));
		 ...
		 var oSerRecordKeepingMenu = new YAHOO.widget.Menu("Record Keeping");
                            var oSerRecordKeepingMenu = new YAHOO.widget.Menu("<%=resource.getString("admin.header.serial80") %>");
               // oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("Serial Language", {disabled: <%=ser_privilege[62]%>,  url: ""}));
                oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.serial81") %>", { disabled: <%=ser_privilege[62]%>,  url: "<%=request.getContextPath()%>/serial/ser_language.jsp"}))
                // oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("Budget Heads", {disabled: <%=ser_privilege[63]%>,  url: "<%=request.getContextPath()%>/acquisition/acq_add_budgethead.jsp"}));
                oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.serial82") %>", { disabled: <%=ser_privilege[63]%>,  url: "<%=request.getContextPath()%>/acquisition/acq_add_budgethead.jsp"}))
                // oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("Budgets", {disabled: <%=ser_privilege[64]%>,  url: "<%=request.getContextPath()%>/acquisition/acq_budget_alloc.do"}));
                oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.serial83") %>", { disabled: <%=ser_privilege[64]%>,  url: "<%=request.getContextPath()%>/acquisition/acq_budget_alloc.do"}))
                // oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("Vendors", {disabled: <%=ser_privilege[65]%>,  url: "<%=request.getContextPath()%>/acquisition/acq_budget_alloc.do"}));
                oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.serial84") %>", { disabled: <%=ser_privilege[65]%>,  url: "<%=request.getContextPath()%>/acquisition/acq_initiate_vendor.jsp"}))
                 // oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("Exchange Rates", {disabled: <%=ser_privilege[66]%>,  url: "<%=request.getContextPath()%>/acquisition/acq_budget_alloc.do"}));
                oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.serial85") %>", { disabled: <%=ser_privilege[66]%>,  url: "<%=request.getContextPath()%>/acquisition/acq_currency1.jsp"}))
                // oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("Set Base Currency", {disabled: <%=ser_privilege[67]%>,  url: "<%=request.getContextPath()%>/acquisition/acq_budget_alloc.do"}));
                oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.serial86") %>", { disabled: <%=ser_privilege[67]%>,  url: "<%=request.getContextPath()%>/acquisition/acq_base_currency.jsp"}))
                // oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("Publisher", {disabled: <%=ser_privilege[68]%>,  url: "<%=request.getContextPath()%>/acquisition/acq_budget_alloc.do"}));
                oSerRecordKeepingMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.serial87") %>", { disabled: <%=ser_privilege[68]%>,  url: "<%=request.getContextPath()%>/serial/ser_publisher.jsp"}))
...
//submenu of serial
               ...
               //oSerMenu.addItem(new YAHOO.widget.MenuItem("Record Keeping", {submenu:oSerRecordKeepingMenu ,   disabled: <%=ser_privilege[61]%>,  url:"" } ));
                oSerMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.serial79") %>", {submenu:oSerRecordKeepingMenu , disabled: <%=ser_privilege[61]%>, url:"" } ));
...
var oCirInstituteMemberDetailsMenu = new YAHOO.widget.Menu("Member Details");
         ...
         /*        oCirInstituteMemberDetailsMenu.addItem(new YAHOO.widget.MenuItem("Register", {  disabled: <%=cir_privilege[3]%>,  url: "<%=request.getContextPath()%>/circulation/cir_member_reg.jsp"}));
            ...
            */
                 oCirInstituteMemberDetailsMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation1") %>", {  disabled: <%=cir_privilege[3]%>,  url: "<%=request.getContextPath()%>/circulation/cir_member_reg.jsp"}));
                 oCirInstituteMemberDetailsMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation2") %>", {  disabled: <%=cir_privilege[4]%>,  url: "<%=request.getContextPath()%>/circulation/cir_member_reg.jsp"}));
                 oCirInstituteMemberDetailsMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation3") %>", {  disabled: <%=cir_privilege[5]%>,  url: "<%=request.getContextPath()%>/circulation/cir_member_reg.jsp"}));
                 oCirInstituteMemberDetailsMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation4") %>", {  disabled: <%=cir_privilege[6]%>,  url: "<%=request.getContextPath()%>/circulation/cir_member_reg.jsp"}));
                 oCirInstituteMemberDetailsMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation5") %>", {  disabled: <%=cir_privilege[7]%>,  url: "<%=request.getContextPath()%>/circulation/cir_viewallload.do"}));
...
var oCirInstituteMemberAccountMenu = new YAHOO.widget.Menu("Member Account");
            ...
            */
                 oCirInstituteMemberAccountMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation6") %>", {  disabled: <%=cir_privilege[9]%>,  url: "<%=request.getContextPath()%>/circulation/manage_member_account.jsp"}));
                 oCirInstituteMemberAccountMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation7") %>", {  disabled: <%=cir_privilege[10]%>,  url: "<%=request.getContextPath()%>/circulation/manage_member_account.jsp"}));
                 oCirInstituteMemberAccountMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation8") %>", {  disabled: <%=cir_privilege[11]%>,  url: "<%=request.getContextPath()%>/circulation/manage_member_account.jsp"}));
                 oCirInstituteMemberAccountMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation9") %>", {  disabled: <%=cir_privilege[12]%>,  url: "<%=request.getContextPath()%>/circulation/manage_member_account.jsp"}));
                 oCirInstituteMemberAccountMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation10") %>", {  disabled: <%=cir_privilege[13]%>,  url: "<%=request.getContextPath()%>/circulation/cir_viewallaccount.do"}));
             ...
             */
              ...
              /*   oCirReminderMenu.addItem(new YAHOO.widget.MenuItem("Overdue Reminder", {  disabled: <%=cir_privilege[65]%>,  url: ""}));
                 ...
                 oCirReminderMenu.addItem(new YAHOO.widget.MenuItem("Bindery Order", {  disabled: <%=cir_privilege[67]%>,  url: ""}));
                    */
                oCirReminderMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation15") %>", {  disabled: <%=cir_privilege[65]%>,  url: "<%=request.getContextPath()%>/circulation/reminder_member.do"}));
              ...
              /*   oCirMemberRelatedParameterMenu.addItem(new YAHOO.widget.MenuItem("Member Id Sequence", {  disabled: <%=cir_privilege[72]%>,  url: ""}));
                 ...
                 oCirMemberRelatedParameterMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("opac.newmemberentry.typemem") %>", {  disabled: <%=cir_privilege[73]%>,  url: "<%=request.getContextPath()%>/systemsetup/manage_member.jsp"}));
                 oCirMemberRelatedParameterMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("opac.newmemberentry.memsubcat") %>", {  disabled: <%=cir_privilege[74]%>,  url: "<%=request.getContextPath()%>/systemsetup/submember1.do"}));
...
//Start: Second Level Circulation Menu 2222222222222222222222222222222222222222222222222222222222222222222222
              ...
              /**    oCirMemberManagementMenu.addItem(new YAHOO.widget.MenuItem("Member Details", { submenu:oCirInstituteMemberDetailsMenu ,  disabled: <%=cir_privilege[2]%>,  url:"" }));
                oCirMemberManagementMenu.addItem(new YAHOO.widget.MenuItem("Member Account", { submenu:oCirInstituteMemberAccountMenu ,  disabled: <%=cir_privilege[8]%>,  url:"" }));
                  ...
                  oCirMemberManagementMenu.addItem(new YAHOO.widget.MenuItem("Upload Member Details", {   disabled: <%=cir_privilege[20]%>,  url:"<%=request.getContextPath()%>/circulation/member_data_import.jsp" }));
...
*/
                ...
                oCirMemberManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation33") %>", { submenu:oCirInstituteMemberAccountMenu ,  disabled: <%=cir_privilege[8]%>,  url:"" }));
                 oCirMemberManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation34") %>", {   disabled: <%=cir_privilege[14]%>,  url:"<%=request.getContextPath()%>/circulation/requestfromopac.do" }));
                  oCirMemberManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation35") %>", {   disabled: <%=cir_privilege[15]%>,  url:"<%=request.getContextPath()%>/circulation/cir_member_reg.jsp" }));

                  oCirMemberManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation36") %>", {   disabled: <%=cir_privilege[16]%>,  url:"<%=request.getContextPath()%>/circulation/statistics.do" }));
                  oCirMemberManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation37") %>", {   disabled: <%=cir_privilege[17]%>,  url:"<%=request.getContextPath()%>/circulation/cir_viewallaccount1.do" }));
                  oCirMemberManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation38") %>", {   disabled: <%=cir_privilege[18]%>,  url:"<%=request.getContextPath()%>/circulation/cir_viewallaccount1.do" }));
                  ...
                  oCirMemberManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation40") %>", {   disabled: <%=cir_privilege[20]%>,  url:"<%=request.getContextPath()%>/circulation/member_data_import.jsp" }));
...
*/
               ...
               /*  oCirFineManagementMenu.addItem(new YAHOO.widget.MenuItem("Fine Collection", {  disabled: <%=cir_privilege[36]%>,  url: ""}));
                 ...
                 oCirFineManagementMenu.addItem(new YAHOO.widget.MenuItem("Fine Notices", {  disabled: <%=cir_privilege[38]%>,  url: ""}));
                    ...
                    */
                 oCirFineManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation47") %>", {  disabled: <%=cir_privilege[36]%>,  url: "<%=request.getContextPath()%>/circulation/cir_fine_detail.jsp"}));
...
*/
                  oCirCirculationEnquiriesMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation63") %>", {  disabled: <%=cir_privilege[56]%>,  url: "<%=request.getContextPath()%>/circulation/cir_enquirymember.jsp"}));
                 oCirCirculationEnquiriesMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation64") %>", {  disabled: <%=cir_privilege[57]%>,  url: "<%=request.getContextPath()%>/circulation/cir_enquirymember.jsp"}));
                 oCirCirculationEnquiriesMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation65") %>", {  disabled: <%=cir_privilege[58]%>,  url: "<%=request.getContextPath()%>/circulation/statistics.do"}));
                 ...
                 oCirCirculationEnquiriesMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation67") %>", {  disabled: <%=cir_privilege[60]%>,  url: "<%=request.getContextPath()%>/circulation/statistics.do"}));
...
*/
                   oCirCirculationReport.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation68") %>", {  disabled: <%=cir_privilege[62]%>,  url: "<%=request.getContextPath()%>/circulation/cir_checkout_report.jsp"}));
                oCirCirculationReport.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation69") %>", {  disabled: <%=cir_privilege[63]%>,  url: "<%=request.getContextPath()%>/circulation/cir_checkin_report.jsp"}));
...
*/
            oCirSystemSetupMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation73") %>", {submenu:oCirMemberRelatedParameterMenu ,  disabled: <%=cir_privilege[71]%>,  url: ""}));
                oCirSystemSetupMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation74") %>", {  disabled: <%=cir_privilege[75]%>,  url: "<%=request.getContextPath()%>/circulation/add_activity.jsp"}));
                oCirSystemSetupMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation75") %>", {  disabled: <%=cir_privilege[76]%>,  url: "<%=request.getContextPath()%>/circulation/add_cancelreason.jsp"}));
                oCirSystemSetupMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup6") %>", {  disabled: <%=cir_privilege[77]%>,  url: "<%=request.getContextPath()%>/systemsetup/managebooktype.do"}));
                oCirSystemSetupMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation77") %>", {  disabled: <%=cir_privilege[78]%>,  url: "<%=request.getContextPath()%>/systemsetup/manage_notices.jsp"}));
...
*/
  ...
  oCirMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation85") %>", {Submenu:oCirMemberManagementMenu ,   disabled: <%=cir_privilege[1]%>,  url:"" } ));
                oCirMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation86") %>", {   disabled: <%=cir_privilege[27]%>,  url:"<%=request.getContextPath()%>/circulation/cir_viewallload.do"  } ));
                oCirMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation87") %>", {submenu:oCirMembershipCardManagementMenu ,   disabled: <%=cir_privilege[28]%>,  url:""  }));
                 ...
                 oCirMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation88") %>", {  disabled: <%=cir_privilege[33]%>,  url: "<%=request.getContextPath()%>/circulation/cir_checkout.jsp"}));
                  oCirMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.circulation89") %>", {  disabled: <%=cir_privilege[34]%>,  url: "<%=request.getContextPath()%>/circulation/cir_checkin.jsp"}));
...
//Start: Second Level Catalogue Menu 2222222222222222222222222222222222222222222222222222222222222222222222
                var oCatInitiateCataloguingMenu = new YAHOO.widget.Menu("Bibliographic Entry");


               /* oCatInitiateCataloguingMenu.addItem(new YAHOO.widget.MenuItem("Entry using Simple Template AACR", {  disabled: <%=cat_privilege[2]%>,  url: ""}));
                oCatInitiateCataloguingMenu.addItem(new YAHOO.widget.MenuItem("Entry using MARC21 Template", {  disabled: <%=cat_privilege[3]%>,  url: ""}));
                 oCatInitiateCataloguingMenu.addItem(new YAHOO.widget.MenuItem("Entry using Customized Template", {  disabled: <%=cat_privilege[4]%>,  url: ""}));
*/
                    oCatInitiateCataloguingMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.cataloguing8") %>", {  disabled: <%=cat_privilege[2]%>,  url: "<%=request.getContextPath()%>/cataloguing/cat_biblio.jsp"}));
               oCatInitiateCataloguingMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.cataloguing9") %>", {  disabled: <%=cat_privilege[3]%>,  url: "<%=request.getContextPath()%>/cataloguing/cat_new_MARC.jsp"}));
                oCatInitiateCataloguingMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.cataloguing37") %>", {  disabled: <%=cat_privilege[4]%>,  url: "<%=request.getContextPath()%>/cataloguing/cat_editmarc.jsp"}));
             

            
               var oCatReportsMenu = new YAHOO.widget.Menu("Catalogue Reports");

             /*  oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("Document Slip", {  disabled: <%=cat_privilege[16]%>, url: ""}));
               oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("List Titles", {  disabled: <%=cat_privilege[17]%>, url: ""}));
               oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("Subjects/Keywords", {  disabled: <%=cat_privilege[18]%>, url: ""}));
               oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("Arrival Notice", {  disabled: <%=cat_privilege[19]%>, url: ""}));
               oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("Classified Subjects", {  disabled: <%=cat_privilege[20]%>, url: ""}));
               oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("Highly Priced titles", {  disabled: <%=cat_privilege[21]%>, url: ""}));
               oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("Withdrawn Register", {  disabled: <%=cat_privilege[22]%>, url: ""}));
*/
 oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.cataloguing21") %>", {  disabled: <%=cat_privilege[16]%>, url: ""}));
               oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.cataloguing22") %>", {  disabled: <%=cat_privilege[17]%>, url: ""}));
               oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.cataloguing23") %>", {  disabled: <%=cat_privilege[18]%>, url: ""}));
               oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.cataloguing24") %>", {  disabled: <%=cat_privilege[19]%>, url: ""}));
               oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.cataloguing25") %>", {  disabled: <%=cat_privilege[20]%>, url: ""}));
               oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.cataloguing26") %>", {  disabled: <%=cat_privilege[21]%>, url: ""}));
               oCatReportsMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.cataloguing27") %>", {  disabled: <%=cat_privilege[22]%>, url: ""}));


var oSearchMenu = new YAHOO.widget.Menu("Search Record");

         /*      oSearchMenu.addItem(new YAHOO.widget.MenuItem("Bibliographic Details", {  disabled: <%=cat_privilege[6]%>,  url: "<%=request.getContextPath()%>/cataloguing/cat_search.jsp"}));
               oSearchMenu.addItem(new YAHOO.widget.MenuItem("Accession Register", {  disabled: <%=cat_privilege[7]%>,  url: "<%=request.getContextPath()%>/cataloguing/acc_search.jsp"}));
*/
 ...
 var oDataImportExport = new YAHOO.widget.Menu("Data Import/Export");
         ...
         /*      oDataImportExport.addItem(new YAHOO.widget.MenuItem("Data Import", {  disabled: <%=cat_privilege[13]%>, url: "<%=request.getContextPath()%>/cataloguing/cat_data_import_read.jsp" }));
               oDataImportExport.addItem(new YAHOO.widget.MenuItem("Data Export", {  disabled: <%=cat_privilege[14]%>, url: "<%=request.getContextPath()%>/cataloguing/cat_exportDatabaseToExcell.jsp" }));
*/

               oDataImportExport.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.cataloguing38") %>", {  disabled: <%=cat_privilege[13]%>, url: "<%=request.getContextPath()%>/cataloguing/cat_data_import_read.jsp" }));
               oDataImportExport.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.cataloguing39") %>", {  disabled: <%=cat_privilege[14]%>, url: "<%=request.getContextPath()%>/cataloguing/cat_exportDatabaseToExcell.jsp"  }));
...
//Start: First Level Catalogue Menu 11111111111111111111111111111111111111111111111111111111111111111111111
              ...
              /*  oCatMenu.addItem(new YAHOO.widget.MenuItem("Bibliographic Entry", {submenu:oCatInitiateCataloguingMenu ,   disabled: <%=cat_privilege[1]%>, url:""} ));
                oCatMenu.addItem(new YAHOO.widget.MenuItem("Search Record", {submenu:oSearchMenu ,  disabled: <%=cat_privilege[5]%>, url:""}));

               
                oCatMenu.addItem(new YAHOO.widget.MenuItem("Accession Management", {  disabled: <%=cat_privilege[8]%>,  url: "<%=request.getContextPath()%>/cataloguing/cat_accession.jsp"}));
                oCatMenu.addItem(new YAHOO.widget.MenuItem("Latest Addition List", {  disabled: <%=cat_privilege[9]%>, url:""}));
                oCatMenu.addItem(new YAHOO.widget.MenuItem("Generate Book BarCode", {  disabled: <%=cat_privilege[10]%>,url:"<%=request.getContextPath()%>/cataloguing/barcode_entry.jsp" }));
                oCatMenu.addItem(new YAHOO.widget.MenuItem("Union Catalog", {  disabled: <%=cat_privilege[11]%>,  url: "<%=request.getContextPath()%>/viewMarcRepos.do"}));
                oCatMenu.addItem(new YAHOO.widget.MenuItem("Data Import/Export", {submenu:oDataImportExport,   disabled: <%=cat_privilege[12]%>,url:""}));
                oCatMenu.addItem(new YAHOO.widget.MenuItem("Catalogue Reports", {submenu:oCatReportsMenu ,  disabled: <%=cat_privilege[15]%>,url:""}));
                oCatMenu.addItem(new YAHOO.widget.MenuItem("Annual Stock", {  disabled: <%=cat_privilege[23]%>,url:""}));
                oCatMenu.addItem(new YAHOO.widget.MenuItem("Database Backup", {  disabled: <%=cat_privilege[24]%>, url:""}));
	        oCatMenu.addItem(new YAHOO.widget.MenuItem("Subject Updates", {  disabled: <%=cat_privilege[25]%>, url:""}));
	        oCatMenu.addItem(new YAHOO.widget.MenuItem("Generate Catalog Card", {  disabled: <%=cat_privilege[26]%>,url:"<%=request.getContextPath()%>/cataloguing/listcataloguecard.jsp" }));
...
*/
            ...
            /*    oAcqListTitlesMenu.addItem(new YAHOO.widget.MenuItem("On-Approval Titles", {  disabled: <%=acq_privilege[16]%>, url: ""}));
                ...
                oAcqListTitlesMenu.addItem(new YAHOO.widget.MenuItem("Approved Titles", {  disabled: <%=acq_privilege[19]%>,url: "<%=request.getContextPath()%>/acq_approval2.do"}));
                oAcqListTitlesMenu.addItem(new YAHOO.widget.MenuItem("Rejected Titles", {  disabled: <%=acq_privilege[20]%>,url: ""}));
*/
                        oAcqListTitlesMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition5") %>", {  disabled: <%=acq_privilege[16]%>, url:"<%=request.getContextPath()%>/acq_approval1.do"}));
                ...
                oAcqListTitlesMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition8") %>", {  disabled: <%=acq_privilege[19]%>,url: "<%=request.getContextPath()%>/acq_approval2.do"}));
              ...
              /*  oAcqViewListForOrderMenu.addItem(new YAHOO.widget.MenuItem("Direct Request", {  disabled: <%=acq_privilege[23]%>,url: "<%=request.getContextPath()%>/acq_firmorder1.do"}));
                oAcqViewListForOrderMenu.addItem(new YAHOO.widget.MenuItem("Approved Request ", {  disabled: <%=acq_privilege[24]%>,url: ""}));
*/

                    oAcqViewListForOrderMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition10") %>", {  disabled: <%=acq_privilege[23]%>,url: "<%=request.getContextPath()%>/acq_firmorder1.do"}));
...
//Start:Second Level Acquisition Menu 22222222222222222222222222222222222222222222222222222222222222222222
           ...
           /*    oAcqGenerateTitleMenu.addItem(new YAHOO.widget.MenuItem("Refer from Demend list/ Requests", { disabled: <%=acq_privilege[2]%>,url: ""}));
              ...
              */
              oAcqGenerateTitleMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition16") %>", { disabled: <%=acq_privilege[2]%>,url: "<%=request.getContextPath()%>/acquisition/acqAllBiblio3.do"}));
                ...
                oAcqGenerateTitleMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition18") %>", {  disabled: <%=acq_privilege[4]%>,url: "<%=request.getContextPath()%>/acquisition/acq_new_entry.jsp"}));
               oAcqGenerateTitleMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition19") %>", { disabled: <%=acq_privilege[5]%>,url: "<%=request.getContextPath()%>/acquisition/acq_search_title.jsp"}));
...
*/
                oAcqApprovalprocessMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition20") %>", { disabled: <%=acq_privilege[7]%>, url: "<%=request.getContextPath()%>/acquisition/acq_initiate_approval.jsp"}));
              ...
              /*   oAcqPlaceorderMenu.addItem(new YAHOO.widget.MenuItem("View List For Order", {submenu:oAcqViewListForOrderMenu , disabled: <%=acq_privilege[22]%> ,url: ""}));
                 oAcqPlaceorderMenu.addItem(new YAHOO.widget.MenuItem("Generate Order", {disabled: <%=acq_privilege[25]%> ,url: "<%=request.getContextPath()%>/acq_order.do"}));
                 oAcqPlaceorderMenu.addItem(new YAHOO.widget.MenuItem("List of Ordered Titles", {disabled: <%=acq_privilege[26]%> ,url: "<%=request.getContextPath()%>/acquisition/acq_order_process_report.jsp"}));
...
*/
                ...
                oAcqPlaceorderMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition25") %>", {submenu:oAcqViewListForOrderMenu , disabled: <%=acq_privilege[22]%> ,url: ""}));
                 ...
                 oAcqPlaceorderMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition27") %>", {disabled: <%=acq_privilege[26]%> ,url: "<%=request.getContextPath()%>/acquisition/acq_order_process_report.jsp"}));
              ...
              /*  oInvoiceManagementMenu.addItem(new YAHOO.widget.MenuItem("Process Invoice", {disabled: <%=acq_privilege[31]%> ,url: "<%=request.getContextPath()%>/acquisition/acq_invoice_item_main.jsp"}));
                oInvoiceManagementMenu.addItem(new YAHOO.widget.MenuItem("Payment Request", {disabled: <%=acq_privilege[32]%>,url: "<%=request.getContextPath()%>/acquisition/acq_payment_request.jsp"}));
                oInvoiceManagementMenu.addItem(new YAHOO.widget.MenuItem("Payment Updates", {disabled: <%=acq_privilege[33]%> , url: "<%=request.getContextPath()%>/invoice_payment_update.do"}));
...
*/
 ...
 oInvoiceManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition30") %>", {disabled: <%=acq_privilege[31]%> ,url: "<%=request.getContextPath()%>/acquisition/acq_invoice_item_main.jsp"}));
                oInvoiceManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition31") %>", {disabled: <%=acq_privilege[32]%>,url: "<%=request.getContextPath()%>/acquisition/acq_payment_request.jsp"}));
                oInvoiceManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition32") %>", {disabled: <%=acq_privilege[33]%> , url: "<%=request.getContextPath()%>/invoice_payment_update.do"}));
           ...
           /*    oAccessioningMenu.addItem(new YAHOO.widget.MenuItem("Accession Process", {disabled: <%=acq_privilege[40]%> ,url: "<%=request.getContextPath()%>/acq_book_accessioning.do"}));
               oAccessioningMenu.addItem(new YAHOO.widget.MenuItem("Accession Register", {disabled: <%=acq_privilege[41]%> ,url: ""}));
*/

                  oAccessioningMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition34") %>", {disabled: <%=acq_privilege[40]%> ,url: "<%=request.getContextPath()%>/acq_book_accessioning.do"}));
...
*/
                    oAcqRecordkeepingMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition36") %>", {disabled: <%=acq_privilege[45]%> ,url:"<%=request.getContextPath()%>/acquisition/acq_initiate_vendor.jsp"}));
...
*/
  ...
  oAcqBudgetManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition66") %>", {  disabled: <%=acq_privilege[78]%>,url: "<%=request.getContextPath()%>/acquisition/acq_add_budgethead.jsp"}));
                oAcqBudgetManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition84")%>", {  disabled: <%=acq_privilege[79]%>,  url: "<%=request.getContextPath()%>/acquisition/acq_budget_alloc.do"}));
               oAcqBudgetManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition68") %>", {  disabled: <%=acq_privilege[80]%>, url: "<%=request.getContextPath()%>/acquisition/acq_currency1.jsp"}));
                oAcqBudgetManagementMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition85")%>", {  disabled: <%=acq_privilege[81]%>, url: "<%=request.getContextPath()%>/acquisition/acq_base_currency.jsp"}));
...
//Start: First Level Acquisition Menu1111111111111111111111111111111111111111111111111111111111111111111
            ...
            /*    oAcqMenu.addItem(new YAHOO.widget.MenuItem("Generate Title", {submenu:oAcqGenerateTitleMenu , disabled: <%=acq_privilege[1]%> , url:"" } ));
                ...
                oAcqMenu.addItem(new YAHOO.widget.MenuItem("Receive Order", { disabled:<%=acq_privilege[29]%> , url:"<%=request.getContextPath()%>/acq_recieve_order.do" }));
...
*/
                ...
                oAcqMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.acquisition74") %>", { disabled:<%=acq_privilege[29]%> , url:"<%=request.getContextPath()%>/receive_item.do" }));
...
//sum menu of admin-staffAcc
            ...
            oStaffAccMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.admin4")%>", {url: "<%=request.getContextPath()%>/admin/account.jsp?p=6"}));
                ...
                //oStaffAccMenu.addItem(new YAHOO.widget.MenuItem("View All Staff Account", {url: "<%=request.getContextPath()%>/viewallaccount.do"}));
                oStaffAccMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.admin8")%>", {url: "<%=request.getContextPath()%>/viewallaccount.do?p=10"}));
...
//submenu of admin Staff
             ...
             //   oStaffMenu.addItem(new YAHOO.widget.MenuItem("Register Staff", {url: "<%=request.getContextPath()%>/admin/acq_register.jsp"}));
                ...
                //oStaffMenu.addItem(new YAHOO.widget.MenuItem("View All Staff Record", {url: "<%=request.getContextPath()%>/viewall.do"}));
                oStaffMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.admin13")%>", {url: "<%=request.getContextPath()%>/viewall.do?p=5"}));

                //oStaffMenu.addItem(new YAHOO.widget.MenuItem("Upload Staff Record", {url: "<%=request.getContextPath()%>/admin/cat_data_import_read.jsp"}));
                oStaffMenu.addItem(new YAHOO.widget.MenuItem("Upload Staff Record", {url: "<%=request.getContextPath()%>/admin/cat_data_import_read.jsp"}));
...
<%
        if(login_role.equalsIgnoreCase("insti-admin") || login_role.equalsIgnoreCase("admin")){%>
               ...
               // oManDepMenu.addItem(new YAHOO.widget.MenuItem("Add SubLibrary", {url: "<%=request.getContextPath()%>/admin/manage_library.jsp"}))
                 oManDepMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.sublibrary1")%>", {url: "<%=request.getContextPath()%>/admin/manage_library.jsp"}))
               // oManDepMenu.addItem(new YAHOO.widget.MenuItem("Update SubLibrary", {url: "<%=request.getContextPath()%>/admin/manage_library.jsp"}))
                oManDepMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.sublibrary2")%>", {url: "<%=request.getContextPath()%>/admin/manage_library.jsp"}))
               // oManDepMenu.addItem(new YAHOO.widget.MenuItem("Delete SubLibrary", {url: "<%=request.getContextPath()%>/admin/manage_library.jsp"}))
               oManDepMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.sublibrary3")%>", {url: "<%=request.getContextPath()%>/admin/manage_library.jsp"}))
               // oManDepMenu.addItem(new YAHOO.widget.MenuItem("View SubLibrary", {url: "<%=request.getContextPath()%>/admin/manage_library.jsp"}))
                oManDepMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.sublibrary4")%>", {url: "<%=request.getContextPath()%>/admin/manage_library.jsp"}))
               // oManDepMenu.addItem(new YAHOO.widget.MenuItem("ViewAll SubLibrary", {url: "<%=request.getContextPath()%>/admin/sub_lib_viewall.do"}))

               oManDepMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.sublibrary5")%>", {url: "<%=request.getContextPath()%>/admin/sub_lib_viewall.do"}))
<%}%>
//submenu of Manage Faculty
               ...
               // oFacultyMenu.addItem(new YAHOO.widget.MenuItem("Add Faculty", {url: "<%=request.getContextPath()%>/systemsetup/manage_faculty.jsp"}))
                oFacultyMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.faculty1")%>", {url: "<%=request.getContextPath()%>/systemsetup/manage_faculty.jsp"}))
                //oFacultyMenu.addItem(new YAHOO.widget.MenuItem("Update Faculty", {url: "<%=request.getContextPath()%>/systemsetup/manage_faculty.jsp"}))
                oFacultyMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.faculty2")%>", {url: "<%=request.getContextPath()%>/systemsetup/manage_faculty.jsp"}))
                //oFacultyMenu.addItem(new YAHOO.widget.MenuItem("Delete Faculty", {url: "<%=request.getContextPath()%>/systemsetup/manage_faculty.jsp"}))
                oFacultyMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.faculty3")%>", {url: "<%=request.getContextPath()%>/systemsetup/manage_faculty.jsp"}))
                //oFacultyMenu.addItem(new YAHOO.widget.MenuItem("View Faculty", {url: "<%=request.getContextPath()%>/systemsetup/manage_faculty.jsp"}))
                oFacultyMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.faculty4")%>", {url: "<%=request.getContextPath()%>/systemsetup/manage_faculty.jsp"}))
                //oFacultyMenu.addItem(new YAHOO.widget.MenuItem("ViewAll Faculty", {url: "<%=request.getContextPath()%>/systemsetup/view_allfaculty.do"}))
                oFacultyMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.faculty5")%>", {url: "<%=request.getContextPath()%>/systemsetup/view_allfaculty.do"}))
...
//submenu of Manage Department
              ...
              //  oDepartmentMenu.addItem(new YAHOO.widget.MenuItem("Add Department", {url: "<%=request.getContextPath()%>/systemsetup/managedept1.do"}))
                oDepartmentMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.dept1")%>", {url: "<%=request.getContextPath()%>/systemsetup/managedept1.do"}))
                ...
                oDepartmentMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.dept2")%>", {url: "<%=request.getContextPath()%>/systemsetup/managedept1.do"}))
                ...
                oDepartmentMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.dept3")%>", {url: "<%=request.getContextPath()%>/systemsetup/managedept1.do"}))
                //oDepartmentMenu.addItem(new YAHOO.widget.MenuItem("View Department", {url: "<%=request.getContextPath()%>/systemsetup/managedept1.do"}))
                oDepartmentMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.dept4")%>", {url: "<%=request.getContextPath()%>/systemsetup/managedept1.do"}))
                ...
                oDepartmentMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.dept5")%>", {url: "<%=request.getContextPath()%>/systemsetup/view_alldept.do"}))
...
//submenu of Manage Course
               ...
               // oCourseMenu.addItem(new YAHOO.widget.MenuItem("Add Course", {url: "<%=request.getContextPath()%>/systemsetup/managecourse1.do"}))
                oCourseMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.course1")%>", {url: "<%=request.getContextPath()%>/systemsetup/managecourse1.do"}))
                //oCourseMenu.addItem(new YAHOO.widget.MenuItem("Update Course", {url: "<%=request.getContextPath()%>/systemsetup/managecourse1.do"}))
                oCourseMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.course2")%>", {url: "<%=request.getContextPath()%>/systemsetup/managecourse1.do"}))
                //oCourseMenu.addItem(new YAHOO.widget.MenuItem("Delete Course", {url: "<%=request.getContextPath()%>/systemsetup/managecourse1.do"}))
                oCourseMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.course3")%>", {url: "<%=request.getContextPath()%>/systemsetup/managecourse1.do"}))
                //oCourseMenu.addItem(new YAHOO.widget.MenuItem("View Course", {url: "<%=request.getContextPath()%>/systemsetup/managecourse1.do"}))
                oCourseMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.course4")%>", {url: "<%=request.getContextPath()%>/systemsetup/managecourse1.do"}))
                //oCourseMenu.addItem(new YAHOO.widget.MenuItem("ViewAll Course", {url: "<%=request.getContextPath()%>/systemsetup/view_allcourse.do"}))
                oCourseMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.course5")%>", {url: "<%=request.getContextPath()%>/systemsetup/view_allcourse.do"}))
...
//submenu of Member
              ...
              //  oMemberMenu.addItem(new YAHOO.widget.MenuItem("Add Member", {url: "<%=request.getContextPath()%>/systemsetup/manage_member.jsp"}))
                oMemberMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.member1")%>", {url: "<%=request.getContextPath()%>/systemsetup/manage_member.jsp"}))
              //  oMemberMenu.addItem(new YAHOO.widget.MenuItem("Update Member", {url: "<%=request.getContextPath()%>/systemsetup/manage_member.jsp"}))
                oMemberMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.member2")%>", {url: "<%=request.getContextPath()%>/systemsetup/manage_member.jsp"}))
                //oMemberMenu.addItem(new YAHOO.widget.MenuItem("Delete Member", {url: "<%=request.getContextPath()%>/systemsetup/manage_member.jsp"}))
                oMemberMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.member3")%>", {url: "<%=request.getContextPath()%>/systemsetup/manage_member.jsp"}))
                //oMemberMenu.addItem(new YAHOO.widget.MenuItem("View Member", {url: "<%=request.getContextPath()%>/systemsetup/manage_member.jsp"}))
                oMemberMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.member4")%>", {url: "<%=request.getContextPath()%>/systemsetup/manage_member.jsp"}))
                //oMemberMenu.addItem(new YAHOO.widget.MenuItem("ViewAll AllMember", {url: "<%=request.getContextPath()%>/systemsetup/viewall_member.do"}))
                oMemberMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.member5")%>", {url: "<%=request.getContextPath()%>/systemsetup/viewall_member.do"}))
...
//submenu of SubMember
                ...
                oSubMemberMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.submember1")%>", {url: "<%=request.getContextPath()%>/systemsetup/submember1.do"}))
                //oSubMemberMenu.addItem(new YAHOO.widget.MenuItem("Update SubMember", {url: "<%=request.getContextPath()%>/systemsetup/submember1.do"}))
                oSubMemberMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.submember2")%>", {url: "<%=request.getContextPath()%>/systemsetup/submember1.do"}))
                //oSubMemberMenu.addItem(new YAHOO.widget.MenuItem("Delete SubMember", {url: "<%=request.getContextPath()%>/systemsetup/submember1.do"}))
                oSubMemberMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.submember3")%>", {url: "<%=request.getContextPath()%>/systemsetup/submember1.do"}))
                //oSubMemberMenu.addItem(new YAHOO.widget.MenuItem("View SubMember", {url: "<%=request.getContextPath()%>/systemsetup/submember1.do"}))
                oSubMemberMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.submember4")%>", {url: "<%=request.getContextPath()%>/systemsetup/submember1.do"}))
                ...
                oSubMemberMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.submember5")%>", {url: "<%=request.getContextPath()%>/systemsetup/viewall_submember.do"}))
...
//submenu of Manage Book Type
                ...
                oBookMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.doccat1")%>", {url: "<%=request.getContextPath()%>/systemsetup/document_category.jsp"}))
                ...
                oBookMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.doccat2")%>", {url: "<%=request.getContextPath()%>/systemsetup/document_category.jsp"}))
               // oBookMenu.addItem(new YAHOO.widget.MenuItem("Delete Document Category", {url: "<%=request.getContextPath()%>/systemsetup/document_category.jsp"}))
                oBookMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.doccat3")%>", {url: "<%=request.getContextPath()%>/systemsetup/document_category.jsp"}))
                ...
                oBookMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.doccat4")%>", {url: "<%=request.getContextPath()%>/systemsetup/document_category.jsp"}))
                ...
                oBookMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.doccat5")%>", {url: "<%=request.getContextPath()%>/systemsetup/viewallcat.do"}))
...
//submenu of Manage Fine
                ...
                oFineMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.fine1")%>", {url: "<%=request.getContextPath()%>/systemsetup/managebooktype.do"}))
                //oFineMenu.addItem(new YAHOO.widget.MenuItem("Update FineDetail", {url: "<%=request.getContextPath()%>/systemsetup/managebooktype.do"}))
                oFineMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.fine2")%>", {url: "<%=request.getContextPath()%>/systemsetup/managebooktype.do"}))
                //oFineMenu.addItem(new YAHOO.widget.MenuItem("Delete FineDetail", {url: "<%=request.getContextPath()%>/systemsetup/managebooktype.do"}))
                oFineMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.fine3")%>", {url: "<%=request.getContextPath()%>/systemsetup/managebooktype.do"}))
                //oFineMenu.addItem(new YAHOO.widget.MenuItem("View FineDetail", {url: "<%=request.getContextPath()%>/systemsetup/managebooktype.do"}))
                oFineMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.fine4")%>", {url: "<%=request.getContextPath()%>/systemsetup/managebooktype.do"}))
                //oFineMenu.addItem(new YAHOO.widget.MenuItem("ViewAll FineDetail", {url: "<%=request.getContextPath()%>/systemsetup/view_allbook.do"}))
                oFineMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.fine5")%>", {url: "<%=request.getContextPath()%>/systemsetup/view_allbook.do"}))
...
*/
                 oLocations.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.loc1")%>", {url: "<%=request.getContextPath()%>/systemsetup/add_location.jsp"}))
                oLocations.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.loc2")%>", {url: "<%=request.getContextPath()%>/systemsetup/add_location.jsp"}))
                oLocations.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.loc3")%>", {url: "<%=request.getContextPath()%>/systemsetup/add_location.jsp"}))
                oLocations.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.loc4")%>", {url: "<%=request.getContextPath()%>/systemsetup/add_location.jsp"}))
                oLocations.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.loc5")%>", {url: "<%=request.getContextPath()%>/systemsetup/view_alllocations.do"}))
...
//submenu of manage notices
              ...
              /*  oManNotMenu.addItem(new YAHOO.widget.MenuItem("Add Notices", {url: "<%=request.getContextPath()%>/systemsetup/manage_notices.jsp"}))
                ...
                */
                ...
                oManNotMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.notice1")%>", {url: "<%=request.getContextPath()%>/systemsetup/manage_notices.jsp"}))
                oManNotMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.notice2")%>", {url: "<%=request.getContextPath()%>/systemsetup/manage_notices.jsp"}))
                oManNotMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.notice3")%>", {url: "<%=request.getContextPath()%>/systemsetup/manage_notices.jsp"}))
                oManNotMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.notice4")%>", {url: "<%=request.getContextPath()%>/systemsetup/manage_notices.jsp"}))
                oManNotMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.systemsetup.notice5")%>", {url: "<%=request.getContextPath()%>/systemsetup/view_allnotices.do"}))
...
//submenu of Administrator
    ...
    <% if(login_role.equalsIgnoreCase("insti-admin") || login_role.equalsIgnoreCase("admin")){%>
		...
		oAdminMenu.addItem(new YAHOO.widget.MenuItem("<%=resource.getString("admin.header.changeimage")%>", {url: "<%=request.getContextPath()%>/admin/changelogo.jsp"}));


		//oAdminMenu.addItem(new YAHOO.widget.MenuItem("Reset Staff Password", {url: ""}));		
		oAdminMenu.addItem(new YAHOO.widget.MenuItem("Reset Staff Password", {url: ""}));	
	<%}%>	
...
//submenu of System Setup
               ...
               /*  oSetupMenu.addItem(new YAHOO.widget.MenuItem("Manage Notices", {submenu:oManNotMenu}));
                ...
                oSetupMenu.addItem(new YAHOO.widget.MenuItem("Manage Reservation Priority", { submenu: oCourseMenu }));
		oSetupMenu.addItem(new YAHOO.widget.MenuItem("Set No of Fine Installments", {url:""}));
		oSetupMenu.addItem(new YAHOO.widget.MenuItem("Set CopyRight Setting for DL", {url:""}));
                      */
                ...
                oSetupMenu.addItem(new YAHOO.widget.MenuItem("Manage Reservation Priority", {url:""}));
		oSetupMenu.addItem(new YAHOO.widget.MenuItem("Set No of Fine Installments", {url:""}));
		oSetupMenu.addItem(new YAHOO.widget.MenuItem("Set CopyRight Setting for DL", {url:""}));
...
//submenu of Manage Book Type
                ...
                oBookMenu.addItem(new YAHOO.widget.MenuItem("Add Book Category", {url: "<%=request.getContextPath()%>/systemsetup/managebooktype.do"}))
                oBookMenu.addItem(new YAHOO.widget.MenuItem("Update Book Category", {url: "<%=request.getContextPath()%>/systemsetup/managebooktype.do"}))
                oBookMenu.addItem(new YAHOO.widget.MenuItem("Delete Book Category", {url: "<%=request.getContextPath()%>/systemsetup/managebooktype.do"}))
                oBookMenu.addItem(new YAHOO.widget.MenuItem("View Book Category", {url: "<%=request.getContextPath()%>/systemsetup/managebooktype.do"}))
                oBookMenu.addItem(new YAHOO.widget.MenuItem("ViewAll Book Category", {url: "<%=request.getContextPath()%>/systemsetup/view_allbook.do"}))
...
<% if(locale1.equalsIgnoreCase("ar")|| locale1.equalsIgnoreCase("ur")){%>
     //oMenuBar.addItem("HELP");
               oMenuBar.addItem(new YAHOO.widget.MenuBarItem("<%=resource.getString("admin.header.main10") %>", {url:"<%=request.getContextPath()%>/module.jsp"}));
                 //oMenuBar.addItem(new YAHOO.widget.MenuBarItem("OPAC", {url:"<%=request.getContextPath()%>/OPAC/OPACmain.jsp"}));
                oMenuBar.addItem(new YAHOO.widget.MenuBarItem("<%=resource.getString("admin.header.main9") %>", {url:"<%=request.getContextPath()%>/OPAC/OPACmain1.jsp"}));
  ...
  //oMenuBar.addItem(new YAHOO.widget.MenuBarItem("HOME", {url:"<%=request.getContextPath()%>/admin/main.jsp"}));
                oMenuBar.addItem(new YAHOO.widget.MenuBarItem("<%=resource.getString("admin.header.main1") %>", {url:"<%=request.getContextPath()%>/admin/main.jsp"}));
...
<table width="100%"  border="0px" class="logout">
               ...
               <tr>
                    <td  width="300px"   valign="top">
                        <table border="0"  style="font:8pt Verdana;"><tr><td valign="top"><%=resource.getString("login.hello")%>,&nbsp;
...
<table>
<tr>
<td align="right">   <%if (request.getAttribute("imagechange1")!=null){%><%--
                        <html:img src="/LibMS/admin/logo.jsp" width="50" height="50" />
                        <%}else{%>
--%>   <html:img src="/LibMS/admin/viewimage.jsp" width="50" border="1px" height="50" />
                        <%}%>
</td>
<td align="center">
...
<span style="font-size:20px;font-weight:bold;color:blue;" >
 ...
 <%=library_name%></span>&nbsp;&nbsp;<br/><span class="mess"><%=resource.getString("opac.simplesearch.library")%>&nbsp;[<%=sublibrary_name%>]&nbsp;&nbsp;<%=resource.getString("admin.header.role")%>:&nbsp;[<%=role_name%>]</span>
</td></tr>
</table>
...
<tr style="background-color:#E0E8F5;color:black;font-weight:bold;"><td height=20px width=15%>&nbsp;Library Management System(LibMS) </td><td align=center width=50%>
<%=library_name%>&nbsp;(<%=sublibrary_name%>)

</td><td  align="right"  valign="top" width=15%><%=resource.getString("login.hello")%>,&nbsp;   <%=username%>                  


                        <!--<script>document.write('<span ');
document.write('height:10px;border:0px solid black;font:bold 10pt Verdana;');
document.write(' onClick="toggle_menu(1);');
document.write('event.cancelBubble=1" ><span style="cursor:hand;text-decoration:none;">');
...
|&nbsp;<a style="color:black;text-decoration:none" href="<%=request.getContextPath()%>/logout.do"><%=resource.getString("login.signout")%>&nbsp;</a>

</td></tr>
               <tr> 

<td width="50%" style="font: arial;font-size: 22px;" colspan=2 valign="middle" align=left>
<table><tr><td>
&nbsp;     <html:img src="/LibMS/admin/viewimage.jsp" width="50px" height="50px"  />&nbsp; </td><td>     <%=role_name%> Interface            
</td></tr></table>
</td>
...
<a href="<%=request.getContextPath()%>/staffupdate.do"><html:img src="/LibMS/images/update.jpg" width="40px" height="40px"  /><br>Update Profile</a>
</td><td align=center>&nbsp;
<a href="<%=request.getContextPath()%>/changeuserpassword.do"><html:img src="/LibMS/images/setting.jpg" width="40px" height="40px"  /><br>Change Password</a></td>
<td align=center>&nbsp;<html:img src="/LibMS/images/logo.png" width="120px" height="50px"  /></td>
</tr></table>
