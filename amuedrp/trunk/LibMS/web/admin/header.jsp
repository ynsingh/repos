...
//Start:Second Level Acquisition Menu 22222222222222222222222222222222222222222222222222222222222222222222
              ...
              var oAcqPlaceorderMenu = new YAHOO.widget.Menu("Place Order");
               ...
               oAccessioningMenu.addItem(new YAHOO.widget.MenuItem("Accession Register", {disabled: <%=acq_privilege[41]%> ,url: ""}));
                ...
                oAcqRecordkeepingMenu.addItem(new YAHOO.widget.MenuItem("Vendors", {disabled: <%=acq_privilege[45]%> ,url:"<%=request.getContextPath()%>/acquisition/acq_vendor.jsp"}));
...
<table width="100%"  border="0px" class="logout">
               ...
               <tr><td width="150px" align="right">
                    ...
                    <td align="center" class=""><span style="font-size:20px;font-weight:bold;color:blue;" > <%=library_name%></span>&nbsp;&nbsp;<br/><span class="mess">Library:&nbsp;[<%=sublibrary_name%>]&nbsp;&nbsp;User Role:&nbsp;[<%=role_name%>]</span></td>
