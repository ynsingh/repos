...
<div
   ...
   right:5px;
      ...
      visibility: show;">
    <link rel="stylesheet" href="/LibMS-Struts/css/page.css"/><br><br><br>
...
<input type="submit" value="Confirm Privilege" name="button" class="txt2" onclick="quit()"/>
<input type="submit" value="Restore Previous Privilege" name="button" class="txt2"/>
                        ...
                        <script>
                            function quit()
                            {
                               ...
                               location.href="/LibMS-Struts/admin/privilege_message1.jsp";
                            }
                            </script>
