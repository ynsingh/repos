...
<html>
    ...
    <body>
        <html:form  action="/manage_email.do" method="post">
           <table  align="left" width="500px" height="150px" style="background-color: white;border:#c0003b 1px solid;margin:0px 0px 0px 0px;">
           <tr><td style="background-color: #c0003b;color:white;" colspan="2" class="btn1" height="30px"><b>Email Account Setting</b> </td></tr>
           <tr><td width="100px" class="btn3" align="left">SMTP Address</td><td><html:text styleId="user_id1" property="user_id1"/></td></tr>
           <tr><td width="100px" class="btn3" align="left">Mail UserName</td><td><html:text styleId="user_id2" property="user_id2"/></td></tr>
        <tr><td class="btn3" align="left">Mail User Password</td><td><html:password styleId="password1" property="password1"/>
                <tr><td class="btn3" align="left">Mail Port</td><td><html:password styleId="password1" property="password1"/>
