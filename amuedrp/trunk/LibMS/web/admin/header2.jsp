...
<%@ page language="java" import="java.sql.*,com.myapp.struts.opac.MyQueryResult" %>
...
<html>
    <head>
       ...
       String acquisition=rst1.getString(3);
       String cataloguing=rst1.getString(4);
       String circulation=rst1.getString(5);
       String serial=rst1.getString(6);
       String system_setup=rst1.getString(7);
       String utility=rst1.getString(8);
       String administrator=rst1.getString(9);


String acq2=rst2.getString(3);
//acquisition privilege fields
String acq3=rst2.getString(4);
String acq4=rst2.getString(5);
String acq5=rst2.getString(6);
String acq6=rst2.getString(7);
String acq7=rst2.getString(8);
String acq8=rst2.getString(9);
String acq9=rst2.getString(10);
String acq10=rst2.getString(11);
String acq11=rst2.getString(12);
String acq12=rst2.getString(13);
String acq13=rst2.getString(14);
String acq14=rst2.getString(15);
String acq15=rst2.getString(16);
String acq16=rst2.getString(17);
String acq17=rst2.getString(18);
String acq18=rst2.getString(19);
String acq19=rst2.getString(20);
String acq20=rst2.getString(21);
String acq21=rst2.getString(22);
String acq22=rst2.getString(23);
String acq23=rst2.getString(24);
String acq24=rst2.getString(25);

//cataloguing privilege fields
String cat2=rst3.getString(3);
//out.println(cat2);
String cat3=rst3.getString(4);
String cat4=rst3.getString(5);
String cat5=rst3.getString(6);
String cat6=rst3.getString(7);
String cat7=rst3.getString(8);
String cat8=rst3.getString(9);
String cat9=rst3.getString(10);
String cat10=rst3.getString(11);
String cat11=rst3.getString(12);
String cat12=rst3.getString(13);
String cat13=rst3.getString(14);
String cat14=rst3.getString(15);
String cat15=rst3.getString(16);
String cat16=rst3.getString(17);
String cat17=rst3.getString(18);

//circulation privilege fields
String cir2=rst4.getString(3);
String cir3=rst4.getString(4);
String cir4=rst4.getString(5);
String cir5=rst4.getString(6);
String cir6=rst4.getString(7);
String cir7=rst4.getString(8);
String cir8=rst4.getString(9);
String cir9=rst4.getString(10);
String cir10=rst4.getString(11);
String cir11=rst4.getString(12);
String cir12=rst4.getString(13);
String cir13=rst4.getString(14);
String cir14=rst4.getString(15);
String cir15=rst4.getString(16);
String cir16=rst4.getString(17);
String cir17=rst4.getString(18);
String cir18=rst4.getString(19);
String cir19=rst4.getString(20);
String cir20=rst4.getString(21);
String cir21=rst4.getString(22);

//circulation privilege fields
String ser2=rst5.getString(3);
String ser3=rst5.getString(4);
String ser4=rst5.getString(5);
String ser5=rst5.getString(6);
String ser6=rst5.getString(7);
String ser7=rst5.getString(8);
String ser8=rst5.getString(9);
String ser9=rst5.getString(10);
String ser10=rst5.getString(11);
String ser11=rst5.getString(12);
...
//submenu of Administrator
                ...
                //oAdminMenu.addItem(new YAHOO.widget.MenuItem("Cut", { url: "newhtml.html", helptext: "Ctrl + X", disabled: }), 1);
