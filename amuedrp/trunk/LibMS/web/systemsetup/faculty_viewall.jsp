...
String FacultyName=resource.getString("systemsetup.add_faculty.facultyname");
pageContext.setAttribute("FacultyName", FacultyName);
...
<body>
 <table dir="<%=rtl%>" border="1" class="table" width="400px" align="center">



       <tr><td dir="<%=rtl%>" align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;"><%=resource.getString("systemsetup.fac_viewall.viewall")%></td></tr>
...
<%
   ...
   opacList=(ArrayList)session.getAttribute("faculty");
   int tcount =0;
   int perpage=4;
   int tpage=0;
...
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0"
  ...
  <columns>
    ...
    <column width="200">
      <header value="${FacultyName}" hAlign="left" styleClass="admingridheader"/>
