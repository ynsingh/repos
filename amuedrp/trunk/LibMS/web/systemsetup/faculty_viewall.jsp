...
<body>
 <table border="1" class="table" width="400px" align="center">
       ...
       <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;">View All Faculty</td></tr>
...
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0"
  ...
  <columns>
    ...
    <column width="200">
      <header value="Faculty Name" hAlign="left" styleClass="admingridheader"/>
