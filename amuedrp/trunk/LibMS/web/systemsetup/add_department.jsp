...
<%}%>
  ...
  <tr>
    ...
    <td dir="<%=rtl%>"><html:text property="dept_name" styleId="department_name"  value="" styleClass="textBoxWidth" onfocus="statwords('Please Enter Valid Department Name ');" onblur="return loadHelp();"
/>
