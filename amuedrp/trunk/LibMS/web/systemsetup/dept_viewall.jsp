...
String DepartmentName=resource.getString("systemsetup.add_dept.deptname");
...
<body>
 <table dir="<%=rtl%>"  class="table" width="600px" align="center">
       ...
       <tr><td dir="<%=rtl%>" align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;"><%=resource.getString("systemsetup.dept_viewall.viewall")%></td></tr>
...
<%
   ...
   opacList=(ArrayList)session.getAttribute("dept");
   int tcount =0;
   int perpage=4;
   int tpage=0;
...
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0"
  ...
  <columns>
    ...
    <column width="200">
      <header value="${DepartmentName}" hAlign="left" styleClass="admingridheader"/>
      <item   value="${doc.deptName}" hAlign="left"  styleClass="item"/>
    </column>    
