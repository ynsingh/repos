...
int tcount =0;
 ...
 opacList=(ArrayList)request.getAttribute("acqRecHeaderList");
...
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  <columns>
    ...
    <column width="80">
        <header value="Receiving Dtae" hAlign="left" styleClass="header"/>
        <item   value="${doc.recievedDate}"  hAlign="left"   styleClass="item"/>
    </column>
    <column width="120">
        <header value="Received By" hAlign="left" styleClass="header"/>
        <item   value="${doc.recievedBy}"  hAlign="left"  styleClass="item"/>
    </column>
    <column width="80">
