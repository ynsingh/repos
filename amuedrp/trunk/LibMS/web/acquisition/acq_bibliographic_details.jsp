...
function isNumberKey(evt)
   ...
   <html:form method="post" action="/acq_biblio" style="position:absolute; left:200px; top:150px;"  >
...
<tr>
  ...
  <tr>
    <td align="right" class="txtStyle"><strong>Author:<a class="star">*</a></strong></td>
  <td><html:text property="author" name="AcqBiblioActionForm" styleClass="textBoxWidth" />
  ...
  <td><html:text property="publisher_name" name="AcqBiblioActionForm" styleClass="textBoxWidth" /></td>
  ...
  <td><html:text property="publishing_year" onkeypress="return isNumberKey(event)" name="AcqBiblioActionForm" styleClass="textBoxWidth" />
  ...
  <tr>
    ...
    <td><html:text  property="isbn" name="AcqBiblioActionForm" styleClass="textBoxWidth" /></td>
  ...
  <td><html:text property="edition" name="AcqBiblioActionForm" styleClass="textBoxWidth" /></td>
...
<td>
    ...
    <td><html:text readonly="false" property="title" name="AcqBiblioActionForm" styleClass="textBoxWidth" />
    </td>
       </tr>
       <tr>
            <td align="right" class="txtStyle"><strong>Sub Authors:</strong></td>
  <td><html:text property="sub_author" name="AcqBiblioActionForm" styleClass="textBoxWidth" />
  ...
  <input type="button" onclick="javascript:animatedcollapse.show(['1','2','3'])" value="+"/>
     <input type="button" onclick="javascript:animatedcollapse.hide(['1','2','3'])" value="-"/></td></tr>
            ...
            <div id="1" style="display: none;">
                        <html:text property="sub_author0" name="AcqBiblioActionForm" styleClass="textBoxWidth" tabindex="7"/>
</div>
<div id="2" style="display: none;">
    <html:text property="sub_author1" name="AcqBiblioActionForm" styleClass="textBoxWidth" tabindex="8"/>
</div>
<div id="3" style="display: none;">
    <html:text property="sub_author2" name="AcqBiblioActionForm" styleClass="textBoxWidth" tabindex="9"/>
</div>
</td>
            </tr>
<tr>
            <td align="right" class="txtStyle"><strong>Publication Place :</strong></td>
  <td><html:text property="publication_place" name="AcqBiblioActionForm" styleClass="textBoxWidth" /></td>
       </tr>
       <tr>
            <td align="right" class="txtStyle"><strong>LCC No:</strong></td>
  <td><html:text property="lcc_no" name="AcqBiblioActionForm" styleClass="textBoxWidth" />
         </td>
       </tr>
       <tr>
             <td align="right" class="txtStyle"><strong>No of Volumes</strong></td>
  <td><html:text property="volume_no" onkeypress="return isNumberKey(event)" name="AcqBiblioActionForm" styleClass="textBoxWidth" /></td>
       </tr>
   </table>
...
<td align="center" colspan="4">
    ...
    &nbsp;&nbsp;&nbsp;<input name="button" type="button" onclick="return send()" value="Cancel" />
&nbsp;&nbsp;&nbsp;<input name="button" type="submit" value="Initiate Acquisition" />
</td>
