...
<body>
   ...
   right:5px;
      ...
      visibility: show;">
       ...
       <html:form action="/acq_initiate_recieve_order"  onsubmit="return check1()" method="post"  style="position:absolute; left:400px; top:50px;">
 <table width="400px" height="200px"  valign="top" align="center" style="border:#cccccc solid 1px;">

  <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;"> Recieving Processing</td></tr>
   <tr><td></td></tr>
        ...
        <tr><td   width="400px" height="200px" valign="top" style="" align="center">
                ...
                <table cellspacing="10px">
                    ...
                    <tr><td rowspan="5">
                            <table>
                                <tr><td  align="left" class="txtStyle"> <strong> Recieving No:</strong></td></tr>
                               <tr><td><html:text property="receiving_no"  styleId="orderno" name="AcqOrderManagementActionForm" styleClass="textBoxWidth" /></td>

                            </tr>


                                <tr><td td  align="left" class="txtStyle"> <strong> Vendor:</strong></td></tr>
          ...
          <html:options collection="vendors" name="AcqBibliographyDetails" labelProperty="vendor" property="vendor"/>
                                ...
                                <tr><td  align="left" class="txtStyle"> <strong> Order No:</strong></td></tr>
                        ...
                        </td><td width="150px" align="center"> <input type="submit" name="button" value="New Recieve Order" Class="txt1"/>
</td></tr>
                    

 <tr><td width="150px" align="center"> <html:submit property="button" value="View Recieve Order" styleClass="txt1"/>
</td></tr>
 <tr><td width="150px" align="center"> <html:submit property="button" value="Print" styleClass="txt1" />
</td></tr>
