...
function check1()
{
    if(document.getElementById('budget_name').value=="")
    {
        alert("Enter Budget Head Name");

        document.getElementById('budget_name').focus();
...
function send()
{
    window.location="<%=request.getContextPath()%>/acquisition/acq_add_budgethead.jsp";
    return false;
}
</script>
<html>
   ...
   right:5px;
      ...
      visibility: show;">
   <html:form method="post" action="/add_budget"  onsubmit="return check1()" >
       <table border="1" class="table" align="center">
                <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;" ><b>Budget Head Detail Entry</b></td></tr>
                <tr><td>
...
<tr>
    <td align="left" class="txtStyle"><strong>Budget Id</strong></td>
...
<tr>
  ...
  <td><html:textarea readonly="<%=read%>" property="budgethead_description" name="AcqBudgetActionForm" styleClass="textBoxWidth" />
  </td>
  </tr>
<tr><td colspan="5" height="5px"></td>
</tr>
