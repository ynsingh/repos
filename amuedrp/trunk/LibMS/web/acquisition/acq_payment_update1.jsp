...
int tcount =0;
 ...
 opacList=(ArrayList)session.getAttribute("acqforpaymentupdate");
...
%>
<form action="invoice_payment_update2.do" method="post" id="f" name="f">
  <tr><td class="mess">
                  <%
                    if (msg!=null)
                    {
...
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  <columns>
    ...
    <column width="100">
        ...
        <item   value="${doc.totalAmt}"  hAlign="left"  styleClass="item"/>
    </column>
    <column width="100">
