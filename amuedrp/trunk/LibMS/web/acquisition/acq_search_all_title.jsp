...
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  ...
  <columns>
    ...
    <column width="70">
      ...
      <item   value="Initiate Acquisition"   hAlign="left" hyperLink="${path}/acquisition/titleShow.do?id=${doc.id.titleId}"
	      styleClass="item" hyperLinkTarget="_parent" />
    </column>
       <column width="70">
      <header value="" hAlign="left" styleClass="header"/>
     <!-- <item   value="Edit"   hAlign="left" hyperLink="/LibMS-Struts/acquisition/titleShow1.do?id=${doc.id.titleId}"
	      styleClass="item" hyperLinkTarget="_parent" />-->
    </column>
