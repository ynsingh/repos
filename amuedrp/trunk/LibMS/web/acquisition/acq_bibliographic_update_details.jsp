...
function send()
{
    window.location="<%=request.getContextPath()%>/acquisition/acq_update_titlegrid.jsp";
    return false;
}
function acq()
{
...
<tr>
  ...
  <td><html:text property="publishing_year" name="AcqBiblioActionForm" styleClass="textBoxWidth" />
...
<tr>
  ...
  <td><html:text property="volume_no" name="AcqBiblioActionForm" styleClass="textBoxWidth" /></td>
       </tr>
   </table>
