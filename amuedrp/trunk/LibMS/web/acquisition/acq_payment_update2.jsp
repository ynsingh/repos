...
int tcount =0;
 ...
 opacList=(ArrayList)session.getAttribute("processedprn");
...
%>
<form action="invoice_payment_update3.do"  method="post" id="f" name="f">
  <tr><td class="mess">
                  <%
                    if (msg!=null)
                    {
...
<tr><td>
        ...
        <strong>Payment Update Date:</strong>
        <input type="text" name="prn_date" id="prn_date"/>
        <input type="hidden" name="list" id="list"/>
        <input type="submit" name="button" value="Submit"/>
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  <columns>
    <column width="80">
        <header value="PRN" hAlign="left" styleClass="header"/>
    ...
    <column width="100">
        ...
        <item   value="${doc.total_amount}"  hAlign="left"  styleClass="item"/>
    </column>
    <column width="100">
    ...
    <column width="100">
        <header value="Payment Date" hAlign="left" styleClass="header"/>
        <item   value="${doc.payment_update_date}"  hAlign="left"  styleClass="item"/>
    </column>
    <column width="100">
        <header value="Update" hAlign="left" styleClass="header"/>
        <item   value="Update"  hAlign="left"   styleClass="item"/>
    </column>
    <columns>
    <column width="50">
        ...
        <item>
            <![CDATA[
            <input type="checkbox" name="check" align="right" id="check" value="${doc.prn}" onClick="javascript:get_check_value();">
            ]]>
          </item>
    </column>
   </columns>
