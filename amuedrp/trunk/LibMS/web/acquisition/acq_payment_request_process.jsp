...
%>
<form action="payment_request_process.do" method="post" id="f" name="f">
...
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  <columns>
    ...
    <column width="50">
        ...
        <item>
            <![CDATA[
            <input type="checkbox" name="check" align="right" id="check" value="${doc.prn},${doc.invoice_no},${doc.recieving_no}"  onClick="javascript:get_check_value();">
            ]]>
          </item>
    </column>
   </columns>
