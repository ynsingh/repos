...
function check1()
{
    if(document.getElementById('budgethead_id').value=="")
    {
        alert("Enter Budget Head Id...");
...
<body style="margin:0px 0px 0px 0px">
    ...
    <html:form method="post" onsubmit="return check1()" action="/budget">
...
<table class="table" border="1" width="400px" height="180px" align="center">
                ...
                <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;">Manage Budget Head</td></tr>
    ...
    <input type="hidden" name="library_id" value="<%=library_id%>">
        ...
        %>
                 ...
                 <tr><td align="justify" colspan="2"><font color="blue" size="-1"><b>Example:</b> ugc for University Grant Commission, cl for Central Library , cs for Computer Science & so on, if Budget Head exists.</font></td></tr>
