...
<head>
     <script>
           ...
           function check1()
                ...
                {
                   if(document.getElementById('recievingno').value=="")
            {
                alert("Enter Recieving No....");

                document.getElementById('recievingno').focus();
...
<body>
   ...
   right:5px;
      ...
      visibility: show;">
       ...
       <html:form action="/acq_initiate_invoice"  onsubmit="return check1()"method="post"  style="position:absolute; left:400px; top:50px;">
 <table width="400px" height="200px"  valign="top" align="center" style="border:#cccccc solid 1px;">

  <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;"> Invoice Processing</td></tr>
   <tr><td></td></tr>
        ...
        <tr><td   width="400px" height="200px" valign="top" style="" align="center">
                ...
                <table cellspacing="10px">
                    ...
                    <tr><td rowspan="5">
                            <table>
                                <tr><td  align="left" class="txtStyle"> <strong> Invoice No<a class="star">*</a>:</strong></td></tr>
                                <tr><td><html:text property="invoice_no" styleId="invoiceno"   name="AcqOrderManagementActionForm" styleClass="textBoxWidth" /></td>

                            </tr>
                                <tr><td  align="left" class="txtStyle"> <strong> Recieving No<a class="star">*</a>:</strong></td></tr>
                                <tr><td><html:text property="receiving_no" styleId="recievingno"   name="AcqOrderManagementActionForm" styleClass="textBoxWidth" /></td>
  ...
  </td><td width="150px" align="center"> <input type="submit" name="button" value="New Invoice" Class="txt1"/>
</td></tr>
