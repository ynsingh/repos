...
int tcount =0;
 ...
 opacList=(ArrayList)request.getAttribute("acqinvoicedetails");
...
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  <columns>
     <column width="80">
        ...
        <item   value="${doc.id.invoiceNo}"  hAlign="left"   styleClass="item"/>
    </column>
    <column width="80">
        <header value="Recieving No" hAlign="left" styleClass="header"/>
        <item   value="${doc.id.recievingNo}"  hAlign="left"   styleClass="item"/>
    </column>

    <column width="80">
        <header value="Order NO" hAlign="left" styleClass="header"/>
        <item   value="${doc.orderNo}"  hAlign="left"  styleClass="item"/>
    </column>
    ...
    <column width="80">
        <header value="Discount" hAlign="left" styleClass="header"/>
        <item   value="${doc.discount}"  hAlign="left"  styleClass="item"/>
    </column>

    <column width="80">
        <header value="Net Total" hAlign="left" styleClass="header"/>
        <item   value="${doc.netTotal}"  hAlign="left"  styleClass="item"/>
    </column>
