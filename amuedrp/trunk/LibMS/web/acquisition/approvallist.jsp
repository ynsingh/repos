...
int i=0;
 int j=0;
List<AcqBibliographyDetails> l11=(List<AcqBibliographyDetails>)session.getAttribute("opacList");
...
<form id="f1" >
    <table border="0px" style="margin: 0px 0px 0px 0px;">
        <tr><td valign="top" >
             ...
             <tr bgcolor="#E0E8F5" ><td width="100" >Control No</td><td width="200">Title</td><td width="200">Author</td><td width="100">ISBN</td><td width="100">No of Copies</td><td width="200">Select for all copies</td><td width="200">Select for limited copies</td></tr>

             <logic:iterate id="ApprovalList" name="opacList" offset="<%=String.valueOf(fromIndex)%>" length="2">
                <tr>
                    ...
                    <td><input type="checkbox" id="check" name="check" value='<bean:write name="ApprovalList" property="control_no"/>,<bean:write name="ApprovalList" property="no_of_copies"/>'  onclick="get_check_value4(<%=i%>)"/></td>
                    <td><input type="checkbox" id="check1" name="check1" value='<bean:write name="ApprovalList" property="control_no"/>,<bean:write name="ApprovalList" property="no_of_copies"/>' onclick="get_check_value(<%=i%>)" /></td>
                    <td><div id="div<%=++i%>">
                        </div></td>
                </tr>
