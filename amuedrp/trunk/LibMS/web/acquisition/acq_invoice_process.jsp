...
function quit()
  {
      ...
      window.location="/LibMS/acquisition/acq_initiate_invoice.jsp";
      return false;
  }
...
<html>
    ...
    <body>
        <html:form method="post"  styleId="f" action="/acq_invoice_process" style="position:absolute; left:20%; top:20%;">
            ...
            <tr>
           <td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;">Invoicing Process</td>
       </tr>
       <tr><td><br>
               <table width="700" border="0">

                   <tr><td  align="right" class="txtStyle"> <strong> Invoicing No:</strong></td>
                       <td><html:text property="invoice_no" readonly="true" styleId="orderno" name="AcqOrderManagementActionForm" styleClass="textBoxWidth" /></td>

                            </tr>
                            <tr><td  align="right" class="txtStyle"> <strong> Recieving No:</strong></td>
                       <td><html:text property="receiving_no" readonly="true" styleId="orderno" name="AcqOrderManagementActionForm" styleClass="textBoxWidth" /></td>
                        <td width="150" align="right" class="txtStyle"><strong>invoicing date:</strong> </td>
                     <td><html:text  property="invoice_date" name="AcqOrderManagementActionForm" styleClass="textBoxWidth" />
                   ...
                   <tr>
                     ...
                     <td><html:text readonly="true" value="<%=cdate%>" property="recieved_date" name="AcqOrderManagementActionForm" styleClass="textBoxWidth" />

    </td>
                   </tr>
                   <tr>
                       <td align="right" class="txtStyle"><strong>Recieved By:</strong></td>
                       <td><html:text readonly="true" styleId="orderby" property="recieved_by" name="AcqOrderManagementActionForm" styleClass="textBoxWidth" />
        ...
        <tr>
                       ...
                       <input align="left" type="submit" name="button" value="Submit" class="txt1" />
                    <input align="left" type="button" name="button" value="Back" class="txt1" onclick="return quit();"/>
        ...
        <tr>
       <td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;">Invoice List For Recieved Items </td>
       </tr>
        <tr><td><div id="divlist">
                   <iframe name="listdiv" frameborder="0px" width="100%" src="<%=request.getContextPath()%>/acquisition/invoice_orderlist.jsp"></iframe>
               </div>
           </td></tr>
        <tr align="center">
        <td align="center" dir="" colspan="4"><p align="center" dir="">Pages&nbsp;&nbsp;
        <%for(int ii=1;ii<=noofpages;ii++){%>
        <a dir="" target="listdiv" href="<%=request.getContextPath()%>/acquisition/invoice_orderlist1.jsp?pageIndex=<%=ii%>"><%=ii%></a>&nbsp;&nbsp;

        <%}%>
            </p>
        </td></tr>
         <tr>
       <td align="right" class="headerStyle" bgcolor="#E0E8F5" height="25px;">
            <strong>Total Amount:</strong>
           <input type="text" name="list" id="list" value="" /><br>
          ...
          <form name="myform" action="<%=request.getContextPath()%>/acquisition/acq_invoice_process.jsp">
