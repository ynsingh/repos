...
int tcount =0;
 ...
 opacList=(ArrayList)request.getAttribute("acqinvoiceheader");
...
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  <columns>
    ...
    <column width="80">
        ...
        <item   value="${doc.id.vendorId}"  hAlign="left"   styleClass="item"/>
    </column>

    <column width="80">
        <header value="Order NO" hAlign="left" styleClass="header"/>
        <item   value="${doc.id.orderNo}"  hAlign="left"  styleClass="item"/>
    </column>
