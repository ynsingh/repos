...
int i=0;
 int j=0;
List<ApprovalList> l11=(List<ApprovalList>)session.getAttribute("opacList1");
...
<form id="f1" >
    <table border="0px" style="margin: 0px 0px 0px 0px;">
        <tr><td valign="top" >
             ...
             <logic:iterate id="ApprovalList" name="opacList1" offset="<%=String.valueOf(fromIndex)%>" length="2">
                <tr>
