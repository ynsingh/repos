<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
   "http://www.w3.org/TR/html4/loose.dtd">
    ...
    <%@ page import="java.io.*,com.myapp.struts.Acquisition.*"   %>
...
<tr><td align="center"><span class="headerStyle">Duplicate Title Detail</span><br><br></td></tr>
<tr><td>
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  ...
  <columns>
    ...
    <column width="70">
      ...
      <item   value="View"  hAlign="left"   hyperLink="/LibMS/acquisition/viewOwn.do?id=${doc.id.titleId}"
	      styleClass="item"/>
    </column>
  </columns>
...
<%}%>
          ...
          <html:hidden property="library_id" name="AcqBiblioActionForm" value="<%=library_id%>"/>
                ...
                <html:hidden property="author" name="AcqBiblioActionForm" value="<%=author%>"/>
                ...
                <html:hidden property="title" name="AcqBiblioActionForm" value="<%=title%>"/>
                     ...
                     <tr> <td align="center"> <input type="submit" name="button" value="Add Title" Class="txt1"/>
