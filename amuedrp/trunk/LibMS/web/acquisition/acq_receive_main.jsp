...
function send()
{
   ...
   <jsp:include page="/admin/header.jsp"/>
    <body>
        <form method="post" action="receive_item11.do" id="f"  style="position:absolute; left:30%; top:30%">
            <table border="1" class="table" width="400">
                <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;" ><b>Recieving Book</b></td></tr>
               ...
               <strong>Enter Receiving No:<a class="star">*</a></strong><br>

               <input type="text" name="recieving_no"  styleClass="textBoxWidth" id="recieving_no"/><br>
                        </td>
                    </tr>
...
function check()
{
  ...
  if(document.getElementById('recieving_no').value=="")
  {
     alert("Enter Receiving No");
     document.getElementById('recieving_no').focus();
     return false;
  }
}
</script>
