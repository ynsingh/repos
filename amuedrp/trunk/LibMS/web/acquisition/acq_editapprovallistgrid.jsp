...
function send1()
{
    top.location="<%= request.getContextPath() %>/acquisition/titleShow1.do?id=${doc.id.controlNo}";
    return false;
}
</script>
         <style>
...
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  ...
  <columns>
      ...
      <item   value="${doc.id.controlNo}"  hAlign="left"
	      styleClass="item"/>
       </column>
    ...
    <column width="100">
     ...
     <column width="100">
      ...
      <item   value="Edit"   hAlign="left" hyperLink="${path}/acquisition/titleShow1.do?id=${doc.id.controlNo}"
