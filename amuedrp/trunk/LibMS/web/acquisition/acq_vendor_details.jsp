...
<html>
   ...
   <html:form method="post" action="/acq_vendor_dtail"  onsubmit="return check1();" style="position:absolute; left:200px; top:150px;"  >
...
<tr>
    ...
    <td><html:text readonly="false" property="vendor" name="AcqVendorActionForm" styleId="vendor_name" styleClass="textBoxWidth" /></td>
</tr>
...
<tr>
    ...
    <td><html:text readonly="false" property="contact_person" name="AcqVendorActionForm" styleId="contact_person"  styleClass="textBoxWidth" /></td>
</tr>
<tr><td colspan="5" height="5px"></td>
</tr>
<tr>
      <td  align="right" class="txtStyle"><strong>Phone No:<a class="star">*</a></strong></td>
      <td><html:text readonly="false" property="phone" name="AcqVendorActionForm" styleId="ph"  styleClass="textBoxWidth" /></td>
  </tr>
<tr><td colspan="5" height="5px"></td>
</tr>
<tr>
    <td width="150" align="right" class="txtStyle"><strong>Address:</strong> </td>
    <td><html:text readonly="false" property="address" name="AcqVendorActionForm" styleClass="textBoxWidth" />

    </td>
    <td width="150" align="right" class="txtStyle"><strong>Vendor Currency:</strong> <a class="star">*</a></td>
    <td><html:select property="vendor_currency" name="AcqVendorActionForm" styleId="vendor_currency" style="width: 200px;">
  ...
  <td><html:text property="city" name="AcqVendorActionForm" styleClass="textBoxWidth" />
 ...
 <td align="right" class="txtStyle"><strong>State:</strong></td>
  <td><html:text property="state" name="AcqVendorActionForm" styleClass="textBoxWidth" /></td>
  </tr>
  <tr><td colspan="5" height="5px"></td>
</tr>
  ...
  <td><html:text property="country" name="AcqVendorActionForm" styleClass="textBoxWidth" /></td>
 <td align="right" class="txtStyle"><strong>Pin No:</strong></td>
  <td><html:text property="pin" name="AcqVendorActionForm" styleClass="textBoxWidth" /></td>
  </tr>
  <tr><td colspan="5" height="5px"></td>
</tr>
...
<tr>
  ...
  <td><html:text property="fax" name="AcqVendorActionForm" styleClass="textBoxWidth" />
   </td>
 <td align="right" class="txtStyle"><strong>Email:<a class="star">*</a></strong></td>
 <td><html:text property="email" name="AcqVendorActionForm" onblur="return echeck(email.value)" styleId="email" styleClass="textBoxWidth" />
