...
int tcount =0;
 ...
 opacList=(ArrayList)session.getAttribute("allinvoice");
...
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  <columns>
    ...
    <column width="100">
        <header value="Invoice Date" hAlign="left" styleClass="header"/>
        <item   value="${doc.invoice_date}"  hAlign="left"  styleClass="item"/>
    </column>
    <column width="100">
    ...
    <column width="120">
        <header value="Net Total" hAlign="left" styleClass="header"/>
        <item   value="${doc.net_total}"  hAlign="left"  styleClass="item"/>
    </column>
    <columns>
    <column width="50">
        ...
        <item>
            <![CDATA[
            <input type="checkbox" name="check" align="right" id="check" value="${doc.invoice_no},${doc.order_no},${doc.vendor_id},${doc.recieving_no},${doc.net_total}"  onClick="javascript:get_check_value();">
            ]]>
          </item>
    </column>
   </columns>
