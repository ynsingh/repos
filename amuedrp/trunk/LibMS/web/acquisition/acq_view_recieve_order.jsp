...
List<ApprovalList> l1=(List<ApprovalList>)session.getAttribute("opacList2");
...
function quit()
  {
      ...
      window.location="/LibMS/acquisition/acq_initiate_recieve_order.jsp";
      return false;
  }
    ...
    <body>
       ...
       <td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;">Ordered List For Recieving </td>
        ...
        <tr><td><div id="divlist">
                   <iframe name="listdiv" frameborder="0px" width="100%" src="<%=request.getContextPath()%>/acquisition/recieved_orderlist1.jsp"></iframe>
               </div>
           </td></tr>
        <tr align="center">
        <td align="center" dir="" colspan="4"><p align="center" dir="">Pages&nbsp;&nbsp;
        <%for(int ii=1;ii<=noofpages;ii++){%>
        <a dir="" target="listdiv" href="<%=request.getContextPath()%>/acquisition/recieved_orderlist1.jsp?pageIndex=<%=ii%>"><%=ii%></a>&nbsp;&nbsp;
