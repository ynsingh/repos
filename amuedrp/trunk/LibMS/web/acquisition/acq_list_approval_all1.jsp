...
--%>
    ...
    <%@ page import="org.apache.taglibs.datagrid.DataGridParameters,com.myapp.struts.Acquisition.ApprovalList"%>
...
function print()
{
    top.location="<%=request.getContextPath()%>/print1.do";
    return false;
}
...
int tcount =0;
 ...
 opacList1=(ArrayList<ApprovalList>)session.getAttribute("onApprovalList");
...
tcount = opacList1.size();
   ...
   if ((toIndex = fromIndex+4) >= opacList1.size())
...
<table style="position:absolute; left: 20%; top: 20%;" class="table">
    <tr><td class="headerStyle" align="center" height="25px">On Approved List</td></tr>
...
<input type="button" onclick="return print();" name="button" value="Print On Approval Report" />
