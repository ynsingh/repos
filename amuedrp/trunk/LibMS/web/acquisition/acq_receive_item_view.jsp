...
int tcount =0;
 ...
 opacList=(ArrayList)request.getAttribute("acqRecDetailsList");
...
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  <columns>
    ...
    <column width="80">
        ...
        <item   value="${doc.controlNo}"  hAlign="left"   styleClass="item"/>
    </column>
    <column width="80">
        <header value="Received Copies" hAlign="left" styleClass="header"/>
        <item   value="${doc.recievedCopies}"  hAlign="left"  styleClass="item"/>
    </column>
    <column width="80">
        <header value="Pending Copies" hAlign="left" styleClass="header"/>
        <item   value="${doc.pendingCopies}"  hAlign="left"  styleClass="item"/>
    </column>
    <column width="80">
        <header value="Unit Price" hAlign="left" styleClass="header"/>
        <item   value="${doc.unitPrice}"  hAlign="left"  styleClass="item"/>
    </column>
