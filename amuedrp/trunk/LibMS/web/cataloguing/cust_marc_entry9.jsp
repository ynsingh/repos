<%-- 
    Document   : cust_marc_entry9
    Created on : Jul 2, 2011, 12:46:51 PM
    Author     : zeeshan
--%>
...
ddtabmenu.definemenu("ddtabs3", 9) //initialize Tab Menu #3 with 1st tab selected
</script>
...
<div id="tags1" style=" background: powderblue; ">
    ...
    while(marc.size()>i)
    {
          ...
          System.out.println("tag no = "+tagnr);
          System.out.println("tag name = "+tagnm);
     %>
