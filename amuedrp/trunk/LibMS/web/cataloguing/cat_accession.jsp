...
function submitDelete()
{
 ...
 <script>
   ...
   <jsp:include page="/admin/header.jsp"/>
    <body>
        <html:form method="post" action="/catAccession" style="position:absolute; left:30%; top:30%">
            <table border="1" class="table" width="400" dir="<%=rtl%>">
                <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;" ><b><%=resource.getString("cataloguing.cataccession.header")%></b></td></tr>
  ...
  <html:select property="document_type" name="BibliographicDetailEntryActionForm" styleClass="textBoxWidth" >
       <html:option value=""><%=resource.getString("cataloguing.catoldtitle.select")%></html:option>
         ...
         <%=resource.getString("cataloguing.catoldtitle.err1")%>
                   ...
                   <%--         <strong dir="<%=rtl%>"><%=resource.getString("cataloguing.cataccessionentry.accessionno")%>:</strong><br>
                            <html:text property="accession_no" name="BibliographicDetailEntryActionForm" styleClass="textBoxWidth"/><br><br>--%>
