    ...
    <body>
        <html:form method="post" action="/catAccession" style="position:absolute; left:30%; top:30%">
            <table border="1" class="table" width="400">
                <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;" ><b>Manage Accession Register</b></td></tr>
       ...
       <html:option value="">Select</html:option>
        ...
        <bean:write name="err_name" />
                          ...
                          <bean:write name="err_name" />
                                 ...
                                 <strong></strong><br>
                            <html:hidden property="isbn10" name="BibliographicDetailEntryActionForm" styleClass="textBoxWidth"/><br><br>
