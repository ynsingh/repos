   ...
   right:5px;
    ...
    <table width="100%" height="600px" valign="top" style="" >
        <tr><td valign="top" width="90%" style="">
                <br/>  <a href="#" onclick="javascript:showdiv();"> Add Bibliograhic details Logo</a>
 <div id="image1"
   style="  top:130px;
   left:30%;
   overflow: hidden;
   ...
   <html:form action="/catimageupload" method="post" styleId="form1" enctype="multipart/form-data">
<%
