...
%>
<table style="position:absolute; left: 10%; top: 25%;" border="0">
<div>
<%
if(tcount==0)
{
...
{%>
<tr><td align="center"><span class="headerStyle">Data from acquisition</span><br><br></td></tr>
<tr><td>
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  ...
  <columns>
    ...
    <column width="100">
      ...
      <item   value="${doc.publisherId}"  hAlign="left"
	      styleClass="item"/>
    </column>
    <column width="50">
      <header value="Edition" hAlign="left" styleClass="header"/>
      <item   value="${doc.edition}"  hAlign="left"
	      styleClass="item"/>
    </column>
    <column width="100">
        <header value="Action" hAlign="left" styleClass="header"/>
        <item   value="Import Data"  hAlign="left" hyperLink="${path}/cataloguing/search1.do?id=${doc.id.controlNo}"
	      styleClass="item"/>
    </column>
  </columns>
...
<tr><td align="center"><input name="button" type="button" onclick="return send()" value="Back" class="txt1"/></td></tr>
</table>
</body>
</html>
