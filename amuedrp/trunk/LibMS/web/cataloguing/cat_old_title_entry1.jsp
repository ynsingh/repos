...
<html>
    ...
    <%if(msg1!=null){%>   <span style=" position:absolute; top: 120px; font-size:12px;font-weight:bold;color:red;" ><%=msg1%></span>  <%}%>
        <html:form method="post" action="/catOldBiblio" style="position:absolute; left:200px; top:150px;"  >
 <table border="1" class="table" width="720">
...
<tr>
    <td width="150" align="right" class="txtStyle"><strong>Document Type<a class="star">*</a>:</strong> </td>
    <td><html:select property="document_type" name="BibliographicDetailEntryActionForm" styleClass="textBoxWidth" >
       <html:option value="">Select</html:option>
            <html:option value="book">Book</html:option>
            <html:option value="cd">CDs</html:option>
  </html:select>
...
<tr><td colspan="5" height="5px"></td>
  ...
  <td><html:text property="index_no" name="BibliographicDetailEntryActionForm"  styleClass="textBoxWidth" /></td>
<td align="right" class="txtStyle"><strong>No of pages:</strong></td>
  <td><html:text property="no_of_pages" name="BibliographicDetailEntryActionForm"  styleClass="textBoxWidth" /></td>
  </tr>
  <tr><td colspan="5" height="5px"></td>
</tr>
  <tr>
   <td align="right" class="txtStyle"><strong>Physical Width:</strong></td>
  <td><html:text property="physical_width" name="BibliographicDetailEntryActionForm" styleClass="textBoxWidth" /></td>
  <td align="right" class="txtStyle"><strong>Price:</strong></td>
  <td><html:text property="price" name="BibliographicDetailEntryActionForm"  styleClass="textBoxWidth" /></td>
  </tr>
<tr><td colspan="5" height="5px"></td>
</tr>
  <tr>
   <td align="right" class="txtStyle"><strong>Bind Type:</strong></td>
  <td><html:text property="bind_type" name="BibliographicDetailEntryActionForm"  styleClass="textBoxWidth" /></td>
 <td align="right" class="txtStyle"><strong>No of copies:</strong></td>
  <td><html:text property="no_of_copies" name="BibliographicDetailEntryActionForm"  styleClass="textBoxWidth" /></td>
  </tr>
  <tr><td colspan="5" height="5px"></td>
</tr>
