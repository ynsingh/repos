...
<%@page import="com.myapp.struts.cataloguing.StrutsUploadForm,java.util.*"%>

<html:html lang="true">
    <link rel="stylesheet" href="/LibMS/css/page.css"/>
    <link rel="stylesheet" href="/LibMS/css/newFormat.css"/>
    <head>
    ...
    <body>
        ...
        <html:form action="/insert" method="post"  style="position:absolute;left:10%;  top:15%">
                    ...
                    <td>
                        <table border="1" align="center" >
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <html:select     property="<%=combo.concat(String.valueOf(row))%>" name="StrutsUploadForm" styleClass="textBoxWidth" onchange="showdata1" styleId="col2">

                                        <%for (int j = 0; j < size; j++) {

                                                                                       if ((j == 0)&&(table_column[row]!=null)) {%>
                                        <html:option value="<%=table_column[row]%>"><%=table_column[row]%>&nbsp;&nbsp;<p class="mess"><%=column_datatype[row]%></p></html:option>
                                        <%}
                                            if ((j != row)&&(j<max_size)) {
