...
function fun(){
   ...
   right:5px;
      ...
      visibility: show;">
        ...
        <html:form action="/accessionEntryJournal" method="post">
            ...
            <html:hidden property="thesis_status" name="BibliographicDetailEntryActionForm"/>
            ...
            <tr><td colspan="6">&nbsp;</td></tr>
                ...
                <tr><td align="<%=align%>">Publisher:</td><td><html:text property="publisher_name" name="BibliographicDetailEntryActionForm" readonly="true"/></td>
            ...
            <html:options collection="mixlist"  labelProperty="locationName" property="locationId"></html:options>
                   ...
                   <tr><td align="<%=align%>">Country:</td><td><html:text property="publication_place" name="BibliographicDetailEntryActionForm" readonly="true"/></td>
                  <td align="<%=align%>"  valign="top">Remarks:</td><td><html:textarea  property="notes" name="BibliographicDetailEntryActionForm" readonly="true"/></td>
                  <td align="<%=align %>"><%=resource.getString("cataloguing.cataccessionentry.shelflocation")%>:</td><td><html:text property="shelving_location" name="BibliographicDetailEntryActionForm" readonly="<%=read%>"/></td>
                   ...
                   <tr><td align="<%=align %>">Website:</td><td><html:text property="website" name="BibliographicDetailEntryActionForm" readonly="true"/></td><td align="<%=align %>"><%=resource.getString("cataloguing.cataccessionentry.nocopy")%>:</td><td><html:text property="no_of_copies" name="BibliographicDetailEntryActionForm" readonly="true"/></td><td align="<%=align %>"><%=resource.getString("cataloguing.cataccessionentry.volumeno")%>:</td><td><html:text property="volume_no" name="BibliographicDetailEntryActionForm" readonly="<%=read%>"/></td></tr>
                   <tr><td align="<%=align %>">Class:</td><td><html:text property="clas" name="BibliographicDetailEntryActionForm" readonly="true"/></td><td align="<%=align%>"><%=resource.getString("cataloguing.catoldtitleentry1.series")%>:</td><td><html:text property="ser_note" name="BibliographicDetailEntryActionForm" readonly="true" /></td><td align="<%=align %>"><%=resource.getString("cataloguing.cataccessionentry.index")%>:</td><td><html:text property="index_no" name="BibliographicDetailEntryActionForm" readonly="<%=read%>"/></td></tr>
                   <tr><td align="<%=align %>">Frequency:</td><td><html:text property="frequency" name="BibliographicDetailEntryActionForm" readonly="true"/></td><td align="<%=align %>">ISSN:</td><td><html:text property="issn" name="BibliographicDetailEntryActionForm" readonly="true"/></td><td align="<%=align %>"><%=resource.getString("cataloguing.cataccessionentry.noofpage")%>:</td><td><html:text property="no_of_pages" name="BibliographicDetailEntryActionForm" readonly="<%=read%>"/></td></tr>

                   <tr><td align="<%=align %>">History:</td><td><html:text property="history" name="BibliographicDetailEntryActionForm" readonly="true"/></td>
                       <td align="<%=align%>"  valign="top">Latest:</td><td><html:text  property="latest" name="BibliographicDetailEntryActionForm" readonly="true"/></td>
                       <td align="<%=align %>"><%=resource.getString("cataloguing.cataccessionentry.physicalwidth")%>:</td><td><html:text property="physical_width" name="BibliographicDetailEntryActionForm" readonly="<%=read%>"/></td>
                   </tr>
                   <tr><%--<td align="<%=align %>"><%=resource.getString("cataloguing.catoldtitleentry1.publishingyear")%>:</td><td><html:text property="publishing_year" name="BibliographicDetailEntryActionForm" readonly="true"/></td>--%>
                       <td align="<%=align %>"><%=resource.getString("cataloguing.catoldtitleentry1.callno")%>:</td><td><html:text property="call_no" name="BibliographicDetailEntryActionForm" readonly="true"/></td> <td align="<%=align %>"><%=resource.getString("cataloguing.cataccessionentry.bindtype")%>:</td><td><html:text property="bind_type" name="BibliographicDetailEntryActionForm" readonly="<%=read%>"/></td>
                   </tr>
                   <tr>
