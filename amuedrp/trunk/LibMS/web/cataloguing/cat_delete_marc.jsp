<%-- 
    Document   : cat_delete_marc
    Created on : Jul 13, 2011, 1:16:25 PM
    Author     : zeeshan
--%>
     ...
     %>
        ...
        <table border="0" cellspacing="4" cellpadding="1" bgcolor="lightskyblue" width="60%" style="position: absolute; top: 23%; left: 20%">
          ...
          <font color="green">  </font>
            <html:form action="/deletemarc" method="post" >
                <tr><td align="center" >Tag Number</td><td ><input type="text" readonly value="<%=tagnr %>" name="tagnumber" /></td><td></td></tr>
            <tr><td align="center">Tag Name</td><td ><input type="text" readonly value="<%=tagn %>" name="tagname" /></td><td></td></tr>
            ...
            <tr><td colspan="3"><a href="javascript:animatedcollapse.toggle('toggle')">+</a>
                    <div id="toggle" style="width: 100%; background: lightskyblue; display:none" >
                        <table border="0" align="center" width="80%">
                            ...
                            <tr><td>
                                     Symbol $<input type="text" value="<%=sb[1] %>" readonly name="subsymbol1" size="2" maxlength="1" /></td><td>   Description <input type="text" name="subdesc1" value="<%=sd[1] %>" readonly maxlength="100" /></td>
                                <td>R <select name="repeatable11" >
              <option value="<%=r[1]%>" ><%=r[1]%></option>
            <option value="<%=!r[1]%>" ><%=!r[1]%></option>
            </select></td></tr>

                            <tr><td> Symbol $<input type="text" value="<%=sb[2] %>" name="subsymbol2" readonly size="2" maxlength="1" /></td> <td>  Description <input type="text" readonly name="subdesc2" value="<%=sd[2] %>" maxlength="100" /></td>
                                <td>R <select name="repeatable12" >
               <option value="<%=r[2]%>" ><%=r[2]%></option>
            <option value="<%=!r[2]%>" ><%=!r[2]%></option>
            </select></td></tr>
                            <tr><td> Symbol $<input type="text" value="<%=sb[3] %>" name="subsymbol3" size="2" readonly maxlength="1" /></td> <td>  Description <input type="text" name="subdesc3" readonly value="<%=sd[3] %>" maxlength="100" /></td>
                                <td>R <select name="repeatable13" >
                <option value="<%=r[3]%>" ><%=r[3]%></option>
            <option value="<%=!r[3]%>" ><%=!r[3]%></option>
            </select></td></tr>
                            <tr><td> Symbol $<input type="text" value="<%=sb[4] %>" readonly name="subsymbol4"  size="2" maxlength="1" /></td> <td>  Description <input type="text" name="subdesc4" readonly value="<%=sd[4] %>" maxlength="100" /></td>
            ...
            <tr><td align="center"><input type="submit" value="Delete" name="btn" style="width: 150px;" /></td><td><input type="button" value="Cancel" name="cancel" onclick="back();" style="width: 150px;" /></td></tr>
           </html:form>
        </table>
