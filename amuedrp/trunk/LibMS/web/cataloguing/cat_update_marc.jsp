<%-- 
    Document   : cat_update_marc
    Created on : Jun 21, 2011, 12:35:16 PM
    Author     : zeeshan
--%>
...
%>
        ...
        <logic:iterate id="Biblio" name="MARCList" offset="<%=String.valueOf(fromIndex)%>" length="2">
          <html:form action="/cataloguing/updateMarc">
            <tr>
        <input type="hidden" name="bib_id" value='<bean:write name="Biblio" property="id.bibId"/>'/>
            ...
            <td><bean:write name="Biblio" property="$a"/></td>
                ...
                <tr><td colspan="4" align="right">  <a><input type="submit" value="Update" style="border: hidden; cursor: pointer;"/></a></td></tr>
        </html:form>
        </logic:iterate>
...
<tr align="center">
        ...
        <a dir="" target="same" href="<%=request.getContextPath()%>/cataloguing/cat_update_marc.jsp?pageIndex=<%=ii%>"><%=ii%></a>&nbsp;&nbsp;
