...
%>
 ...
 <!--br><font color="red" face="CALIBRI"><%//=query%></font-->
<%
   //List<AcqGiftedDocument> opacList=(List<AcqGiftedDocument>)request.getAttribute("doc");
   //opacList=Arrays.asList(ob);
   //Iterator<AcqGiftedDocument> it= opacList.iterator();
...
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  ...
  <columns>
      ...
      <item   value="${doc.id.biblioId}"  hAlign="left"
	      styleClass="item"/>
    <column width="200">
      <header value="Document Category" hAlign="left" styleClass="header"/>
      <item   value="${doc.accessionType}"  hAlign="left"
	      styleClass="item"/>
    </column>
    <column width="200">
    ...
    <column width="250">
      <header value="Main Author" hAlign="left" styleClass="header"/>
      <item   value="${doc.authorMain}"  hAlign="left"
	      styleClass="item"/>
    </column>
