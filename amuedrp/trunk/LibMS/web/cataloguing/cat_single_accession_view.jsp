...
<script>
            function send()
{
    window.location="<%=request.getContextPath()%>/cataloguing/cat_view_accession_grid.jsp";
    return false;
}</script>
<%
...
<link href="<%=request.getContextPath()%>/css/page.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        <html:form action="/updateSingle" method="post">
            ...
            <tr><td align="right">Volume No:</td><td><html:text property="volume_no" name="BibliographicDetailEntryActionForm1" readonly="true"/></td><td align="right">Accession No:</td><td><html:text property="accession_no" name="BibliographicDetailEntryActionForm1" readonly="true"/></td>

                <td align="right">Location:</td>
                <td>
                    <html:select property="location" name="BibliographicDetailEntryActionForm1" disabled="true">
            <html:options collection="mixlist"  labelProperty="locationName" property="locationId"></html:options>
            </html:select>
                </td>

                <td align="right">Shelving Location:</td><td><html:text property="shelving_location" name="BibliographicDetailEntryActionForm1" readonly="true"/></td></tr>
            <tr><td align="right">Index:</td><td><html:text property="index_no" name="BibliographicDetailEntryActionForm1" readonly="true"/></td><td align="right">No of Pages:</td><td><html:text property="no_of_pages" name="BibliographicDetailEntryActionForm1" readonly="true"/></td><td align="right">Physical Width:</td><td><html:text property="physical_width" name="BibliographicDetailEntryActionForm1" readonly="true"/></td><td align="right">Bind Type:</td><td><html:text property="bind_type" name="BibliographicDetailEntryActionForm1" readonly="true"/></td></tr>
            
            <tr><td height="20px;" colspan="8"></td></tr>
            <tr><td></td><td></td><td colspan="2" align="center"><input name="button" type="submit" value="Update" class="txt1"/></td><td align="right"><input name="button" type="submit" onclick="return send()" value="Back" class="txt1"/></td><td></td><td></td><td></td></tr>
