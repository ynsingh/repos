  ...
  <%if(msg1!=null){%>   <span style=" position:absolute; top: 100px; font-size:12px;font-weight:bold;color:red;" ><%=msg1%></span>  <%}%>
    ...
    <table border="1" class="table" width="80%" style="position: absolute; top: 20%; left: 10%">
        <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;" colspan="2" ><b>Bibliographic Detail Entry</b></td></tr>
            <tr><td>
                    <table width="100%">
                        <tr><td>    <html:form method="post" action="/catUpdateAction2">
...
<tr>
    ...
    <td>
        <html:select property="book_type" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" value="<%=booktype%>" disabled="true"  tabindex="1">
...
<tr>
    ...
    <td><html:text property="subtitle" name="BibliographicDetailEntryActionForm1" readonly="true" styleClass="textBoxWidth" /></td>
  ...
  <td><html:text property="main_entry" name="BibliographicDetailEntryActionForm1" readonly="true" styleClass="textBoxWidth" />
 ...
 <td><html:text property="publisher_name" name="BibliographicDetailEntryActionForm1" readonly="true" styleClass="textBoxWidth" /></td>
     </tr>
  <tr><td height="2px"></td>
</tr>
     <tr>
  <td align="right" class="txtStyle"><strong>Publishing Year:</strong></td>
  <td><html:text property="publishing_year" name="BibliographicDetailEntryActionForm1" readonly="true" styleClass="textBoxWidth" />
  </td>
  </tr>
  <tr><td height="2px"></td>
</tr>
  <tr>
    ...
    <td><html:text  property="isbn10" name="BibliographicDetailEntryActionForm1" readonly="true" styleClass="textBoxWidth" /></td>
   </tr>
  <tr><td height="2px"></td>
</tr>
   <tr>
    <td align="right" class="txtStyle"><strong>Edition:</strong></td>
  <td><html:text property="edition" name="BibliographicDetailEntryActionForm1" readonly="true" styleClass="textBoxWidth" /></td>
  ...
  <td><html:text property="alt_title" name="BibliographicDetailEntryActionForm1" readonly="true" styleClass="textBoxWidth" /></td>
  </tr>
  <tr><td height="2px"></td>
</tr>
  <tr>
...
<tr><td colspan="5" height="10px"></td>
 ...
 <td>
    ...
    <td><html:text readonly="true" property="title" name="BibliographicDetailEntryActionForm1" readonly="true" styleClass="textBoxWidth" />
    </td>
         </tr>
         <tr><td height="2px"></td>
</tr>
  ...
  <td><html:text property="statement_responsibility" name="BibliographicDetailEntryActionForm1" readonly="true" styleClass="textBoxWidth" />
      <br><span class="err">   <html:messages id="err_name" property="statement_responsibility">
        ...
        <td><html:text property="added_entry" name="BibliographicDetailEntryActionForm1" readonly="true" styleClass="textBoxWidth" />
...
<tr><td align="right" class="txtStyle"><strong>Publication Place :</strong></td>
  <td><html:text property="publication_place" name="BibliographicDetailEntryActionForm1" readonly="true" styleClass="textBoxWidth" /></td>
</tr>
<tr><td height="2px"></td>
</tr>
