  ...
  <%if(msg1!=null){%>   <span style=" position:absolute; top: 80px; font-size:12px;font-weight:bold;color:red;" ><%=msg1%></span>  <%}%>
    ...
    <table border="1" class="table" width="80%" style="position: absolute; top: 20%; left: 10%">
        <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;" colspan="2" ><b>Bibliographic Detail Entry</b></td></tr>
            <tr><td>
                    <table width="100%">
                        <tr><td>    <html:form method="post" action="/catUpdateAction1">
 ...
 <td>
  ...
  <td><html:text property="statement_responsibility" name="BibliographicDetailEntryActionForm" styleClass="textBoxWidth" />
      <br><span class="err">   <html:messages id="err_name" property="statement_responsibility">
        ...
        <td><html:text property="added_entry" name="BibliographicDetailEntryActionForm" styleClass="textBoxWidth" />
...
<html:text property="added_entry0" name="BibliographicDetailEntryActionForm" styleClass="textBoxWidth"/>
</div>
<div id="2" style="display: none;">
    <html:text property="added_entry1" name="BibliographicDetailEntryActionForm" styleClass="textBoxWidth"/>
</div>
<div id="3" style="display: none;">
    <html:text property="added_entry2" name="BibliographicDetailEntryActionForm" styleClass="textBoxWidth"/>
</div>
 </td>
            </tr>
       <tr><td height="2px"></td>
