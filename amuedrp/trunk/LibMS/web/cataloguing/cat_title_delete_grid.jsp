...
{%>
<tr><td align="center"><span class="headerStyle">Bibliographic Detail Delete</span><br><br></td></tr>
<tr><td>
    ...
    <column width="250">
      ...
      <column width="50">
       <header value="Action" hAlign="left" styleClass="header"/>
          <item   value="Delete"  hAlign="left"   hyperLink="./cataloguing/deleteSingle.do?id=${doc.id.biblioId}"
	      styleClass="item"/>
    </column>
  </columns>
