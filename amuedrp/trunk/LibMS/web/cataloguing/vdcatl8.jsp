...
<tr>
    <td>Series Added Entry- Personal Name (R)(800) : <a href="javascript:animatedcollapse.toggle('800')">ind</a> <div id="800" style="width: 150px; display:none" >ind1<input type="text" value="<%=marc800.getIndicator1() %>" readonly name="in8001" maxlength="1" size="1" onFocus="setObj(description[0],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /> ind2<input type="text" value="<%=marc800.getIndicator2() %>" readonly name="in8002" maxlength="1" size="1" onFocus="setObj(description[1],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /></div></td>
<td>
    $a Personal name (NR) <input type="text" value="<%=marc800.get$a() %>" name="z800a" readonly id="800a" onFocus="setObj(description[2],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
<font size="2">
<a href="javascript:animatedcollapse.toggle('800b')">$b </a>

<div id="800b" style=" background: #FDF5E6; display:none">
    Numeration (NR) <input type="text" value="<%=marc800.get$b() %>" name="z800b" readonly id="800b" onFocus="setObj(description[3],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
<a href="javascript:animatedcollapse.toggle('800c')">$c </a>

<div id="800c" style=" background: #FDF5E6; display:none">
    Titles and other words associated with a name (R)<input type="text" value="<%=marc800.get$c() %>" name="z800c" readonly id="800c" onFocus="setObj(description[4],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('800d')">$d </a>

<div id="800d" style=" background: #FDF5E6; display:none">
    Dates associated with a name (NR) <input type="text" value="<%=marc800.get$d() %>" name="z800d" readonly id="800d" onFocus="setObj(description[5],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
<a href="javascript:animatedcollapse.toggle('800f')">$f </a>

<div id="800f" style=" background: #FDF5E6; display:none">
    Date of a work (NR) <input type="text" value="<%=marc800.get$f() %>" name="z800f" readonly id="800f" onFocus="setObj(description[6],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
<a href="javascript:animatedcollapse.toggle('800l')">$l </a>

<div id="800l" style=" background: #FDF5E6; display:none">
    Language of a work (NR)<input type="text" value="<%=marc800.get$l() %>" name="z800l" readonly id="800l" onFocus="setObj(description[7],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('800t')">$t </a>

<div id="800t" style=" background: #FDF5E6; display:none">
    Title of a work (NR) <input type="text" value="<%=marc800.get$t() %>" name="z800t" readonly id="800t" onFocus="setObj(description[8],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('800v')">$v </a>

<div id="800v" style=" background: #FDF5E6; display:none">
    Volume/sequential designation (NR) <input type="text" value="<%=marc800.get$v() %>" name="z800v" id="800v" readonly onFocus="setObj(description[9],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
<a href="javascript:animatedcollapse.toggle('800s')">$s </a>

<div id="800s" style=" background: #FDF5E6; display:none">
    Version (NR) <input type="text" value="<%=marc800.get$s() %>" name="z800s" readonly id="800s" onFocus="setObj(description[10],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('8004')">$4 </a>

<div id="8004" style=" background: #FDF5E6; display:none">
    Relator code (R) <input type="text" value="<%=marc800.get$4() %>" name="z8004" id="8004" readonly onFocus="setObj(description[11],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
</font></td></tr>

<tr><td colspan="2"><hr width="90%" size="2" color="green"/></td></tr>
<tr>
    <td>Series Added Entry-Uniform Title (R)(830) : <a href="javascript:animatedcollapse.toggle('830')">ind</a> <div id="830" style="width: 150px; display:none" >ind1<input type="text" value="<%=marc830.getIndicator1() %>" readonly name="in8301" maxlength="1" size="1" onFocus="setObj(description[1],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /> ind2<input type="text" value="<%=marc830.getIndicator2() %>" readonly name="in8302" maxlength="1" size="1" onFocus="setObj(description[12],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /></div></td>
<td>
    $a Uniform title (NR) <input type="text" value="<%=marc830.get$a() %>" name="z830a" readonly id="830a" onFocus="setObj(description[13],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
<font size="2">
<a href="javascript:animatedcollapse.toggle('830h')">$h </a>

<div id="830h" style=" background: #FDF5E6; display:none">
    Medium (NR) <input type="text" value="<%=marc830.get$h() %>" name="z830h" id="830h" readonly onFocus="setObj(description[14],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('830n')">$n </a>

<div id="830n" style=" background: #FDF5E6; display:none">
    Number of part/section of a work (R) <input type="text" value="<%=marc830.get$n() %>" readonly name="z830n" id="830n" />
</div>

<a href="javascript:animatedcollapse.toggle('830p')">$p </a>

<div id="830p" style=" background: #FDF5E6; display:none">
    Name of part/section of a work (R) <input type="text" value="<%=marc830.get$p() %>" readonly name="z830p" id="830p" />
</div>

<a href="javascript:animatedcollapse.toggle('830v')">$v </a>

<div id="830v" style=" background: #FDF5E6; display:none">
    Volume/sequential designation (NR) <input type="text" value="<%=marc830.get$v() %>" name="z830v" readonly id="830v" onFocus="setObj(description[15],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('830x')">$x </a>

<div id="830x" style=" background: #FDF5E6; display:none">
    International Standard Serial Number (NR) <input type="text" value="<%=marc830.get$x() %>" name="z830x" readonly id="830x" onFocus="setObj(description[16],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('8303')">$3 </a>

<div id="8303" style=" background: #FDF5E6; display:none">
    Materials specified (NR) <input type="text" value="<%=marc830.get$3() %>" name="z8303" id="8303" readonly onFocus="setObj(description[17],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('8305')">$5 </a>

<div id="8305" style=" background: #FDF5E6; display:none">
    Institution to which field applies (R) <input type="text" value="<%=marc830.get$5() %>" name="z8305" id="8305" readonly onFocus="setObj(description[18],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
</font></td></tr>

<tr><td colspan="2"><hr width="90%" size="2" color="green"/></td></tr>
<tr>
    <td>Series Added Entry-Uniform Title (R)(850) : <a href="javascript:animatedcollapse.toggle('850')">ind</a> <div id="850" style="width: 150px; display:none" >ind1<input type="text" value="<%=marc850.getIndicator1() %>" readonly name="in8501" maxlength="1" size="1" onFocus="setObj(description[19],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /> ind2<input type="text" value="<%=marc850.getIndicator2() %>" readonly name="in8502" maxlength="1" size="1" onFocus="setObj(description[19],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /></div></td>
<td>
    $a Uniform title (NR) <input type="text" value="<%=marc850.get$a() %>" name="z850a" readonly id="850a" onFocus="setObj(description[20],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</td></tr>

<tr><td colspan="2"><hr width="90%" size="2" color="green"/></td></tr>
<tr>
    <td>Location (R) (852) : <a href="javascript:animatedcollapse.toggle('852')">ind</a> <div id="852" style="width: 150px; display:none" >ind1<input type="text" value="<%=marc852.getIndicator1() %>" name="in8521" readonly maxlength="1" size="1" onFocus="setObj(description[21],'override',800,70)" onBlur="clearTimeout(openTimer);stopIt()" /> ind2<input type="text" value="<%=marc852.getIndicator2() %>" name="in8522" maxlength="1" size="1" onFocus="setObj(description[22],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /></div></td>
<td>
    $a Location (NR)  <input type="text" value="<%=marc852.get$a() %>" name="z852a" readonly id="852a" onFocus="setObj(description[23],'override',800,70)" onBlur="clearTimeout(openTimer);stopIt()" />
<font size="2">
<a href="javascript:animatedcollapse.toggle('852b')">$b </a>

<div id="852b" style=" background: #FDF5E6; display:none">
    Sublocation or collection (R) <input type="text" value="<%=marc852.get$b() %>" name="z852b" readonly id="852b" onFocus="setObj(description[24],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('852c')">$c </a>

<div id="852c" style=" background: #FDF5E6; display:none">
    Shelving location (R) <input type="text" value="<%=marc852.get$c() %>" name="z852c" id="852c" readonly onFocus="setObj(description[25],'override',800,70)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
...
<div id="852f" style=" background: #FDF5E6; display:none">
    Coded location qualifier (R) <input type="text" value="<%=marc852.get$f() %>" name="z852f" readonly id="852f" onFocus="setObj(description[27],'override',800,150)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('852h')">$h </a>

<div id="852h" style=" background: #FDF5E6; display:none">
    Classification part (NR) <input type="text" value="<%=marc852.get$h() %>" name="z852h" id="852h" readonly onFocus="setObj(description[28],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('852i')">$i </a>

<div id="852i" style=" background: #FDF5E6; display:none">
    Item part (R) <input type="text" value="<%=marc852.get$i() %>" name="z852i" id="852i" readonly onFocus="setObj(description[29],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('852n')">$n </a>

<div id="852n" style=" background: #FDF5E6; display:none">
    Country code (NR) <input type="text" value="<%=marc852.get$n() %>" name="z852n" id="852n" readonly onFocus="setObj(description[30],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('852t')">$t </a>

<div id="852t" style=" background: #FDF5E6; display:none">
    Copy number (NR) <input type="text" value="<%=marc852.get$t() %>" name="z852t" id="852t" readonly onFocus="setObj(description[31],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('852u')">$u </a>

<div id="852u" style=" background: #FDF5E6; display:none">
    Uniform Resource Identifier (R) <input type="text" value="<%=marc852.get$u() %>" name="z852u" id="852u" readonly onFocus="setObj(description[32],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
</font></td></tr>
...
<tr><td colspan="2"><hr width="90%" size="2" color="green"/></td></tr>
<tr>
    <td>Electronic Location and Access (R) (856) : <a href="javascript:animatedcollapse.toggle('856')">ind</a> <div id="856" style="width: 150px; display:none" >ind1<input type="text" value="<%=marc856.getIndicator1() %>" readonly name="in8561" maxlength="1" size="1" onFocus="setObj(description[33],'override',800,60)" onBlur="clearTimeout(openTimer);stopIt()" /> ind2<input type="text" value="<%=marc856.getIndicator2() %>" name="in8562" readonly maxlength="1" size="1" onFocus="setObj(description[34],'override',800,70)" onBlur="clearTimeout(openTimer);stopIt()" /></div></td>
<td>
    $a Host name (R)  <input type="text" value="<%=marc856.get$a() %>" name="z856a" readonly  id="856a" onFocus="setObj(description[35],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
<font size="2">
<a href="javascript:animatedcollapse.toggle('856b')">$b </a>

<div id="856b" style=" background: #FDF5E6; display:none">
    Access number (R) <input type="text" value="<%=marc856.get$b() %>" name="z856b" id="856b" readonly onFocus="setObj(description[36],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856c')">$c </a>

<div id="856c" style=" background: #FDF5E6; display:none">
    Compression information (R) <input type="text" value="<%=marc856.get$c() %>" name="z856c" id="856c" readonly onFocus="setObj(description[37],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856d')">$d </a>

<div id="856d" style=" background: #FDF5E6; display:none">
    Path (R)  <input type="text" value="<%=marc856.get$d() %>" name="z856d" id="856d" readonly onFocus="setObj(description[38],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856f')">$f </a>

<div id="856f" style=" background: #FDF5E6; display:none">
    Electronic name (R) <input type="text" value="<%=marc856.get$f() %>" name="z856f" id="856f" readonly onFocus="setObj(description[39],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856h')">$h </a>

<div id="856h" style=" background: #FDF5E6; display:none">
    Processor of request (NR) <input type="text" value="<%=marc856.get$h() %>" name="z856h" id="856h" readonly onFocus="setObj(description[40],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856i')">$i </a>

<div id="856i" style=" background: #FDF5E6; display:none">
    Instruction (R) <input type="text" value="<%=marc856.get$i() %>" name="z856i" id="856i" readonly onFocus="setObj(description[41],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856j')">$j </a>

<div id="856j" style=" background: #FDF5E6; display:none">
    Bits per second (NR)  <input type="text" value="<%=marc856.get$j() %>" name="z856j" id="856j" readonly onFocus="setObj(description[42],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856k')">$k </a>

<div id="856k" style=" background: #FDF5E6; display:none">
    Password (NR) <input type="text" value="<%=marc856.get$k() %>" name="z856k" id="856k" readonly onFocus="setObj(description[43],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856l')">$l </a>

<div id="856l" style=" background: #FDF5E6; display:none">
    Logon (NR) <input type="text" value="<%=marc856.get$l() %>" name="z856l" id="856l" readonly onFocus="setObj(description[44],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856m')">$m </a>

<div id="856m" style=" background: #FDF5E6; display:none">
    Contact for access assistance (R) <input type="text" value="<%=marc856.get$m() %>" readonly name="z856m" id="856m" onFocus="setObj(description[45],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856n')">$n </a>

<div id="856n" style=" background: #FDF5E6; display:none">
    Name of location of host (NR) <input type="text" value="<%=marc856.get$n() %>" name="z856n" readonly id="856n" onFocus="setObj(description[46],'override',800,60)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856o')">$o </a>

<div id="856o" style=" background: #FDF5E6; display:none">
    Operating system (NR) <input type="text" value="<%=marc856.get$o() %>" name="z856o" id="856o" readonly onFocus="setObj(description[47],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856p')">$p </a>

<div id="856p" style=" background: #FDF5E6; display:none">
    Port (NR) <input type="text" value="<%=marc856.get$p() %>" name="z856p" readonly id="856p" onFocus="setObj(description[48],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856q')">$q </a>

<div id="856q" style=" background: #FDF5E6; display:none">
    Electronic format type (NR) <input type="text" value="<%=marc856.get$q() %>" name="z856q" readonly id="856q" onFocus="setObj(description[49],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856t')">$t </a>

<div id="856t" style=" background: #FDF5E6; display:none">
    Terminal emulation (R) <input type="text" value="<%=marc856.get$t() %>" name="z856t" readonly id="856t" onFocus="setObj(description[50],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856u')">$u </a>

<div id="856u" style=" background: #FDF5E6; display:none">
    Uniform Resource Identifier (R) <input type="text" value="<%=marc856.get$u() %>" name="z856u" readonly id="856u" onFocus="setObj(description[51],'override',800,70)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856s')">$s </a>

<div id="856s" style=" background: #FDF5E6; display:none">
    File size (R) <input type="text" value="<%=marc856.get$s() %>" name="z856s" id="856s" readonly onFocus="setObj(description[52],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856x')">$x </a>

<div id="856x" style=" background: #FDF5E6; display:none">
    Non-public note (R) <input type="text" value="<%=marc856.get$x() %>" name="z856x" readonly id="856x" onFocus="setObj(description[53],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('856z')">$z </a>

<div id="856z" style=" background: #FDF5E6; display:none">
    Public note (R) <input type="text" value="<%=marc856.get$z() %>" name="z856z" readonly id="856z" onFocus="setObj(description[54],'override',800,70)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
</font></td></tr>
</table></html:form>
     <%
