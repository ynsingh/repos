  ...
  <%if(msg1!=null){%>   <span style=" position:absolute; top: 90px; font-size:12px;font-weight:bold;color:red;" ><%=msg1%></span>  <%}%>
    ...
    <table border="1" class="table" width="80%" style="position: absolute; top: 20%; left: 10%">
        <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;" colspan="2" ><b>Bibliographic Detail Entry</b></td></tr>
            <tr><td>
                    <table width="100%">
                        <tr><td>    <html:form method="post" action="/catUpdateAction">
...
<tr>
    ...
    <td>
        <html:select property="book_type" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" value="<%=booktype%>" tabindex="1">
...
<tr>
    ...
    <td><html:text property="subtitle" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" /></td>
  ...
  <td><html:text property="main_entry" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" />
 ...
 <td><html:text property="publisher_name" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" /></td>
     </tr>
  <tr><td height="2px"></td>
</tr>
     <tr>
  <td align="right" class="txtStyle"><strong>Publishing Year:</strong></td>
  <td><html:text property="publishing_year" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" />
  </td>
  </tr>
  <tr><td height="2px"></td>
</tr>
  <tr>
    ...
    <td><html:text  property="isbn10" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" /></td>
   </tr>
  <tr><td height="2px"></td>
</tr>
   <tr>
    <td align="right" class="txtStyle"><strong>Edition:</strong></td>
  <td><html:text property="edition" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" /></td>
  ...
  <td><html:text property="alt_title" name="BibliographicDetailEntryActionForm1"  styleClass="textBoxWidth" /></td>
  </tr>
  <tr><td height="2px"></td>
</tr>
  <tr>
      <td align="right" class="txtStyle"><strong>Series:</strong></td>
      <td><html:text property="ser_note" styleClass="textBoxWidth" name="BibliographicDetailEntryActionForm1"/></td>
  </tr>
  <tr><td height="2px"></td>
</tr>
  <tr>
   <td align="right" class="txtStyle"><strong>Abstract:</strong></td>
   <td><html:textarea rows="5" cols="20" property="thesis_abstract" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" /></td>
   </tr>
...
<tr><td colspan="5" height="10px"></td>
 ...
 <td>
    ...
    <td><html:text readonly="true" property="title" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" />
    </td>
         </tr>
         <tr><td height="2px"></td>
</tr>
  ...
  <td><html:text property="statement_responsibility" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" />
      <br><span class="err">   <html:messages id="err_name" property="statement_responsibility">
        ...
        <td><html:text property="added_entry" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" />
       ...
       <tr>
                ...
                <td>
                    <div id="1" style="display: none;">
                        <html:text property="added_entry0" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth"/>
</div>
<div id="2" style="display: none;">
                        <html:text property="added_entry1" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth"/>
</div>
<div id="3" style="display: none;">
                        <html:text property="added_entry2" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth"/>
</div>
 </td>
            </tr>
     <tr><td height="2px"></td>
  ...
  <td><html:text property="publication_place" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" /></td>
</tr>
<tr><td height="2px"></td>
</tr>
<tr> <td align="right" class="txtStyle"><strong>LCC No:</strong></td>
  <td><html:text property="LCC_no" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" />
         </td></tr>
<tr><td height="2px"></td>
</tr>
<tr> <td align="right" class="txtStyle"><strong>ISBN-13: </strong></td>
  <td><html:text  property="isbn13"  name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" /></td>
</tr>
<tr><td height="2px"></td>
</tr>
<tr><td align="right" class="txtStyle"><strong>Call No<a class="star">*</a>:</strong></td>
  <td><html:text property="call_no" name="BibliographicDetailEntryActionForm1" styleClass="textBoxWidth" />
...
<tr><td align="right" class="txtStyle"><strong>Subjects:</strong></td>
  <td><html:text property="subject" name="BibliographicDetailEntryActionForm1"  styleClass="textBoxWidth" /></td>
</tr>
<tr><td height="2px"></td>
</tr>
<tr> <td align="right" class="txtStyle"><strong>Notes:</strong></td>
  <td><html:textarea rows="5" cols="20" property="notes" name="BibliographicDetailEntryActionForm1"  styleClass="textBoxWidth" /></td>
</tr>
     </table></td></tr>
