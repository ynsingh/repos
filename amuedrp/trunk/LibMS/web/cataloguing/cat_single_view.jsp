...
<script>
            function send()
{
    window.location="<%=request.getContextPath()%>/cataloguing/cat_single_view_grid.jsp";
    return false;
}</script>
<%
...
<link href="<%=request.getContextPath()%>/css/page.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        <html:form action="/updateSingle" method="post">
            ...
            <tr><td></td><td></td><td colspan="2" align="center"></td><td align="right"><input name="button" type="submit" onclick="return send()" value="Back" class="txt1"/></td><td></td><td></td><td></td></tr>
