...
{%>
<tr><td align="center"><span class="headerStyle">Main Library Bibliographic Detail</span><br><br></td></tr>
<tr><td>
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  ...
  <columns>
    ...
    <column width="100">
      ...
      <item   value="View"  hAlign="left"   hyperLink="${path}/cataloguing/search3.do?id=${doc.id.biblioId}"
	      styleClass="item"/>
    </column>
  </columns>
