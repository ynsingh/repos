...
<html>
   ...
   <jsp:include page="/admin/header.jsp"/>
    <body>
        ...
        <html:form method="post" action="/catOldBiblioAction" style="position:absolute; left:200px; top:200px;">
            <table border="1" class="table" width="400">
                ...
                <html:hidden property="author_main" name="BibliographicDetailEntryActionForm" value="Old"/>
                 <html:hidden property="call_no" name="BibliographicDetailEntryActionForm" value="Old"/>
                <html:hidden property="title" name="BibliographicDetailEntryActionForm" value="Old"/>
                <html:hidden property="document_type" name="BibliographicDetailEntryActionForm" value="Old"/>
                <tr><td>
                <table border="0" cellspacing="4" cellpadding="1" align="center">
                    <tr><td><br><br></td></tr>
                    <tr><td rowspan="7" width="100">
                            Enter ISBN:<br><br>
                            <html:text property="isbn10" name="BibliographicDetailEntryActionForm" styleClass="textBoxWidth"/><br>
