...
{%>
<tr><td align="center"><span class="headerStyle">Own Library Bibliographic Detail</span><br><br></td></tr>
<tr><td>
<ui:dataGrid items="${opacList}" var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid" >
  ...
  <columns>
    ...
    <column width="70">
      ...
      <item   value="View"  hAlign="left"   hyperLink="${path}/cataloguing/accessionView.do?id=${doc.id.biblioId}"
	      styleClass="item"/>
    </column>
  </columns>
