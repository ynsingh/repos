...
function send()
{
    window.location="<%=request.getContextPath()%>/cataloguing/cat_title_edit_grid.jsp";
    return false;
}
</script>
<html>
    ...
    <table border="1" class="table" width="80%" style="position: absolute; top: 20%; left: 10%">
        <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;" colspan="2" ><b>Bibliographic Detail Entry</b></td></tr>
            <tr><td>
                    <table width="100%">
                        <tr><td>
                                <html:form method="post" action="/catOldBiblio" target="_blank">
...
<tr>
    ...
    <td>
        <html:select property="book_type" name="BibliographicDetailEntryActionForm1" value="<%=booktype%>" styleClass="textBoxWidth" disabled="true"  tabindex="1">
