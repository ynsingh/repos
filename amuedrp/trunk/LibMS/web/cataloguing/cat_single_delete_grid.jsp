...
{%>
<tr><td align="center"><span class="headerStyle">Accession Detail Delete</span><br><br></td></tr>
<tr><td>
    ...
    <column width="200">
      ...
      <column width="50">
       <header value="Action" hAlign="left" styleClass="header"/>
          <item   value="Delete"  hAlign="left"   hyperLink="${path}/cataloguing/DeleteSingleItem.do?id=${doc.accessionNo}"
	      styleClass="item"/>
    </column>
  </columns>
