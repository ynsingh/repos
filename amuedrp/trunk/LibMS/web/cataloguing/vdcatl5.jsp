<%-- 
    Document   : vdcatl5
    Created on : Jul 21, 2011, 12:28:14 PM
    Author     : zeeshan
--%>
...
<html:form styleId="ucat5" action="/vdaction.do" method="post">
<table width="100%" cellspacing="5" >
  <tr><input type="hidden"  name="zclick" id="zclick" /></tr>
    <tr>
        <td>General Note (R)(500) : <a href="javascript:animatedcollapse.toggle('500')">ind</a> <div id="500" style="width: 150px; display:none" >ind1<input type="text" value="<%=marc500.getIndicator1()==null?"":marc500.getIndicator1() %>" readonly name="in5001" maxlength="1" size="1" onFocus="setObj(description[0],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /> ind2<input type="text" value="<%=marc500.getIndicator2()==null?"":marc500.getIndicator2() %>" readonly name="in5002" maxlength="1" size="1" onFocus="setObj(description[0],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /></div></td>
        <td>$a General note (NR)<input type="text" value="<%=marc500.get$a()==null?"":marc500.get$a() %>" readonly name="z500a" id="500a" onFocus="setObj(description[1],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
<font size="2">
<a href="javascript:animatedcollapse.toggle('5003')">$3 </a>

<div id="5003" style=" background: #FDF5E6; display:none">
    Materials specified (NR)<input type="text" value="<%=marc500.get$3()==null?"":marc500.get$3() %>" readonly name="z5003" id="5003" onFocus="setObj(description[2],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
</font></td></tr>
<tr><td colspan="2"><hr width="90%" size="2" color="green"/></td></tr>

<tr>
    <td>Dissertation note (R)(502) : <a href="javascript:animatedcollapse.toggle('502')">ind</a> <div id="502" style="width: 150px; display:none" >ind1<input type="text" value="<%=marc502.getIndicator1()==null?"":marc502.getIndicator1() %>" readonly name="in5021" maxlength="1" size="1" onFocus="setObj(description[0],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /> ind2<input type="text" value="<%=marc502.getIndicator2()==null?"":marc502.getIndicator2() %>" name="in5022" readonly maxlength="1" size="1" onFocus="setObj(description[0],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /></div></td>
<td>
    $a Dissertation note (R)<input type="text" value="<%=marc502.get$a()==null?"":marc502.get$a() %>" readonly name="z502a" id="502a" onFocus="setObj(description[3],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />

<a href="javascript:animatedcollapse.toggle('502b')">$b </a>

<div id="502b" style=" background: #FDF5E6; display:none">
    Degree type (NR)<input type="text" value="<%=marc502.get$b()==null?"":marc502.get$b() %>" name="z502b" readonly id="502b" onFocus="setObj(description[4],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
<a href="javascript:animatedcollapse.toggle('502c')">$c </a>

<div id="502c" style=" background: #FDF5E6; display:none">
    Name of granting institution (NR)<input type="text" value="<%=marc502.get$c()==null?"":marc502.get$c() %>" readonly  name="z502c" id="502c" onFocus="setObj(description[5],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
<a href="javascript:animatedcollapse.toggle('502d')">$d </a>

<div id="502d" style=" background: #FDF5E6; display:none">
    Year degree granted (NR)<input type="text" value="<%=marc502.get$d()==null?"":marc502.get$d() %>" name="z502d" id="502d" readonly onFocus="setObj(description[6],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
<a href="javascript:animatedcollapse.toggle('502g')">$g </a>

<div id="502g" style=" background: #FDF5E6; display:none">
    Miscellaneous information (R)<input type="text" value="<%=marc502.get$g()==null?"":marc502.get$g() %>" name="z502g" id="502g" readonly onFocus="setObj(description[7],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
<a href="javascript:animatedcollapse.toggle('502o')">$o </a>

<div id="502o" style=" background: #FDF5E6; display:none">
    Dissertation identifier (R)<input type="text" value="<%=marc502.get$o()==null?"":marc502.get$o() %>" name="z502o" id="502o" readonly onFocus="setObj(description[8],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
</td></tr>
...
<tr>
    <td>Bibliography, Etc. Note (R)(504) : <a href="javascript:animatedcollapse.toggle('504')">ind</a> <div id="504" style="width: 150px; display:none" >ind1<input type="text" value="<%=marc504.getIndicator1()==null?"":marc504.getIndicator1() %>" readonly name="in5041" maxlength="1" size="1" onFocus="setObj(description[0],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /> ind2<input type="text" value="<%=marc504.getIndicator2()==null?"":marc504.getIndicator2() %>" readonly name="in5042" maxlength="1" size="1" onFocus="setObj(description[0],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /></div></td>
<td>
    $a Bibliography, etc. note (NR) <input type="text" value="<%=marc504.get$a()==null?"":marc504.get$a() %>" readonly name="z504a" id="504a" onFocus="setObj(description[9],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />

<a href="javascript:animatedcollapse.toggle('504b')">$b </a>

<div id="504b" style=" background: #FDF5E6; display:none">
    Number of references (NR) <input type="text" value="<%=marc504.get$b()==null?"":marc504.get$b() %>" name="z504b" readonly id="504b" onFocus="setObj(description[10],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
</td></tr>
<tr><td colspan="2"><hr width="90%" size="2" color="green"/></td></tr>

<tr>
    <td>Formatted Contents Note (R)(505) : <a href="javascript:animatedcollapse.toggle('505')">ind</a> <div id="505" style="width: 150px; display:none" >ind1<input type="text" value="<%=marc505.getIndicator1()==null?"":marc505.getIndicator1() %>" readonly name="in5051" maxlength="1" size="1" onFocus="setObj(description[11],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /> ind2<input type="text" value="<%=marc505.getIndicator2()==null?"":marc505.getIndicator2() %>" readonly name="in5052" maxlength="1" size="1" onFocus="setObj(description[12],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /></div></td>
<td>
    $a Formatted contents note (NR) <input type="text" value="<%=marc505.get$a()==null?"":marc505.get$a() %>" readonly name="z505a" id="505a" onFocus="setObj(description[13],'override',800,50)" onBlur="clearTimeout(openTimer);stopIt()" />

<a href="javascript:animatedcollapse.toggle('505g')">$g </a>

<div id="505g" style=" background: #FDF5E6; display:none">
    Miscellaneous information (R) <input type="text" value="<%=marc505.get$g()==null?"":marc505.get$g() %>" name="z505g" readonly id="505g" onFocus="setObj(description[14],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
<a href="javascript:animatedcollapse.toggle('505r')">$r </a>

<div id="505r" style=" background: #FDF5E6; display:none">
    Statement of responsibility (R) <input type="text" value="<%=marc505.get$r()==null?"":marc505.get$r() %>" name="z505r" id="505r" readonly onFocus="setObj(description[15],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('505t')">$t </a>
<div id="505t" style=" background: #FDF5E6; display:none">
    Title (R) <input type="text" value="<%=marc505.get$t()==null?"":marc505.get$t() %>" name="z505t" id="505t" readonly onFocus="setObj(description[16],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
<a href="javascript:animatedcollapse.toggle('505u')">$u </a>

<div id="505u" style=" background: #FDF5E6; display:none">
    Uniform Resource Identifier (R) <input type="text" value="<%=marc505.get$u()==null?"":marc505.get$u() %>" name="z505u" readonly id="505u" onFocus="setObj(description[17],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
</td></tr>

<tr><td colspan="2"><hr width="90%" size="2" color="green"/></td></tr>
<tr>
    <td>Summary, etc. (R)(520) : <a href="javascript:animatedcollapse.toggle('520')">ind</a> <div id="520" style="width: 150px; display:none" >ind1<input type="text" value="<%=marc520.getIndicator1()==null?"":marc520.getIndicator1() %>" readonly name="in5201" maxlength="1" size="1" onFocus="setObj(description[18],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /> ind2<input type="text" value="<%=marc520.getIndicator2()==null?"":marc520.getIndicator2() %>" readonly name="in5202" maxlength="1" size="1" onFocus="setObj(description[19],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /></div></td>
<td>
    $a Summary, etc. (NR) <input type="text" value="<%=marc520.get$a()==null?"":marc520.get$a() %>" readonly name="z520a" id="520a" onFocus="setObj(description[20],'override',800,90)" onBlur="clearTimeout(openTimer);stopIt()" />

<a href="javascript:animatedcollapse.toggle('520b')">$b </a>

<div id="520b" style=" background: #FDF5E6; display:none">
    Expansion of summary note (NR) <input type="text" value="<%=marc520.get$b()==null?"":marc520.get$b() %>" readonly name="z520b" id="520b" onFocus="setObj(description[21],'override',800,90)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
<a href="javascript:animatedcollapse.toggle('520c')">$c </a>

<div id="520c" style=" background: #FDF5E6; display:none">
    Assigning source (NR) <input type="text" value="<%=marc520.get$c()==null?"":marc520.get$c() %>" name="z520c" readonly id="520c" onFocus="setObj(description[22],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('520u')">$u </a>

<div id="520u" style=" background: #FDF5E6; display:none">
    Uniform Resource Identifier (R) <input type="text" value="<%=marc520.get$u()==null?"":marc520.get$u() %>" name="z520u" readonly id="520u"onFocus="setObj(description[23],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>

<a href="javascript:animatedcollapse.toggle('5202')">$2 </a>
<div id="5202" style=" background: #FDF5E6; display:none">
    Source (NR) <input type="text" value="<%=marc520.get$2()==null?"":marc520.get$2() %>" name="z5202" id="5202" readonly onFocus="setObj(description[24],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" >
</div>

<a href="javascript:animatedcollapse.toggle('5203')">$3 </a>
<div id="5203" style=" background: #FDF5E6; display:none">
    Materials specified (NR) <input type="text" value="<%=marc520.get$3()==null?"":marc520.get$3() %>" readonly name="z5203" id="5203" onFocus="setObj(description[25],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
</td></tr>
...
<tr>
    <td>Language Note (R)(546) : <a href="javascript:animatedcollapse.toggle('546')">ind</a> <div id="546" style="width: 150px; display:none" >ind1<input type="text" value="<%=marc546.getIndicator1()==null?"":marc546.getIndicator1() %>" readonly name="in5461" maxlength="1" size="1" onFocus="setObj(description[0],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /> ind2<input type="text" value="<%=marc546.getIndicator2()==null?"":marc546.getIndicator2() %>" readonly name="in5462" maxlength="1" size="1" onFocus="setObj(description[0],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" /></div></td>
<td>
    $a Language Note (NR) <input type="text" value="<%=marc546.get$a()==null?"":marc546.get$a() %>" readonly name="z546a" id="546a" onFocus="setObj(description[26],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />

<a href="javascript:animatedcollapse.toggle('546b')">$b </a>

<div id="546b" style=" background: #FDF5E6; display:none">
    Information code or alphabet (R) <input type="text" value="<%=marc546.get$b()==null?"":marc546.get$b() %>" readonly name="z546b" id="546b" onFocus="setObj(description[27],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
<a href="javascript:animatedcollapse.toggle('5463')">$3 </a>

<div id="5463" style=" background: #FDF5E6; display:none">
    Materials specified (NR) <input type="text" value="<%=marc546.get$3()==null?"":marc546.get$3() %>" name="z5463" id="5463" readonly onFocus="setObj(description[28],'override',800,30)" onBlur="clearTimeout(openTimer);stopIt()" />
</div>
</td></tr>
