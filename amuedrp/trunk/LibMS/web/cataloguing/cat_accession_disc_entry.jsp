...
function fun(){
   ...
   right:5px;
      ...
      visibility: show;">
        ...
        <html:form action="/DiscAccessionEntry" method="post">
            ...
            <table width="80%" class="table" dir="<%=rtl%>" style="border:solid 1px black;" align="center">
                <tr style="border:solid 1px black"><td colspan="4" class="headerStyle"  height="25px"  width="40%" align="center">CD/DVD <%=resource.getString("cataloguing.cataccessionentry.bibliodetail")%></td><td colspan="2" align="center" width="60%" class="headerStyle" ><%=resource.getString("cataloguing.cataccessionentry.accessionheader")%></td></tr>
