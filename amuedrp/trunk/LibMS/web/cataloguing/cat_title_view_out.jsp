...
function send()
{
    window.location="<%=request.getContextPath()%>/cataloguing/cat_viewAll_biblio.jsp";
    return false;
}
</script>
<html>
...
animatedcollapse.init()
    ...
    <body>
        <table border="0" class="table" width="70%" style="position: absolute; left: 10%; top: 5%">
        <tr><td align="center" class="headerStyle" bgcolor="#E0E8F5" height="25px;" colspan="2" ><b>Bibliographic Detail</b></td></tr>
            <tr><td>
                    <table width="100%">
...
<tr> <td align="right" class="txtStyle"><strong>Second ISBN: </strong></td>
