...
/**
 * AcqPrivilegeId generated by hbm2java
 */
public class AcqPrivilegeId  implements java.io.Serializable {


     private String staffId;
     private String libraryId;

    public AcqPrivilegeId() {
    }

    public AcqPrivilegeId(String staffId, String libraryId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AcqPrivilegeId) ) return false;
		 AcqPrivilegeId castOther = ( AcqPrivilegeId ) other; 
