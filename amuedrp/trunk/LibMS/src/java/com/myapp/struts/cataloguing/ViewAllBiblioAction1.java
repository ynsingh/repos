...
public class ViewAllBiblioAction1 extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        String document_type=institute.getDocument_type();
       ...
       System.out.println(pageno);
           List rst = dao.getAccession(library_id, sub_library_id,search_by,search_keyword, sort_by,pageno,document_type);
