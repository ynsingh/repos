 ...
 * @author Dushyant
 */
public class CirOpacApprovedActionForm  extends org.apache.struts.action.ActionForm{
  ...
  private byte[] uploadedFile;
    ...
    public CirOpacApprovedActionForm() {
        super();
    ...
    /**
     * @param TXTREG_DATE the TXTREG_DATE to set
     */
    ...
    /**
     * @param TXTEXP_DATE the TXTEXP_DATE to set
     */
