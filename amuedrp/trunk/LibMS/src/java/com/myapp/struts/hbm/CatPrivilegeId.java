...
/**
 * CatPrivilegeId generated by hbm2java
 */
public class CatPrivilegeId  implements java.io.Serializable {


     private String staffId;
     private String libraryId;

    public CatPrivilegeId() {
    }

    public CatPrivilegeId(String staffId, String libraryId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CatPrivilegeId) ) return false;
		 CatPrivilegeId castOther = ( CatPrivilegeId ) other; 
