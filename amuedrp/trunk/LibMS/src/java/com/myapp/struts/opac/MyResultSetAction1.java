 ...
 * @author Faraz
 */
public class MyResultSetAction1 extends org.apache.struts.action.Action {
    ...
    request.setAttribute("MyResultSet1", rst);
    System.out.println("page="+page);
    if (page!=null){
        if(page.equals("newarrivals")) return mapping.findForward("newarrival");
         if(page.equals("accessionno")) return mapping.findForward("accessionno");
    }
