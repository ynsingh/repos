...
/**
 * CirOpacRequestId generated by hbm2java
 */
public class CirOpacRequestId  implements java.io.Serializable {
    ...
    public CirOpacRequestId() {
    }

    public CirOpacRequestId(String libraryId, String sublibraryId, int rid) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CirOpacRequestId) ) return false;
		 CirOpacRequestId castOther = ( CirOpacRequestId ) other; 
