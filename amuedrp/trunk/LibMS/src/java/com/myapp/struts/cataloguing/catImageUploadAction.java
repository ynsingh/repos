...
public class catImageUploadAction extends org.apache.struts.action.Action {
...
if (form1.getImg()!=null)
         {
                  ...
                  UserLog.writeImage1(bib.getId().getLibraryId()+bib.getId().getSublibraryId()+bib.getId().getBiblioId()+"."+ext, iii);
...
if(bib.getEntryLanguage()!=null && bib.getEntryLanguage().isEmpty()==false)
{
    ...
    bib1.setImage(bib.getId().getLibraryId()+bib.getId().getSublibraryId()+bib.getId().getBiblioId()+"."+ext);
...
{   bib.setImage(bib.getId().getLibraryId()+bib.getId().getSublibraryId()+bib.getId().getBiblioId()+"."+ext);
    bibdao.update(bib);
