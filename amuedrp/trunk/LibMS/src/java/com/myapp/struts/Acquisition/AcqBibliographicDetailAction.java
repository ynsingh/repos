 ...
 * @author maqbool
 */
public class AcqBibliographicDetailAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
            ...
            throws Exception {
        AcqBiblioActionForm acqbibfrm=null;
        System.out.println("Yes its calling");
        
         acqbibfrm= (AcqBiblioActionForm)form;
