 ...
 * @author maqbool
 */
public class AcqInvoiceProcessAction extends org.apache.struts.action.Action {
  ...
  AcqRecievingHeader acqrecvhr=new AcqRecievingHeader();
  ...
  List<ApprovalList> acqorder1= new ArrayList<ApprovalList>();
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
      ...
      //  acqrecvhr=acqodao.searchRecieveHeaderByVendor(order_no, vendor_id, library_id, sub_library_id, recieving_no);
      //  acqorder1=acqodao.searchInvoiceByRecieve(order_no,library_id, sub_library_id,recieving_no);

          if(button.equals("New Invoice"))
            {
            if(acqrecvhr ==null)
             {
