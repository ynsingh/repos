...
public class BibliographicEntryDAO {



     public  DocumentDetails searchBook(String acc_no,String library_id, String sub_library_id) {
...
List obj=null;
     ...
     public  List searchByAccessionNo11(String library_id, String sub_library_id,String search_keyword,int pageNumber) {
        Session session = HibernateUtil.getSessionFactory().openSession();
        session.beginTransaction();
        List obj=null;
        try {
    ...
    public  List searchByAccessionNo12(String library_id, String sub_library_id,int pageNumber) {
        Session session = HibernateUtil.getSessionFactory().openSession();
        session.beginTransaction();
        List obj=null;
        try {
