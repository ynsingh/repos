            ...
            if (card_type.equalsIgnoreCase("gc")) {
                ...
                if (result == true) {
                    ...
                    //"Member Account Created Successfully for LibMS OPAC Login", "Login Id=" + cca.getMem_id() + " Your Password for LibMS OPAC Login is=" + password
                      ...
                      obj=new Email((String)session1.getAttribute("webmail"),(String)session1.getAttribute("webpass"),path,cma1.getEmail(),password,"Congruation,Your are Registered as Library Member","You Have been registered as a valid Library member for Library Name"+session1.getAttribute("library_name").toString()+"\nYour Member Account as Follows \nUser Id:"+cca.getMem_id()+"\nPassword:"+password+".\n","Dear "+cca.getMem_name()+",\n","Thanks,\n"+session1.getAttribute("username")+",\n"+"Institute Admin");
