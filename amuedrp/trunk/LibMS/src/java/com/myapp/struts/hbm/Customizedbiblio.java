...
/**
 * Customizedbiblio generated by hbm2java
 */
public class Customizedbiblio  implements java.io.Serializable {


     private CustomizedbiblioId id;
    ...
    public CustomizedbiblioId getId() {
        return this.id;
    }
    
    public void setId(CustomizedbiblioId id) {
        this.id = id;
    }
