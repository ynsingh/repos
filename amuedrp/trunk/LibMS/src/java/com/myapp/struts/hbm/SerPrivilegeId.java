...
/**
 * SerPrivilegeId generated by hbm2java
 */
public class SerPrivilegeId  implements java.io.Serializable {


     private String staffId;
     private String libraryId;

    public SerPrivilegeId() {
    }

    public SerPrivilegeId(String staffId, String libraryId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SerPrivilegeId) ) return false;
		 SerPrivilegeId castOther = ( SerPrivilegeId ) other; 
