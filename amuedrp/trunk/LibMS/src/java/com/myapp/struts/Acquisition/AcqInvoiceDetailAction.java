 ...
 * @author maqbool
 */
public class AcqInvoiceDetailAction extends org.apache.struts.action.Action {
   ...
   AcqRecievingDetails acqa=new AcqRecievingDetails();
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        String budget_head_id=acqbibform.getBudget_head_id();
        ...
        double amount=Integer.parseInt(t2[1]);
        l1.add(controlno);
        }
}
...
if(!l1.isEmpty())
        ...
        // List<AcqOrder1> aa2=ado.BibliobyControlId2(library_id, sub_library_id, con_no,order_no);
         List<AcqBudgetTransaction> aa2=ado.BudgetHeadId(library_id,budget_head_id,con_no);
        /* AcqBibliographyDetails acqobj=ado.BibliobyControlId(library_id, sub_library_id, con_no);
         ...
         {
            double x=aa2.get(k).getAmount();
            AcqBudgetAllocation acqbibdtail1 = ado.BudgetByControlId(library_id,con_no,x);
           acqbibdtail1.setTotalAmount(String.valueOf(Double.parseDouble(acqbibdtail1.getTotalAmount())-x));

           ado.updateBudget(acqbibdtail1);
