 ...
 */
public class BibliographicDetailsLangId  implements java.io.Serializable {
    ...
    public BibliographicDetailsLangId() {
    }

    public BibliographicDetailsLangId(int biblioId, String libraryId, String sublibraryId) {
