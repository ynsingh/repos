...
/**
 * CirMemberAccountId generated by hbm2java
 */
public class CirMemberAccountId  implements java.io.Serializable {
    ...
    public CirMemberAccountId() {
    }

    public CirMemberAccountId(String libraryId, String sublibraryId, String memid) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CirMemberAccountId) ) return false;
		 CirMemberAccountId castOther = ( CirMemberAccountId ) other; 
