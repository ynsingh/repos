...
System.out.println(no_of_issueable+"...................");
 ...
 obj=new Email((String)session.getAttribute("webmail"),(String)session.getAttribute("webpass"),path,cirobj.getEmail(),password,"Update Circulation Member Account as Library Member","Your Account is Updated for Library member for Library Name "+session.getAttribute("library_name").toString()+"\nYour Member Account as Follows \nUser Id:"+mem_id+"\nPassword:"+password+".\n","Dear "+cirobj.getFname()+" "+cirobj.getMname()+" "+cirobj.getLname()+",\n","Thanks,\n"+session.getAttribute("username")+",\n"+"Institute Admin");
...
System.out.println("hggggggggggggggg");
        ...
        if(!chkobj.isEmpty())
        {
          ...
          obj=new Email((String)session.getAttribute("webmail"),(String)session.getAttribute("webpass"),path,cirobj.getEmail(),"","Update LibMS Member Account","Sorry Your Member Account is Deleted for Library Name "+session.getAttribute("library_name").toString()+"\n","Dear "+cirobj.getFname()+" "+cirobj.getMname()+" "+cirobj.getLname()+",\n","Thanks,\n"+session.getAttribute("username")+",\n"+"Institute Admin");
            executor.submit(new Runnable() {
