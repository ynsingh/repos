 ...
 */
public class OwnAccessionEntryAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (button.equals("Add Item")) {
            if (StringUtils.isEmpty(bform.getAccession_no())) {
                String msg3 = "Accession no field can not be left blank";
