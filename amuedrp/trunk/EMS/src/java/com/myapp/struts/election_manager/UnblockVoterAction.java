...
public class UnblockVoterAction extends org.apache.struts.action.Action {
		...
		//for(int i=0;i<obj.size();i++){
			...
			if(o==null){
				...
				VoterRegistrationDAO.update(obj1);
                                session.setAttribute("msg1","Voter with Enrollment No:-" +enrollment+ "  Successfully Unblock From Election"+e.getElectionName());
