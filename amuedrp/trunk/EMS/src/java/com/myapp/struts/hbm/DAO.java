        ...
        try {
         ...
         //    SQLQuery query = session.createQuery("select COLUMN_NAME  from information_schema.columns where table_name ='bibliographic_details' order by ordinal_position) UNION (select COLUMN_NAME from information_schema.columns where table_name ='accession_register' order by ordinal_position)");
          ...
          //  SQLQuery query = session.createSQLQuery("(select COLUMN_NAME  from information_schema.columns where table_name ='bibliographic_details' order by ordinal_position) UNION ALL (select COLUMN_NAME from information_schema.columns where table_name ='accession_register' order by ordinal_position)");
              query = session.createSQLQuery("(select COLUMN_NAME  from information_schema.columns where table_name ='voter_registration' and  TABLE_SCHEMA='emsiitk' order by ordinal_position)");
...
return obj;
    ...
    public static List columnname2(String table_name) {
        Session session = HibernateUtil.getSessionFactory().openSession();
List obj=null;
        try {
            session.beginTransaction();
         //    SQLQuery query = session.createQuery("select COLUMN_NAME  from information_schema.columns where table_name ='bibliographic_details' order by ordinal_position) UNION (select COLUMN_NAME from information_schema.columns where table_name ='accession_register' order by ordinal_position)");
          ...
          //  SQLQuery query = session.createSQLQuery("(select COLUMN_NAME  from information_schema.columns where table_name ='bibliographic_details' order by ordinal_position) UNION ALL (select COLUMN_NAME from information_schema.columns where table_name ='accession_register' order by ordinal_position)");
              query = session.createSQLQuery("(select COLUMN_NAME  from information_schema.columns where table_name ='candidate_registration' and  TABLE_SCHEMA='emsiitk' order by ordinal_position)");
            //SQLQuery query = session.createSQLQuery("SHOW COLUMNS FROM temp_excell_import");
//query.setResultTransformer(Transformers.aliasToBean(Tab.class));
           obj=  query.list();
        }
...
List obj=null;
        try {
            ...
            SQLQuery query = session.createSQLQuery("(select COLUMN_NAME  from information_schema.columns where table_name ='"+table_name+"' TABLE_SCHEMA='emsiitk' order by ordinal_position)");
...
List obj=null;
        try {
         ...
         //    SQLQuery query = session.createQuery("select COLUMN_NAME  from information_schema.columns where table_name ='bibliographic_details' order by ordinal_position) UNION (select COLUMN_NAME from information_schema.columns where table_name ='accession_register' order by ordinal_position)");
            ...
            SQLQuery query = session.createSQLQuery("select DATA_TYPE  from information_schema.columns where table_name ='voter_registration' and TABLE_SCHEMA='emsiitk' order by ordinal_position") ;
//query.setResultTransformer(Transformers.aliasToBean(Tab.class));
            obj=  query.list();
        } catch(Exception e){
        e.printStackTrace();
...
return obj;
      ...
      public static List datatype2(String table_name) {
        Session session = HibernateUtil.getSessionFactory().openSession();
List obj=null;
        try {
            session.beginTransaction();
         //    SQLQuery query = session.createQuery("select COLUMN_NAME  from information_schema.columns where table_name ='bibliographic_details' order by ordinal_position) UNION (select COLUMN_NAME from information_schema.columns where table_name ='accession_register' order by ordinal_position)");
            ...
            SQLQuery query = session.createSQLQuery("select DATA_TYPE  from information_schema.columns where table_name ='candidate_registration' and TABLE_SCHEMA='emsiitk' order by ordinal_position") ;
//query.setResultTransformer(Transformers.aliasToBean(Tab.class));
            obj=  query.list();
        } catch(Exception e){
        e.printStackTrace();
...
//return maxbiblio;
//    }
public static boolean insertgenericc(CandidateRegistration obj) throws Exception {
        Session session = HibernateUtil.getSessionFactory().openSession();
        Transaction tx = null;
...
return false;
    ...
    public static boolean insertgeneric(VoterRegistration obj) throws Exception {
        Session session = HibernateUtil.getSessionFactory().openSession();
        Transaction tx = null;
...
//    }
    ...
    public static String[] selectedcombo(String[] table, int size, com.myapp.struts.Voter.StrutsUploadForm ub) {
        try {
    ...
    public static String[] selectedcombo1(String[] table, int size, com.myapp.struts.Candidate.StrutsUploadForm ub) {
        try {
