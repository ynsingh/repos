 ...
 */
public class dupl_email extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
         ...
         if(test)
         {
          ...
          getServletContext().getRequestDispatcher("/acq_registerstaff.jsp?email_id='Duplicate Email'").forward(request, response);
