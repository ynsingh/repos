     ...
     //   sublibrary_id=(String)session.getAttribute("sublibrary_id");
            ...
            try
            {
                  ...
                  //  System.out.println(DAO.columnname(table_name).size()+".................");
                    for (int k = 0; k < DAO.columnname2(table_name).size(); k++) {
if(k==3) continue;
                        System.out.println(DAO.columnname2(table_name).get(k).toString()+".................");
                         obj.add(DAO.columnname2(table_name).get(k).toString());
                    }
                  ...
                  l=0;
                    for (int k = 0; k < DAO.datatype2(table_name).size(); k++) {
                       if(k==3) continue;
                         obj1.add(DAO.datatype2(table_name).get(k).toString());
                    }
                    ...
                    System.out.println("mapcolumn:::::::::::::::::::::::::"+map_column.length+obj1.size());
