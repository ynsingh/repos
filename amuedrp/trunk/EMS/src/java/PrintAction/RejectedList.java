...
public class RejectedList extends org.apache.struts.action.Action {
 ...
 ElectionManagerDAO dao=new ElectionManagerDAO();
        String path = servlet.getServletContext().getRealPath("/");
         JasperCompileManager.compileReportToFile(path+"/reports/Rejected.jrxml");
...
//         hash.put("image",list.get(11));
         ...
         JasperFillManager.fillReportToFile(path+"/reports/Rejected.jasper",hash,data);

         File file= new File(path+"/reports/Rejected.jrprint");
         ...
         pdf.setParameter(JRExporterParameter.OUTPUT_FILE_NAME, path+"/reports/Rejected.pdf");
