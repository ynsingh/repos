...
//         hash.put("image",list.get(11));
         ...
         JasperFillManager.fillReportToFile(path+"/reports/AllCandidate.jasper",hash,data);

         File file= new File(path+"/reports/AllCandidate.jrprint");
         ...
         pdf.setParameter(JRExporterParameter.OUTPUT_FILE_NAME, path+"/reports/AllCandidate.pdf");
