...
public class PrintNomination extends org.apache.struts.action.Action {
 ...
 ElectionManagerDAO dao=new ElectionManagerDAO();
        String path = servlet.getServletContext().getRealPath("/");
         JasperCompileManager.compileReportToFile(path+"/reports/NominationReport.jrxml");
...
//         hash.put("image",list.get(11));
         ...
         JasperFillManager.fillReportToFile(path+"/reports/NominationReport.jasper",hash,data);

         File file= new File(path+"/reports/NominationReport.jrprint");
         ...
         pdf.setParameter(JRExporterParameter.OUTPUT_FILE_NAME, path+"/reports/NominationReport.pdf");
