...
<body>
 ...
 <html:option  value="Select"> Select </html:option>
            <html:options collection="Institute"  labelProperty="instituteName" property="instituteId"  name="Institute" ></html:options>
                                    ...
                                    <tr>
                                        <td align="left">Department*:</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<html:text readonly="true" name="CandidateRegActionForm" styleId="dep1" property="department"  value="<%=dep%>" /></td>

                                    </tr>

                                    <tr>
                                        <td align="left">Course*:</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<html:text readonly="true" name="CandidateRegActionForm" styleId="cour1" property="course" value="<%=cour%>"/></td>
                                    </tr>

                                    <tr>
                                        <td align="left">Year :</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<html:text readonly="true"  name="CandidateRegActionForm" styleId="year1" property="year" value="<%=yr%>"/></td>
                        ...
                        <tr><td>
                                <table width="700" border="0" cellspacing="6" cellpadding="2" align="left">
                                    ...
                                    <tr--%>
                                    <tr><td  width="30%">Duration of course:</td><td><html:text  readonly="true" name="CandidateRegActionForm" styleId="dur1" value="<%=dur%>" property="duration" /> </td><td width="30%">
                                    </tr>
                                    <tr>
                                        <td align="left">Current Session:</td><td><html:text readonly="true"  name="CandidateRegActionForm" styleId="sess1" value="<%=sess%>" property="session"  /></td>
                                    </tr
                                    <tr><td width="15%">Date of Joining<br>(DD-MM-YYYY)</td><td><html:text readonly="true"  name="CandidateRegActionForm" styleId="1" property="j_date" value="<%=jdate%>" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table><tr><td>
                                                    ...
                                                    <td><html:text readonly="true"  name="CandidateRegActionForm"  styleId="vname1"  value="<%=vname%>"  property="v_name"/></td>
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Date of Birth*<br>(DD-MM-YYYY)</td><td><html:text readonly="true"  name="CandidateRegActionForm"  property="b_date"  value="<%=bdate%>" styleId="3" />
                                            <a href="javascript:NewCal('3','ddmmmyyyy')"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></td>
                                    </tr>


                                    <tr> <td>Father's Name*</td><td><html:text  readonly="true" name="CandidateRegActionForm" styleId="fname1"  value="<%=fname%>"  property="f_name"/></td></tr>
                                    ...
                                    <tr>
                                        <td align="left">Mobile No*:</td><td><html:text readonly="true" name="CandidateRegActionForm" styleId="mnumb1" value="<%=mnumb%>" property="m_number" /></td>
                                    </tr>
                                </table>   </td>
                            <td>

                                <table> <tr>
                                        <td align="left">Corresponding Address:</td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td> &nbsp;&nbsp;<html:text readonly="true" name="CandidateRegActionForm" styleId="cadd1" property="c_add" value="<%=cadd%>"  /></td>
                                    </tr>
                                    <tr>
                                        <td align="left">City:</td><td>&nbsp;&nbsp;<html:text readonly="true" name="CandidateRegActionForm" property="city"  value="<%=city%>" styleId="city1"/></td>
                                    </tr>

                                    <tr>
                                        <td align="left">State:</td><td>&nbsp;&nbsp;<html:text readonly="true" name="CandidateRegActionForm" property="state" value="<%=state%>" styleId="state1"/></td>
                                    </tr>


                                    <tr>
                                        <td align="left">Zip Code:</td><td>&nbsp;&nbsp;<html:text readonly="true" name="CandidateRegActionForm" property="zipcode"  value="<%=zcode%>" styleId="zcode1"/></td>
                                    </tr>
                                    <tr>
                                        <td align="left">Country:*</td><td>&nbsp;&nbsp;<html:text readonly="true" name="CandidateRegActionForm" property="country"  value="<%=country%>" styleId="country1"/></td>
                                    ...
                                    <tr>    <td align="left">Permanent Address</td><td><html:text  readonly="true" name="CandidateRegActionForm" property="p_add" value="<%=padd%>" styleId="padd1"/></td></tr>
                                    <tr>    <td align="left">City</td><td><html:text readonly="true" name="CandidateRegActionForm" property="city1" value="<%=city1%>"  styleId="city21"/></td></tr>
                                    <tr>    <td align="left">State</td><td><html:text readonly="true" name="CandidateRegActionForm" property="state1" value="<%=state1%>" styleId="state21"/></td></tr>
                                    <tr> <td align="left">ZIP Code</td><td><html:text  readonly="true" name="CandidateRegActionForm" property="zipcode1"  value="<%=zcode1%>" styleId="zcode21"/></td><td colspan="2"></tr>
                                    <tr><td align="left">Country</td><td><html:text readonly="true" name="CandidateRegActionForm" property="country1" value="<%=country1%>" styleId="country21"/></td></tr>
                                </table>
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="2">email*:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<html:text readonly="true" name="CandidateRegActionForm"   value="<%=email%>" styleId="email1" property="email"/></td>
                        ...
                        <tr><td align="">Enrolled IN*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                                <html:select property="enrolled_in" styleId="enrolled"  name="CandidateRegActionForm"  tabindex="10" disabled="true">
                        ...
                        <tr>
                            <td align="left">Marks %*:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<html:text  name="CandidateRegActionForm" styleId="mark" property="p_marks" readonly="true"/></td>
                        </tr>
                        <tr>
                            <td align="left">Attendence %*:&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<html:text  name="CandidateRegActionForm" styleId="attendence" property="p_attendence" readonly="true"/></td>
                        </tr>
                </td></tr>

            <tr><td align="left" >Backlog*
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <html:radio name="CandidateRegActionForm" property="backlog" value="yes" disabled="true"/>Yes<html:radio name="CandidateRegActionForm" property="backlog" styleId="backlog" value="no" disabled="true"/>N0 </td></tr>
            <br> <tr><td align="left">Criminal log*&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<html:radio name="CandidateRegActionForm" property="criminal"  value="yes" disabled="true"/>Yes<html:radio  name="CandidateRegActionForm" property="criminal"  styleId="criminal" value="no" disabled="true"/>No</td></tr>
            <br><tr><td>Indisciplinery Action*  &nbsp;&nbsp;&nbsp;&nbsp;<html:radio name="CandidateRegActionForm" property="indisc" value="yes" disabled="true"/>Yes<html:radio name="CandidateRegActionForm" property="indisc"  value="no" disabled="true"/>No</td></tr>
           <br>
           <tr><td>Election* &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<html:text name="CandidateRegActionForm" property="elections" value="<%=election%>" readonly="true"/>
                </td></tr>
            <br>
            <tr><td>Position* &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<html:text name="CandidateRegActionForm" property="position" value="<%=position%>" readonly="true"/>
                </td></tr>
