...
function fun()
{
  ...
  <%if(status!=null){%>
    ...
    <%}%>
document.Form1.action="/EMS/votersetup2.do?page=0";
...
<option value="course">Course</option>
  ...
  <tr><td colspan="2" id="ifr3"><IFRAME  name="f1" src="/EMS/votersetup2.do?page=0" frameborder=0  id="f1" width="100%" height="700px" ></IFRAME></td></tr>
