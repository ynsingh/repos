...
req.send("cast="+positionSel+"&compute=true");
...
var divtag1 = document.createElement("div");
               ...
               var htm1 = '<span style="margin-left: 30%"><%=session.getAttribute("electionName")%></span>';
...
var noofchoice = em1[iii].getElementsByTagName("noofchoice");
var noofchoice1;
...
htm = htm +'<table class="ballot"><tbody><tr><th style="text-align: left;">Candidate ID/EnrollmentNo</th><th style="text-align: left;">Candidate Name</th><th>offline Vote</th></tr>';
...
for(jj=0;jj<ca.length;jj++)
    {
       ...
       htm = htm +'<tr><td style="text-align: left;"><label for="entry'+iii+'">'+e+'</label></td><td style="text-align: left;"><label for="entry'+iii+'">'+candidatename+'</label></td>';

       var cl = "checkCandidateLimit("+iii+","+jj+",this,"+ noofchoice1 +",count1["+iii+"],'"+e+"','"+positionname+"')";
if(noofchoice1>1)
       {
               htm = htm +'<td><input type="textbox" value=""  onblur="'+cl+'"   name="entry'+iii+'" id="entry'+iii+'" ></td></tr>';
       }
       else
           {
               htm = htm +'<td><input type="textbox" value=""   onblur="'+cl+'" name="entry'+iii+'" id="entry'+iii+'" ></td></tr>';
...
function checkCandidateLimit(iii,jj,this1,noofchoice,currentSel,candidateName,positionName)
{
    ...
    if(this1.value!="")
        {
            positionSel[iii][1][jj]=candidateName+"."+this1.value;
 ...
 <%--   if(count1[iii]>noofchoice)
        ...
        count1[iii]=1;
        positionSel[iii][1][0]=candidateName+"."+this1.value;
       // alert(positionSel[iii]);
    }
    ...
    <body onload="previewBallot()" style="margin: 0px;">
        ...
        <div id="main" style="width: 100%; height: 100%" class="datagrid">
            <div id="middle" style="width: 100%;margin-left: 0%; position: relative;" class="datagrid">
                <form id="form1">
                <div id="ballot" style="width: 660px; position: relative;margin-left: 0px; margin-top: 0px; border: 2px solid #F2F5A9;background-color: #D8CEF6;overflow: auto;font-family: Gill, Helvetica, sans-serif ;font-size: 12px;" class="datagrid">
