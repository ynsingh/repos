    ...
    var divtag = document.createElement("div");
               ...
               // divtag.style.backgroundColor = "gray";
                ...
                htm+='<div style="position: relative">';
                  htm+='<iframe name="f1" id="f1"  src="<%=request.getContextPath()%>/election.do?election='+ electVal +'&amp;agm=true" width="665px" style="height: '+ h1 +'px" />';
...
function loadresult1()
{
    ...
    var divtag = document.createElement("div");
                ...
                htm+= '<div style="background-color: teal;width: 100%;position: relative">&nbsp;<span style="float: right;"><a href="#" title="Close this window" onclick="deleteBod();">[X]</a></span></div>';
                htm+='<div style="position: relative">';
                htm+='<iframe name="f1" id="f1"  src="<%=request.getContextPath()%>/Voter/viewagm.jsp?election='+ electVal +'&amp;compute1=t" width="665px" style="height: '+ h1 +'px" />';
                    htm+='</div></div>';
                divtag.innerHTML = htm;
                document.getElementById("bod").appendChild(divtag);
...
%>
          <%if(lstclosedelection!=null && !lstclosedelection.isEmpty()){%>
              ...
              <html:options collection="ClosedelectionList" property="id.electionId" labelProperty="electionName" />
                        </html:select><input type="button"  value="Add AGM Vote" onclick="loadresult();"  id="electionsubmit"/>
                        <input type="button"  value="View AGM Vote" onclick="loadresult1();"  id="electionsubmit1"/>
                      <%--  <input type="button"  value="Update AGM Vote" onclick="loadresult2();"  id="electionsubmit"/>--%>
                    </html:form>
               <%}%>
