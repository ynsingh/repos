...
<%
    String msg2 =(String)request.getAttribute("msg1");
     ...
     <script type="text/javascript" language="javascript">
         alert("<%=msg2%>");
         top.location.href="<%=request.getContextPath()%>/election_manager/search_voter.jsp?status=BL";
...
<ui:dataGrid items="${requestList}"  var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid">
  ...
  <columns>
    ...
    <column width="10%">
      ...
      <item   value="Unblock From Login" hyperLink="${path}/unblockvoterfrmlogin.do?id=${doc.enrollment}${status}"  hAlign="left" styleClass="item"/>
    </column>
