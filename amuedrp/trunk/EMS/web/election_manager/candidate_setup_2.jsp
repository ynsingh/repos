<%--
    Document   : candidate_setup_2
    Created on : Dec 21, 2013, 3:21:34 PM
    Author     : Farooq
--%>
...
<ui:dataGrid items="${requestList}"  var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid">
  ...
  <columns>
    ...
    <column width="10%">
      ...
      <item   value="Delete" hyperLink="${path}/candidate1.do?id=${doc.enrollment}${amp}pos=${doc.position_id}${stat}${amp}eid=${doc.election_id}${amp}va=delete"  hAlign="left" styleClass="item"/>
    </column>
...
<%
String msg1=(String)session.getAttribute("wmsg1");
if(msg1!=null){
    out.println(msg1);
    session.removeAttribute("wmsg1");
}
else if((String)session.getAttribute("wmsg")!=null){
	
	    		out.println((String)session.getAttribute("wmsg"));
