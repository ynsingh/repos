...
if(rs!=null){
  Iterator it = rs.iterator();
   while (it.hasNext()) {
        ...
        Ob.setAlternatemail(voter.getAlternateMail());
...
var loc="/EMS/votersetup1.do?page="+<%=nextPage%>;
//alert(loc);
location.href= loc;
...
if(pageNumber>=1)
  ...
  previousPage = 0 + "";
%>
var loc="/EMS/votersetup1.do?page="+<%=previousPage%>;
//alert(loc);
location.href= loc;
...
<table align=""  width="100%" style="padding-left: 10%;padding-right: 10%">
   <tr><td colspan="2" align="left">
       ...
       <script type="text/javascript" language="javascript">
       alert("<%=msg2%>");
      top.window.location.href="<%=request.getContextPath()%>/election_manager/block_voter_1.jsp?status=A";
       </script>
       <% }%>
...
<ui:dataGrid items="${requestList}"  var="doc"  name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid">
  ...
  <columns>
    ...
    <column width="10%">
      <header value="Alternate Email" hAlign="left" styleClass="header"/>
      <item   value="${doc.alternatemail}" hyperLink="${path}/newregistration2.do?id=${doc.enrollment}${status}"  hAlign="left" styleClass="item"/>
    </column>
      ...
      <item   value="Block" hyperLink="${path}/blklogin.do?id=${doc.enrollment}${status}"  hAlign="left" styleClass="item"/>
    </column>
