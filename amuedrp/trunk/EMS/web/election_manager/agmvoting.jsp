...
req.open("POST","<%=request.getContextPath()%>/VoteCast.do?agm=true", true);
...
htm = htm +'<table class="ballot"><tbody><tr><th style="text-align: left;">Candidate ID/EnrollmentNo</th><th style="text-align: left;">Candidate Name</th><th>AGM Vote</th></tr>';
