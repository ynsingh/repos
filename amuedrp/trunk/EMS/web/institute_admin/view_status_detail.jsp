<%-- 
    Document   : view_status_detail
    Created on : Apr 11, 2011, 6:57:55 PM
    Author     : Edrp-04
--%>
...
<html>
    ...
    <body onload="funload()">
        ...
        <html:form action="/change_status" method="post">
            ...
            <table width="40%" align="center" class="txt" dir="<%=rtl%>" style="font-family: arial;font-weight: bold;color:brown;font-size:13px">
                ...
                String status=ems.getElectionManager().getStatus();
                %>
                ...
                <tr> <td  align="<%=align%>" dir="<%=rtl%>"><%=resource.getString("workingstatus")%></td><td  align="<%=align%>" dir="<%=rtl%>">

                         <select  id="working_status" name="status"  tabindex="18" title="Select Working Status">
                         <%
                         if(status.equals("OK"))
                             {
                            %>
