...
<script type="text/javascript" language="javascript">
    ...
    loc = "http://<%=request.getHeader("host")%><%=request.getContextPath()%>/institute_admin/delete_managergrid.jsp";
...
<table align="<%=align%>" dir="<%=rtl%>" width="90%">
  ...
  <columns>
    ...
    <column width="10%">
      ...
      <item   onclick="sesdel();" value="Delete" hyperLink="${path}/status_detail.do?id=${doc.manager_id}"  hAlign="left" styleClass="item" />
    </column>
