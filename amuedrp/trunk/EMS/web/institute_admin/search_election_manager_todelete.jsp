...
function fun()
{
document.Form1.action="../delete_managers.do";
...
<body onload="fun()" class="datagrid">
    ...
    <form name="Form1" action="../delete_managers.do" style="height: 100%" >
...
<option value="registration_id"><%=resource.getString("registrationid")%></option>
  ...
  <tr><td colspan="2" id="ifr3"><IFRAME  name="f1" src="../delete_managers.do" frameborder=0  id="f1" width="100%" height="700px" ></IFRAME></td></tr>
