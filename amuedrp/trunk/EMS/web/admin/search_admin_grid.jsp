...
<ui:dataGrid items="${requestList}"  var="doc" name="datagrid1" cellPadding="0" cellSpacing="0" styleClass="datagrid">
  ...
  <columns>
    ...
    <column width="100">
      ...
      <item   value="${doc.registration_id}" hyperLink="/EMS-Struts/admin/index7.jsp?id=${doc.registration_id}"  hAlign="left"    styleClass="item"/>
    </column>

    <column width="200">
      <header value="Institute Name" hAlign="left" styleClass="header"/>
      <item   value="${doc.institute_name}" hAlign="left" hyperLink="/EMS-Struts/admin/index7.jsp?id=${doc.registration_id}"  styleClass="item"/>
    </column>
    ...
    <column width="150">
      ...
      <item   value="${doc.admin_email}" hyperLink="/EMS-Struts/admin/index7.jsp?id=${doc.registration_id}"  hAlign="left" styleClass="item"/>
    </column>

   <column width="100">
   <header value="Institute ID" hAlign="left" styleClass="header"/>
 <item  value="${doc.institute_id}" hyperLink="/EMS-Struts/admin/index7.jsp?id=${doc.registration_id}"  hAlign="left" styleClass="item"/>
    </column>
      <column width="100">
   <header value="Status" hAlign="left" styleClass="header"/>
 <item  value="${doc.status}" hyperLink="/EMS-Struts/admin/index7.jsp?id=${doc.registration_id}"  hAlign="left" styleClass="item"/>
    </column>
 </columns>
