...
//   top.location.href="<%=request.getContextPath()%>/preferencialelectionResult1.do?election=<%=election1%>";  
//}
...
req.onreadystatechange = getReadyStateHandler(req, designBallot1);

req.open("POST","<%=request.getContextPath()%>/preferencialelectionResult1.do?election=<%=election%>", true);
...
function designBallot1(cartXML)
{
