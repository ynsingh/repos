...
<body bgcolor="#fffffd" onload="organisationPortalList()">
	<noscript>
		<h1>
			...
			support javascript. To work properly, this page requires javascript
			to be enabled.
		</h1>
	</noscript>
	...
	<table height="100%" width="100%" cellspacing="0px" cellpadding="0px">
		<tr height="10%">
			<td width="100%">
				<table
					style="border: 0px solid #000066; width: 100%; background-image: url('img/backimage.PNG'); background-repeat: repeat;"
					cellspacing="0px" cellpadding="0px">
					<tr>
						<td valign="top">
							<div>
								<div
									style="float: left; width: 70%; color: #000066; font-size: 30px; font-family: algerian; background-image: url(header-gif.rev.gif); background-repeat: no-repeat; background-position: left; height: 13%; text-align: center; text-shadow: aqua;">
									<bean:message key="header.title" />
									<br>
									<div
										style="padding-bottom: 15px; font: normal; font-family: Arial, Helvetica, sans-serif; color: #000000;">
										<b><font size="3"><bean:message
													key="header.subtitle" />
										</font>
										</b>
										<br>
										<font size="2">(<bean:message key="header.subtitle1" />)</font>
									</div>
								</div>
							</div>
							<div align="right" style="padding-right: 10px;">
								<b><font size="1"><bean:message key="header.welcome" />
								</font>
								</b>
								<font size="1"> <c:out value="${sessionScope.uid}" /> |</font>

								<html:link action="logout" styleClass="B">
									<font size="-1"><bean:message key="header.logout" />
									</font>
								</html:link>
							</div>
						</td>
		...
		<tr height="80%">
			<td align="justify" style="color: #000000;"50%">
				<table width="100%" height="100%">
					<tr>
						<td class="outerbox">

							<b><bean:message key="label.pmsPortals" />
								<br />
								<br /> <bean:message key="label.hello" /> , <b><font
									color="blue"><c:out value="${sessionScope.uid}" />
								</font>
							</b>
							<br /> <br />
								<bean:message key="label.message" /> <br />
								<br /> </b>
							<table class="innerbox" cellpadding="10px;" cellspacing="2px;"
								align="center">
								<html:javascript formName="portalnameform"
									dynamicJavascript="true" staticJavascript="true" />
								<html:form action="/mainwelcome"
									onsubmit="return validatePortalnameform(this)">

									<tr>
										<td>
											<input type="hidden" name="uname" id="uname"
												value="${sessionScope.uid}" size="20" readonly="readonly" />
										</td>
									</tr>
									<tr>
										<td align="left">
										...
										<td>
											<html:select property="portalname" indexed="portalname"
												style="width: 270px;height: 22px;"
												onchange="organisationPortalList()">
				...
				<sql:param value="${sessionScope.uid}" />
									...
									<tr>
										<td align="left">
											<bean:message key="label.organizationName" />
											:
										</td>
										<td>
											<html:select indexed="orgname" property="orgname"
												onchange="validUserRoleList()"
												style="width: 270px;height: 22px;">
												<html:option value="--Select--"></html:option>
											</html:select>
									...
									<tr>
										...
										<td>
											<html:select indexed="rolename" property="rolename"
												style="width: 270px;height: 22px;">
												<html:option value="--Select--"></html:option>
											</html:select>
									...
									<tr>
										<td></td>
										<td align="left">
											<html:submit styleClass="butStnd"></html:submit>
										</td>
									</tr>
								</html:form>
							</table>
		...
		<tr height="10%">
			<td class="footerpage"><jsp:include
					page="/WEB-INF/JspFiles/common/footer.jsp"></jsp:include>
			</td>
		</tr>
		<%
			}
