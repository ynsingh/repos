...
//out.println(s2);
String s4="Hi,\n You are working for this project="+(String)request.getAttribute("AssignProjName")+"\n Your User Id="+request.getAttribute("uidinfo")+"\n Password="+request.getAttribute("passinfo");
//new MailSend().mail(s2.trim(),s4);
//MailSend.Mail();
bool=NewMail.sendMail(s4,"pms.dei2010@gmail.com",s2,"PMS Info");
