...
<display:table name="fileDownloadList.list" export="false" pagesize="5" requestURI="/fileDownloadList.do" decorator="in.ac.dei.edrp.pms.deco.PmsDecorator" class="dataTable">
