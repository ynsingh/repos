 ...
 * @struts.action-forward name="neworg" path="page.neworganization"
 */
/**
 * It returns the mapping forward string for next view.
 */
public class ForwardNewOrgAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//request.setAttribute("message", "Add New Organisation");
