...
function RenderCssCal(bNewCal) {
	...
	if (Cal.Scroller=="DROPDOWN") {
		...
		for (i = 1950; i < (dtToday.getFullYear() + 25);i++)	{
			if (i==Cal.Year)
				SelectStr="Selected";
			else
				SelectStr="";	
  ...
  //******************End Month and Year selector in arrow******************************
	...
	if (UseImageFiles)
	{
        vCalTime+="<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\");' src='img/cal_close.gif' width='16' height='14' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
    }
    else
    {
