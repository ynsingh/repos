...
package common.Components.com.iwobanas.controls.dataGridClasses
{
	...
	import common.Components.com.iwobanas.controls.dataGridClasses.filterEditors.WildcardFilterEditor;
	import common.Components.com.iwobanas.controls.dataGridClasses.filters.ColumnFilterBase;
	...
	public class MDataGridColumn extends DataGridColumn
	{
		...
		public function MDataGridColumn(columnName:String=null)
		{
			...
			itemRenderer = new ClassFactory(common.Components.com.iwobanas.controls.dataGridClasses.BoldSearchItemRenderer);
			headerRenderer = new ClassFactory(common.Components.com.iwobanas.controls.dataGridClasses.DropDownFilterHeaderRenderer);
			filterEditor = new ClassFactory(common.Components.com.iwobanas.controls.dataGridClasses.filterEditors.WildcardFilterEditor);
		}
