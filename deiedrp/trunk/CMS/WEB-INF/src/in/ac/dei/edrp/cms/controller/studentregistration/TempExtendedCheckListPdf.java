...
public class TempExtendedCheckListPdf extends AbstractPdfView {
	...
	try{	
		...
		/*String path = this.getServletContext().getRealPath("/")+ "RegistrationCharts";
		File file = new File(path);
		file.mkdir();*/
		...
		String headerText = "TEMPORARY REGISTRATION CHART";
