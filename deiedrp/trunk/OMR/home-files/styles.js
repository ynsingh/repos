vb1g2j7n=xppr('1g2j7_0.png');vb1g2j7o=xppr('1g2j7_1.png');vb1g2j7c=xppr('1g2j7_2.png');

 
var btIdPref='vb', pressedItem='1g2j7';
...
function xpe(id) {
	...
	if(pressedItem==x&&(xe=='n'||xe=='o'))return;
	if(xe=='c') {
		if(pressedItem!=-1)document[btIdPref+pressedItem].src=eval(btIdPref+pressedItem+'n'+'.src');
		pressedItem=x;
	};
