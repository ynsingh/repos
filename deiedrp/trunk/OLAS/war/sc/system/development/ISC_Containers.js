...
/*
  ...
  Version 7.0RC3/LGPL Development Only (2009-09-24)
...
,isc.A.makeFooter=function(){if(!this.showFooter)return;this.addAutoChild("footer",{height:this.footerHeight});if(!this.footer)return;this.footer.addMember(isc.LayoutSpacer.create());this.addAutoChild("statusBar",{height:this.footer.getHeight(),visibility:this.minimized?isc.Canvas.HIDDEN:isc.Canvas.INHERIT});if(this.status!=null)this.setStatus(this.status);if(this.canDragResize){this.addAutoChild("resizer",{dragTarget:this,visibility:this.minimized?isc.Canvas.HIDDEN:isc.Canvas.INHERIT});if(this.resizer)this.resizer.bringToFront()}}
...
);isc.B._maxIndex=isc.C+3;isc.showLoginDialog=function(_1,_2){return isc.LoginDialog.create(isc.addProperties({},_2,{loginFunc:_1}))}
