...
if(_4.downloadResult==null)_4.downloadResult=true;if(_4.downloadToNewWindow==null)_4.downloadToNewWindow=_1=="viewFile"?true:false;if(_4.showPrompt==null)_4.showPrompt=false;if(!isc.isAn.Object(_2)){_2={};_2[this.getPrimaryKeyField()]=_2}
...
return 1}
return _7}
);isc.B._maxIndex=isc.C+146;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$628=0;isc.A.$71l={sum:function(_1,_2,_3){var _4=0;for(var i=0;i<_2.length;i++){var _6=_1[_2[i].name],_7=parseFloat(_6);if(isc.isA.Number(_7)&&_7==_6){_4+=_7}else{return null}}
