...
public interface GreetingService extends RemoteService {
    ...
    List<DataBean> updateMarks(String university_id, String entity_type,
        String entity_name, String program_name, String branch_name,
        String specialization_id);

//    List<DataBean> getUpdateMarks(String university_id, String entity_type,
//        String entity_name, String program_name, String branch_name);

    List<DataBean> getmeritStudent(String university_id, String entity_type,
        String entity_name, String program_name, String branch_name);

    boolean generateTestNumber(String university_id, String entity_type,
        String entity_name, String program_name, String branch_name,
        String specialization_id);
...
//        String entity_name);
//
//    ReportInfoGetter[] methodBranchNameList(String userid, String program_name,
//        String entity_name);
