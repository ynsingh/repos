...
public interface GreetingServiceAsync {
    ...
    void updateMarks(String university_id, String entity_type,
        ...
        String specialization_id, AsyncCallback<List<DataBean>> callback);

//    void getUpdateMarks(String university_id, String entity_type,
//        String entity_name, String program_name, String branch_name,
//        AsyncCallback<List<DataBean>> asyncCallback);

    void getmeritStudent(String university_id, String entity_type,
        String entity_name, String program_name, String branch_name,
         AsyncCallback<List<DataBean>> asyncCallback);

    void generateTestNumber(String university_id, String entity_type,
        String entity_name, String program_name, String branch_name,
        String specialization_id, AsyncCallback<Boolean> asyncCallback);
...
//        AsyncCallback<ReportInfoGetter[]> asyncCallback);
//
//    void methodBranchNameList(String userid, String program_name,
//        String entity_name, AsyncCallback<ReportInfoGetter[]> asyncCallback);
    ...
    void getResetFlag(String userid, String entity_type, String entity_name,
        String program_name, String branch_name, String specialization_id,
