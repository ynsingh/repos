        ...
        connectTemp.getprogCompElig(entity_id,
            new AsyncCallback<CM_ProgramInfoGetter[]>() {
                ...
                public void onSuccess(CM_ProgramInfoGetter[] arg0) {
                    ...
                    data1 = new Object[arg0.length][5];
                    ...
                    for (int i = 0; i < arg0.length; i++) {
                        for (int k = 0; k < 5; k++) {
                            if (k == 0) {
                                ...
                                str = "" + arg0[i].getCut_off_percentage();
                            }
                    ...
                    BaseColumnConfig[] columns = new BaseColumnConfig[] {
                            ...
                            new ColumnConfig(cons.label_branchname(), "branch",
                                120, true),
                            new ColumnConfig(cons.component(), "age", 90, true),
                            new ColumnConfig(cons.category(), "category", 70,
                                true),
                            new ColumnConfig(cons.cutoffPercent(), "cutoff",
                                120, true)
                        };
                            ...
                            public void onClick(Button button, EventObject e) {
                                ...
                                if (records.length < 1) {
                                                        ...
                                                        MessageBox.confirm(confirm,
                                                            ...
                                                            new MessageBox.ConfirmCallback() {
                                                                public void execute(
                                                                    ...
                                                                    if (btnID.matches(
                                                                                "yes")) {
                                                                        connectTemp.editProgCompEligibility(editProg,
                                                                            modifierid,
                                    ...
                                    editFlex.setWidget(3, 0,
                                        new Label(cons.component()));
                                    editFlex.setWidget(3, 3, componentLabel);
                                    editFlex.setWidget(4, 0,
                                        new Label(cons.category()));
                                    editFlex.setWidget(4, 3, categoryLabel);
                                    editFlex.setWidget(5, 0,
                                        new Label(cons.cutoffPercent()));
                                    editFlex.setWidget(5, 3, ageNF);
                                    ...
                                    window.setTitle(cons.heading_manageprogramCompElig());
                                                ...
                                                if (btnID.matches("yes")) {
                                                    for (int i = 0;
                                                        ...
                                                        Univ[4] = records[i].getAsString(
                                                                "age");
                                                        Univ[5] = records[i].getAsString(
                                                                "cutoff");

                                                        connectTemp.deleteProgCompElig(Univ,
                                                            new AsyncCallback<String>() {
                                                                public void onFailure(
                                                                    Throwable arg0) {
                                                                }
