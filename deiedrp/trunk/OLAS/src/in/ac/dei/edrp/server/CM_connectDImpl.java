...
public class CM_connectDImpl extends RemoteServiceServlet implements CM_connectD {
	...
	public String methodAddUniversity(String universityCode,
			...
			String universityCity, String universityState,
			String universityPincode, String universityPhoneNumber,
			String universityOtherPhoneNumber, String universityFaxNumber,
			String universityInsertTime, String universityCreatorID) throws Exception {
...
//               String userid= "E"+universityID+"0000000000001";
	...
	public void methodAddUniversityAdmin(boolean flagd, String universityName, String userGroupName, String userName,
...
//	        createconnection();
	        List li = null;
				...
				li = client.queryForList("selectUniversityName", value);
	     	        ...
	     	        System.out.println("size+"+li.size()+value);
     ...
     */
    @SuppressWarnings("unchecked")
    public CM_UniversityInfoGetter[] methodManageUniversityList(String criteria, String value)
        throws Exception {
        try {
//            createconnection();
            List li = null;
           ...
           li = client.queryForList("selectAllUniversityDetails", null);
            	 ...
            	 li = client.queryForList("selectAllUniversityDetailsWithUniversityName",value);
            
            else if(criteria.equalsIgnoreCase("University ID"))
            	 li = client.queryForList("selectAllUniversityDetailsWithUniversityID",value);
            
            else if(criteria.equalsIgnoreCase("University City"))
           	 li = client.queryForList("selectAllUniversityDetailsWithUniversityCity",value);
            
            else if(criteria.equalsIgnoreCase("University State"))
           	 li = client.queryForList("selectAllUniversityDetailsWithUniversityState",value);
...
//	        createconnection();
	        List<?> l1 = null;
				...
				l1 = client.queryForList("selectProgramName", null);
	     	        ...
	     	        System.out.println("size+"+l1.size()+value1);
     ...
     * @throws Exception
     */	
	public CM_BranchSpecializationInfoGetter[] methodBranchList(String programName)
	{	
		System.out.println("Heyy Branch ur program is: " + programName);
		List<?> l2 = null;
	    try {
//	        createconnection();        
     ...
     */	
	@SuppressWarnings("unchecked")
	public CM_BranchSpecializationInfoGetter[] methodSpecializationList(String programName, String branchName)
	{	
		List l2 = null;
	    try {
//	        createconnection();        
	        	System.out.println("ye"+ programName + branchName);
	        	...
	        	if(programName != null && branchName.equals("Select")){
		        	System.out.println("ashu1"+programName+""+branchName);
		        	programWithSpecialization.setProgram_name(programName);
		        	l2 = client.queryForList("selectSpecializationWithProgram", programWithSpecialization);
		        }

	        else if(programName != null && !branchName.equals("Select")){
	        	System.out.println("ashu2"+programName+""+branchName);	
	        	cmb.setProgram_name(programName);
	        	cmb.setBranch_name(branchName);
	        	
	        	l2 = client.queryForList("selectSpecializationWithProgramBranch", cmb);
	        	}
	        
//				l2 = client.queryForList("selectSpecializationName", programWithSpecialization);
	        	 
	     	        System.out.println("Specialization Name size = "+l2.size()+", "+programName+""+branchName);
...
//	}
     ...
     * @throws Exception
     */	
	public CM_BranchSpecializationInfoGetter[] methodBranchSpecializationList(String programName, String branchName, String specializationName)
	{	
...
//	        createconnection();        
	        	...
	        	CM_BranchSpecializationInfoGetter programWithBranchWithSpecialization = new CM_BranchSpecializationInfoGetter();
	        		
	        if(programName != null){
	        		
	        		System.out.println("grid me: "+ programName +", "+branchName+ ", "+ specializationName);
	        		
	       		if(branchName.equals("Select") && specializationName.equals("Select")){
...
//	    					select c.program_name, b.branch_name, a.specialization_name from entity_program_master c,entity_program_specialization_detail a,entity_program_branch_detail b where a.program_id = (select program_id from entity_program_master where program_name = 'B.E.') AND a.branch=b.branch AND c.program_id = a.program_id;
	        				l1 = client.queryForList("selectAllWithProgramName", programWithBranchWithSpecialization);
	        			}	
	        			
	        			if(value.equalsIgnoreCase("0")){
	        				
	        				l1 = client.queryForList("selectAllWithProgramSpecializationWithoutBranch", programWithBranchWithSpecialization);		
	        			}
	        			
	        		}
	        	else if(branchName.equals("Select") && !specializationName.equals("Select")){
...
//	   						select a.specialization_name,b.program_name from entity_program_specialization_detail a,entity_program_master b where specialization_name = 'Computer Networks' AND b.program_id = a.program_id;
	        			...
	        			l1 = client.queryForList("selectAllWithProgramNameSpecialization", programWithBranchWithSpecialization);
	        		}
	        	else if(!branchName.equals("Select") && specializationName.equals("Select")){
...
//	    								select a.program_name, b.branch_name, c.specialization_name from entity_program_master a, entity_program_branch_detail b, entity_program_specialization_detail c where a.program_name = 'B.E.' AND b.branch_name = 'Computer Science';      		
	        			...
	        			l1 = client.queryForList("selectAllWithProgramNameBranchName", programWithBranchWithSpecialization);		
...
//	    					select a.program_name, b.branch_name, c.specialization_name from entity_program_master a, entity_program_branch_detail b, entity_program_specialization_detail c where a.program_name = 'B.E.' AND b.branch_name = 'Computer Science' AND c.specialization_name = 'Computer Networks';
	        	...
	        	l1 = client.queryForList("selectAllWithProgramNameBranchNameSpecialization", programWithBranchWithSpecialization);
...
//				l1 = client.queryForList("selectAllThree", programWithBranchWithSpecialization);
	     	        ...
	     	        System.out.println("size+"+l1.size()+programName);
...
//            	if(criteria.equalsIgnoreCase("Program"))
            	 ...
            	 li = client.queryForList("selectProgramOfferingEntity1", selectedProgramOfferedColumn);
...
*/	
  public CM_BranchSpecializationInfoGetter[] methodAssignProgramsToEntity(String programName, String branchName,
			...
			String seats, String mentor) throws Exception {
		
		try{
			System.out.println(programName + branchName + specializationName + collegeCenter + location+ seats+ mentor);
		}catch (Exception e) {
    	...
    	try {
            	...
            	CM_BranchSpecializationInfoGetter[] progID =
            		(CM_BranchSpecializationInfoGetter[]) l1.toArray(new CM_BranchSpecializationInfoGetter[l1.size()]);
            	String program_id = progID[0].getProgram_id();
            	
            	String branch = "";
            	try{
            	System.out.println("before l2 and if");
            	System.out.println("branch Name: "+ branchName);
            	if (branchName.equals("NULL")){
            		branch = "000";
            		System.out.println("Yes, branch = null");
            	}
            	else 
            	{
            	l2 = client.queryForList("selectBranch", branchName);
            	CM_BranchSpecializationInfoGetter[] brnch =
            		(CM_BranchSpecializationInfoGetter[]) l2.toArray(new CM_BranchSpecializationInfoGetter[l2.size()]);
...
//            	}
            	...
            	try{
            	System.out.println("before l3");
            	if (specializationName.equals("null")){
            		specialization = "null";
            		System.out.println("Specialization = null");
            	}
            	else {
            	l3 = client.queryForList("selectSpecialization", specializationName);
            	CM_BranchSpecializationInfoGetter[] speclztion =
            		(CM_BranchSpecializationInfoGetter[]) l3.toArray(new CM_BranchSpecializationInfoGetter[l3.size()]);
            	System.out.println(speclztion);
            	...
            	System.out.println(offeringEntity);
            	String offered_by = offeringEntity[0].getEntity_id();
            	
            	l5 = client.queryForList("selectLocationID", location);
            	CM_BranchSpecializationInfoGetter[] loction =
            		(CM_BranchSpecializationInfoGetter[]) l5.toArray(new CM_BranchSpecializationInfoGetter[l5.size()]);
            	System.out.println(offeringEntity);
	...
	public CM_BranchSpecializationInfoGetter[] methodProgramOfferedByProgramList(
        ...
        try {
        	...
        	System.out.println("in ConnectIMPL: " + programOfferedBy + value);
	...
	*/	
	public void methodEditProgramOfferedBy(
			CM_BranchSpecializationInfoGetter editProgramOfferedBy) throws Exception {
        try {
            
        	System.out.println("in ConnectIMPL: " + editProgramOfferedBy.getProgram_id());
        	System.out.println("in ConnectIMPL: " + editProgramOfferedBy.getBranch());
        	System.out.println("in ConnectIMPL: " + editProgramOfferedBy.getSpecialization());
        	System.out.println("in ConnectIMPL: " + editProgramOfferedBy.getOffered_by());
        	System.out.println("in ConnectIMPL: " + editProgramOfferedBy.getEntity_employee_id());
        	System.out.println("in ConnectIMPL: " + editProgramOfferedBy.getSeats());
        	System.out.println("in ConnectIMPL: " + editProgramOfferedBy.getLocation_id());
        	System.out.println("New IDs: ");
        	System.out.println("in ConnectIMPL: " + editProgramOfferedBy.getNew_offered_by());
        	System.out.println("in ConnectIMPL: " + editProgramOfferedBy.getNew_entity_employee_id());
        	System.out.println("in ConnectIMPL: " + editProgramOfferedBy.getNew_seats());
        	System.out.println("in ConnectIMPL: " + editProgramOfferedBy.getNew_location_id());
	...
	public void methodDeleteProgramOfferedBy(
			CM_BranchSpecializationInfoGetter deleteProgramOfferedBy) throws Exception {
        try {
            
        	System.out.println("Row which has to be deleted: ");
        	System.out.println("in ConnectIMPL: " + deleteProgramOfferedBy.getProgram_id());
        	System.out.println("in ConnectIMPL: " + deleteProgramOfferedBy.getBranch());
        	System.out.println("in ConnectIMPL: " + deleteProgramOfferedBy.getSpecialization());
        	System.out.println("in ConnectIMPL: " + deleteProgramOfferedBy.getOffered_by());
        	System.out.println("in ConnectIMPL: " + deleteProgramOfferedBy.getEntity_employee_id());
        	System.out.println("in ConnectIMPL: " + deleteProgramOfferedBy.getSeats());
        	System.out.println("in ConnectIMPL: " + deleteProgramOfferedBy.getLocation_id());       	
	...
	public CM_BranchSpecializationInfoGetter[] methodWeightageDescriptionFromSpecialWeightagePopulate()
        ...
        try {
        	...
        	li = client.queryForList("selectWeightageDescriptionFromSpecialWeightage", null);
	...
	public void methodAddSpecialWeightage(String weightageDescription, String group, String weightagePercentage,
			String university_id, String code) throws Exception {
        try {
    		...
    		System.out.println("VALUES AAYIN: " + Integer.parseInt(sysinfo[0].getSystem_value()));
...
//    		System.out.println("Value: "+ value);
	...
	@Override
	public void methodUpdateSpecialWeightage(String grouping, String weightagePercentage,
	...
	public void methodDeleteSpecialWeightage(String weightageDescription)
        ...
        try {
        	...
        	System.out.println("WD is: " + weightageDescription);
...
//            pstatement2.setString(4, selectedSession);
	...
	@Override
	public CM_BranchSpecializationInfoGetter[] methodSpecialWeightagePopulate(String weightageDescription)
			throws Exception {
		...
		try {
        	...
        	li = client.queryForList("selectSpecialWeightage", weightageDescription);
	...
	public void methodAddProgramFirstDegree(String programOfferedBy, String program,
   		 String descriptionText, String firstDegreeCodeNumber) throws Exception {
		...
		List<?> l3;
            try {
            	 ...
            	 System.out.println("(1)" + programOfferedBy);
            	 System.out.println("(2)" + program);
            	 System.out.println("(3)" + descriptionText);
            	 System.out.println("(4)" + firstDegreeCodeNumber);
            	 ...
            	 System.out.println(enID[0].getEntity_id() + " yups "+ prID[0].getProgram_id());
	...
	*/
	public CM_BranchSpecializationInfoGetter[] methodProgramFromProgramFirstDegreePopulate(String programOfferedBy)
			throws Exception {
        try {
           
        	List<?> li;
        	
        	li = client.queryForList("selectProgramFromProgramFirstDegree", programOfferedBy);
	...
	*/
	public CM_BranchSpecializationInfoGetter[] methodProgramFirstDegreePopulate(String programOfferedBy, String programDescription)
			throws Exception {
        try {
	...
	public void methodDeleteProgramFirstDegree(
			CM_BranchSpecializationInfoGetter deleteProgramFirstDegree) throws Exception {
        try {
            
        	System.out.println("Row which has to be deleted: ");
//        	System.out.println("in ConnectIMPL: " + deleteProgramOfferedBy.getProgram_id());
//        	System.out.println("in ConnectIMPL: " + deleteProgramOfferedBy.getBranch());
        	System.out.println("in ConnectIMPL: " + deleteProgramFirstDegree.getFirst_degree_description());
        	System.out.println("in ConnectIMPL: " + deleteProgramFirstDegree.getFirst_degree_code());       	
	...
	public void methodInsertProgramPaperCode(String uniid, String program, String programOfferedBy,
	...
	*/
	...
	public void methodDeleteFromProgramPaperCode(
			CM_BranchSpecializationInfoGetter deleteProgramPaperCode) throws Exception {
        try {      	
