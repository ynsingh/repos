...
public class ServletUtils {
	 ...
	 * opened in the browser. * @param fileName the name of the file. This will
	 * be encoded as UTF-8. * @param contentLen the length of the file, zero (0)
	 * if unknown. * @param request the {@code HttpServletRequest}. * @param
	 * response the {@code HttpSerletResponse}. * @throws
