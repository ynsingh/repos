...
<link rel="stylesheet" href="style/Displaytagex.css" type="text/css"></link>
 ...
 <display:table name="memberList.list" defaultsort="1" export="false" pagesize="<%=Integer.parseInt(key) %>" requestURI="/viewmember.do" decorator="deco.PmsDecorator" class="dataTable" >
