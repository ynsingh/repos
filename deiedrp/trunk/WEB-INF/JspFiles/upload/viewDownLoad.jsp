...
<link rel="stylesheet" href="style/Displaytagex.css" type="text/css"></link>
  ...
  <logic:notEmpty name="fileDownloadList" property="list">
    ...
    <font color="#0000ff" size="2">You don't have any file to download.</font>
    <br><br>
   ...
   <display:table name="fileDownloadList.list" export="false" pagesize="5" requestURI="/viewdownload.do" decorator="deco.PmsDecorator" class="dataTable">
			...
			<display:column property="fdescription" title="File Description" sortable="true" />
			<display:column property="size" title="File Size" sortable="true" />
			</display:table>		
 </logic:notEmpty>
  </body>
</html:html>
