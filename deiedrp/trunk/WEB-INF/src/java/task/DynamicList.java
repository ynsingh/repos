...
public class DynamicList{
	...
	public String[] orgList(String name,String uname) {
		try{
			con=MyDataSource.getConnection();
	...
	public String[] projectList(String name,String rname,String uname) {
