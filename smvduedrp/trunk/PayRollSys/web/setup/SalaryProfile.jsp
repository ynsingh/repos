            ...
            <f:view>
                <rich:panel header="Existing Profiles">
                    ...
                    <h:panelGrid  columns="2">
                        ...
                        <rich:dataTable  binding="#{EmployeeTypeControllerBean.dataGrid}" 
                                         id="designation" value="#{EmployeeTypeControllerBean.employeeTypes}" 
                                         var="desig" border="1">
                            <h:column>
                                <f:facet name="header">
                            ...
                            <h:column>
                                ...
                                <h:selectBooleanCheckbox value="#{desig.pfApplies}" />
                            </h:column>
                        </rich:dataTable>                        
                    </h:panelGrid>
                ...
                <rich:modalPanel id="pnl">
                    <rich:panel header="Add New Profile">
                        <h:form >
                            ...
                            <h:selectBooleanCheckbox styleClass="field" required="true" value="#{SalaryProfileBean.pfApplies}" />
                            <a4j:commandButton styleClass="panel" reRender="designation" value="Save" action="#{SalaryProfileBean.save}" />
