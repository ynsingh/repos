            ...
            <h:panelGrid columns="2">
                <rich:panel header="Monthly Salary Processing" id="mypnl">
                    <h:form>                        
                        ...
                        <a4j:commandButton reRender="inpnl,dpnl,salpnl"
                ...
                <rich:panel style="width:300px;height:465px;" header="Salary Tools">
                    ...
                    <rich:panel style="width:280px;border:1;">
                        <h:panelGrid  columns="3">
                            <h:form>
                                ...
                                <a4j:commandButton reRender="inpnl,dpnl,salpnl" action="#{SalaryProcessingBean.scale}" value="Refresh"/>
                            </h:form>
                        </h:panelGrid>
                    </rich:panel>
                    ...
                    <rich:panel id="salpnl" header="Salary Summery">
                        <h:panelGrid columns="2">
                            ...
                            <h:form>
                                <h:inputHidden value="#{SalaryProcessingBean.empCode}"/>
                                <h:selectOneMenu value="#{SalaryProcessingBean.copyDate}">
                                    <f:selectItems value="#{SalaryProcessingBean.copyDates}"/>
                                </h:selectOneMenu>
                                <a4j:commandButton action="#{SalaryProcessingBean.copyData}" value="Copy Data"/>
                            </h:form>
                        </h:panelGrid>
                    </rich:panel>
                </rich:panel>
