...
<html>
    ...
    <body class="subpage" id="">
        <div class="container_form">
            <f:view>
                <rich:panel header="Annual PF Report">
                    <h:form id="investmentheads">
                        <h:panelGrid columns="4">
                            <h:outputText value="Employee Code"/>
                            <h:outputText id="empcCode"  value="#{PFReport.empCode}"/>
                        </h:panelGrid>    
                            <rich:dataTable   style="width:90%;"
                                              value="#{PFReport.data}" var="dt">
                                ...
                                <rich:column width="40%" >
                                 ...
                                 <f:facet name="footer">
                                     <h:outputText  value="Net Total #{PFReport.netTotal}"/>
                                    </f:facet>
                            </rich:dataTable>
                    </h:form>
                </rich:panel>
