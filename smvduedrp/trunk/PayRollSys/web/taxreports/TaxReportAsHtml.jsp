<%-- 
    Document   : TaxReportAsHtml
    Created on : 5 Mar, 2012, 10:58:47 PM
    Author     : Dhruv Mahajan
--%>

<%@page import="org.smvdu.payroll.taxmanager.TaxController"%>
...
<html>
    ...
    <body>
        <%
            ...
            try
            {
                JasperPrint jasperPrint = JasperFillManager.fillReport(path + "/" + "JasperFile/investment.jasper", map, cn);
