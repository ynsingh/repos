<%-- 
    Document   : FinalTaxPayableAsHtml
    Created on : 14 May, 2012, 2:56:06 PM
    Author     : smvdu
--%>
...
<html>
    ...
    <body>
        <%
            ...
            try
            {
                JasperPrint jasperPrint = JasperFillManager.fillReport(path + "/" + "JasperFile/finaltax.jasper", map, cn);
