<%-- 
    Document   : ActualnpaidTaxAsHtml
    Created on : 21 March, 2013, 11:19:58 AM
    Author     : smvdu
--%>
...
<html>
    ...
    <body>
        <%
            ...
            map.put("org_title", "Actual and Paid Tax ");
           // map.put("year", ""+ub.getCurrentYear());
            ...
            try
            {
                JasperPrint jasperPrint = JasperFillManager.fillReport(path + "/" + "JasperFile/actualpaid.jasper", map, cn);
