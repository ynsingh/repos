...
<f:view>
    <html>
        ...
        <body>
            <a4j:region>
                <rich:panel header="List Of Registered College/Institute's" style="font-size:17px;font-weight:bold;">
                    <h:form>
                        <h:panelGrid columns="1">
                            ...
                            <rich:panel>
                                ...
                                <h:dataTable headerClass="headerStyle" rowClasses="rowStyle" style="font-size:14px;font-weight:bold;" id="upda" rows="20"  value="#{OrgProfileBean.collegeList}" binding="#{OrgProfileBean.dataGrid1}"  var="ins"> 
