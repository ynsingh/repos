                ...
                <h:form id="frmTest">
                    ...
                    <div class="form_lables">
                        <label>
                                    ...
                                    <h:inputText label=" instName" requiredMessage="Name can not be empty" required="true" value="#{OrgProfileBean.name}" />                     
                        </label>
                        ...
                        <label>
                                    ...
                                    <h:inputText id="insta1" requiredMessage="Address can not empty " required="true"  value="#{OrgProfileBean.address1}"/>
                        </label>
                        ...
                        <label>
                                    <span>City :</span>
                                    <h:inputText id="instc" requiredMessage="City can not empty " required="true" value="#{OrgProfileBean.city}"/>
                        </label>
                        ...
                        <label>
                                    <span>Pincode :</span>
                                    <h:inputText id="instpc" requiredMessage="Pincode can not empty " required="true" value="#{OrgProfileBean.pincode}"/>  <h:outputText value="e.g. For IIT Kanpur (208016)" />
                        </label>
                        ...
                        <label>
                                    ...
                                    <h:selectOneMenu requiredMessage="State can not empty " required="true" value="#{OrgProfileBean.state}">
                        ...
                        <label>
                                    ...
                                    <h:inputText id="instcc" requiredMessage="Country Code can not empty " required="true" value="#{OrgProfileBean.countryCode}"/>
                        ...
                        <label>
                                    ...
                                    <h:inputText id="instph" requiredMessage="Number can not be empty" required="true"   value="#{OrgProfileBean.phone}"/>
                        ...
                        <label>
                                    ...
                                    <h:inputText id="instidn" requiredMessage="Domain can not be empty" required="true"  value= "#{OrgProfileBean.instDomain}"/>
                        ...
                        <label>
                                    ...
                                    <h:inputText id="instweb" requiredMessage="Website can not be empty" required="true"  value="#{OrgProfileBean.web}"/>
                        ...
                        <label>
                                    ...
                                    <h:inputText id="instafn" requiredMessage="First name can not empty " required="true" value="#{OrgProfileBean.adminfn}"/>
                        ...
                        <h:column>       <h:message for="instafn" /></h:column>
                         ...
                         <label>
                                    <span> Last Name :</span>
                                    <h:inputText id="instaln" requiredMessage="Last name can not empty" required="true" value="#{OrgProfileBean.adminln}"/>
                        </label>
                        ...
                        <label>
                                    ...
                                    <h:inputText id="instd" requiredMessage="Designation can not empty" required="true" value="#{OrgProfileBean.adminDesig}"/>
                        </label>
