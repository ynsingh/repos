CREATE DATABASE  IF NOT EXISTS `eportfolio` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `eportfolio`;
...
--
-- Table structure for table `media_publication`
--

DROP TABLE IF EXISTS `media_publication`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `media_publication` (
  `mpId` bigint(11) NOT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  `type_of_media` text,
  `title_of_media` text,
  `title_of_article` text,
  `pub_date` varchar(25) DEFAULT NULL,
  `url` text,
  `summary` text,
  `api` int(10) DEFAULT NULL,
  PRIMARY KEY (`mpId`),
  KEY `mpUID_FK` (`user_id`),
  KEY `usermedia_fk_idx` (`user_id`),
  CONSTRAINT `usermedia_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `media_publication`
--

LOCK TABLES `media_publication` WRITE;
/*!40000 ALTER TABLE `media_publication` DISABLE KEYS */;
/*!40000 ALTER TABLE `media_publication` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `consultancy_nature`
--

DROP TABLE IF EXISTS `consultancy_nature`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `consultancy_nature` (
  `c_nature_Id` bigint(11) NOT NULL AUTO_INCREMENT,
  `consultancyId` bigint(11) DEFAULT NULL,
  `name_consultancy` text,
  `nature_work` text,
  PRIMARY KEY (`c_nature_Id`),
  KEY `C_ID_FK` (`consultancyId`),
  CONSTRAINT `C_ID_FK` FOREIGN KEY (`consultancyId`) REFERENCES `consultancy` (`consultancy_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `consultancy_nature`
--

LOCK TABLES `consultancy_nature` WRITE;
/*!40000 ALTER TABLE `consultancy_nature` DISABLE KEYS */;
/*!40000 ALTER TABLE `consultancy_nature` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `feedback` (
  ...
  `comment` text,
  `f_subject` varchar(50) DEFAULT NULL,
...
CREATE TABLE `grade_value` (
  ...
  `gtd_id` int(3) DEFAULT NULL,
  `grade_val_id` int(10) NOT NULL,
  `grade_value` text,
  `grade_date` datetime DEFAULT NULL,
  PRIMARY KEY (`grade_val_id`),
  KEY `gtdid_fk_idx` (`gtd_id`),
  KEY `course_fk_idx` (`course_id`),
  KEY `fac_id_fk_idx` (`faculty_id`),
  CONSTRAINT `course_fk` FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fac_id_fk` FOREIGN KEY (`faculty_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `gtdid_fk` FOREIGN KEY (`gtd_id`) REFERENCES `grade_type_details_master` (`gtd_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `book_chapter` (
  `book_chapter_id` bigint(11) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(100) DEFAULT NULL,
  `bc_type` varchar(45) DEFAULT NULL,
  `role` varchar(15) DEFAULT NULL,
  `title` text,
  `no_coauthor` int(3) DEFAULT NULL,
  `publisher` text,
  `isbn` varchar(20) DEFAULT NULL,
  `published_on` varchar(25) DEFAULT NULL,
  `p_from` int(5) DEFAULT NULL,
  `p_to` int(5) DEFAULT NULL,
  `language` varchar(50) DEFAULT NULL,
  `affiliation` text,
  `url` text,
  `summary` text,
  PRIMARY KEY (`book_chapter_id`),
  KEY `BC_UID_FK` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `profile_employment` (
  `employmentInfo_id` bigint(10) NOT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  `jTitle` text,
  `orgName` text,
  `oAddress` varchar(100) DEFAULT NULL,
  `oCity` varchar(100) DEFAULT NULL,
  `oState` varchar(100) DEFAULT NULL,
  `oCountry` varchar(100) DEFAULT NULL,
  `jDate` varchar(45) DEFAULT NULL,
  `lDate` varchar(45) DEFAULT NULL,
  `description` text,
  PRIMARY KEY (`employmentInfo_id`),
  KEY `e_u_ID_Fk` (`user_id`),
  CONSTRAINT `e_u_ID_Fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `profile_employment` WRITE;
/*!40000 ALTER TABLE `profile_employment` DISABLE KEYS */;
/*!40000 ALTER TABLE `profile_employment` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `evidence` (
  ...
  `Instruction` text,
  `add_date_schedule` tinyint(1) DEFAULT NULL,
  `add_anno_odate` tinyint(1) DEFAULT NULL,
  `addto_gradebook` tinyint(1) DEFAULT NULL,
  `ass_attach` varchar(100) DEFAULT NULL,
  `Institute_id` int(10) DEFAULT NULL,
  `programme_id` int(10) DEFAULT NULL,
  `course_id` int(10) DEFAULT NULL,
  `faculty_id` varchar(100) DEFAULT NULL,
  `save_evid` tinyint(1) DEFAULT NULL,
  `cancel` tinyint(1) DEFAULT NULL,
  `cancel_reason` text,
  PRIMARY KEY (`EvidenceId`),
  KEY `faculty_fk_id_idx` (`faculty_id`),
  KEY `cours_fk_id_idx` (`course_id`),
  CONSTRAINT `cours_fk_id` FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `faculty_fk_id` FOREIGN KEY (`faculty_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `course` (
  ...
  KEY `course_fk_id_idx` (`programme_id`),
  CONSTRAINT `course_fk_id` FOREIGN KEY (`programme_id`) REFERENCES `programme` (`programme_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `consultancy` (
  `consultancy_id` bigint(11) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(100) NOT NULL,
  `client_name` varchar(100) DEFAULT NULL,
  `d_from` varchar(25) DEFAULT NULL,
  `d_to` varchar(25) DEFAULT NULL,
  `no_of_consultancy` int(2) DEFAULT NULL,
  `revenue` varchar(100) DEFAULT NULL,
  `service` text,
  `url` text,
  `summary` text,
  PRIMARY KEY (`consultancy_id`),
  KEY `Consult_user_FK` (`user_id`),
  CONSTRAINT `Consult_user_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `review_committee`
--

DROP TABLE IF EXISTS `review_committee`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `review_committee` (
  `review_committeeId` bigint(11) NOT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  ...
  `url` text,
  `review` text,
  `minutes_file` longblob,
  PRIMARY KEY (`review_committeeId`),
  KEY `RC_UID_FK` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `review_committee`
--

LOCK TABLES `review_committee` WRITE;
/*!40000 ALTER TABLE `review_committee` DISABLE KEYS */;
/*!40000 ALTER TABLE `review_committee` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `grade_type_details_master`
--

DROP TABLE IF EXISTS `grade_type_details_master`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `grade_type_details_master` (
  `gtd_id` int(3) NOT NULL,
  `gt_id` int(3) DEFAULT NULL,
  `details` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`gtd_id`),
  KEY `gt_ID_FK` (`gt_id`),
  CONSTRAINT `gt_ID_FK` FOREIGN KEY (`gt_id`) REFERENCES `grade_type_master` (`gt_Id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `grade_type_details_master`
--

LOCK TABLES `grade_type_details_master` WRITE;
/*!40000 ALTER TABLE `grade_type_details_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `grade_type_details_master` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `conference` (
  `conference_id` bigint(11) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(100) DEFAULT NULL,
  `conf_type` varchar(20) DEFAULT NULL,
  `research_area` varchar(100) DEFAULT NULL,
  `asso_project` varchar(5) DEFAULT NULL,
  `project_name` text,
  `role` varchar(30) DEFAULT NULL,
  `presentation_type` varchar(25) DEFAULT NULL,
  `paper_title` text,
  `no_coauthor` int(3) DEFAULT NULL,
  `pfrom` int(10) DEFAULT NULL,
  `pto` int(10) DEFAULT NULL,
  `conference_name` text,
  `dfrom` varchar(25) DEFAULT NULL,
  `dto` varchar(25) DEFAULT NULL,
  `org_name` text,
  ...
  KEY `Conf_U_ID_FK` (`user_id`),
  CONSTRAINT `Conf_U_ID_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `profile_interest` (
  ...
  `acad_interest` varchar(100) DEFAULT NULL,
  `pers_interest` varchar(100) DEFAULT NULL,
  `tech_interest` varchar(100) DEFAULT NULL,
  `reser_interst` varchar(100) DEFAULT NULL,
  `my_hobbies` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`interest_id`),
  KEY `profile_interest_f_id` (`user_id`),
  CONSTRAINT `profile_interest_f_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `grade_type_master`
--

DROP TABLE IF EXISTS `grade_type_master`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `grade_type_master` (
...
--
-- Dumping data for table `grade_type_master`
--

LOCK TABLES `grade_type_master` WRITE;
/*!40000 ALTER TABLE `grade_type_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `grade_type_master` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `profile_contact` (
  `contactInfo_id` bigint(11) NOT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  ...
  `h_telephone` bigint(12) DEFAULT NULL,
  `o_telephone` bigint(12) DEFAULT NULL,
  `mobile_no` bigint(12) DEFAULT NULL,
  `fax_no` bigint(12) DEFAULT NULL,
  ...
  KEY `P_C_UID_FK` (`user_id`),
  CONSTRAINT `P_C_UID_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `profile_contact` WRITE;
/*!40000 ALTER TABLE `profile_contact` DISABLE KEYS */;
/*!40000 ALTER TABLE `profile_contact` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `governance` (
  `governanceId` bigint(11) NOT NULL,
  `userId` varchar(100) DEFAULT NULL,
  `nameCommittee` text,
  `nameUniversity` text,
  `durationFrom` varchar(25) DEFAULT NULL,
  `durationTo` varchar(25) DEFAULT NULL,
  `responsibility` text,
  `url` text,
  `summary` text,
  PRIMARY KEY (`governanceId`),
  KEY `Gov_U_Id_FK` (`userId`),
  KEY `userGov_fk_idx` (`userId`),
  CONSTRAINT `userGov_fk` FOREIGN KEY (`userId`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `evidence_submission`
--

DROP TABLE IF EXISTS `evidence_submission`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `evidence_submission` (
  `submission_id` int(11) NOT NULL,
  `evidence_id` int(10) DEFAULT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  `institute_id` int(10) DEFAULT NULL,
  `programme_id` int(10) DEFAULT NULL,
  `course_id` int(10) DEFAULT NULL,
  ...
  `save_draft` tinyint(1) DEFAULT NULL,
  `grades_obtained` varchar(45) DEFAULT NULL,
  `faculty_comment` text,
  `faculty_attachment` varchar(100) DEFAULT NULL,
  `can_comment` tinyint(1) DEFAULT NULL,
  `list_student` text,
  PRIMARY KEY (`submission_id`),
  KEY `evid_fk_idx` (`evidence_id`),
  KEY `evsub_ufk_id_idx` (`user_id`),
  KEY `evsub_cfk_id_idx` (`course_id`),
  CONSTRAINT `evid_fk` FOREIGN KEY (`evidence_id`) REFERENCES `evidence` (`EvidenceId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `evsub_cfk_id` FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `evsub_ufk_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `evidence_submission`
--

LOCK TABLES `evidence_submission` WRITE;
/*!40000 ALTER TABLE `evidence_submission` DISABLE KEYS */;
/*!40000 ALTER TABLE `evidence_submission` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `profile_academic`
--

DROP TABLE IF EXISTS `profile_academic`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `profile_academic` (
  `academicInfo_id` bigint(10) NOT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  `degree` text,
  `university` text,
  `location` text,
  ...
  PRIMARY KEY (`academicInfo_id`),
  KEY `a_u_ID_FK` (`user_id`),
  CONSTRAINT `a_u_ID_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `profile_academic`
--

LOCK TABLES `profile_academic` WRITE;
/*!40000 ALTER TABLE `profile_academic` DISABLE KEYS */;
/*!40000 ALTER TABLE `profile_academic` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_plan` (
  ...
  PRIMARY KEY (`plan_id`),
  KEY `u_id_FK` (`user_id`),
  CONSTRAINT `u_id_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `profile_test`
--
...
CREATE TABLE `profile_test` (
  ...
  `tDescription` text,
  PRIMARY KEY (`test_id`),
  KEY `t_U_ID_FK` (`user_id`),
  CONSTRAINT `t_U_ID_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `profile_test`
--

LOCK TABLES `profile_test` WRITE;
/*!40000 ALTER TABLE `profile_test` DISABLE KEYS */;
/*!40000 ALTER TABLE `profile_test` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `profile_honor_award`
--

DROP TABLE IF EXISTS `profile_honor_award`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `profile_honor_award` (
  `honor_award_id` bigint(10) NOT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  `haTitle` text,
  `Issuer` text,
  `haDate` varchar(50) DEFAULT NULL,
  `haDescription` text,
  PRIMARY KEY (`honor_award_id`),
  KEY `ha_u_ID_FK` (`user_id`),
  CONSTRAINT `ha_u_ID_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `profile_honor_award`
--

LOCK TABLES `profile_honor_award` WRITE;
/*!40000 ALTER TABLE `profile_honor_award` DISABLE KEYS */;
/*!40000 ALTER TABLE `profile_honor_award` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `department` (
  ...
  `introduction` text,
  `postal_address` text,
  `phone_code` int(5) DEFAULT '0',
  `phone_no` int(8) DEFAULT '0',
  `mobile_no` bigint(12) DEFAULT '0',
  `fax` int(10) DEFAULT '0',
  `dept_email_id` varchar(100) DEFAULT NULL,
  `date_register` date DEFAULT NULL,
  PRIMARY KEY (`department_id`),
  KEY `fk_department_1_idx` (`institute_id`),
  CONSTRAINT `fk_department_Ins1` FOREIGN KEY (`institute_id`) REFERENCES `institute` (`institute_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `profile_social`
--

DROP TABLE IF EXISTS `profile_social`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `profile_social` (
  `socialInfo_id` bigint(10) NOT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  `gtalk` text,
  `skype` text,
  `msn` text,
  ...
  `twitter` text,
  `blog` text,
  PRIMARY KEY (`socialInfo_id`),
  KEY `s_u_ID_FK` (`user_id`),
  CONSTRAINT `s_u_ID_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `profile_social`
--

LOCK TABLES `profile_social` WRITE;
/*!40000 ALTER TABLE `profile_social` DISABLE KEYS */;
/*!40000 ALTER TABLE `profile_social` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `events` (
  `Events_id` bigint(10) NOT NULL AUTO_INCREMENT,
  `event_title` text,
  `event_date_from` date DEFAULT NULL,
  `event_date_to` date DEFAULT NULL,
  `create_date` date DEFAULT NULL,
  `event_display_date` date DEFAULT NULL,
  `venue` text,
  `address` text,
  ...
  CONSTRAINT `creator_fk` FOREIGN KEY (`creator`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `profile_pro_affiliation`
--

DROP TABLE IF EXISTS `profile_pro_affiliation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `profile_pro_affiliation` (
  `pro_affiliation_id` bigint(10) NOT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  `role` varchar(100) DEFAULT NULL,
  `orgBody` text,
  `vFrom` varchar(100) DEFAULT NULL,
  `vUpto` varchar(100) DEFAULT NULL,
  `place` varchar(100) DEFAULT NULL,
  `country` varchar(100) DEFAULT NULL,
  `summary` text,
  PRIMARY KEY (`pro_affiliation_id`),
  KEY `Pro_Affili_U_ID_FK` (`user_id`),
  CONSTRAINT `Pro_Affili_U_ID_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `profile_pro_affiliation`
--

LOCK TABLES `profile_pro_affiliation` WRITE;
/*!40000 ALTER TABLE `profile_pro_affiliation` DISABLE KEYS */;
/*!40000 ALTER TABLE `profile_pro_affiliation` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `book_chapter_author`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `book_chapter_author` (
  `author_id` bigint(11) NOT NULL AUTO_INCREMENT,
  `bc_id` bigint(11) DEFAULT NULL,
  `fname` varchar(100) DEFAULT NULL,
  `lname` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`author_id`),
  KEY `bc_ID_FK` (`bc_id`),
  CONSTRAINT `bc_ID_FK` FOREIGN KEY (`bc_id`) REFERENCES `book_chapter` (`book_chapter_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `book_chapter_author`
--

LOCK TABLES `book_chapter_author` WRITE;
/*!40000 ALTER TABLE `book_chapter_author` DISABLE KEYS */;
/*!40000 ALTER TABLE `book_chapter_author` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `journal_author` (
  `journal_author_id` bigint(11) NOT NULL AUTO_INCREMENT,
  `j_id` bigint(11) DEFAULT NULL,
  `fname` varchar(100) DEFAULT NULL,
  `lname` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`journal_author_id`),
  KEY `JID_FK` (`j_id`),
  CONSTRAINT `JID_FK` FOREIGN KEY (`j_id`) REFERENCES `journal` (`journal_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `resume` (
  `idResume` bigint(10) NOT NULL,
  `user_id` varchar(45) DEFAULT NULL,
  `resume` longblob,
  `resume_name` varchar(45) DEFAULT NULL,
  `resume_size` bigint(10) DEFAULT NULL,
  `resume_type` varchar(45) DEFAULT NULL,
  `upload_date` datetime DEFAULT NULL,
  PRIMARY KEY (`idResume`),
  KEY `resume_fk_uid` (`user_id`),
  CONSTRAINT `resume_fk_uid` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `journal` (
  `journal_id` bigint(11) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(100) DEFAULT NULL,
  `conf_type` varchar(25) DEFAULT NULL,
  `research_area` text,
  `asss_project` varchar(5) DEFAULT NULL,
  `project_name` text,
  `paper_title` text,
  `no_coauthor` int(3) DEFAULT NULL,
  `journal_name` text,
  `volume_no` int(10) DEFAULT NULL,
  `serial_no` int(10) DEFAULT NULL,
  `issn_no` varchar(15) DEFAULT NULL,
  `pfrom` int(10) DEFAULT NULL,
  `pto` int(10) DEFAULT NULL,
  `date` varchar(25) DEFAULT NULL,
  `impact_factor` varchar(100) DEFAULT NULL,
  `avg_citagtion_index` varchar(100) DEFAULT NULL,
  `scopus` text,
  `language` varchar(50) DEFAULT NULL,
  `affiliation` text,
  `url` text,
  ...
  KEY `JID_UID_FK` (`user_id`),
  CONSTRAINT `JID_UID_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `activities_comments` (
  ...
  `submitor_id` varchar(100) DEFAULT NULL,
  `commentor_id` varchar(100) DEFAULT NULL,
  `activity_id` int(10) DEFAULT NULL,
  `activity_submition_id` int(10) DEFAULT NULL,
  `course_id` int(10) DEFAULT NULL,
  `comment` text,
  `commentor_file_path` varchar(100) DEFAULT NULL,
  `rating` double DEFAULT NULL,
  PRIMARY KEY (`comment_id`),
  KEY `actsubId_fk_idx` (`activity_submition_id`),
  KEY `sumitor_fk_idx` (`submitor_id`),
  KEY `comntor_fk_idx` (`commentor_id`),
  KEY `activity_fk_id_idx` (`activity_id`),
  KEY `course_fk_id_idx` (`course_id`),
  CONSTRAINT `activity_fk_id` FOREIGN KEY (`activity_id`) REFERENCES `evidence` (`EvidenceId`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `actsubId_fk` FOREIGN KEY (`activity_submition_id`) REFERENCES `evidence_submission` (`submission_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `comntor_fk` FOREIGN KEY (`commentor_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `course_fks_id` FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `sumitor_fk` FOREIGN KEY (`submitor_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `contact_us` (
  `contact_id` bigint(30) NOT NULL,
  `contactName` varchar(50) DEFAULT NULL,
  `contactAddress` varchar(100) DEFAULT NULL,
  `contactOff` bigint(20) DEFAULT NULL,
  `contactMob` bigint(20) DEFAULT NULL,
...
--
-- Table structure for table `talk_lecture`
--

DROP TABLE IF EXISTS `talk_lecture`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `talk_lecture` (
  `talk_lectureId` bigint(11) NOT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  ...
  `name_event` text,
  `lecture_topic` text,
  `delevered_on` varchar(25) DEFAULT NULL,
  `time_from` varchar(10) DEFAULT NULL,
  `time_to` varchar(10) DEFAULT NULL,
  `level` varchar(25) DEFAULT NULL,
  `url` text,
  `description` text,
  PRIMARY KEY (`talk_lectureId`),
  KEY `ITGL_UID_FK` (`user_id`),
  KEY `usertalk_fk_idx` (`user_id`),
  CONSTRAINT `usertalk_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='	';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `talk_lecture`
--

LOCK TABLES `talk_lecture` WRITE;
/*!40000 ALTER TABLE `talk_lecture` DISABLE KEYS */;
/*!40000 ALTER TABLE `talk_lecture` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `testimonials` (
  `testi_req_id` int(11) NOT NULL AUTO_INCREMENT,
  `testi_requestor` varchar(100) DEFAULT NULL,
  `testi_req_to` varchar(100) DEFAULT NULL,
  `testi_req_cc` varchar(100) DEFAULT NULL,
  `testi_req_bcc` varchar(100) DEFAULT NULL,
  `testi_type` varchar(45) DEFAULT NULL,
  `testi_req_message` text,
  `testi_req_file` text,
  `testi_for_name` varchar(100) DEFAULT NULL,
  `testi_for_email` varchar(100) DEFAULT NULL,
  `testi_for_address` varchar(100) DEFAULT NULL,
  `testi_req_date` date DEFAULT NULL,
  ...
  `report` text,
  `testimonialscol` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`testi_req_id`),
  KEY `requestor_ID_FK_idx` (`testi_requestor`),
  KEY `request_to_ID_FK_idx` (`testi_req_to`),
  CONSTRAINT `requestor_ID_FK` FOREIGN KEY (`testi_requestor`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `request_to_ID_FK` FOREIGN KEY (`testi_req_to`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `seminars_workshops_author`
--

DROP TABLE IF EXISTS `seminars_workshops_author`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `seminars_workshops_author` (
  `sw_author_id` bigint(11) NOT NULL AUTO_INCREMENT,
  `sw_id` bigint(11) DEFAULT NULL,
  `fname` varchar(100) DEFAULT NULL,
  `lname` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`sw_author_id`),
  KEY `SW_ID_FK` (`sw_id`),
  KEY `SW_ID_FK_idx` (`sw_id`),
  CONSTRAINT `SW_ID_FK` FOREIGN KEY (`sw_id`) REFERENCES `seminars_workshops` (`seminars_workshops_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `seminars_workshops_author`
--

LOCK TABLES `seminars_workshops_author` WRITE;
/*!40000 ALTER TABLE `seminars_workshops_author` DISABLE KEYS */;
/*!40000 ALTER TABLE `seminars_workshops_author` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `profile_picture` (
  ...
  PRIMARY KEY (`Pic_id`),
  KEY `profile_picture_fk` (`user_id`),
  CONSTRAINT `profile_picture_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user` (
  `registration_id` bigint(11) DEFAULT NULL,
  ...
  `institute_id` int(10) DEFAULT NULL,
  `programe` text,
  `univ_reg_no` varchar(45) DEFAULT NULL,
  `fname` varchar(50) DEFAULT NULL,
  `lname` varchar(50) DEFAULT NULL,
  `reg_time` datetime DEFAULT NULL,
  `activ_time` datetime DEFAULT NULL,
  `last_login` datetime DEFAULT NULL,
  `deleted` tinyint(1) DEFAULT NULL,
  `Activ_status` tinyint(1) DEFAULT NULL,
  ...
  KEY `pfk_id_idx` (`programme_id`),
  CONSTRAINT `pfk_id` FOREIGN KEY (`programme_id`) REFERENCES `programme` (`programme_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,'ignouerp@egyankosh.ac.in','21232f297a57a5a743894a0e4a801fc3','admin',NULL,NULL,NULL,NULL,'Administrator','.',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `extra_activities` (
  `activities_id` bigint(11) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(100) DEFAULT NULL,
  `organization_name` text,
  `role` varchar(100) DEFAULT NULL,
  `tfrom` varchar(25) DEFAULT NULL,
  `tto` varchar(25) DEFAULT NULL,
  `description` text,
  `cause` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`activities_id`),
  KEY `extra_UID_FK` (`user_id`),
  CONSTRAINT `extra_UID_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `extra_activities` WRITE;
/*!40000 ALTER TABLE `extra_activities` DISABLE KEYS */;
/*!40000 ALTER TABLE `extra_activities` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `conference_authors` (
  `conference_authors_id` bigint(11) NOT NULL AUTO_INCREMENT,
  `conf_id` bigint(11) DEFAULT NULL,
  `fname` varchar(100) DEFAULT NULL,
  `lname` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`conference_authors_id`),
  KEY `c_U_ID_FK` (`conf_id`),
  CONSTRAINT `c_U_ID_FK` FOREIGN KEY (`conf_id`) REFERENCES `conference` (`conference_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `projects` (
  ...
  KEY `pro_U_ID_FK` (`user_id`),
  CONSTRAINT `pro_U_ID_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `inventor` (
  `idInventor` bigint(11) NOT NULL AUTO_INCREMENT,
  `PatentId` bigint(11) DEFAULT NULL,
  `fName` varchar(100) DEFAULT NULL,
  `lName` varchar(100) DEFAULT NULL,
  `address` text,
  PRIMARY KEY (`idInventor`),
  KEY `InventFK` (`PatentId`),
  CONSTRAINT `InventFK` FOREIGN KEY (`PatentId`) REFERENCES `patent` (`patentId`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `profile_skill` (
  `skill_id` bigint(10) NOT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  `skills` varchar(100) DEFAULT NULL,
  `type` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`skill_id`),
  KEY `skill_User_ID_FK` (`user_id`),
  CONSTRAINT `skill_User_ID_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `student_exchange` (
  `student_exchangeId` bigint(11) NOT NULL,
  `userId` varchar(100) DEFAULT NULL,
  `programmeType` varchar(25) DEFAULT NULL,
  `nameUniversity` text,
  ...
  `durationFrom` varchar(25) DEFAULT NULL,
  `durationTo` varchar(25) DEFAULT NULL,
  `degreeLevel` varchar(15) DEFAULT NULL,
  `degraeeName` text,
  `researchColl` text,
  `url` text,
  `description` text,
  `ifOther` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`student_exchangeId`),
  KEY `Ex-U-Id_FK` (`userId`),
  CONSTRAINT `Ex-U-Id_FK` FOREIGN KEY (`userId`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `student_exchange` DISABLE KEYS */;
/*!40000 ALTER TABLE `student_exchange` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `my_notes` (
  ...
  KEY `notes_fk_id` (`user_id`),
  CONSTRAINT `notes_fk_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `like_dislike` (
  ...
  `evidence_subId` int(10) DEFAULT NULL,
  `comment_id` int(10) DEFAULT NULL COMMENT '		',
  `like_count` int(10) DEFAULT NULL,
  `dislike_count` int(10) DEFAULT NULL,
  `user_detail` text,
  PRIMARY KEY (`like_dislike_id`),
  KEY `evsub_fk_id_idx` (`evidence_subId`),
  CONSTRAINT `evsub_fk_id` FOREIGN KEY (`evidence_subId`) REFERENCES `evidence_submission` (`submission_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `institute` (
  ...
  `city_place` varchar(100) DEFAULT NULL,
  `state` varchar(100) DEFAULT NULL,
  `country` varchar(100) DEFAULT NULL,
  `pinzip` int(7) DEFAULT NULL,
...
CREATE TABLE `userdocs` (
  ...
  CONSTRAINT `user_id_Fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `userdocs`
--

LOCK TABLES `userdocs` WRITE;
/*!40000 ALTER TABLE `userdocs` DISABLE KEYS */;
/*!40000 ALTER TABLE `userdocs` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `personal_info` (
  `Personal_Info_id` bigint(11) NOT NULL,
  `email_id` varchar(100) DEFAULT NULL,
  `first_name` varchar(100) DEFAULT NULL,
  `last_name` varchar(100) DEFAULT NULL,
  `father_name` varchar(100) DEFAULT NULL,
  `mother_name` varchar(100) DEFAULT NULL,
  `other_guardian` varchar(100) DEFAULT NULL,
  `gender` varchar(7) DEFAULT NULL,
  `date_of_birth` date DEFAULT NULL,
  `pBirth` varchar(100) DEFAULT NULL,
  `mStatus` varchar(15) DEFAULT NULL,
  `aadhaar_no` bigint(13) DEFAULT NULL,
  `passport_no` varchar(15) DEFAULT NULL,
  `pan_no` varchar(15) DEFAULT NULL,
  `active_status` int(3) DEFAULT '1',
  `cast_category` varchar(10) DEFAULT NULL,
  `religion` varchar(50) DEFAULT NULL,
  `nationality` varchar(100) DEFAULT NULL,
  `language_known` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`Personal_Info_id`),
  KEY `ufk_id_idx` (`email_id`),
  CONSTRAINT `ufk_id` FOREIGN KEY (`email_id`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `patent` (
  `patentId` bigint(11) NOT NULL AUTO_INCREMENT,
  `userId` varchar(100) DEFAULT NULL,
  `patentType` varchar(15) DEFAULT NULL,
  `country` varchar(45) DEFAULT NULL,
  `patentTitle` text,
  `assignee` text,
  `appl_No` int(10) DEFAULT NULL,
  `field` varchar(25) DEFAULT NULL,
  `patentDate` varchar(25) DEFAULT NULL,
  ...
  KEY `P_FK` (`userId`),
  CONSTRAINT `P_FK` FOREIGN KEY (`userId`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `seminars_workshops` (
  `seminars_workshops_id` bigint(11) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(100) DEFAULT NULL,
  `sw_type` varchar(15) DEFAULT NULL,
  `sw_name` text,
  `d_from` varchar(25) DEFAULT NULL,
  `d_to` varchar(25) DEFAULT NULL,
  `venue` varchar(100) DEFAULT NULL,
  `state` varchar(100) DEFAULT NULL,
  `country` varchar(100) DEFAULT NULL,
  `sw_role` varchar(25) DEFAULT NULL,
  `per_type` varchar(25) DEFAULT NULL,
  `paper_title` text,
  `no_coauthors` int(3) DEFAULT NULL,
  `area_theme_topic` text,
  `source_funding` text,
  `amount_funded` bigint(10) DEFAULT NULL,
  `language` varchar(100) DEFAULT NULL,
  `url` text,
  `abstract` text,
  PRIMARY KEY (`seminars_workshops_id`),
  KEY `SW_UID_FK` (`user_id`),
  KEY `usersemi_fk_idx` (`user_id`),
  CONSTRAINT `usersemi_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `seminars_workshops`
--

LOCK TABLES `seminars_workshops` WRITE;
/*!40000 ALTER TABLE `seminars_workshops` DISABLE KEYS */;
/*!40000 ALTER TABLE `seminars_workshops` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_plan_task`
--

DROP TABLE IF EXISTS `user_plan_task`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_plan_task` (
  `plan_id` bigint(11) NOT NULL,
  `task_id` bigint(11) NOT NULL,
  `t_title` text,
  `t_description` text,
  `t_date` varchar(35) DEFAULT NULL,
  `status` int(4) DEFAULT '0',
  PRIMARY KEY (`task_id`),
  KEY `plan_id_FK` (`plan_id`),
  CONSTRAINT `plan_id_FK` FOREIGN KEY (`plan_id`) REFERENCES `user_plan` (`plan_id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_plan_task`
--

LOCK TABLES `user_plan_task` WRITE;
/*!40000 ALTER TABLE `user_plan_task` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_plan_task` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_personal_request`
--

DROP TABLE IF EXISTS `user_personal_request`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_personal_request` (
  ...
  KEY `reqId_fk_uid_idx` (`requestor_id`),
  CONSTRAINT `reqId_fk_uid` FOREIGN KEY (`requestor_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_personal_request`
--

LOCK TABLES `user_personal_request` WRITE;
/*!40000 ALTER TABLE `user_personal_request` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_personal_request` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `thesis_dissertation`
--

DROP TABLE IF EXISTS `thesis_dissertation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `thesis_dissertation` (
  `thesis_dissertation_id` bigint(11) NOT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  `report_type` varchar(35) DEFAULT NULL,
  `programme` varchar(15) DEFAULT NULL,
  `other` varchar(50) DEFAULT NULL,
  `department` text,
  `name_university` varchar(100) DEFAULT NULL,
  `city_state` varchar(100) DEFAULT NULL,
  `country` varchar(100) DEFAULT NULL,
  `thesis_type` varchar(15) DEFAULT NULL,
  `thesis_title` text,
  ...
  `url` text,
  `abstract` text,
  PRIMARY KEY (`thesis_dissertation_id`),
  KEY `TD_UID_FK` (`user_id`),
  KEY `userthesis_fk_idx` (`user_id`),
  CONSTRAINT `userthesis_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `thesis_dissertation`
--

LOCK TABLES `thesis_dissertation` WRITE;
/*!40000 ALTER TABLE `thesis_dissertation` DISABLE KEYS */;
/*!40000 ALTER TABLE `thesis_dissertation` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `profile_references` (
  `references_id` bigint(10) NOT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  ...
  `state` varchar(100) DEFAULT NULL,
  `country` varchar(100) DEFAULT NULL,
  `phoneno` bigint(13) DEFAULT '0',
  `mobileno` bigint(13) DEFAULT NULL,
  `email_id` varchar(100) DEFAULT NULL,
  `website` text,
  `department` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`references_id`),
  KEY `ref_U_ID_FK` (`user_id`),
  CONSTRAINT `ref_U_ID_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `vistingcard`
--

DROP TABLE IF EXISTS `vistingcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vistingcard` (
  `visitcard_id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(70) DEFAULT NULL,
  `display_name` varchar(70) DEFAULT NULL,
  `designation` varchar(45) DEFAULT NULL,
  `company` varchar(100) DEFAULT NULL,
  `mobile` bigint(10) DEFAULT NULL,
  `office_ph` bigint(10) DEFAULT NULL,
  `fax` int(10) DEFAULT NULL,
  `email` varchar(60) DEFAULT NULL,
  `website_off` varchar(80) DEFAULT NULL,
  `website_per` varchar(80) DEFAULT NULL,
  PRIMARY KEY (`visitcard_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vistingcard`
--

LOCK TABLES `vistingcard` WRITE;
/*!40000 ALTER TABLE `vistingcard` DISABLE KEYS */;
INSERT INTO `vistingcard` VALUES (1,'amit@egyankosh.ac.in','Amit  Kumar Dudeja','Progrmmer','Google',9654859011,29571923,1234123,'bunty_dudeja@yahoo.co.in','http://14.139.40.226:8084/ePortfolio','http://www.abc.com');
/*!40000 ALTER TABLE `vistingcard` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `profile_certification` (
  `certification_id` bigint(10) NOT NULL,
  `user_id` varchar(100) DEFAULT NULL,
  `certificationName` text,
  `certificationAuthority` text,
  `license` text,
  `certificationDate` varchar(50) DEFAULT NULL,
  `validDate` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`certification_id`),
  KEY `certificate_u_ID_FK` (`user_id`),
  CONSTRAINT `certificate_u_ID_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `programme` (
  ...
  `programme_name` text,
  `programme_code` varchar(50) DEFAULT NULL,
  `duration` int(5) DEFAULT NULL,
  `overview` text,
  PRIMARY KEY (`programme_id`),
  KEY `instifk_id_idx` (`institute_id`),
  KEY `fk_programme_Dept_idx` (`department_id`),
  CONSTRAINT `fk_programme_Dept` FOREIGN KEY (`department_id`) REFERENCES `department` (`department_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `instifk_id` FOREIGN KEY (`institute_id`) REFERENCES `institute` (`institute_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-11-23 11:33:39
