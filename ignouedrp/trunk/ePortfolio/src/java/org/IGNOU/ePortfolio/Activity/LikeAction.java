 ...
 * @author Amit
 */
public class LikeAction extends ActionSupport implements Serializable, ModelDriven<Object> {
    ...
    public String SaveLike() throws ParseException {
        ...
        if (likedislikelist.isEmpty()) {
            ...
            if (userDetail1.contains(user_id)) {
                ...
                if (Ldval.contentEquals("Like")) {
                    likeCount = likeCount1;
                    dislikeCount = dislikeCount1;
                } else {
                    likeCount = likeCount1 + L;
                    dislikeCount = dislikeCount1 - L;
                    jsonlike.put(user_id, "Like");
                    userDetail1 = jsonlike.toString();
                }
                userDetail = userDetail1;
            } else {
                jsonlike = new JSONObject(userDetail1);
                jsonlike.accumulate(user_id, "Like");
