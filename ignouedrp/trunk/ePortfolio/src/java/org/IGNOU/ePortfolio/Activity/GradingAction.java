 ...
 * @author IGNOU Team
 */
public class GradingAction extends ActionSupport implements Serializable  {
    ...
    private List<ActivitiesSubmission> ActivitiesSubmitedList;
    private List<ActivitiesAnnounce> evList;
     ...
     */
    public List<ActivitiesSubmission> getActivitiesSubmitedList() {
     ...
     */
    public void setActivitiesSubmitedList(List<ActivitiesSubmission> ActivitiesSubmitedList) {
     ...
     * @return the evList
     */
    public List<ActivitiesAnnounce> getEvList() {
        return evList;
    }
     ...
     */
    public void setEvList(List<ActivitiesAnnounce> evList) {
        this.evList = evList;
    }
}
