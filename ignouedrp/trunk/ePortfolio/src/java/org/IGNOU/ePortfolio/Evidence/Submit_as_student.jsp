                            ...
                            <div class="v_gallery">
                                <div class="w98 mar0a">
                                    <div class="w100 fl-l mart10">
                                        <div class="bradcum">
                                            <a href="<s:url value="/Welcome-Index.jsp"/>">Home</a>&nbsp;>&nbsp;<a href="<s:url value="/MyEdudation-Workspace.jsp"/>">My Education and Work</a>&nbsp;><a href="<s:url value="/Evidence/StudentTaskList"/>"> Task /Activity</a>&nbsp;>&nbsp;Submit Task / Activities
                                        </div>
                                        <div class="w100 fl-l">
                                    ...
                                    <div class="w100 fl-l mart10">
                                        <fieldset class="w650p mar0a">
                                            ...
                                            <s:form method="post" name="myform" action="EvSubmision" namespace="/Evidence" theme="simple" enctype="multipart/form-data">
