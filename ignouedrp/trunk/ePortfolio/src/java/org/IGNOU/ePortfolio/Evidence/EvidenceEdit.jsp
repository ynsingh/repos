                                    ...
                                    <div class="w100 fl-l mart20">
                                        <fieldset class="w550p mar0a">
                                            ...
                                            <table class="tablepaging" id="tablepaging" width="100%" cellspacing="0" cellpadding="5" border="1">
                                                <s:form id="FormId" action="UpdateEvidInfo" name="myform" method="post"  theme="simple" namespace="/Evidence" enctype="multipart/form-data">
                                                    <s:iterator value="EvidenceList">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <sj:datepicker id="date0" name="openDate" value="%{openDate}" changeMonth="true" changeYear="true"/>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Closing Date (MM/DD/YY)</td>
                                                            <td> 
                                                                <sj:datepicker id="date1" name="closeDate" value="%{closeDate}" changeMonth="true" changeYear="true"/>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Accept Until</td>
                                                            <td> 
                                                                <sj:datepicker id="date2" name="lastAcceptDate" value="%{lastAcceptDate}" changeMonth="true" changeYear="true"/>
                                                            </td>
                                                        </tr>
                                                        <tr>
