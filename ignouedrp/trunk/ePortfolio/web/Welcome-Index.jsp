                            ...
                            <div class="w100 fl-l mart10">
                                ...
                                <div class="gallery">
                                    <ul id="" class="jcarousel-skin-tango">
                                        ...
                                        <li><a href="" target="_blank"><img src="<s:url value="/icons/course.gif"/>" alt="Corse" /><span>Course</span></a></li>
                                ...
                                <div class="w100 fl-l mart10">
                                    ...
                                    <div class="gallery">
                                      ...
                                      <!--      <li><s:a href="%{ActId}"><img src="<s:url value="/icons/task-activities.gif"/>" width="60" height="60"/><span>Activities</span></s:a></li> -->
                                            ...
                                            <li><a href="<s:url value="/ErrorPage/PageUnderConstruction.jsp"/>"><img src="<s:url value="/icons/institute.gif"/>" alt="Institute" /><span>Institute</span></a></li>
                                            <li><a href="<s:url value="/ErrorPage/PageUnderConstruction.jsp"/>"><img src="<s:url value="/icons/course.gif"/>" alt="Course" /><span>Courses</span></a></li>
