            ...
            <div class="w990p mar0a">
                ...
                <div class="w100 fl-l">
                    <div class="middle_bg">
                        ...
                        <div class="right_box">
                            <div class="my_account_bg">Add Social Networks</div>
                            <div class="v_gallery">
                                <div class="w98 mar0a">
                                    <div class="w100 fl-l mart10">
                                        ...
                                        <div class="w100 fl-l mart10">
                                            <fieldset class="w300p mar0a">
                                                <legend><strong>Add Social Information</strong></legend>
                                                <s:form action="AddSocialInfo" method="post" theme="simple">
                                                    <table width="95%" class="mar0a" cellpadding="0" border="0" cellspacing="0">
                                                        <tr>
