                        ...
                        <div class="right_box">
                            ...
                            <div class="v_gallery">
                                <div class="w100 fl-l mart10">
                                    ...
                                    <div class="bradcum">
                                        <a href="<s:url value="/Welcome-Index.jsp"/>">Home</a>&nbsp;>&nbsp;<a href="<s:url value="/MyEdudation-Workspace.jsp"/>">My Education and Work</a>&nbsp;><a href="<s:url value="/Evidence/StudentTaskList"/>"> Task /Activity</a>&nbsp;> <a href="<s:url value="/Evidence/SubmitedEvi"/>"> Submitted Task / Activities</a>&nbsp;> Comment Reply 
                                    </div>
                                    <% }%> 
                                    <div class="w100 fl-l mart20">
                                        ...
                                        <s:if test="allper!='null'">
                                            <s:form action="ReplyonComment" namespace="/Evidence" theme="simple" method="post" enctype="multipart/form-data">
                                                <fieldset class="w550p mar0a mart10">
