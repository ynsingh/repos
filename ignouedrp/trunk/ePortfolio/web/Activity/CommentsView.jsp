                        ...
                        <div class="right_box">
                            ...
                            <div class="v_gallery">
                                <div class="w100 fl-l mart10">
                                    ...
                                    <div class="bradcum">
                                        <a href="<s:url value="/Welcome-Index.jsp"/>">Home</a>&nbsp;>&nbsp;<a href="<s:url value="/MyEdudation-Workspace.jsp"/>">My Education and Work</a>&nbsp;><a href="<s:url value="/Activity/StudentTaskList"/>"> Task /Activity</a>&nbsp;> <a href="<s:url value="/Activity/SubmitedEvi"/>"> Submitted Task / Activities</a>&nbsp;> View Comments
                                    </div>
                                    <div align="right" class="tab_btn">
                                        <div class="tab_btn_1"><a onclick="history.go(-1);"><img src="<s:url value="/icons/back-arrow.png"/>" class="w25p" /></a></div>
                                        <div class="fl-r">
