                                            ...
                                            <s:iterator value="userDetaillist">
                                                <sj:div id="column1" cssClass="column" sortable="true" sortableConnectWith=".column"
                                                    ...
                                                    <div class="ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
                                                        ...
                                                        <div class="portlet-content">  <s:iterator value="profileSkills" >
                                                                <s:property value="skills"/>,&nbsp;
                                                            </s:iterator>
                                                        </div>
                                                    </div>
                                                    <div class="ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
                                                        <div class="ui-widget-header ui-corner-all"><span class="title">Education</span><span class="ui-icon ui-icon-plusthick"></span></div>
                                                        <div class="portlet-content"><table border="0" align="center" width="100%">
                                                                <tr>
                                                    ...
                                                    <div class="ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
                                                        <div class="ui-widget-header ui-corner-all"><span class="title">Professional Affiliation</span><span class="ui-icon ui-icon-plusthick"></span></div>
