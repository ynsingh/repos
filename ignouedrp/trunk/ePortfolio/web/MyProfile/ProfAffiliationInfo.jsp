    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function() {
                $(".add_affiliation a").click(function() {
                    $("#add_affiliation_form").toggle();
                });
            });
        </script>
    </head>
                        ...
                        <div class="right_box">
                            ...
                            <div class="v_gallery">
                                ...
                                <div class="w100 fl-l">
                                    ...
                                    <div class="add_affiliation fl-r mart20"><a href="#" onclick="show_from()"><img src=" <s:url value="/icons/add.gif"/>" title="Add Qualification"/></a>
                                    </div>
                                </div>
                                <div class="w100 fl-l">
                                    <div class="w100 fl-l tc fbld fcgreen"><s:property value="msg"/></div>
                                    <div id="add_affiliation_form" style="display:none;" class="fl-l w100">
                                    ...
                                    <div class="w100 fl-l">
                                        <table class="tablepaging" id="tablepaging" width="100%" cellspacing="0" cellpadding="5" border="1">
                                            <tr>
                                                ...
                                                <th>Place</th>
                                                <th>Country</th>
                                                <th class="w25p">Edit</th>
                                                <th class="w25p">Delete</th>
                                            </tr>
