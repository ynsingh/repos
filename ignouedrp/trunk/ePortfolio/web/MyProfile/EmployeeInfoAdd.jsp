                                        ...
                                        <s:form action="AddEmploment" method="post" namespace="/MyProfile" name="myform" theme="simple">
                                            <fieldset class="w450p mar0a">
                                                ...
                                                <table width="70%" class="mar0a" cellpadding="4" border="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td>Joining Date</td>
                                                        <td><sj:datepicker readonly="true"  id="date0" name="jdate" changeMonth="true" changeYear="true"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Leaving Date</td>
                                                        <td><sj:datepicker readonly="true"  id="date1" maxDate="-1d" name="ldate" changeMonth="true" changeYear="true"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Description</td>
