                                        ...
                                        <s:form action="AddAffiliation" method="post" namespace="/MyProfile" name="myform" theme="simple">
                                            <fieldset class="w425p mar0a">
                                                ...
                                                <table width="70%" class="mar0a" cellpadding="4" border="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td>Working From</td>
                                                        <td><sj:datepicker id="date0" name="vfrom" changeMonth="true" changeYear="true"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Work Upto</td>
                                                        <td><sj:datepicker id="date1" maxDate="-1d" name="vupto" changeMonth="true" changeYear="true"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Place</td>
