<%-- 
    Document   : ProfAffiliationInfoAdd
    Created on : Oct 14, 2011, 11:13:07 AM
Author     : IGNOU Team
Version      : 1
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Add Professional Affiliation</title>
            ...
            <div class="w990p mar0a">
                ...
                <div class="w100 fl-l">
                    <div class="middle_bg">
                        ...
                        <div class="right_box">
                            <div class="my_account_bg">Add Professional Affiliation</div>
                            <div class="v_gallery">
                                <div class="bradcum"> <a href="<s:url value="/Welcome-Index.jsp"/>">Home</a>&nbsp;>&nbsp;<a href="<s:url value="/MyPortfolio.jsp"/>">My Portfolio</a>&nbsp;>&nbsp;<a href="<s:url value="/MyProfile/MyProfile.jsp"/>">My Profile</a> > <s:a action="ShowAffiliation">Professional Affiliation</s:a>&nbsp;>&nbsp;Add Professional Affiliation </div>
                                ...
                                <div class="w100 fl-l">
                                    ...
                                    <div class="w100 fl-l">
                                        <s:form action="AddAffiliation" method="post" namespace="/MyProfile" name="myform" theme="simple">
                                            <fieldset class="w425p mar0a">
                                                <legend class="fbld">Add Professional Affiliation</legend>
                                                <table width="70%" class="mar0a" cellpadding="4" border="0" cellspacing="0">
                                                    <tr>
                                                        <td width="25%">Role</td>
                                                        <td width="45%"><s:textfield name="role"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Organization/Body</td>
                                                        <td><s:textfield name="orgBody"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Working From</td>
                                                        <td><sj:datepicker readonly="true"  id="date0" name="vfrom" changeMonth="true" changeYear="true"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Work Upto</td>
                                                        <td><sj:datepicker readonly="true"  id="date1" maxDate="-1d" name="vupto" changeMonth="true" changeYear="true"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Place</td>
                                                    ...
                                                    <tr>
                                                        <td>Country</td>
                                                        <td><select name="country" class="w255p">
