        ...
        <div id="container">
            <div class="wrapper">
                ...
                <div id="col2">
                    <h3>My References</h3>
                    <br/><br/>
                    <s:form action="UpdateTest" method="post" namespace="/MyProfile">
                        <s:iterator value="ScoreList" var="Score">
                            <s:hidden name="testId"/><s:hidden name="userId"/>
                            <table align="center" width="75%" cellpadding="4" border="0" cellspacing="0">   
                                <s:textfield cssClass="width250" name="tname" label="Test Name"/>
                                <s:textfield cssClass="width250" name="score" label="Score"/>
                                <s:textfield cssClass="width250 date-picker" name="tdate" label="Date"/>
                                <s:textarea cssClass="width250" name="tdescription" label="Description"/>
                            </table>
                            <br/>
