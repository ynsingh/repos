        ...
        <div id="container">
            <div class="wrapper">
                ...
                <div id="col2">
                    <h3>My References</h3>
                    <br/><br/>
                    <s:form action="UpdateInfo" method="post" namespace="/MyProfile">
                        <s:iterator value="RefList" var="ProRef">
                            <s:hidden name="referencesId"/><s:hidden name="userId"/>
                            <table align="center" width="75%" cellpadding="4" border="0" cellspacing="0">                          
                                ...
                                <s:textfield cssClass="width250" name="phoneno" label="Phone No."/>
