          ...
          <div class="v_gallery">
            <div class="w98 mar0a">
              <div class="w100 fl-l mart10">
                ...
                <div class="w100 fl-l mart10">
                  <div class="w98 maroa tr"> <a href="editAcademic"> <img src="<s:url value="/icons/edit.gif"/>" title="Edit Record"/> </a> <a href="AcademicInfoAdd.jsp"> <img src=" <s:url value="/icons/add.gif"/>" title="Add Qualification"/> </a> </div>
                  <div class="w100 fl-l tc fbld fcgreen">
                    <s:property value="msg"/>
                  </div>
                  <div class="w100 fl-l mart5">
                    <table width="98%" class="mar0a" border="1" cellpadding="4" cellspacing="0">
                      <tr>
                        <th>S.No</th>
