<%-- 
    ...
    Created on : Sep 13, 2011, 5:33:47 PM
Author     : Vinay
Version      : 1
--%>
    ...
    <body><%        
        ...
        <div id="container">
            <div class="wrapper">
                ...
                <div id="col2">
                    <h3>Add Publication Information</h3>
                    <br/>
                    <p align="right">
                    <a href="<s:url value="/MyWorkspace/PublicationInfoAdd.jsp"/>">New Form</a>
                    </p><br/> 
                    <s:form action="AddPublication" method="post" namespace="/MyProfile" name="PublicationForm" onsubmit="return validatePlanForm()">
                        <table align="center" width="75%" cellpadding="4" border="0" cellspacing="0">                          
                            ...
                            <s:textfield cssClass="width250" name="auther1" label="Author 1"/>
                            <s:textfield cssClass="width250" name="auther2" label="Author 2"/>
                            <s:textfield cssClass="width250" name="auther3" label="Author 3"/>
                            <s:textfield cssClass="width250" name="auther4" label="Author 4"/>
