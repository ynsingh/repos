    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function() {
                $(".add_reference a").click(function() {
                    $("#add_reference_form").toggle();
                });
            });
        </script>
    </head>
                        ...
                        <div class="right_box">
                            ...
                            <div class="v_gallery">
                                ...
                                <div class="w100 fl-l">
                                    ...
                                    <div class="add_reference wau fl-r mart10"><a href="#" onclick="show_from()"><img src="<s:url value="/icons/add.gif"/>" align="right" title="Add Reference"/></a></div>
                                </div>
                                <div class="w100 fl-l">
                                    <div id="add_reference_form" style="display:none;" class="fl-l w100">
                                        <fieldset class="w700p mar0a">
                                            <legend><strong>Add References</strong></legend>
                                            <s:form action="AddReferenceInfo" method="post" namespace="/MyProfile" name="myform" theme="simple">
