<%-- 
    Document   : ExtraActivities-Edit
    Created on : Feb 29, 2012, 5:28:46 PM
    Author     : IGNOU Team
--%>
                            ...
                            <div class="v_gallery">
                                <div class="w98 mar0a">
                                    <div class="w100 fl-l mart10">
                                        <div class="bradcum">
                                            <a href="<s:url value="/Welcome-Index.jsp"/>">Home</a>&nbsp;>&nbsp;<a href="<s:url value="/MyEdudation-Workspace.jsp"/>">My Education and Work</a>&nbsp;> <a href="<s:url value="/MyWorkspace/MyWorkspace.jsp"/>">My Workspace</a> &nbsp;> <a href="ShowExt">Extra Activities</a> &nbsp;> Edit Extra Activities
                                        </div> 
                                        <div class="w100 fl-l mart10">
                                            <fieldset class="w600p mar0a">
                                                <legend><strong>Edit Extra Activities</strong></legend>
                                                <s:form action="UpdateExt" method="post" namespace="/MyWorkspace" name="myform" theme="simple">
                                                    <table width="95%" border="0" class="mar0a" cellpadding="2" cellspacing="0">
                                                        <s:iterator value="EXTList">
                                                            <s:hidden name="activitiesId"/>
                                                            <tr>
