<%-- 
    Document   : ProjectInfoAdd
    Created on : Oct 19, 2011, 3:26:15 PM
    Author     : IGNOU Team
    Version      : 1
--%>
            ...
            <div class="w990p mar0a">
                ...
                <div class="w100 fl-l">
                    <div class="middle_bg">
                        ...
                        <div class="right_box">
                            <div class="my_account_bg">Add Project</div>
                            <div class="v_gallery">
                                <div class="w100 fl-l mart10">
                                    <div class="w98 mar0a">
                                        <div class="bradcum"> <a href="<s:url value="/Welcome-Index.jsp"/>">Home</a>&nbsp;>&nbsp;<a href="<s:url value="/MyEdudation-Workspace.jsp"/>">My Education and Work</a>&nbsp;> <a href="<s:url value="/MyWorkspace/MyWorkspace.jsp"/>">My Workspace</a> &nbsp;><a href="ProjectInfo">My Projects</a> &nbsp;>Add Project </div>
                                        <div class="w100 fl-l mart10">
                                            <fieldset class="w600p mar0a">
                                                <legend><strong>Add Project</strong></legend>
                                                <s:form action="AddProjInfo" method="post" namespace="/MyProfile" name="AcademicForm" onsubmit="return validatePlanForm()" theme="simple">
