        ...
        <div id="container">
            <div class="wrapper">
                ...
                <div id="col2">
                    ...
                    <br/>
                    <br/>
                    <s:form action="AddProjInfo" method="post" namespace="/MyProfile" name="AcademicForm" onsubmit="return validatePlanForm()">
                        <table align="center" width="85%" cellpadding="4" border="0" cellspacing="0">
                            ...
                            <s:textfield cssClass="width250 date-picker" name="startDate" label="Start Date"/>
                            <s:textfield cssClass="width250 date-picker" name="endDate" label="End Date"/>
                            <s:textarea cssClass="width250" name="description" label="Description"/>
