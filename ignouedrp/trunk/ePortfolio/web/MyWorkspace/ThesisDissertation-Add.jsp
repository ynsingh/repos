<%-- 
    Document   : ThesisDissertation-Add
    Created on : Feb 21, 2012, 4:43:19 PM
    Author     : IGNOU Team
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Add Thesis / Dissertation</title>
            ...
            <div class="w990p mar0a">
                ...
                <div class="w100 fl-l">
                    <div class="middle_bg">
                        ...
                        <div class="right_box">
                            <div class="my_account_bg">Add Thesis / Dissertation</div>
                            <div class="w100 fl-l mart10">
                                <div class="w98 mar0a">
                                    <div class="bradcum"> <a href="<s:url value="/Welcome-Index.jsp"/>">Home</a>&nbsp;>&nbsp;<a href="<s:url value="/MyEdudation-Workspace.jsp"/>">My Education and Work</a>&nbsp;> <a href="<s:url value="/MyWorkspace/MyWorkspace.jsp"/>">My Workspace</a> &nbsp;> <a href="<s:url value="/MyWorkspace/MyPublications.jsp"/>">My Publication</a> &nbsp;> <a href="showTD">Thesis / Dissertation</a> &nbsp;> Add Thesis / Dissertation </div>
                                    <div class="w100 fl-l mart10">
                                        <fieldset class="w550p mar0a">
                                            <legend><strong>Add Thesis / Dissertation</strong></legend>
                                            <s:form action="AddTD" method="post" namespace="/MyWorkspace" name="">
                                                <table width="95%" border="0" class="mar0a" cellpadding="0" cellspacing="2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="60%"><select name="country" style="width: 200px;">
