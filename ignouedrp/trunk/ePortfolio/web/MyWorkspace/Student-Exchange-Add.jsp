                                            ...
                                            <s:form action="AddExchangeInfo" method="post" namespace="/MyWorkspace" name="" theme="simple">
                                                <table width="95%" border="0" class="mar0a" cellpadding="0" cellspacing="2">
                                                    ...
                                                    <tr>
                                                        <td>Duration:</td>
                                                        <td>From&nbsp;
                                                            <sj:datepicker readonly="true"  id="date0" value="%{durationFrom}" name="durationFrom" cssClass="w80p" changeMonth="true" changeYear="true"/>
                                                            &nbsp;To&nbsp;
                                                            <sj:datepicker readonly="true"  id="date1" value="%{durationTo}" name="durationTo" cssClass="w80p" changeMonth="true" changeYear="true"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Degree Level: </td>
