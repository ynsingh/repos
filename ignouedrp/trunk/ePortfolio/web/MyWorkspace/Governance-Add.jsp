                                            ...
                                            <s:form action="AddGovernance" method="post" namespace="/MyWorkspace" name="" theme="simple">
                                                <table border="0" class="mar0a" cellpadding="0" cellspacing="0" width="90%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>From&nbsp;
                                                            <sj:datepicker readonly="true"  id="date0" name="durationFrom" cssClass="w70p" changeMonth="true" changeYear="true"/>
                                                            &nbsp;To&nbsp;
                                                            <sj:datepicker readonly="true"  id="date1" name="durationTo" cssClass="w70p" changeMonth="true" changeYear="true"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
