<%-- 
    Document   : Patent-Edit
    Created on : Feb 6, 2012, 10:40:21 AM
    Author     : IGNOU Team
--%>
            ...
            <div class="w990p mar0a">
                ...
                <div class="w100 fl-l">
                    <div class="middle_bg">
                        ...
                        <div class="right_box">
                            <div class="my_account_bg">Edit Patent</div>
                            <div class="v_gallery">
                                <div class="w98 mar0a">
                                    <div class="w100 fl-l mart10">
                                        <div class="bradcum">
                                            <a href="<s:url value="/Welcome-Index.jsp"/>">Home</a>&nbsp;>&nbsp;<a href="<s:url value="/MyEdudation-Workspace.jsp"/>">My Education and Work</a>&nbsp;> <a href="<s:url value="/MyWorkspace/MyWorkspace.jsp"/>">My Workspace</a> &nbsp;> <a href="<s:url value="/MyWorkspace/MyPublications.jsp"/>">My Publication</a> &nbsp;> <a href="ShowPatent">Patent</a> &nbsp;> Edit Patent
                                        </div>
                                        <div class="w100 fl-l mart10">
                                        <fieldset class="w600p mar0a">
                                            <legend><strong>Edit Patent</strong></legend>
                                            <s:form action="UpdatePatent" method="post" namespace="/MyWorkspace" id="aform">
                                                <s:iterator value="PatentListList" var="PatentModel">
                                                    <s:hidden name="patentId"/><s:hidden name="userId"/>
                                                    <table width="95%" border="0" class="" cellpadding="0" cellspacing="2" align="center">
                                                        <s:radio name="patentType" label="Patent Type" list="{'National', 'International'}"/>
                                                        <tr>
                                                            <td width="35%">If International, select</td>
                                                            <td width="60%">
                                                            ...
                                                            <s:iterator value="inventors">   
                                                                <s:hidden name="idInventor"/>
                                                                <s:textfield name="fname" label="Inventor Last Name" disabled="true"/>
                                                                <s:textfield name="lname" label="Inventor First Name" disabled="true"/>
                                                                <s:textarea name="address" label="Address of Inventor" disabled="true"/>
                                                            </s:iterator>
                                                        <tr><td colspan="2" align="center"><font color="#FF0000">To change Inventor details, first delete the record and add as new entry.</font></td></tr>
