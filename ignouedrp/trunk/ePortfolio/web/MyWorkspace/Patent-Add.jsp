<%-- 
    Document   : Patent-Add
    Created on : Dec 15, 2011, 3:19:33 PM
    Author     : IGNOU Team
    Version    : 1
--%>
            ...
            <div class="w990p mar0a">
                ...
                <div class="w100 fl-l">
                    <div class="middle_bg">
                        ...
                        <div class="right_box">
                            <div class="my_account_bg">Add Patent</div>
                            <div class="w100 fl-l mart10">
                                <div class="w98 mar0a">
                                    <div class="bradcum"> <a href="<s:url value="/Welcome-Index.jsp"/>">Home</a>&nbsp;>&nbsp;<a href="<s:url value="/MyEdudation-Workspace.jsp"/>">My Education and Work</a>&nbsp;> <a href="<s:url value="/MyWorkspace/MyWorkspace.jsp"/>">My Workspace</a> &nbsp;> <a href="<s:url value="/MyWorkspace/MyPublications.jsp"/>">My Publication</a> &nbsp;> <a href="ShowPatent">Patent</a> &nbsp;> Add Patent </div>
                                    <div class="w100 fl-l mart10">
                                        <fieldset class="w600p mar0a">
                                            <legend><strong>Add Patent</strong></legend>
                                            <s:form action="AddPatent" method="post" namespace="/MyWorkspace" id="aform">
                                                <table width="95%" border="0" class="mar0a" cellpadding="0" cellspacing="2">
                                                    <s:radio name="patentType" list="{'National','International'}" label="Patent Type" />
                                                    <tr>
