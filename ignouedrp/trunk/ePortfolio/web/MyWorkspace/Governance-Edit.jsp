                                                    ...
                                                    <table border="0" class="mar0a" cellpadding="2" cellspacing="0" width="90%">
                                                        <s:iterator value="GovernanceListList" var="GovernanceModel">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>From&nbsp;
                                                                    <sj:datepicker readonly="true"  id="date0" name="durationFrom" value="{durationFrom}" cssClass="w70p" changeMonth="true" changeYear="true"/>
                                                                    &nbsp;To&nbsp;
                                                                    <sj:datepicker readonly="true"  id="date1" name="durationTo" value="{durationTo}" cssClass="w70p" changeMonth="true" changeYear="true"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
