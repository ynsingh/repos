                                                ...
                                                <s:form action="UpdateTL" method="post" namespace="/MyWorkspace" name="" theme="simple">
                                                    <table width="95%" border="0" class="mar0a" cellpadding="2" cellspacing="0">
                                                        <s:iterator value="TLList">
                                                            ...
                                                            <tr>
                                                                <td>Delivered on:</td>
                                                                <td><sj:datepicker id="date0" name="deleveredOn" value="%{deleveredOn}" changeMonth="true" changeYear="true"/></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Time:</td>
                                                                <td><sj:datepicker id="time0" name="timeFrom" value="%{timeFrom}" timepicker="true" timepickerShowSecond="true" timepickerFormat="hh:mm:ss" timepickerOnly="true" cssClass="w55p" showOn="focus"/>
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;To&nbsp;&nbsp;&nbsp;
                                                                    <sj:datepicker id="time1" name="timeTo" value="%{timeTo}" timepicker="true" timepickerShowSecond="true" timepickerFormat="hh:mm:ss" timepickerOnly="true" cssClass="w55p" showOn="focus"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
