<%-- 
    Document   : Invited-Talks-Edit
    Created on : Feb 17, 2012, 5:03:06 PM
    Author     : IGNOU Team
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Edit Invited Talks / Guest Lectures</title>
            ...
            <div class="w990p mar0a">
                ...
                <div class="w100 fl-l">
                    <div class="middle_bg">
                        ...
                        <div class="right_box">
                            <div class="my_account_bg">Edit Invited Talk / Lecture</div>
                            <div class="v_gallery">
                                <div class="w98 mar0a">
                                    <div class="w100 fl-l mart10">
                                        <div class="bradcum">
                                            <a href="<s:url value="/Welcome-Index.jsp"/>">Home</a>&nbsp;>&nbsp;<a href="<s:url value="/MyEdudation-Workspace.jsp"/>">My Education and Work</a>&nbsp;> <a href="<s:url value="/MyWorkspace/MyWorkspace.jsp"/>">My Workspace</a> &nbsp;> <a href="<s:url value="/MyWorkspace/MyPublications.jsp"/>">My Publication</a> &nbsp;> <a href="showTL">Invited Talk/Guest Lectures</a> &nbsp;>Edit Invited Talk/Guest Lectures 
                                        </div>
                                        <div class="w100 fl-l mart10">
                                            <fieldset class="w650p mar0a">
                                                <legend><strong>Edit Invited Talk/Guest Lectures</strong></legend>
                                                <s:form action="UpdateTL" method="post" namespace="/MyWorkspace" name="" theme="simple">
                                                    <table width="95%" border="0" class="mar0a" cellpadding="2" cellspacing="0">
                                                        <s:iterator value="TLList">
                                                            <s:hidden name=" talkLectureId"/><s:hidden name="userId"/>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td>Delivered on:</td>
                                                                <td><sj:datepicker readonly="true"  id="date0" name="deleveredOn" value="%{deleveredOn}" changeMonth="true" changeYear="true"/></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Time:</td>
                                                                <td><sj:datepicker readonly="true"  id="time0" name="timeFrom" value="%{timeFrom}" timepicker="true" timepickerShowSecond="true" timepickerFormat="hh:mm:ss" timepickerOnly="true" cssClass="w55p" showOn="focus"/>
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;To&nbsp;&nbsp;&nbsp;
                                                                    <sj:datepicker readonly="true"  id="time1" name="timeTo" value="%{timeTo}" timepicker="true" timepickerShowSecond="true" timepickerFormat="hh:mm:ss" timepickerOnly="true" cssClass="w55p" showOn="focus"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
