        ...
        try
        {
            ...
            //while(true)
            {
                ...
                if (received.equals("Yes would like to connect"))
                {
                    ...
                    received = dis.readUTF();// read the random number and certificate of the far end
	                  ...
	                  if(flag)
	                {
	                	...
	                	byte[] key_partone = encrypt_msg.encrypt_message(Farend_public, key_part);
	         		 	...
	         		 	sym_key = symmetric_key.longkey(randmkey_farend, own_randm);// combine own and farend random nos for generating kay
