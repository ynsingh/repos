...
//
//public class GenerateIpList {
//	Collection<String> key_extracted = IdexManagement.			/// code to extract hash_id from array by first converting it into collection then to an array
