...
/**
 *   StudentCaptureDeviceDialog.java
...
public class StudentCaptureDeviceDialog extends Dialog implements ActionListener, ItemListener {
  	...
  	protected StudentCaptureDeviceDialog(Frame parent, String title, boolean mode) {
