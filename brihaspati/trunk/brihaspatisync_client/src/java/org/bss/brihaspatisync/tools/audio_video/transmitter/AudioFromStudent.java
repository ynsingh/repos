...
public class AudioFromStudent {
	...
	private int portBase=RuntimeDataObject.getController().getAudioHandraisePort();
	...
	System.out.println("AudioFromStudent stop successfully");
    }
