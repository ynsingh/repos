...
public class LocalServer implements Runnable {
	...
	public void run() {
		while(flag) {
				...
				HttpMethod method = new GetMethod("http://localhost:8090");
				...
				try {
					if(image!=null) {
						...
						VideoPanel.getController().runDesktopSharing(image);
					}
				} catch(Exception e){ System.out.println("Error in loding image in video_panel : "+e.getMessage()); }
