...
HTMLArea.Config = function () {
	...
	this.popupURL = "../../popups/Fckpopups/";
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID) {
	    ...
	    case "showhelp" : window.open(_editor_url + "../popups/Fckpopups/reference.html", "ha_help"); break;
...
HTMLArea.prototype.popupURL = function(file) {
	...
	if (file.match(/^plugin:\/\/(.*?)\/(.*)/)) {
		...
		if (!/\.html$/.test(popup))
			popup += ".html";
		url = _editor_url + "plugins/" + plugin + "/../popups/Fckpopups/" + popup;
	} else
