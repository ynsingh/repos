...
public class Post_Get_StudentVideo implements Runnable {
	...
	public Post_Get_StudentVideo(String lecture_id){
		...
		try {
			...
			while(flag) {
				try {
					...
					try {
		                        	if(image_new!=null){
                                        		buffer_mgt.putByte(image_new,client_ip,"stud_video"+lecture_id);
