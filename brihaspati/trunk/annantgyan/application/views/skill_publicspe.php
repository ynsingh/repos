...
<div class="container ">
	<h2 style="text-align: center;text-decoration:underline;"> Public Speaking Skills</h2>
	<div class="col-md-12"  id="card">
	 	...
	 	<p  style="color: black;font-size: 18px;">
	 		We shall offer online training program for public speaking skills for all interested individuals/ colleges/ organizations. Our team of professionals will also provide offline support to different colleges and organizations.
	 	</p>
	 	
    </div>
<div class="row">
    	<div class="col-md-12">
    		<img src="<?php echo base_url('images/Public-Speaking.png');?>" style="width: 100%;" id="card">
    	</div>
