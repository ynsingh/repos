	...
	<div class="col-md-12" id='card'>
		...
		<table class="table table-bordered">
			<thead style="font-size: 18px;">
				<tr  class="info">
					<th>Sr. No.</th><th>Name</th><th>Email</th><th>Phone</th><th>Place</th><th>School/College/Organisation Name</th> <th>A/c No.</th><th>IFSC Code</th>
				</tr>
			</thead>
			<tbody>
				<?php 
				...
				<tr>
								...
								<td><?php echo $row->ref_place;?></td>
								<td><?php echo $row->ref_orgname;?></td>
								<td><?php echo $row->ref_bank_acno;?></td>
								<td><?php echo $row->ref_bank_ifsc;?></td>
