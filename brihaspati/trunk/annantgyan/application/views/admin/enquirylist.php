...
<div class="container">
	<center><h2>Enquiry List</h2></center>
...
-->		
		...
		<table class="table table-bordered">
			<thead style="font-size: 18px;">
				<tr  class="info">
					<th>Sr. No.</th><th>Name</th><th>Mobile</th><th>Email</th><th>Interest</th><th>Other Query</th> <th>Date</th>
				</tr>
			</thead>
			<tbody>
				<?php 
				...
				<tr>
								...
								<td><?php echo $row->en_mobile;?></td>
								<td><?php echo $row->en_email;?></td>
								<td><?php echo $row->en_interestin;?></td>
								<td><?php echo $row->en_otherquery;?></td>
