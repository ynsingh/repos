...
<div class="container ">
	<h2 style="text-align: center;text-decoration:underline;"> Effective Communication Skills</h2>
	<div class="col-md-12"  id="card">
	 	...
	 	<p  style="color: black;font-size: 18px;">
	 		We shall offer online training program for  effective communication skills for all interested individuals/ colleges’ organizations.
	 	</p>
	 	
    </div>
  <div class="row">
    	<div class="col-md-12">
    		<img src="<?php echo base_url('images/Effective-Comm.jpg');?>" style="width: 100%;" id="card">
    	</div>
