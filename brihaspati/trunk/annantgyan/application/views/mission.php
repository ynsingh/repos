...
<head>
	...
	<title>Annant Gyan</title>
      ...
      <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/js/bootstrap.min.js"></script>-->
        ...
        <script src="<?php echo base_url('assets/js/1.12.4jquery.min');?>"></script>
...
<div class="container ">
	<h2 style="text-align: center;text-decoration:underline;">Vision</h2>
	<div class="col-md-12" id="card" >
	 	

		<p style="color: #79522f;font-size: 24px;text-decoration:underline;">Vision</p>
