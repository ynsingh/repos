...
public class ReflectorStatusManager 
{
	...
	protected static String searchElement(String userid,String sessionid,String RoleId) {
	...
	protected static String Register(String userid,String sessionid,String RoleId){
		String message_ip="";
		try{
			DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
                        DocumentBuilder builder = factory.newDocumentBuilder();
	...
	protected static void updateStatusPeer(String userid){
		userid=userid.trim();
		try {
			DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
			DocumentBuilder builder = factory.newDocumentBuilder();
