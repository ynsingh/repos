...
================================================== -->
    ...
    <header class="jumbotron subhead" id="overview">
        <div class="container">
            <h1>Brihaspati General Accounting System</h1>
        </div>
    </header>
         <!-- Docs nav
    ================================================== -->
        <div class="row-fluid">
			...
			<li><a href="#ChangeAccount"><i class="icon-chevron-right"></i>Change Account</a></li>
	            ...
	            <li><a href="#ManageUsers"><i class="icon-chevron-right"></i>Manage Users</a></li>
		    <li><a href="#MySQLAdminSetting"><i class="icon-chevron-right"></i>MySQL Admin Setting</a></li>
       		    <li><a href="#AccountsFunctionality"><i class="icon-chevron-right"></i>Accounts Functionality</a></li>
...
<font size="4">
 <ol>
<p align="justify" STYLE="line-height: 150%">
Trial blalance is a list of all the General ladger accounts.  This list will contain the name of ladger account and the value
