...
<?php
	...
	echo "<br>";
	echo "<b>Rejection Date</b> : "."<span class=\"value\">".$vc_date."</span>";
	echo "</td>";
	...
	echo "</table>";
  	...
  	$this->db->select('approved_by')->from('bill_approval_status')->where('bill_no',$bill_no)->where('status',"Approved")->order_by('id','asc');
        $approv_dbase = $this->db->get();
        if($approv_dbase->num_rows() > 0)
	{   
		echo "<td valign=\"top\">";
        	echo "<table width=\"100%\" border=\"1\" style=\"color: black; border-collapse:collapse; border:1px solid #000000;\">";
	...
	echo "<td align=\"center\" style=\"background-color:#efe3b5;\"><b>Rejected By</b></td>";
        echo "<tr>";
        echo "<td>$us_name</td>";
        echo "</tr>";
