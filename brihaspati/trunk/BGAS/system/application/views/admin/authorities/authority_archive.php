...
echo "<thead><tr><th>Authority</th><th>User Name</th><th>User Email</th><th>From Date</th><th>Till Date</th><th>Type</th></tr></thead>";
echo "<tbody>";
$odd_even = "odd";
...
echo "</table>";
echo "<br />";
echo anchor('admin/authorities/auth_allocation', 'Back', array('title' => 'Back to Manage Authority Allocation'));
