<?php
	...
	$this->db->from('settings');
        ...
        echo "<thead><tr><th></th><th align=\"center\" colspan=\"5\">GROSS BLOCK</th><th align=\"center\" colspan=\"4\">DEPRECIATION BLOCK</th><th align=\"center\" colspan=\"2\">NET BLOCK</th></tr></thead>";
	 $this->db->select('name,code,id')->from('ledgers')->where('group_id',152);
        ...
        echo "<tr>";
                ...
                echo "<td>Dep/Amortization Opening <br> Balance </td>";
                echo "<td>Depreciation/</br>Amortization <br> for the Year</td>";
		 echo "<td> Deductions/ <br> Adjustment</td>";
                echo "<td> Total <br> Depreciation<br>Amortization</td>";
