...
xmlhttp.open("GET","gms.xml",false);
xmlhttp.send();
...
<div id="content">
                <div style="width:67%; margin-top:-1px;">
		...
		<p>
		 <?php
                ...
                echo    "<input name='filenm' type='hidden' value='gms.xml'/>";
                echo "<input name='redirect' type='hidden' value='gms.php'/>";
...
if( empty($_SESSION['username']) )
		...
		var count = i+1 
                ...
                document.write(">");
                document.write(" GMS SERVER"+count);
