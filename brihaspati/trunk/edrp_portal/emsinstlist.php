...
xmlhttp.open("GET","emsinstlist.xml",false);
xmlhttp.send();
...
<tr>
        ...
        { 
		     ...
		     <td>
		        <a href='ems.php'  title='Go To PAYROLL'>CHOME</a> | 
			</td>
			 <td>
                        <a href='emsmod.php'  title='Go To MODULE OF PAYROLL'>COMPONENT MODULE</a> |
                        </td>
			 <td>
                        <a href='emsinstlist.php'  title='Go To INSTITUTE OF PAYROLL'>LIST OF INSTITUTE</a> 
                        </td>
</tr></table>
</div>
<div id="content">
<div id ="columnC">
        <div>
        <div style="width:60%; margin-top:-10px;font-size:14px;color:#333;line-height:160%;">
                   <?php
               ...
               <?php
                ...
                echo    "<input name='filenm' type='hidden' value='emsinstlist.xml'/>";
                echo "<input name='redirect' type='hidden' value='emsinstlist.php'/>";
...
<?php
                 if(! empty($_SESSION['username']) )
                {?>
<div style="width:56%;float:right;margin-top:-17%;margin-right:-44%">
 <?php
                }else{
?>
                <div style="width:49%;float:right;margin-top:-4%;margin-right:-38%">
<?php
                }
?>
