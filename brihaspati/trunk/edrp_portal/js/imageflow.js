...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		aspectRatio:        1.904,          /* Aspect ratio of the ImageFlow container (width divided by height) */
		...
		percentLandscape:   144,            /* Scale landscape format */
		...
		startID:            6,              /* Image ID to begin with */
	...
	this.init = function (options)
	{
		...
		if(ImageFlowDiv)
		{
			...
			ImageFlowDiv.style.visibility = 'hidden';
	...
	this.loadingStatus = function()
	{
		...
		if(my.circular)
		{
			...
			completed = (finished < 100) ? 0 : Math.round((i/100)*finished);
		}
		...
		for (var index = 0; index < my.max; index++)
		{
			...
			if(my.imageScaling)
			{
				...
				else
				{
					...
					image.style.right = xs - (image.pc / 2) / z * my.size + 'px';
	...
	this.Slideshow =
	{
		...
		stop: function()
		{
			...
			window.clearInterval(my.Slideshow.action, 25000);
