...
xmlhttp.open("GET","bsync.xml",false);
xmlhttp.send();
...
<div id="content">
		...
		<p>
		 <?php
                ...
                echo    "<input name='filenm' type='hidden' value='bsync.xml'/>";
                echo "<input name='redirect' type='hidden' value='bsync.php'/>";
                ...
                <span style="float:right;color:#333;margin-top:-145px;">
                <script type="text/javascript">
                        for (i=0;i<x.length;i++)
                         {               
...
if( empty($_SESSION['username']) )
		...
		var count = i+1 
                ...
                document.write(">");
                document.write(" BrihaspatiSync Server"+count);
