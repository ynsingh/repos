...
CREATE TABLE `items_issued` (
  ...
  `ii_itemindexno` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL, 
...
CREATE TABLE `items_return` (
  ...
  `ir_itemindexno` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL, 
...
CREATE TABLE `inspection_report` (
  ...
  `inr_creatorname` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `inr_creatordate` date NOT NULL,
  `inr_modifiername` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `payment_order` ( 
	...
	`pay_remark` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL , 
	`pay_checkno` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL , 
	`pay_paymethod` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL , 
	`pay_bank` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL , 
	`pay_accountno` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL , 
	`pay_creatordate` DATE NOT NULL , 
	`pay_creatorname` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , 
	`pay_modifiername` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , 
...
CREATE TABLE `stock_item_transfer` ( 
	...
	`sit_name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , 
	`sit_itemindexno` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL, 
	`sit_qty` INT(5) NOT NULL , 
	`sit_uprice` FLOAT(10,2) NOT NULL , 
	`sit_totalprice` FLOAT(10,2) NOT NULL , 
	`sit_desc` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , 
	`sit_todept` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , 
	`sit_toemppf` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , 
	`sit_toreceiver` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , 
	`sit_trfdate` DATE NOT NULL , 
	`sit_remark` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , 
	`sit_creatorname` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , 
	`sit_creatordate` DATE NOT NULL , 
	`sit_modifiername` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , 
...
CREATE TABLE `item_index` ( 
	...
	`itemmtid` INT(11) NOT NULL,
	`itemid` INT(11) NOT NULL , 
	`itemno` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , 
	`itemstatus` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL , 
	PRIMARY KEY (`id`), 
	UNIQUE (`itemno`)
) ENGINE = InnoDB;
