    ...
    <table width="100%">
         <tr align="left">
             <td width="7%">
				 ...
				 <td width="7%">
				 <?php echo anchor('leavemgmt/rejectedreq/', "Rejected Leave", array('title' => 'Rejected Leave Requests' ,'class' =>'top_parent'));?>
				 </td>
				 <?php
					 echo "<td align=\"center\">";
					 echo "<b>Pending Leave Requests</b>";
					 echo "</td>";
				 ?>
            ...
            <thead>
					<tr>
                     ...
                     <th width="2%">To Date</th>
							<th width="2%">Leave Days</th>
			 				<th width="3%">Leave Remaining (Days)</th>
         	...
         	?>
               ...
               ?>
					...
					<td><?php echo anchor('leavemgmt/approve/' . $row['leaveid'] , "Approve",array('onclick' => "return confirm('Are you sure you want to approve leave request')")) . " ";?>/
                   					 	
				   <?php echo anchor('leavemgmt/reject/' . $row['leaveid'] , "Reject", array('title' => 'Reject Leave Requests' ,'class' =>'top_parent'));?>
					</td>
