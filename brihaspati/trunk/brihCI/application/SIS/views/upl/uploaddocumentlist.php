...
<br/></br>
	...
	<table border=0>
		...
		<tr align="left">
			...
			<td>
				<select class="my_dropdown" id="subprfid" name="subprofile" style="width:300px;" required> 
		...
		<tr align="left">
                <td><label for="role_name" class="control-label">PF No:</label></td>
                <td>
                <input type="text" name="pfno"  class="form-control" size="35" required/><br>
                </td>
            </tr>
		<tr align="left">
			<td>
	 ...
	 <table   style="font-size:15px;" >
            <tr><td><b>Note : The file extension should be in png or pdf. </b>
            </td>
            </tr>
	...
	<table>	
            ...
            <tr>
                ...
                <td align="left"></td><td>
                <button name="adddocumentlist" >Add document list</button>
