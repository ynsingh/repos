<!--@name add_recmethddata.php  @author Nagendra Kumar Singh(nksinghiitk@gmail.com) -->
 ...
 <html>
    ...
    <body>
            ...
            <tr>
                <?php
                    ...
                    if($this->roleid == 4){
                        ...
                        echo anchor('report/performance_profile/awards/'.$this->emp_id, 'View Profile ', array('class' => 'top_parent'));
                    }
                    echo "</td>";
            
                    echo "<td align=\"center\" width=\"34%\">";
                    echo "<b>Add Staff Award Details</b>";
                    echo "</td>";
        ...
        <div> 
            <form id="myform" action="<?php echo site_url('empmgmt/add_awarddata/'.$this->emp_id);?>" method="POST" enctype="multipart/form-data">
            ...
            <table style="width:100%; border:1px solid gray;" align="center" class="TFtable">
                <tr><thead><th  style="color:white;background-color:#0099CC; text-align:left; height:30px;" colspan=63">&nbsp;&nbsp; Add Staff Award Details</th></thead></tr>
                <tr></tr><tr></tr>
		<tr>
		    ...
		    <td>
                            <input type="text" name="awardtitle" id="awardtitle" value="" size="40" >
                    </td>
                </tr>
		...
		<option selected="selected" disabled selected>------------ Awarded By---------</option>
		    ...
		    <td>
                ...
                <tr style="color:white;background-color:#0099CC; text-align:left; height:30px;">
                    <td colspan="3">
                    <button name="addawarddata" >Submit</button>
