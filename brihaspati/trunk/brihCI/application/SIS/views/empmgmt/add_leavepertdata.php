...
/*******uoc on the basis of campus*****************************************************************************/
 ...
 /************************select schemes on the basis of department*******************/
    ...
    <body>
        ...
        <div> 
            <form id="myform" action="<?php echo site_url('empmgmt/add_leavepertdata/'.$this->emp_id);?>" method="POST" enctype="multipart/form-data">
		...
		<tr>
                    ...
                    <td>
                            <input type="text" name="layear" id="layear" value="<?php echo isset($_POST["layear"]) ? $_POST["layear"] : ''; ?>" size="40" required>
                    </td>
                </tr>
...
-->
                ...
                <tr style="color:white;background-color:#0099CC; text-align:left; height:30px;">
                    <td colspan="3">
                    <button name="addleavedata" >Submit</button>
