<!--@name add_servicedata.php  @author Manorama Pal(palseema30@gmail.com) -->
 ...
 <html>
    ...
    <body>
            ...
            <tr>
                <?php
                    ...
                    if($this->roleid == 4){
                        ...
                        echo anchor('report/deputation_profile/'.$this->emp_id, 'View Profile ', array('class' => 'top_parent'));
                    }
                    echo "</td>";
            
                    echo "<td align=\"center\" width=\"34%\">";
                    echo "<b>Add Deputation Details</b>";
                    echo "</td>";
        ...
        <div> 
            <form id="myform" action="<?php echo site_url('empmgmt/add_deputatdata/'.$this->emp_id);?>" method="POST" enctype="multipart/form-data">
            ...
            <table style="width:100%; border:1px solid gray;" align="center" class="TFtable">
                <tr><thead><th  style="color:white;background-color:#0099CC; text-align:left; height:30px;" colspan=63">&nbsp;&nbsp; Add Deputation Details</th></thead></tr>
                <tr></tr><tr></tr>
                <tr>
