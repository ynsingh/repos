 ...
 <html>
            ...
            <tr>
                <?php
                    ...
                    if($this->roleid == 4){
                        ...
                        echo anchor('report/performance_profile/trainingorgna/'.$this->emp_id, 'View Profile ', array('class' => 'top_parent'));
                    }
                    echo "</td>";
	...
	<tr>
		...
		<option selected="selected" disabled selected>------------ Select Sub Type of Programme ---------</option>
		    ...
		    <td>
                            <input type="text" name="partno" id="partno" value="" size="40" >
                    </td>
                </tr>
                <tr>
                    <td>Nature of Participant<font color='Red'></font></td>
		    <td>
                            <input type="text" name="naturep" id="naturep" value="" size="40" >
                    </td>
                </tr>
                <tr></tr><tr></tr>
                <tr style="color:white;background-color:#0099CC; text-align:left; height:30px;">
                    <td colspan="3">
                    <button name="addstodata" >Submit</button>
