<!--@name add_recmethddata.php  @author Nagendra Kumar Singh(nksinghiitk@gmail.com) -->
 ...
 <html>
    <title>Recruitment Method Details</title>
    <head>
    ...
    <body>
        <table width="100%">
            <tr>
                <?php
                    ...
                    echo "<b>Add Recruitment Method Details</b>";
                    echo "</td>";
        ...
        <div> 
            <form id="myform" action="<?php echo site_url('empmgmt/add_recmethddata/'.$this->emp_id);?>" method="POST" enctype="multipart/form-data">
            ...
            <table style="width:100%; border:1px solid gray;" align="center" class="TFtable">
                <tr><thead><th  style="color:white;background-color:#0099CC; text-align:left; height:30px;" colspan=63">&nbsp;&nbsp; Add Recruitment Method Details</th></thead></tr>
                <tr></tr><tr></tr>
		<tr>
