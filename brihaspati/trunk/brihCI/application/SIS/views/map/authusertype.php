...
<table style="margin-left:10px;">
     ...
     <form action="<?php echo site_url('map/authusertype');?>" method="POST" class="form-inline">
			...
			<option value="Full Time" class="dropdown-item">Full Time</option>
                        ...
                        <td><input type="text"placeholder="From Date" name="map date" id="StartDate"  size="27" value="<?php echo isset($_POST["map_date"]) ? $_POST["map_date"] : ''; ?>"/><br> </td>
                        </tr>
                        <tr>

                        
                        
                        <td><label>Till Date:</label></td>
                        <td><input type="text"placeholder="Till Date" name="till date" id="EndDate"  size="27" value="<?php echo isset($_POST["map_date"]) ? $_POST["till_date"] : ''; ?>"/><br> </td>
                        </tr>
                        <tr>
