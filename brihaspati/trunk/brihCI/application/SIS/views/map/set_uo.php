<!--@name set_uo.php  @author Shivani  -->
...
/************************select department on basis of uo and campus*******************/
    ...
    <body>
        ...
        <table width="100%"> 
            <tr><td>  
                <?php echo anchor('map/uolist/', "UO List ", array('title' => 'View Detail' , 'class' => 'top_parent'));?>
               <?php
                 echo "<td align=\"right\">";
        ...
        <table>
            <form action="<?php echo site_url('map/setuo');?>" method="POST">
                <tr>
                ...
                <td></td>
                <td colspan="2">   
                    <button name="setuo">Submit</button>
