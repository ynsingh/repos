...
<html>
    <head>
        <title>View Payroll Leave Entry</title>
...
*/
	...
	$uname=$this->session->userdata('username');
        ...
        echo "<b>Staff Leave Entry Payroll Profile Details</b>";
        echo "</td>";
...
<?php	//		print_r($record); ?>
			    ...
			    <td><?php 
                                    $ename=$this->sismodel->get_listspfic1('employee_master','emp_name','emp_id',$record->sle_empid)->emp_name;
					echo $ename;
                                    $ecode=$this->sismodel->get_listspfic1('employee_master','emp_code','emp_id',$record->sle_empid)->emp_code;
                                    echo " ( "."PF No:".$ecode." )";
				    $eddo=$this->sismodel->get_listspfic1('employee_master','emp_ddoid','emp_id',$record->sle_empid)->emp_ddoid;
                                    $ddo=$this->sismodel->get_listspfic1('ddo','ddo_name','ddo_id',$eddo)->ddo_name;
                                    echo "<br/> DDO:".$ddo;
                                    $edept=$this->sismodel->get_listspfic1('employee_master','emp_dept_code','emp_id',$record->sle_empid)->emp_dept_code;
                                    $dept=$this->commodel->get_listspfic1('Department','dept_name','dept_id',$edept)->dept_name;
                                    echo "<br/> Dept :".$dept;
                                    $eschid=$this->sismodel->get_listspfic1('employee_master','emp_schemeid','emp_id',$record->sle_empid)->emp_schemeid;
