<!--@filename transfersalaryslip.php  @author Manorama Pal(palseema30@gmail.com) -->

<?php defined('BASEPATH') OR exit('No direct script access allowed');?>
<html>
    <head>
        <title>Welcome to Transfer salary slip</title>
            ...
            <table class="dggh" width="50%" border="1"  heignt="50%" cellpadding=10 style="float:left;border-width: thin;border-spacing: 2px;border-style: none;" bgcolor="#95a5a6"> 
                ...
                <tr>
                    ...
                    <td><?php 
                        ...
                        <?php else :?>
                        <?php // endif; ?>
                        <?php $finalval=$headval[0]->shdv_defaultvalue* $fromdays/$nodaysmonth; // if($incomedata->sh_calc_type == 'N' && $headval[0]->shdv_defaultvalue != 0):?>
                        <input type="text" class="headamtI" name="headamtI<?php echo $i;?>" id="headamtI<?php echo $i;?>"  value="<?php  echo (round($finalval,2));  ?>" >
                ...
                <tr>
                     ...
                     <?php foreach($deduction as $deductdata){ ?>
                        ...
                        <?php else :?>
                            <?php $finalval=$headval[0]->shdv_defaultvalue * $fromdays/$nodaysmonth;?>
                            <input type="text"  class="headamtD" name="headamtD<?php echo $j;?>" id="headamtD<?php echo $j;?>"  value="<?php echo (round($finalval,2));  ?>" >
             ...
             <table class="dggh" width="50%" border="1"  heignt="50%" cellpadding=10 style="float:left;border-width: thin;border-spacing: 2px;border-style: none;" bgcolor="#95a5a6"> 
                ...
                <tr>
                    ...
                    <td><?php 
                        ...
                        <?php else :?>
                        <?php // endif; ?>
                        <?php $finalval=$headval[0]->shdv_defaultvalue * $trnasitdays/$nodaysmonth; // if($incomedata->sh_calc_type == 'N' && $headval[0]->shdv_defaultvalue != 0):?>
                        <input type="text" class="headamtI" name="headamtI<?php echo $i;?>" id="headamtI<?php echo $i;?>"  value="<?php  echo (round($finalval,2));  ?>" >
                        <?php // $sumincome+=$headval[0]->shdv_defaultvalue;
                             $sumincome+=$finalval;
                        ?>
                ...
                <tr>
                     ...
                     <?php foreach($deduction as $deductdata){ ?>
                        ...
                        <?php  $sumdeduction+=$finalval; // endif;?> 
                        <?php else :?>
                            <?php $finalval=$headval[0]->shdv_defaultvalue * $trnasitdays/$nodaysmonth;?>
                            <input type="text"  class="headamtD" name="headamtD<?php echo $j;?>" id="headamtD<?php echo $j;?>"  value="<?php echo (round($finalval,2));  ?>" >
                            <?php $sumdeduction+=$finalval; //$sumdeduction+=$headval[0]->shdv_defaultvalue;?>
                        <?php endif;?>    
                            <?php else : ?>
            ...
            <table class="dggh" width="50%" border="1"  heignt="50%" cellpadding=10 style="float:left;border-width: thin;border-spacing: 2px;border-style: none;" bgcolor="#95a5a6"> 
                ...
                <tr>
                    ...
                    <td><?php 
                                ...
                                if($incomedata->sh_id == $ccaid || $incomedata->sh_id == $hraid){
                                    if($incomedata->sh_id == $ccaid){
                                      ...
                                      //  echo "in cca condition=====";
                                       ...
                                       // $ccagrade=$headval2[0]->ste_ccato;
                                        
                                        //$ccagrade=$this->sismodel->get_listspfic1('salary_transfer_entry','ems_ccagrade','ems_empid',$empid);
                                        if(!empty($ccaval)){
                        ...
                        <?php else :?>
                        <?php // endif; ?>
                        <?php $finalval=$headval[0]->shdv_defaultvalue * $todays/$nodaysmonth; // if($incomedata->sh_calc_type == 'N' && $headval[0]->shdv_defaultvalue != 0):?>
                        <input type="text" class="headamtI" name="headamtI<?php echo $i;?>" id="headamtI<?php echo $i;?>"  value="<?php  echo (round($finalval,2));  ?>" >
                        <?php // $sumincome+=$headval[0]->shdv_defaultvalue;
                             $sumincome+=$finalval;
                        ?>
                ...
                <tr>
                     ...
                     <?php foreach($deduction as $deductdata){ ?>
                        ...
                        <?php  $sumdeduction+=$finalval; // endif;?> 
                        <?php else :?>
                            <?php $finalval=$headval[0]->shdv_defaultvalue * $todays/$nodaysmonth;?>
                            <input type="text"  class="headamtD" name="headamtD<?php echo $j;?>" id="headamtD<?php echo $j;?>"  value="<?php echo (round($finalval,2));  ?>" >
                            <?php $sumdeduction+=$finalval; //$sumdeduction+=$headval[0]->shdv_defaultvalue;?>
                        <?php endif;?>    
                            <?php else : ?>
