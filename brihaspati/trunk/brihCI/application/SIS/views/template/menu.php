...
//				echo "<a href=" . base_url() . ">Dashboard</a>";
			...
			echo "<li>";
				...
				echo "<ul>";
                                        echo "<li>";
                                                echo anchor('staffmgmt/staffprofile', 'Staff Profile', array('title' => 'Staff Profile'));
                                        echo "</li>";
                                        echo "<li>";
		...
		/*			echo "<li>";
			...
			echo "<li>";
				...
				echo "<ul>";
					echo "<li>";
						echo anchor('archive/authority', 'Authority Archive', array('title' => 'Authority Archive'));
					echo "</li>";
			/*		echo "<li>";
