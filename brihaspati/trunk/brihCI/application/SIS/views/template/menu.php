					...
					echo "<li>";
                                ...
                                //		                echo anchor('setup3/employeetype_list', 'Post Type', array('title' => 'Post Type'));
                                  //                      echo "</li>";
                                                        ...
                                                        echo "</li>";
                                                         echo "<li>";
                                                		echo anchor('setup3/rentrecovery', 'Rent Recovery for Govt. Quarters', array('title' => 'Rent Recovery for Goverment Quarters'));
                                                        echo "</li>";
                                                         echo "<li>";
                                                		echo anchor('setup3/cca_allowance', 'CCA Allowance Calculation', array('title' => 'CCA Allowance Calculation'));
                                                        echo "</li>";
                                        		echo "<li>";
