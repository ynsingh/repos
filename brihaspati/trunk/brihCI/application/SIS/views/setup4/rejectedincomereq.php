...
<title>View Reject User Saving Requests</title>
  <head>
         ...
         <tr align="left">
             <td width="15%">
                                 ...
                                 <?php
                                         ...
                                         echo "<b>Reject User Saving Master Requests</b>";
                                         echo "</td>";
                                 ?>
...
<div class="scroller_sub_page">
   <table class="TFtable">
		...
		<td> <font color="red"><?php echo "Rejected"; ?></font> </td>
                    ...
                    echo "<td colspan=\"20\" align=\"center\"> No Records found...!</td>";
                    }?>
                </tbody>
   </table>
                        </div>
