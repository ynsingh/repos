   ...
   public function searchemp_profile($tbname,$worktype,$keyword)
    {
       ...
       $this->db4->select('emp_id,emp_code,emp_name,emp_scid,emp_uocid,emp_dept_code,emp_desig_code,emp_email,emp_phone,emp_aadhaar_no')->from('employee_master')->where("emp_name LIKE '$keyword%'")->where("emp_worktype", $worktype);
        return $this->db4->get()->result();
    }
