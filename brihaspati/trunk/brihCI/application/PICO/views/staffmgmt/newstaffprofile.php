        ...
        <table style="margin-left:5%;width:90%;border:1px solid gray;" class="TFtable">
           ...
           <!-- <tr><td>
            ...
            <td><label for="ddo" style="font-size:15px;">Drawing and Disbursing Officer<font color='Red'>*</font></label>
                ...
                <td><label for="worksubtype" style="font-size:15px;">Working SubType<font color='Red'>*</font></label>
                        <div><select id="worktypeid" name="worksubtype" required> 
                        <option selected="selected" disabled selected>------------- Working SubType --------------</option>
                        <option value="Teaching">Teaching</option>
                        <option value="NON-Teaching">NON Teaching</option>
                    </select></div>
                </td> 
           ...
           <!--<tr style="height:10px;"></tr>-->
            ...
            <tr>
                ...
                <td><label for="orderno" style="font-size:15px;"> Application Order No</label>
                    <div><input type="text" name="orderno"  value="<?php echo isset($_POST["orderno"]) ? $_POST["orderno"] : ''; ?>" placeholder=" application order No..." size="30">
                </div></td>
            ...
            <tr>
 			...
 			<?php endforeach; ?>
                ...
                <td><label for="caste" style="font-size:15px;">Caste</label>
                    <div><input type="text" name="caste" value="<?php echo isset($_POST["caste"]) ? $_POST["caste"] : ''; ?>" placeholder="Caste..." size="30" >
                </div></td>
            ...
            <tr>
 			...
 			<?php endforeach; ?>
                ...
                <td><label for="basicpay" style="font-size:15px;">Basic Pay</label>
                    <div><input type="text" name="basicpay"  class="keyup-numeric" value="<?php echo isset($_POST["basicpay"]) ? $_POST["basicpay"] : ''; ?>" placeholder="Basic pay..." size="35" >
                </div></td> 
            ...
            <tr>
                ...
                <div><input type="text" name="phdetail" class="keyup-characters" value="<?php echo isset($_POST["phdetail"]) ? $_POST["phdetail"] : ''; ?>" placeholder="Details of PH..." size="35">
                </div></td>
                ...
                <td><label for="empnhisidno" style="font-size:15px;">NHIS ID No</label>
                    <div><input type="text" name="empnhisidno" class="keyup-characters" value="<?php echo isset($_POST["empnhisidno"]) ? $_POST["empnhisidno"] : ''; ?>" placeholder="NHIS ID NO..." size="30">
                </div></td>
            ...
            <tr>
                ...
                <td><label for="dateofhgp" style="font-size:15px;">Date of HGP</label>
                    <div><input type="text" name="dateofhgp" id="Dateofhgp1" value="<?php echo isset($_POST["dateofhgp"]) ? $_POST["dateofhgp"] : ''; ?>" class="form-control" size="30" />
                </div></td>
            ...
            <tr>
                ...
                <td><label for="dateofphd" style="font-size:15px;">Date of Phd Completion</label>
                    <div><input type="text" name="dateofphd" id="Dateofphd"  value="<?php echo isset($_POST["dateofphd"]) ? $_POST["dateofphd"] : ''; ?>" size="35" />
                </div></td>    
            ...
            <tr>
                ...
                <td><label for="bankacno" style="font-size:15px;">Bank ACC No<font color='Red'>*</font></label>
                   <div><input type="text" name="bankacno" class="keyup-characters" value="<?php echo isset($_POST["bankacno"]) ? $_POST["bankacno"] : ''; ?>" placeholder="Bank Acc No..." size="30" required="required">
                </div></td>
            ...
            <tr>
                ...
                <td><label for="phonemobileno" style="font-size:15px;">Phone/Mobile</label>
                    <div><input type="text" name="phonemobileno" class="keyup-numeric" value="<?php echo isset($_POST["phonemobileno"]) ? $_POST["phonemobileno"] : ''; ?>" placeholder="Phone/Mobile No..." size="33" >
                </div></td>
                <td><label for="mothertongue" style="font-size:15px;">Mother Tongue</label>
                    <div><input type="text" name="mothertongue"  class="keyup-characters" value="<?php echo isset($_POST["mothertongue"]) ? $_POST["mothertongue"] : ''; ?>" placeholder="Mother Tongue..." size="30" >
                </div></td> 
            ...
            <tr>
                ...
                <td><label for="Address" style="font-size:15px;">Address</label>
                    <div><textarea name="Address" value="<?php echo isset($_POST["Address"]) ? $_POST["Address"] : ''; ?>"   rows="5" cols="43" required pattern="[a-zA-Z0-9 ]+">Enter text here...</textarea>
