...
<html>
<title>Purchase Proposal|Gem-Form</title>
 <head>    
            ...
            var count=1;
                ...
                $("#addrow1").on("click", function () {
                  ...
                  //  cols += '<td><input type="text" name="srno[]" id="srno" value="" size="3" readonly></td>';
                    ...
                    cols += '<td><input type="text" name="stock[]" id="stock"  size="5"></td>';
...
<body>
    ...
    <form id="myform" action="<?php echo site_url('intender/proposal_gem_entry');?>" method="POST" class="form-inline" autocomplete="OFF" enctype="multipart/form-data">
			<table class="TFtable" >
			    <tr>
        ...
        <table  id="myTable1"  class="TFtable" align="center">
            ...
            <tbody>    
                <tr>
                    ...
                    <td><input type="text" name="stock[]" id="stock"  size="5"></td>
        ...
        <table class="TFtable">
             <tr><th colspan="4"><u>Suggested Supplier:</u></th></tr>
              <tr>
                    ...
                    <td>
                        <select name="pp_vid" id="vendorname"class="my_dropdown">
                        <option selected="" disabled="" value="" style="width: 100% ;">-------------------Select-----------------</option>
                        <?php
                           foreach ($ven as $row) {      
                        ?>
                    ...
                    <td>
                        ...
                        <?php
                           {      
                        ?>
                        <option value="<?php echo $row->vendor_id ?>"><?php echo 'filled';?></option>
                        <?php
                        }
                        ?>
                        </select>
            ...
            <table class="TFtable">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="pp_Date" >Days 
                     
                        <input type="text" name="pp_DateFrom" id="DateFrom"  size="30" placeholder="From Date" > &nbsp; &nbsp;
                        <input type="text" name="pp_DateTo" id="DateTo" size="30" placeholder="To Date">
                    </td>
                </tr>
                <tr >
