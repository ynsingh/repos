...
<table width="100%">
   <tr colspan="2"><td>
	...
	<?php
            ...
            echo "<b>Tender Apply Archive Details</b>";
            echo "</td>";
    	?>
...
<!--	ta_id	ta_tcid	ta_approvedstatus	ta_byname	ta_bydesig	archive_date -->
            <tbody>
                    <?php $count =0?>
                    <?php foreach($taa as $row) 
			{ 
		        echo "<tr>";
		...
		//	echo "</td>";
                  //      echo "<td>". $this->logmodel->get_listspfic1('authorities','name','id',$row->depta_uoid)->name . "</td>";
                        echo "<td>" . $row->ta_id. "</td>";
                        echo "<td>" . $row->ta_tcid . "</td>";
                        echo "<td>" . $row->ta_approvedstatus . "</td>";
                        echo "<td>" . $row->ta_byname . "</td>";
                        echo "<td>" . $row->ta_bydesig. "</td>";
                        echo "<td>" . $row->archive_date. "</td>";
