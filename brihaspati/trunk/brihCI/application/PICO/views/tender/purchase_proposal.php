...
<body>
  ...
  <table class="TFtable">
                ...
                <tr>
                    ...
                    <td>
                         <textarea name="pp_payterm" style="width:100%;height:100px;" readonly placeholder="Give Payment terms here..."><?php echo $tt->ta_payment ?></textarea>
                    </td>
                </tr>
                   <?php
                        }
        ...
        <table class="TFtable" id="myTable2">
            ...
            <tr>
             ...
             <tr>    <?php foreach($proposal as $e) {  ?>
                    <td>     <center><?php echo $e->pp_budgetprojno ;?> </center> </td>
                    <td>      <center><?php echo $e->pp_budgethead ;?> </center> </td>
                    <td>    <center>  <?php echo $e->pp_budgetamt ;?> </center> </td>
                   <?php }  ?>
                </tr>
