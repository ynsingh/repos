...
//                                echo "</li>";
		...
		echo "<li>";
			echo "<a href=" . ">Recieve & Store</a>";
                        echo "<ul>";
                	        echo "<li>";
                                      	echo anchor('picosetup/openitemtype', 'Item Received', array('title' => 'Item Received'));
                                echo "</li>";
                	        echo "<li>";
                                      	echo anchor('picosetup/', 'Item Issued', array('title' => 'Item Issued'));
                                echo "</li>";
                	        echo "<li>";
                                      	echo anchor('picosetup/', 'Item Return', array('title' => 'Item Return'));
                                echo "</li>";
                	        echo "<li>";
