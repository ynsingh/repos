			...
			echo "<a href=" . ">Intender Process</a>";
                ...
                //                echo "<li>";
                  //                      echo anchor('setup3/salhead_config', 'Create Indent', array('title' => 'Purchase Process'));
                    //            echo "</li>";
                	        echo "<li>";
                                      	echo anchor('intender/a_1', 'Inspection Report', array('title' => 'Item Inspection Report'));
                                echo "</li>";
                        echo "</ul>";
		echo "</li>";
		echo "<li>";
            ...
            //                    echo "<li>";
              //                       	echo anchor('setup3/salhead_config', 'Bid/Quote Opening', array('title' => 'Purchase Process'));
                //                echo "</li>";
                                ...
                                echo "</li>";
                                echo "<li>";
                                      	echo anchor('tender/proposals', 'Purchase Proposal', array('title' => 'Purchase Proposal'));
                                echo "</li>";
                                echo "<li>";
                                        echo anchor('intender/gem_proposals', 'Purchase Approval via GeM', array('title' => 'Purchase Approval via GeM'));
				echo "</li>";
                                echo "<li>";
                                     	echo anchor('tender/purchaseproposals', 'Purchase Order', array('title' => 'Purchase Process'));
                                echo "</li>";
                	        echo "<li>";
                                echo "</li>";
			echo "</ul>";
			...
			echo "<a href=" . ">Recieve & Store</a>";
                        echo "<ul>";
                	        ...
                	        echo "<li>";
                                ...
                                echo "</li>";
                	        echo "<li>";
                                      	echo anchor('intender/inspection_report_display', 'Inspection Report', array('title' => 'Item Inspection Report'));
                                echo "</li>";
                	        echo "<li>";
