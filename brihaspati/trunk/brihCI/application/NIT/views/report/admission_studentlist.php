...
<?php if (isset($student_data)) {?>
	...
	<tbody>
		...
		?>
			<tr>
				...
				<td><?php //echo $this->commodel->get_listspfic1('student_admissionstep','jee_mainno','student_masterid',$asmid)->jee_mainno;
	...
	<?php }	}else{ ?><td colspan=15 style="text-align:center;">No Record Found !!!!</td><?php }?>
			<tr>
