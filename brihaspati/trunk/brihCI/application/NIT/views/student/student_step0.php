...
?>	
	   ...
	   <table>
		<tr><td><label for="username">JEE Main Number</label>
        	<!--<label for="username">Hall Ticket Number</label>--></td>
		</td><td>
		
        	<input type="text" name="Sanumber" placeholder="Enter Your JEE Main Number" autofocus value="<?php echo isset($_POST["Sanumber"]) ? $_POST["Sanumber"] : ''; ?>"/> <br>
		</td></tr>
		<tr><td><label for="username">JEE Application Number</label>
        	<!--<label for="username">Hall Ticket Number</label>--></td>
		</td><td>
		
        	<input type="text" name="Sjeeanumber" placeholder="Enter Your JEE Application Number" autofocus value="<?php echo isset($_POST["Sjeeanumber"]) ? $_POST["Sjeeanumber"] : ''; ?>"/> <br>
		</td></tr>	
		<!---<tr ><td>
		...
		<!--<tr><td><label for="text">Date of Birth</label>
