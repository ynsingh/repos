...
<tr>
   ...
   <form action="<?php echo site_url('Downloads/admission_student'); ?>" method="POST">
   	<table>
		<tr>
			<td>
...
<?php if (isset($student_data)) {?>
	...
	<tbody>
		...
		if(!empty($student_data)){
			...
			$progcatid = $this->commodel->get_listspfic1('program','prg_category','prg_id',$prgcatid)->prg_category;
