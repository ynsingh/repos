...
//		 echo "<a style=\"text-decoration:none\" target=\"_blank\" href=$help_uri><b>Click for Help</b></a>";
        ...
        <tbody>
           <?php //$serial_no = 1;
		 $scid=0;$departid=0;$prgbr=0;
		if( count($subsemrec) ): 
		foreach($subsemrec as $row){ 	
		
			
			if($departid !=$row->subp_dept){
			?>
				<tr>
					...
					<b>Department :</b> 
                     	...
                     	<?php $departid =$row->subp_dept;
			
			}
			if($prgbr != $row->subp_degree){
	   		 	echo "<tr align=\"center\">";
	    			echo "<td colspan=9 style='font-size:18px;'>"; echo "<b>Programme Name : </b>";
				echo $this->commodel->get_listspfic1('program','prg_name','prg_id',$row->subp_degree)->prg_name; 
				echo "&nbsp"."&nbsp";
		     ...
		     <td><?php echo $this->commodel->get_listspfic1('subject','sub_name','sub_id',$row->subp_sub_id)->sub_name ?></td>
                   ...
                   <!-- <td><?php //echo $this->commodel->get_listspfic1('program','prg_name','prg_id',$row->subp_degree)->prg_name ?></td>
                    ...
                    <td><?php echo $row->subp_sem; ?></td>
                     <td><?php echo $row->subp_acadyear; ?></td>
