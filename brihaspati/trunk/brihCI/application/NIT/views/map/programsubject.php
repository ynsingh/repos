...
echo "<html>";
echo "<head>";
echo "<title>".'Program Subject List'."</title>";
...
<?php
   ...
   // echo "<thead><tr align=\"left\"><th>Sr. No </th><th>Paper Programme Category</th><th>Degree</th><th>Branch </th><th>Paper Name</th><th>Paper No</th><th>Paper Code</th><th>Paper Short Name</th><th>Semester</th><th>Academic Year </th><th>Subject Name</th><th>Available Action</th></tr></thead>";
	echo "<thead><tr align=\"left\"><th>Sr. No </th><th>Subject Name</th><th>Paper Name</th><th>Paper No</th><th>Paper Code</th><th>Paper Short Name</th><th>Semester</th><th>Academic Year </th><th>Desciption</th><th>Available Action</th></tr></thead>";
...
foreach($paperrecords as $row)
{
	...
	if($prgcatid != $row->subp_prgcat){
	    echo "<tr align=\"center\">";
	    	echo "<td colspan=11 style='font-size:18px;'>"; echo "<b>Programme Category : </b>";
		echo $this->commodel->get_listspfic1('programcategory','prgcat_name','prgcat_id',$row->subp_prgcat)->prgcat_name; echo"</td>";
	    echo "</tr>";
	$prgcatid = $row->subp_prgcat;
	$srno = 1;	
	}

	if($prgbr != $row->subp_degree){
	    echo "<tr align=\"center\">";
	    	echo "<td colspan=10 style='font-size:18px;'>"; echo "<b>Programme Name : </b>";
		echo $program_name; 
		echo "&nbsp"."&nbsp";
		echo "<b>Programme Branch : </b>";
		echo $this->commodel->get_listspfic1('program','prg_branch ','prg_id',$row->subp_degree)->prg_branch; echo"</td>";
	    echo "</tr>";
	$prgbr = $row->subp_degree;
	$srno = 1;	
	}
    ...
    echo "<td>"; echo $row->subp_sem; echo"</td>";	
    echo "<td>"; echo $row->subp_acadyear; echo"</td>";
    echo "<td>"; echo $row->subp_desp; echo"</td>";	
