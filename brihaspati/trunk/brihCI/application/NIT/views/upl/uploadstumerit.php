...
//	echo "<div>";
	...
	echo "<br>";
	echo "JEE application no,entrance exam name,JEE Main no,course name,branch name,student name,student DOB ,student email,father name,marks,admission quota,category,meritlist no,last date of admission";
	echo "<br>";
	echo "123456,JEE,858697,Master Of Science,Civil,Ram Kumar,1989-01-01,ramkumar@iitk.ac.in,Mohan Kumar,400,General,General,1,2017-08-27";
	echo "</b>";
	echo "</div>";
	echo "</div>";
