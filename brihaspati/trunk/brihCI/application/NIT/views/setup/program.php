...
<tr>
	<?php 
  	...
  	echo anchor('setup/viewprogram/', "Program List" ,array('title' => 'Program List' , 'class' => 'top_parent'));
	echo "</td>";
 
        echo "<td align=\"center\" width=\"34%\">";
        echo "<b>Add Program Details</b>";
        echo "</td>";
...
?>
    ...
    <table>
    <tr>
        <!--<td><label for="prgcampus">Select Campus</label><label>Choose your University:</label></td>-->
        <td>
