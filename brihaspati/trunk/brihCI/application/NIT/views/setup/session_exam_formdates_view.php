...
<table style="width:100%;">
	...
	if(!empty($getdatelist)){
         foreach($getdatelist as $row)  
         {
            ...
            //$count = $count + 1;
//  echo  $row->sed_campuscode;
	//$orgid = $this->common_model->get_listspfic1('org_profile','org_id','org_code',$row->sed_campuscode)->org_id;
	if($scid !=$row->sed_campuscode){
           ...
           <!-- <td><?php //echo $this->common_model->get_listspfic1('study_center','sc_name','sc_id',$row->sed_campuscode)->sc_name;?></td>-->
