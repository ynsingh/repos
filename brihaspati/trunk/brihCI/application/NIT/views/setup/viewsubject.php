...
<?php
    ...
    echo "</div>";
    echo "</table>";;
    echo '<div class="scroller_sub_page">';
/* form data */
         echo "<table border=0  class=\"TFtable\">";
         echo "<thead><tr><th>Sr. No </th><th>Subject Name</th><th>Subject Code </th><th>Subject Short Name</th><th>Semester</th><th>Subject Type</th><th>Subject Credit</th><th>Subject Extention</th><th>Subject Description</th><th>Action</th></tr></thead>";
	 $prgid = 0;
	 $srno = 0;
	...
	//$progid = $this->common_model->get_listspfic1('program','prg_id','prg_name',$row->fm_programid)->prg_id;
