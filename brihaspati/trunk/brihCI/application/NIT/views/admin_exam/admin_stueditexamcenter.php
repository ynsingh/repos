<!--
 * @name admin_stueditexamcenter.php
...
function calculate() {
 ...
 <table width="100%">
		 ...
		 <?php
                    ...
                    echo "<b>Update Exam Center Details</b>";
                    echo "</td>";
            	?>
	</tr>
</table>
...
<table>
         <?php
            ...
            echo form_open('adminstuexam/stu_editexamcenter/' . $id);


            echo "<tr>";
                echo "<td>";
                echo form_label('Exam Center Name', 'eec_code');
                echo "</td>";
                echo "<td>";
		...
		echo "<tr>";
                echo "<td>";
                echo form_label('Exam Center Name', 'eec_name');
                echo "</td>";
                echo "<td>";
		...
		echo "<tr>";
                echo "<td>";
                echo form_label('Exam Center Address', 'eec_address');
                echo "</td>";
                echo "<td>";
		...
		<?php
                echo "<td>";
                echo form_label('Exam Center Incharge', 'eec_incharge');
                echo "</td>";
                echo "<td>";
		...
		echo "<tr>";
                echo "<td>";
                echo form_label('Exam Center Number of Room', 'eec_noofroom');
                echo "</td>";
                echo "<td>";
		...
		echo "<tr>";
                echo "<td>";
                echo form_label('Exam Center Capacity in Room', 'eec_capacityinroom');
                echo "</td>";
                echo "<td>";
		...
		echo "<tr>";
                echo "<td>";
                echo form_label('Exam Center Total Capacity', 'eec_totalcapacity');
                echo "</td>";
                echo "<td>";
		...
		echo "<tr>";
                echo "<td>";
                echo form_label('Exam Center Contact No', 'eec_contactno');
                echo "</td>";
                echo "<td>";
		...
		echo "<tr>";
                echo "<td>";
                echo form_label('Exam Center Contact Email', 'eec_contactemail');
                echo "</td>";
                echo "<td>";
