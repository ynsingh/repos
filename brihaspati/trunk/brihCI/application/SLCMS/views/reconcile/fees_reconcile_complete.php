...
<table width="27%;" style="float:left;">
	<tr><td style=""><a href="<?php echo site_url('reconcile/fees_nonreconcile');?>" style="font-weight:bold; margin-left:50px;"> Non Reconcile Fees</td>
        <td style=""><a href="<?php echo site_url('reconcile/fees_reconcile_complete');?>" style="font-weight:bold; margin-left:50px;" id="allf">All Fees</td>
	<td style=""><a href="<?php echo site_url('reconcile/fees_reconcile');?>" style="font-weight:bold; margin-left:50px;" id="reconcile">Reconcile Fees</td>
	</tr>
</table>
</br></br></br></br>
