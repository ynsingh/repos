...
?>
<table class="TFtable">
<form name="marksupload1" id="marksupload1" action="<?php echo site_url('Faculty/studentmarks');?>" method="POST" class="form-inline">
     ...
     foreach($studentdetail as $record){ ?>  
      ...
      <!--  <td>
        ...
        <td>
            <?php
            ?>
            <!--<input type="text" name="marks<//?php echo $i;?>"  $id="m2" size="5" class="keyup-numeric" value="<//?php echo isset($_POST["marks".$i]) ? $_POST["marks".$i] : '0'; ?>" required="required"/>-->
        ...
        <td>
            <?php
            ?>
            <!--<input type="text" name="grade<?//php echo $i;?>"  size="5" maxlength ="1" class="keyup-characters" value="<//?php echo isset($_POST["grade".$i]) ? $_POST["grade".$i] : ''; ?>" required="required"/>-->
