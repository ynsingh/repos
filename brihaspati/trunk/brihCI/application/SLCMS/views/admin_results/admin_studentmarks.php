...
<table width="100%">
		...
		<?php
			...
			echo anchor('admin_studentresult/studentsviewmarks/', "View Student Marks" ,array('title' => 'Student Marks ' , 'class' => 'top_parent'));
                    echo "</td>";
...
<form name="marksupload" id="marksupload" action="<?php echo site_url('admin_studentresult/studentmarks');?>" method="POST" class="form-inline">
...
<input type="text" name="mmarks"  id="m1" size="5" class="keyup-numeric" value="<?php echo isset($_POST["mmarks"]) ? $_POST["mmarks"] : ''; ?>" required/>
</td>
<!--<td>
	...
	<tr>
     ...
     foreach($studentdetail as $record){ ?>  
        ...
        <td><?php
                           ...
                           // echo "<input type=\"text\" name=\"stumid$i\" value=$record->sp_smid>"; 
                   ?>
		<input type="hidden" name="stumid<?php echo $i;?>" value="<?php echo $record->sp_smid;?>">
        </td>
        <td><?php 
      ...
      <!--  <td>
        ...
        <td>
            <?php
            ?>
            <input type="text" name="marks<?php echo $i;?>"  id="m2" size="5" class="keyup-numeric" value="<?php echo isset($_POST["marks".$i]) ? $_POST["marks".$i] : ''; ?>" required="required" />
        ...
        <td>
            <?php
            ?>
            <input type="text" name="grade<?php echo $i;?>"  size="5" maxlength ="1" class="keyup-characters" value="<?php echo isset($_POST["grade".$i]) ? $_POST["grade".$i] : ''; ?>" required />
