...
<form action="<?php echo site_url('request/exam_regi'); ?>"  method="POST">
   ...
   border-radius:50px 0px 0px 50px;box-shadow: 0px 5px 10px 0px #888888;">
...
<table style="width:90%;">
	...
	<tr>
	    ...
	    <input type="text" name="Exemail" placeholder="Enter Your Email-Id" style="" value="<?php echo $this->email; ?>" readonly/>		
		<td/>
...
<img src="<?php echo base_url('uploads/student_sign_photo/student_photo/'.$this->phresult); ?>" height="200" width="200" style="float:right;"></td></tr>
</table>
...
<tr height=30></tr>-->
	...
	<table class="TFtable" id="academic" style="width:90%;text-align:left;">	
...
?>
		<table class="TFtable" id="" style="width:90%;text-align:left;">		
			<thead id="styleTable"><th colspan=7>
			Title of the papers
			</th></thead>
			<thead id="">
