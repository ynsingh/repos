 ...
 <table width= "100%">
     ...
     <form action="<?php echo site_url('setup/fees');?>" method="POST" class="form-inline">
			...
			<select name="program" style="width:100%;">
                        ...
                        <option value="<?php echo $datas->prg_name; ?>"><?php echo $datas->prg_name."(".$this->common_model->get_listspfic1('program','prg_branch','prg_id',$datas->prg_id)->prg_branch.")"; ?></option>
                        <?php endforeach; ?>
                        </select>
                        </td></tr>
			<?php
