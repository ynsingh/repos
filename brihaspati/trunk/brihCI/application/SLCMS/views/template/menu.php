...
*/
			...
			echo "<li>";
                                ...
                                echo "<ul>";
                                        ...
                                        echo "</li>";
                                        echo "<li>";
						echo anchor('adminstuexam/viewattsheet', 'Attandence Sheet Generation', array('title' => 'Attandence Sheet Generation'));
                                        echo "</li>";
                                        echo "<li>";
			...
			echo "<li>";
				...
				echo "<ul>";
					...
					echo "</li>";
					echo "<li>";
						echo anchor('Attendencereport/attendencereport', 'Attendence Report', array('title' => 'Attendence Report'));
					echo "</li>";
				/*	echo "<li>";
