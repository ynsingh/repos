...
<table style="width:100%;font-size:18px;">
	<tr>
		<td align=center><b>Student NoN-Verified Data</b></td>
	</tr>	
</table>
<?php echo validation_errors('<div class="isa_warning">','</div>');?>
   ...
   <form action="<?php echo site_url('adminadmissionstu/adminstu_nonverified'); ?>" method="POST">
   	<table style="width:90%;">
		...
		<td align=left style="font-size:18px;">
			...
			<select name="stu_nondept" style="font-size:18px;height:30px;">
			...
			<input type="submit" name="nonsearch" value="Search" style="height:30px;font-size:18px;">
		</td>
...
<table style="width:100%;" class="TFtable">
	<thead>
		<tr>
			...
			<th>Email-id</th><th>Mobile No.</th><th>Category</th><th>Department</th><th>Program & Branch</th><th>Status</th>
		</tr>
	</thead>
	<tbody>
...
$count = 1;
	if(!empty($stusmid)){
		foreach($stusmid as $data){
			//print_r($stu_deptdata);
