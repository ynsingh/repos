...
<form action="<?php echo site_url('student/student_admissionform'); ?>"  method="POST">
	...
	<table style="width:100%;">
		...
		<td>	
			...
			<select name="stu_addprgcate"  style="font-size:18px;">
				<!--
		...
		<td>	
			...
			<select name="stu_addcourse" id="degree" style="font-size:18px;">
				<?php
				$stu_prgname = $prgname;
				$stu_prgid = $this->commodel->get_listspfic1("program","prg_id","prg_name",$stu_prgname)->prg_id;
				?>
				<option value="<?php echo $stu_prgid;?>"><?php echo $prgname.'( '.$branchname.' )';?></option>
	  		</select>
			<!--<select name="stu_addcourse" id="degree" style="font-size:18px;">
	...
	<tr>
		<td>
				...
				<select name="stu_adddepart"  style="font-size:18px;">
    ...
    $(function () {
		...
		<td>	
			...
			<select name="stu_addabgroup"  style="font-size:18px;" >
