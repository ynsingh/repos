...
<form action='' method='POST'>
	<table style="width:100%;font-size:22px;" border=1>
		...
		<tr>
			<td style="padding:10px 0px 10px 20px;">Name of Student (BLOCK LETTERS):</td>
		</tr>
		<tr>
		...
		<table style="width:100%;font-size:22px;" border=1 id='secondtb'>
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c1" name="cb" value='Original' class="example">
      					 <label for="c1"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c2" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c3" name="cb" value='Original' class="example">
      					 <label for="c3"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c4" name="cb" value='Duplicate' class="example">
...
certificate or marks sheet)<input type="hidden" name="stu_check3" style=" " value="DOB proof" readonly></td>
				<td>
   					 <input type="checkbox" id="c5" name="cb" value='Original' class="example">
      					 <label for="c5"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c6" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c7" name="cb" value='Original' class="example">
      					 <label for="c7"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c8" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c9" name="cb" value='Original' class="example">
      					 <label for="c9"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c10" name="cb" value='Duplicate' class="example">
...
attended</td>
				<td>
   					 <input type="checkbox" id="c11" name="cb" value='Original' class="example">
      					 <label for="c11"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c12" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c13" name="cb" value='Original' class="example">
      					 <label for="c13"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c14" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c15" name="cb" value='Original' class="example">
      					 <label for="c15"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c16" name="cb" value='Duplicate' class="example">
...
qualifying exam in years prior to the current academic year)
				...
				<td>
   					 <input type="checkbox" id="c17" name="cb" value='Original' class="example">
      					 <label for="c17"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c18" name="cb" value='Duplicate' class="example">
...
Issued by the competent authority in case of SC/ST candidates
				...
				<td>
   					 <input type="checkbox" id="c19" name="cb" value='Original' class="example">
      					 <label for="c19"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c20" name="cb" value='Duplicate' class="example">
...
competent authority indicating the status regarding creamy layer
				...
				<td>
   					 <input type="checkbox" id="c21" name="cb" value='Original' class="example">
      					 <label for="c21"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c22" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c23" name="cb" value='Original' class="example">
      					 <label for="c23"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c24" name="cb" value='Duplicate' class="example">
...
business rules]
				...
				<td>
   					 <input type="checkbox" id="c25" name="cb" value='Original' class="example">
      					 <label for="c25"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c26" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c27" name="cb" value='Original' class="example">
      					 <label for="c27"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c28" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
		...
		<tr>
				...
				<td>
   					 <input type="checkbox" id="c29" name="cb" value='Original' class="example">
      					 <label for="c29"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c30" name="cb" value='Duplicate' class="example">
...
JoSAA business rules]
				...
				<td>
   					 <input type="checkbox" id="c31" name="cb" value='Original' class="example">
      					 <label for="c31"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c32" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c33" name="cb" value='Original' class="example">
      					 <label for="c33"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c34" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c35" name="cb" value='Original' class="example">
      					 <label for="c35"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c36" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c37" name="cb" value='Original' class="example">
      					 <label for="c37"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c38" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c39" name="cb" value='Original' class="example">
      					 <label for="c39"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c40" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c41" name="cb" value='Original' class="example">
      					 <label for="c41"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c42" name="cb" value='Duplicate' class="example">
...
$('input.example').on('change', function() {
    $('input.example').not(this).prop('checked', false);  
			...
			<tr>
				...
				<td>
   					 <input type="checkbox" id="c43" name="cb" value='Original' class="example">
      					 <label for="c43"></label></label>
				</td>
				<td>
   					 <input type="checkbox" id="c44" name="cb" value='Duplicate' class="example">
