<!--@filename stu_semgradecarddw.pdf  @author sumit saxena(sumitsesaxena@gmail.com) -->
...
<tr><th>
	<center>Student Grade Card</center>
</th></tr></table>
    <!--     <div style="">-->

	<table border=1 style="width:100%;">
	   <tr> <?php //echo $this->sfeeid;?>
               <th style="text-align:justify;background-color:#dbdbdb;color:black;font-size:18px;">Grade Card Details</th>
            </tr>
	</table>
	<?php 
		$i= 0;
	...
	<td>
	   ...
	   <tr>
            <td style="width:33%;">Grade:<?php echo " ".$row->smr_grade;?></td>
            <td style="width:33%;">Final Grade: <?php echo " ".$row->smr_grade;?> </td>
