...
<title>View Rejected Scholarship Requests</title>
  <head>
...
<body>
    <table width="100%">
         <tr align="left">
				 ...
				 <td  width="10%"><?php echo anchor('scholarship/approvedscholar/', "Approved Scholarship", array('title' => 'Approved Scholarship Requests' ,'class' =>'top_parent'));?>
				 </td>
				
				 <?php
					 echo "<td align=\"center\"width=\"27%\">";
					 echo "<b>Rejected Scholarship Requests</b>";
					 echo "</td>";
				 ?>
