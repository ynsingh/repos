...
/* Re-populating form */
		 ...
		 $data['anou_expdate']['value'] = $this->input->post('anou_expdate', TRUE);
                 ...
                 if ($this->form_validation->run() == FALSE){
                        ...
                        $anou_title = $this->input->post('anou_title', TRUE);
                        $anou_description = $this->input->post('anou_description', TRUE);
		 ...
		 $arins_data = array(
					...
					'anoua_archivename' =>'SLCMS - '. $this->session->userdata('username'),
