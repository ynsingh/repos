 ...
 <script>
	...
	function getdepartment(val){
		var val=val;
	   	$.ajax({
		type: "POST",
		url: "<?php echo base_url();?>hrmindex.php/map/getdeptlist",
		data: {"campusname" : val},
		dataType:"html",
	...
	function getteacherlist(tl){
	        var tl=tl;
                $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>hrmindex.php/map/teacherlist",
                data: {"deptname" : tl},
                dataType:"html",
                success: function(data){
	...
	function getsubject(subj){
	   	...
	   	$.ajax({
	    	type: "POST",
                url: "<?php echo base_url();?>hrmindex.php/map/subjectlist",
	...
	function getpapername(paper){
	   	...
	   	$.ajax({
	    	type: "POST",
                url: "<?php echo base_url();?>hrmindex.php/map/paperlist",
      ...
      function getbranchname(branch){
                ...
                $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>hrmindex.php/map/branchlist",
