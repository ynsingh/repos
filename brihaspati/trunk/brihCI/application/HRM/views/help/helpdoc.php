...
<body>
	...
	<div class="head">Brihaspati Human Resource Management (BHRM)</div>
	<div class="content">
	<div class="sideleft">
        <div id="cssmenu">
        	<ul>
<li><a href="#AboutBrihaspatiHumanResourceManagement">About Brihaspati Human Resource Management (BHRM)</a></li>
  	   ...
  	   <li class='has-sub'><a href="#Map">Map</a>
           ...
           <li class='has-sub'><a href="#HRManagement">HR Management</a>
			<ul>
			<li><a href="#ListofAdvertisement">List of Advertisement</a></li>
			<li><a href="#ApplicationShortCode">Application Short Code</a></li>
			<li><a href="#ListofApplicant">List of Applicant</a></li>
			</ul>
	   ...
	   <li class='has-sub'><a href="#AuditTrails">Audit Trails</a>
	    ...
	    <li class='has-sub'><a href="#Profile">Profile</a>
			...
			<li><a href="#Logout">Logout</a></li>
                ...
                <div class="sideright">
					<section id="AboutBrihaspatiHumanResourceManagement">
					<div class="row-fluid">
						<h2>About Brihaspati Human Resource Management</h2>
					</div>
					<div class="row-fluid">
						<font size="4">
							<ol>
								<p align="justify" STYLE="line-height: 150%">
Brihaspati Human Resource Management is the management of human resources. It is designed by the HR Department to maximize employee performance in service of an employer's strategic objectives.
								</p>
							</ol>
						</font>
					</div>
					...
					<section id="Dashboard">
						...
						<img src="<?php echo base_url(); ?>uploads/HRM/helpscreenshot/dashboard.png" height="130%" width="100%">
						</div>
					</section>
...
<img src="<?php echo base_url(); ?>uploads/helpscreenshot/programcategory.png" height="80%" width="100%">
                                        </div>
                                        </section>
...
<img src="<?php echo base_url(); ?>uploads/helpscreenshot/viewprogramcategory.png" height="80%" width="100%">
                                        </div>
                                        </section>
...
Admin can also View Campus Program Seat List after adding Program Fees with Head Detail. We can edit and delete this data.
                                         ...
                                         <img src="<?php echo base_url(); ?>uploads/helpscreenshot/viewfees.png" height="90%" width="100%">      
					 </font>
                                         </div>
                                    </section>
...
<img src="<?php echo base_url(); ?>uploads/helpscreenshot/degreerule.png" height="100%" width="100%">
                                       </section>
...
<img src="<?php echo base_url(); ?>uploads/helpscreenshot/viewdegreerule.png" height="90%" width="100%">      
                                         </div>
                                    </section>
...
The format of add program fees with head list are given below:-
						...
						<tr>
                                         ...
                                         <img src="<?php echo base_url(); ?>uploads/helpscreenshot/semesterrule.png" height="90%" width="100%">       </font>
...
Admin can also View Semester Rule after adding Semester Rule details. Admin can edit and delete this data.
                                         ...
                                         <img src="<?php echo base_url(); ?>uploads/helpscreenshot/viewsemesterrule.png" height="60%" width="100%">       </font>
...
The format of add program fees with head list are given below:-
						...
						<tr>
                                         ...
                                         <img src="<?php echo base_url(); ?>uploads/helpscreenshot/mastergrade.png" height="90%" width="100%">       
                                         </div>
                                    </section>
...
Admin can also View Grade after adding grade details. Admin can edit and delete this data.
                                         ...
                                         <img src="<?php echo base_url(); ?>uploads/helpscreenshot/viewgrade.png" height="90%" width="100%">       
					</font>
...
Admin can also View Map with User Role List after adding Map User Role details. Admin can edit and delete this data.
 ...
 <section id="ListofAdvertisement">
                                        <div class="row-fluid">
                                        ...
                                        <div class="row-fluid">
                                                <font size="4">
                                                        <ol>
                                                                <p align="justify" STYLE="line-height: 150%">
From here admin can announcement about a job vacancy. Job advertisements are created by human resource professionals or external recruitment agencies working with the managers of departments who need to recruit staff.<br>
The format of Add Advertisement are given below:-
                                                <P ALIGN=JUSTIFY STYLE="margin-bottom: 0in; line-height: 150%">
                                                <table border="2px solid black" style="width:700px">
                                                <tr>
                                                <td><B>Field</B></td>
                                                ...
                                                <td>Enter Vacancy code.Ex:-001,002</td>
                                                </tr>
                                                <tr>
                                                <td><B>Advertisement No.</B></td>
                                                <td>Enter Advertisement No.Ex:-4/2017</td>
                                                </tr>
                                                <tr>
                                                <td><B>Post code</B></td>
 						...
 						<tr>
                                                ...
                                                <td>Enter Name of post.</td>
                                                </tr>
                                                <tr>
                                                <td><B>Name of department</B></td>
                                                <td>Enter Name of department.</td>
                                                </tr>
                                                <tr>
                                                <td><B>Vacancy for sc(In number)</B></td>
                                                <td>Enter Vacancy for sc(In number).</td>
                                                </tr>
						<tr>
                                                <td><B>Vacancy for st(In number)</B></td>
                                                <td>Enter Vacancy for st(In number).</td>
                                                </tr>
						<tr>
                                                <td><B>Vacancy for obc(In number)</B></td>
                                                <td>Enter Vacancy for obc(In number).</td>
                                                </tr>
						<tr>
                                                <td><B>Vacancy for ur(In number)</B></td>
                                                <td>Enter Vacancy for ur(In number).</td>
                                                </tr>
						<tr>
                                                <td><B>Vacancy for pwd(In number)</B></td>
                                                <td>Enter Vacancy for pwd(In number).</td>
                                                </tr>
						<tr>
                                                <td><B>Pay band/Grade pay</B></td>
                                                <td>Enter Pay band/Grade pay.</td>
                                                </tr>
						<tr>
                                                <td><B>Post emoluments</B></td>
                                                <td>Enter Post emoluments.</td>
                                                </tr>
						<tr>
                                                <td><B>Job age limit</B></td>
                                                <td>Enter Job age limit.</td>
                                                </tr>
						<tr>
                                                <td><B>Job group</B></td>
                                                <td>Enter Job group.</td>
                                                </tr>
						<tr>
                                                <td><B>Job Essential</B></td>
                                                <td>Enter Job Essential.</td>
                                                </tr>
						 <tr>
                                                <td><B>Job experience</B></td>
                                                <td>Enter Job experience.</td>
                                                </tr>
					        <tr>
                                                <td><B>Job desirable</B></td>
                                                <td>Enter Job desirable.</td>
                                                </tr>
						<tr>
                                                <td><B>Job responsible</B></td>
                                                <td>Enter Job responsible.</td>
                                                </tr>
					        <tr>
                                                <td><B>Start date online form</B></td>
                                                <td>Select Start date online form.</td>
                                                </tr>
 						<tr>
                                                <td><B>Last date online form</B></td>
                                                <td>Select last date online form.</td>
                                                </tr> 
						<tr>
                                                <td><B>Last date form reached</B></td>
                                                <td>Select Last date form reached.</td>
                                                </tr>
...
<img src="<?php echo base_url(); ?>uploads/HRM/helpscreenshot/advertisment.png" height="110%" width="100%">
                                         </div>
                                    </section>
...
<section id="ApplicationShortCode">
                                        <div class="row-fluid">
                                                <h2>Application Short Code</h2>
                                        </div>
</section>
<section id="ListofApplicant">
                                        <div class="row-fluid">
...
Admin can also view subject paper list after adding subject paper Detail. We can edit and delete this data.
                                         ...
                                         <img src="<?php echo base_url(); ?>uploads/helpscreenshot/viewsublist.png" height="70%" width="100%">      
					 </font>
                                         </div>
                                    </section>
...
The format of add subject paper with teacher list are given below:-
 ...
 <img src="<?php echo base_url(); ?>uploads/helpscreenshot/mapsubjectandpaperwithteacher.png" height="115%" width="100%">  
                                         </div>
                                    </section>
...
Admin can also view Subject and Paper with Teacher list after adding Subject and Paper with Teacher Detail. We can edit and delete this data.
                                         ...
                                         <img src="<?php echo base_url(); ?>uploads/helpscreenshot/viewsubtech.png" height="70%" width="100%">      
					 </font>
                                         </div>
                                    </section>
...
The format of add Subject and Paper with Prerequisite list are given below:-
 ...
 <img src="<?php echo base_url(); ?>uploads/helpscreenshot/mapsubjectandpaperwithprerequisite.png" height="100%" width="100%">  
                                         </div>
                                    </section>
...
Admin can also view Subject and Paper with Prerequisite after adding Subject and Paper with Prerequisite Detail. We can edit and delete this data.
                                         ...
                                         <img src="<?php echo base_url(); ?>uploads/helpscreenshot/viewsubprerequisite.png" height="70%" width="100%">      
					 </font>
                                         </div>
                                    </section>
<section id="MapSubjectandSemester">
                                        <div class="row-fluid">
                                                <h2>MapSubjectandSemester</h2>
                                        </div>
                                        <div class="row-fluid">
                                                <font size="4">
                                                        <ol>
...
The format of add subject paper list are given below:-
 ...
 <img src="<?php echo base_url(); ?>uploads/helpscreenshot/mapsubjectandsemester.png" height="100%" width="100%">  
                                         </div>
                                    </section>
<section id="ViewMapSubjectandPaperwithPrerequisite">
                                        <div class="row-fluid">
...
Admin can also view Map Subject and Semester after adding Subject and Semester Detail. We can edit and delete this data.
                                         ...
                                         <img src="<?php echo base_url(); ?>uploads/helpscreenshot/viewsubsem.png" height="70%" width="100%">      
					 </font>
                                         </div>
                                    </section-->
...
<img src="<?php echo base_url(); ?>uploads/helpscreenshot/fmarchive.png" height="80%" width="100%">
                                         </div>
                                    </section>
...
<img src="<?php echo base_url(); ?>uploads/helpscreenshot/psparchive.png" height="80%" width="100%">
                                         </div>
                                    </section>
...
<img src="<?php echo base_url(); ?>uploads/helpscreenshot/srarchive.png" height="80%" width="100%">
                                         </div>
                                    </section>
