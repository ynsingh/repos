				...
				echo "<li>";
					echo "<a href=" . ">HRManagement</a>";
                                echo "<ul>";
                                        ...
                                        echo "</li>";
                                        echo "<li>";
                                                echo anchor('hrmgmt/viewlistapplicant', 'List of Applicant', array('title' => 'List of Applicant'));
                                        echo "</li>";
				echo "</ul>";
				echo "</li>";
			echo "<li>";
				echo "<a href=" . ">HRManagement</a>";
                                echo "<ul>";
                                        echo "<li>";
                                                echo anchor('hrmgmt/viewadvirtisement', 'List of Advirtisement', array('title' => 'List of Advirtisement'));
                                        echo "</li>";
                                        echo "<li>";
                                                echo anchor('hrmgmt/viewappcode', 'Application Short Code', array('title' => 'List of short code'));
                                        echo "</li>";
