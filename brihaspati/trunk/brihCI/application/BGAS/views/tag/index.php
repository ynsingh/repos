<?php
	...
	foreach ($tags_q->result() as $row)
	{
		...
		echo " &nbsp;";
		echo anchor('tag/delete/' . $row->id , img(array('src' => asset_url() . "assets/bgas/images/icons/delete.png", 'border' => '0', 'alt' => 'Delete Tag', 'class' => "confirmClick", 'title' => "Delete Tag")), array('title' => 'Delete  Tag')) . "</td>";
		echo "</tr>";
