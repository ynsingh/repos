			...
			foreach ($query->result() as $id => $row)
			{
				...
				if($search == "cl_balance") {
					...
					if(strstr($amount1, $c)) {
						...
						echo " &nbsp;" . anchor('ledger/delete/' . $row->id, img(array('src' => asset_url() . "assets/bgas/images/icons/delete.png", 'border' => '0', 'alt' => 'Delete Ledger')), array('class' => "confirmClick", 'title' => "Delete Ledger")) . "</td>";
						echo "</tr>";
						$check++;
					}
				}
