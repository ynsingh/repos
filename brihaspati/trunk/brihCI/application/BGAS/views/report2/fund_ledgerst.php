<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	if ( ! $print_preview)
	{
		echo form_open('report2/fund_ledgerst/' . $ledger_id);
		echo "<p>";
		...
		echo form_label('Ledger Account', 'ledger_id');
                echo " ";
		echo form_input_fund_ledger('ledger_id', $ledger_id);
		echo " ";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	...
	{		
		...
		if ( ! $page_count)
			$page_count = "0";
		$config['base_url'] = site_url('report/fund_ledgerst/' . $ledger_id);
	...
	if ($ledger_id != 0)
	{
		...
		echo "<table border=0 cellpadding=\"5\" class=\"simple-table fund_ledgerst-table\" width=\"$width\">";
		...
		/*echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo form_open('report/download/fund_ledgerst/' . $ledger_id);
