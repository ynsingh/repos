<?php	
	...
	foreach ($users->result()  as $row)
	{
		...
		if($user_components == 'BGAS'){
			...
			echo "<td>" .anchor('admin/user/delete/'.$row->id, img(array('src' => asset_url() . "assets/bgas/images/icons/delete.png", 'border' => '0', 'alt' => 'Delete Student')), array('class' => "confirmClick", 'title' => "Delete User")) . "</td>";
		}
