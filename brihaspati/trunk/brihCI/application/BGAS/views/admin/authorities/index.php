...
foreach ($users->result()  as $row)
{
	...
	echo "<td>" .anchor('admin/authorities/delete/'.$row->id, img(array('src' => asset_url() . "assets/bgas/images/icons/delete.png", 'border' => '0', 'alt' => 'Delete Authority')), array('class' => "confirmClick", 'title' => "You Want To Delete Authority from System")) . "</td>";
