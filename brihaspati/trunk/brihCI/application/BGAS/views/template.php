...
<?php echo link_tag(asset_url() . 'images/favicon.ico', 'shortcut icon', 'bgas/css/image/ico'); ?>
...
<link type="text/css" rel="stylesheet" href="<?php echo asset_url(); ?>assets/bgas/css/loading.css">
<?php
			...
			echo "<li>";
						...
						echo  anchor('','Balance Sheet');
						 echo "<ul>";
							echo "<li>";
								...
								echo anchor(prep_url( base_url().'bgasindex.php/report/balancesheet'), 'Corporate Format', 'target="_blank"');
							echo "</li>";
							echo "<li>";
								if($chart_account == "mhrd"){
								 //echo anchor('report/new_balancesheet', 'MHRD Format', array('title' => 'Balance Sheet MHRD Format', 'class' => 'loading'));
								
								echo anchor(prep_url( base_url().'bgasindex.php/report/new_balancesheet'), 'MHRD Format','target="_blank"');
								}
							...
							//echo "<li>";
                                ...
                                echo anchor(prep_url( base_url().'bgasindex.php/report/new_mhrd'), 'MHRD Format 2015','target="_blank"');  
                                                        }
                                                        echo "</li>";
				...
				//	echo "</li>";
                                                ...
                                                echo  anchor('','Income & Expenditure');
                                                 echo "<ul>";
                                                        echo "<li>";
                                                        	...
                                                        	echo anchor(prep_url( base_url().'bgasindex.php/report/profitandloss'), 'Corporate Format', 'target="_blank"');
                                                        echo "</li>";
                                                        echo "<li>";
                                                        if($chart_account == "mhrd"){
                                                               // echo anchor('report2/profitandloss_mhrd', 'MHRD Format', array('title' => 'Income & Expenditure', 'class' => 'loading'));
                                                        		echo anchor(prep_url( base_url().'bgasindex.php/report2/profitandloss_mhrd'), 'MHRD Format', 'target="_blank"');
                                                        }
                                                        //echo "</li>";
                                                        //echo "<li>";
                                                        if($chart_account == "mhrd2015"){
                                                               // echo anchor('report2/profitandloss_mhrd', 'MHRD Format', array('title' => 'Income & Expenditure', 'class' => 'loading'));
                                                        		echo anchor(prep_url( base_url().'bgasindex.php/report2/profitandloss_mhrdnew'), 'MHRD Format 2015', 'target="_blank"');
                                                        }
                                                        echo "</li>";
                                                  echo "</ul>";
                                         echo "</li>";
					echo "<li>";
						...
						echo anchor(prep_url( base_url().'bgasindex.php/report/paymentreceipt'), 'Payment & Receipt', 'target="_blank"');
					echo "</li>";
					echo "<li>";
						...
						echo "<ul>";
							echo "<li>";
								//echo anchor('unspentbalance/planreport', 'Plan Report', array('title' => 'Plan Report', 'class' => 'loading'));
								 echo anchor(prep_url( base_url().'bgasindex.php/unspentbalance/planreport'), 'Plan Report', 'target="_blank"');
							echo "</li>";
							echo "<li>";
								//echo anchor('unspentbalance/nonplanreport', 'Non-Plan Report', array('title' => 'Non-Plan Report', 'class' => 'loading'));
								echo anchor(prep_url( base_url().'bgasindex.php/unspentbalance/nonplanreport'), 'Non-Plan Report', 'target="_blank"');
							echo "</li>";
							echo "<li>";
								//echo anchor('unspentbalance/summaryreport', 'Summary Report', array('title' => 'Summary Report', 'class' => 'loading'));
								echo anchor(prep_url( base_url().'bgasindex.php/unspentbalance/summaryreport'), 'Summary Report', 'target="_blank"');
							echo "</li>";
						echo "</ul>";
					echo "</li>"; 
				echo "</ul>";
	...
	echo "<div id=\"content\">";
		...
		<div id="main">
			...
			<div class='popup'>
				<div class='cnt223'>
					<p>
						<img src="<?php echo asset_url(); ?>assets/bgas/images/loadingAnimation.gif" alt="loading...">
					</p>
				</div>
			</div>
			<?php if (isset($nav_links)) {
				...
				foreach ($nav_links as $link => $title) {
					if ($title == "Print Preview")
						echo "<li>" . anchor_popup($link, $title, array('title' => $title, 'class' => 'nav-links-item', 'style' => 'background-image:url(\'' . asset_url() . 'assets/bgas/images/buttons/navlink.png\');', 'width' => '1024')) . "</li>";
					else
