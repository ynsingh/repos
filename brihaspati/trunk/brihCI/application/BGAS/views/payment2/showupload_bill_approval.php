...
<tbody>
	...
	//	echo "<tr>";
		...
		if($bill_ext == "pdf")
			echo "<td class=\"thickbox\">".anchor_popup(('../uploads/BGAS/Bills/'.$row->bill_name), $row->bill_name, $atts)."</td>";
		else
			echo "<td class=\"thickbox\">".anchor_popup(('../uploads/BGAS/Bills/'.$row->bill_name), $row->bill_name,$atts,"class=\"thickbox\"")."</td>";
