...
//			}
	...
	$('.ledger-dropdown').live('change', function() {
		...
		bank_cash = '';
		var cheque = $(this).parent().next().next().next().children().attr('value');
...
*/
		...
		*/
		...
		echo "<td>" . form_dropdown_payt('ledger_payt[' . $i . ']', isset($ledger_payt[$i]) ? $ledger_payt[$i] : "1","class =\"pay_type\"") . "</td>";
...
*/
	...
	echo "<tr id=\"entry-total\"><td colspan=2><strong>Total</strong></td><td id=\"dr-total\">0</td><td id=\"cr-total\">0</td><td>" . img(array('src' => asset_url() . "assets/bgas/images/icons/gear.png", 'border' => '0', 'alt' => 'Recalculate Total', 'class' => 'recalculate', 'title' => 'Recalculate Total')) . "</td><td></td><td></td></tr>";
