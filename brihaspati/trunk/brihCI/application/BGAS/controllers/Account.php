...
function __construct() {
	...
	function index()
	{
		...
		$this->template->set('nav_links', array('group/add_fund_group' => 'Add Fund Group','group/add_spons_project' => 'Add Sponsored Project / Fellowship','group/add' => 'Add Group','ledger/add' => 'Add Ledger'));
