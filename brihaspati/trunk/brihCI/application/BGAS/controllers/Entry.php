...
//			$entry_added_message .= anchor('entry/edit/' . $entry_added_type_label_temp . "/" . $entry_added_id_temp, 'Edit', array('class' => 'anchor-link-a')) . " | ";
	...
	
	{
		...
		/**
                ...
                $this->db->select('forward_refrence_id, backward_refrence_id, submitted_by, verified_by, vendor_voucher_number, sanc_letter_date, purchase_order_no');
				...
				$data['purchase_order_number'] = $ref->purchase_order_no;
	...
	function edit($entry_type, $entry_id = 0)
	{
		...
		$val2 = $cur_entry->sanc_type;
                $val3 = $cur_entry->sanc_value;
		//$bank_name='';
		//$name='';
                ...
                else
		{
			...
			$data['purchase_order_no'] = array(
                        	...
                        	'maxlength' => '100',
                        	'size' => '11',
                        	'value' => $cur_entry->purchase_order_no,
                	);
	...
	function download($entry_type, $entry_id = 0)
	{
		...
		$data['cur_entry'] = $cur_entry;
                ...
                $data['purchase_order_number'] = $cur_entry->purchase_order_no;
...
*/
	...
	//	echo $email_port;
		...
		else
		{
			...
			$entry_data['purchase_order_number'] = $cur_entry->purchase_order_no;	
			/* Getting Ledger details */
...
*/
		...
		echo '<td>';
		echo img(array('src' => asset_url() . "assets/bgas/images/icons/add.png", 'border' => '0', 'alt' => 'Add Ledger', 'class' => 'addrow'));
		echo '</td>';
		echo '<td>';
		echo img(array('src' => asset_url() . "assets/bgas/images/icons/delete.png", 'border' => '0', 'alt' => 'Remove Ledger', 'class' => 'deleterow'));
		echo '</td>';
