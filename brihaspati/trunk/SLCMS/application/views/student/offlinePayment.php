...
echo "<center>";
	...
	if($this->session->flashdata('msg')){
		echo "<div style='font-size:20px;text-align:center;background-color:#DFF2BF;width:50%;height:30px;color:black;'>";
...
<span style="font-size:15px;"><b>Note : If any cirumstances your fee detail is wrong so your registration is cancelled.</b></span>
