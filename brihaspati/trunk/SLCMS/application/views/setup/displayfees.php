    ...
    <body>
		...
		<th>Action</th>
		 <!-- <th></th>-->
            ...
            <tbody>
                    <?php $count =0?>
              	    <?php if( count($this->fmresult) ): ?>
                    <?php foreach($this->fmresult as $row){ ?>
                         <tr align="center">
			 <td> <?php echo ++$count; ?> </td>
			 <?php  echo "<td>" . $this->common_model->get_listspfic1('program','prg_name','prg_id',$row->fm_programid)->prg_name. "</td>";?>
