...
//				echo "<a href=" . base_url() . ">Dashboard</a>";
			...
			//	echo anchor('setup', 'Setup', array('title' => 'Setup'));
				...
				echo "<ul>";
					...
					echo "</li>";				
					echo "<li>";
						echo anchor('setup/programcat', 'Program Category', array('title' => 'Program Category'));
					echo "</li>";
					echo "<li>";
			...
			echo "<li>";
				...
				echo "<ul>";
					...
					echo "</li>";
					echo "<li>";
						echo anchor('archive/prgsubja', 'Program Subject Archive', array('title' => 'Program Subject Archive'));
					echo "</li>";
					echo "<li>";
						echo anchor('archive/subpapera', 'Subject Paper Archive', array('title' => 'Subject Paper Archive'));
					echo "</li>";
				echo "</ul>";
			echo "</li>";
			echo "<li>";
