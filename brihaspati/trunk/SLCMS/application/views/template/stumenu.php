...
//				echo "<a href=" . base_url() . ">Dashboard</a>";
			...
			echo "<li>";
				...
				echo "<ul>";
					echo "<li>";
						echo anchor('student/admissionform', 'Admission Form', array('title' => 'Downlaod Admission Form'));
					echo "</li>";
					echo "<li>";
						echo anchor('student/examform', 'Exam Form', array('title' => 'Downlaod Exam Form'));
					echo "</li>";
					echo "<li>";
						echo anchor('student/feesform', 'Fees Receipt', array('title' => 'Downlaod Fees Receipt'));
					echo "</li>";
					echo "<li>";
