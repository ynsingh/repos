        ...
        <table style="margin-left:50px;">
           ...
           <form action="<?php echo site_url('map/mapscprgseat');?>" method="POST" >
            <tr>
                ...
                <td>
                    <?php echo form_dropdown('campus', $campus, '', 'class="abc"');?>
            ...
            <tr>
                ...
                <td>
                 <?php echo form_dropdown('program',$program,'', 'class="abc"');?> 
                </td>
            </tr>
            <tr>
                <td>Number of Seat :</td>
                <td>
                   <input type="text" name="seatno" value="" size="34" >
                </td>
            ...
            <tr>
                <td>Gender :</td>
                <td>
                    <select name="gender"class="my_dropdown" style="width:300px;">
