var gWebflvWidth=600;
var gWebflvHeight=480;
//var gWebflvWidth=400;
//var gWebflvHeight=300;
...
function webflv_mediaplayer_createPlayer(itemId,videoId,playMode) {
        ...
        gWebflvSeekInit = 2;
         var strVideoEmbed = ' <div id="mediaplayer-'+itemId+'" style="text-align:center;" class="videoPlayer"> <object align="middle"  id="videoplayerobject-'+itemId+'" width="'+width+'" height="'+height+'"><param value="/brihaspati2/images/Flvimages/weflv.swf?autoplay'+playMode+'&fileName='+videoId+'&refId='+itemId+'" name="movie"><param value="high" name="quality"><param value="true" name="swLiveConnect"><param value="#000000" name="bgcolor"> <embed type="application/x-shockwave-flash" allowScriptAccess="sameDomain" align="middle" bgcolor="#000000" swLiveConnect="true" quality="high" src="/brihaspati2/images/Flvimages/webflv.swf?autoplay='+playMode+'&fileName='+videoId+'&refId='+itemId+'" mayscript="true" id="videoplayerembed-'+itemId+'" width="'+width+'" height="'+height+'"></embed> </object> </div>';
        ...
        playerElement.setAttribute("style","position:relative;width:480px;height:24px;");
	...
	sliderElement.setAttribute("style","position:absolute;border:1px solid gray;top:4px;left:52px;background-color:black;width:425px;height:18px;");
